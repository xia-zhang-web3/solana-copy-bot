...
V2 status snapshot. The scheduled server unit intentionally avoids the
incremental evidence writer so the live runtime DB does not build a large WAL
or contend with ingestion during routine refreshes.
