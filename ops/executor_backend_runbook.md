...
# COPYBOT_EXECUTOR_IDEMPOTENCY_DB_PATH=state/executor_idempotency.sqlite3
# COPYBOT_EXECUTOR_IDEMPOTENCY_CLAIM_TTL_SEC=60
# COPYBOT_EXECUTOR_IDEMPOTENCY_RESPONSE_RETENTION_SEC=604800
# COPYBOT_EXECUTOR_IDEMPOTENCY_RESPONSE_CLEANUP_BATCH_SIZE=500
# COPYBOT_EXECUTOR_IDEMPOTENCY_RESPONSE_CLEANUP_MAX_BATCHES_PER_RUN=4
# COPYBOT_EXECUTOR_IDEMPOTENCY_RESPONSE_CLEANUP_WORKER_TICK_SEC=300
# NOTE: batch_size * max_batches_per_run must be <= 200000 (fail-closed startup guard)
```
