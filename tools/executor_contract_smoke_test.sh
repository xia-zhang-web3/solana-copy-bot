...
contract_guard_tests=(
  ...
  "resolve_signer_source_config_accepts_file_source_with_matching_pubkey"
  ...
  "executor_config_from_env_rejects_duplicate_route_allowlist_entries"
  ...
  "executor_config_from_env_rejects_route_specific_send_rpc_auth_without_send_rpc_endpoint"
  "executor_config_from_env_rejects_route_specific_send_rpc_auth_file_without_send_rpc_endpoint"
  ...
  "executor_config_from_env_rejects_global_send_rpc_auth_without_any_send_rpc_endpoint"
  "executor_config_from_env_rejects_global_send_rpc_auth_file_without_any_send_rpc_endpoint"
  ...
  "healthz_payload_includes_send_rpc_route_topology"
