...
EOF_EXECUTOR_UPSTREAM_BOOTSTRAP
  cat >"$executor_env_upstream_submit_verify_strict" <<'EOF_EXECUTOR_UPSTREAM_SUBMIT_VERIFY_STRICT'
COPYBOT_EXECUTOR_BACKEND_MODE=upstream
COPYBOT_EXECUTOR_UPSTREAM_SUBMIT_URL=http://127.0.0.1:18080/submit
COPYBOT_EXECUTOR_UPSTREAM_SIMULATE_URL=http://127.0.0.1:18080/simulate
COPYBOT_EXECUTOR_SUBMIT_VERIFY_STRICT=true
COPYBOT_EXECUTOR_SUBMIT_VERIFY_RPC_URL=http://127.0.0.1:18080/verify
EOF_EXECUTOR_UPSTREAM_SUBMIT_VERIFY_STRICT
  cat >"$executor_env_upstream_submit_verify_invalid" <<'EOF_EXECUTOR_UPSTREAM_SUBMIT_VERIFY_INVALID'
COPYBOT_EXECUTOR_BACKEND_MODE=upstream
COPYBOT_EXECUTOR_UPSTREAM_SUBMIT_URL=http://127.0.0.1:18080/submit
COPYBOT_EXECUTOR_UPSTREAM_SIMULATE_URL=http://127.0.0.1:18080/simulate
...
EOF_EXECUTOR_INVALID
  ...
  assert_field_equals "$upstream_output" "go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$upstream_output" "submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$upstream_output" "submit_verify_guard_reason_code" "gate_disabled"
  ...
  local strict_submit_verify_pass_output
  strict_submit_verify_pass_output="$(
    PATH="$FAKE_BIN_DIR:$PATH" \
      DB_PATH="$db_path" \
      CONFIG_PATH="$config_path" \
      SERVICE="copybot-smoke-service" \
      EXECUTOR_ENV_PATH="$executor_env_upstream_submit_verify_strict" \
      GO_NOGO_REQUIRE_EXECUTOR_UPSTREAM="true" \
  ...
  assert_field_equals "$strict_submit_verify_pass_output" "go_nogo_require_submit_verify_strict" "true"
  assert_field_equals "$strict_submit_verify_pass_output" "executor_submit_verify_strict_observed" "true"
  assert_field_equals "$strict_submit_verify_pass_output" "executor_submit_verify_configured" "true"
  assert_field_equals "$strict_submit_verify_pass_output" "submit_verify_guard_verdict" "PASS"
  assert_field_equals "$strict_submit_verify_pass_output" "submit_verify_guard_reason_code" "submit_verify_strict_enabled"
  assert_field_equals "$strict_submit_verify_pass_output" "overall_go_nogo_verdict" "GO"
  assert_field_equals "$strict_submit_verify_pass_output" "overall_go_nogo_reason_code" "all_required_gates_pass"

  local strict_submit_verify_disabled_output
  strict_submit_verify_disabled_output="$(
    PATH="$FAKE_BIN_DIR:$PATH" \
      DB_PATH="$db_path" \
      CONFIG_PATH="$config_path" \
      SERVICE="copybot-smoke-service" \
  ...
  assert_field_equals "$strict_submit_verify_disabled_output" "go_nogo_require_submit_verify_strict" "true"
  assert_field_equals "$strict_submit_verify_disabled_output" "executor_submit_verify_strict_observed" "false"
  assert_field_equals "$strict_submit_verify_disabled_output" "submit_verify_guard_verdict" "WARN"
  assert_field_equals "$strict_submit_verify_disabled_output" "submit_verify_guard_reason_code" "submit_verify_strict_not_enabled"
  assert_field_equals "$strict_submit_verify_disabled_output" "overall_go_nogo_verdict" "NO_GO"
  assert_field_equals "$strict_submit_verify_disabled_output" "overall_go_nogo_reason_code" "submit_verify_guard_not_pass"

  local strict_submit_verify_invalid_output
  strict_submit_verify_invalid_output="$(
    PATH="$FAKE_BIN_DIR:$PATH" \
      DB_PATH="$db_path" \
      CONFIG_PATH="$config_path" \
      SERVICE="copybot-smoke-service" \
      EXECUTOR_ENV_PATH="$executor_env_upstream_submit_verify_invalid" \
      GO_NOGO_REQUIRE_EXECUTOR_UPSTREAM="true" \
      GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT="true" \
      GO_NOGO_TEST_MODE="true" \
      GO_NOGO_TEST_FEE_VERDICT_OVERRIDE="PASS" \
  ...
  assert_field_equals "$strict_submit_verify_invalid_output" "go_nogo_require_submit_verify_strict" "true"
  assert_field_equals "$strict_submit_verify_invalid_output" "executor_submit_verify_strict_observed" "unknown"
  assert_field_equals "$strict_submit_verify_invalid_output" "submit_verify_guard_verdict" "UNKNOWN"
  ...
  local invalid_submit_verify_bool_output=""
  if invalid_submit_verify_bool_output="$(
    PATH="$FAKE_BIN_DIR:$PATH" \
      DB_PATH="$db_path" \
      CONFIG_PATH="$config_path" \
      SERVICE="copybot-smoke-service" \
      GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT="sometimes" \
      bash "$ROOT_DIR/tools/execution_go_nogo_report.sh" 24 60 2>&1
  )"; then
    echo "expected execution_go_nogo_report.sh to fail for invalid GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT token" >&2
    exit 1
  else
    local invalid_submit_verify_bool_exit_code=$?
    if [[ "$invalid_submit_verify_bool_exit_code" -ne 1 ]]; then
      echo "expected exit code 1 for invalid GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT token, got $invalid_submit_verify_bool_exit_code" >&2
      echo "$invalid_submit_verify_bool_output" >&2
      exit 1
    fi
  fi
  assert_contains "$invalid_submit_verify_bool_output" "GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT must be a boolean token"
  assert_contains "$invalid_submit_verify_bool_output" "got: sometimes"
...
EOF_WINDOWED_EXECUTOR_ENV
  ...
  assert_field_equals "$strict_hold_output" "window_24h_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$strict_hold_output" "window_24h_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$strict_hold_output" "window_24h_submit_verify_guard_reason_code" "gate_disabled"
  ...
  assert_field_equals "$go_output" "window_24h_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$go_output" "window_24h_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$go_output" "window_24h_submit_verify_guard_reason_code" "gate_disabled"
...
EOF_ROUTE_FEE_EXECUTOR_ENV
  ...
  assert_field_equals "$hold_output" "window_24h_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$hold_output" "window_24h_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$hold_output" "window_24h_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$hold_output" "window_24h_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$hold_output" "window_24h_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$hold_output" "window_24h_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$hold_output" "window_24h_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$hold_output" "window_24h_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$hold_output" "window_24h_submit_verify_guard_reason_code" "gate_disabled"
  assert_field_equals "$hold_output" "go_nogo_require_confirmed_execution_sample" "false"
  assert_field_equals "$hold_output" "go_nogo_min_confirmed_orders" "1"
  assert_field_equals "$hold_output" "window_24h_go_nogo_require_confirmed_execution_sample" "false"
  ...
  assert_field_equals "$strict_nogo_output" "window_24h_go_nogo_require_jito_rpc_policy" "true"
  assert_field_equals "$strict_nogo_output" "window_24h_jito_rpc_policy_verdict" "WARN"
  assert_field_in "$strict_nogo_output" "window_24h_jito_rpc_policy_reason_code" "jito_policy_not_enabled" "route_profile_not_pass"
  assert_field_equals "$strict_nogo_output" "window_24h_go_nogo_require_fastlane_disabled" "true"
  assert_field_equals "$strict_nogo_output" "window_24h_fastlane_feature_flag_verdict" "PASS"
  assert_field_equals "$strict_nogo_output" "window_24h_fastlane_feature_flag_reason_code" "fastlane_disabled"
  ...
  assert_field_equals "$strict_nogo_output" "window_24h_go_nogo_require_confirmed_execution_sample" "false"
  assert_field_equals "$strict_nogo_output" "window_24h_go_nogo_min_confirmed_orders" "1"
  assert_field_equals "$strict_nogo_output" "window_24h_confirmed_execution_sample_guard_verdict" "SKIP"
  assert_field_equals "$strict_nogo_output" "window_24h_confirmed_execution_sample_guard_reason_code" "gate_disabled"
  ...
  assert_field_equals "$final_hold_output" "go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$final_hold_output" "signoff_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$final_hold_output" "signoff_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$final_hold_output" "signoff_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$final_hold_output" "go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$final_hold_output" "signoff_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$final_hold_output" "signoff_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$final_hold_output" "signoff_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$final_hold_output" "go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$final_hold_output" "signoff_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$final_hold_output" "signoff_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$final_hold_output" "signoff_nested_submit_verify_guard_reason_code" "gate_disabled"
  assert_field_equals "$final_hold_output" "go_nogo_require_confirmed_execution_sample" "false"
  assert_field_equals "$final_hold_output" "go_nogo_min_confirmed_orders" "1"
  assert_field_equals "$final_hold_output" "signoff_nested_go_nogo_require_confirmed_execution_sample" "false"
  ...
  assert_field_equals "$final_go_output" "go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$final_go_output" "signoff_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$final_go_output" "signoff_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$final_go_output" "signoff_nested_submit_verify_guard_reason_code" "gate_disabled"
  assert_field_equals "$final_go_output" "go_nogo_require_confirmed_execution_sample" "false"
  assert_field_equals "$final_go_output" "go_nogo_min_confirmed_orders" "1"
  assert_field_equals "$final_go_output" "signoff_nested_go_nogo_require_confirmed_execution_sample" "false"
  ...
  assert_field_equals "$final_go_windows_1_6_output" "go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$final_go_windows_1_6_output" "signoff_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$final_go_windows_1_6_output" "signoff_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$final_go_windows_1_6_output" "signoff_nested_submit_verify_guard_reason_code" "gate_disabled"
  ...
  assert_field_equals "$final_bundle_output" "signoff_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$final_bundle_output" "signoff_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$final_bundle_output" "signoff_nested_submit_verify_guard_reason_code" "gate_disabled"
...
EOF_DEVNET_EXECUTOR_ENV
  ...
  assert_field_equals "$output" "go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$output" "go_nogo_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$output" "go_nogo_submit_verify_guard_reason_code" "gate_disabled"
  ...
  if [[ "$case_profile" != "fast" ]]; then
    ...
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_simulate_returns_canonical_identity_echoes_on_success"
    ...
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_submit_rejects_network_fee_mismatch_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_submit_rejects_null_network_fee_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_submit_rejects_slippage_bps_mismatch_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_submit_rejects_compute_budget_mismatch_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_submit_rejects_tip_lamports_mismatch_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_submit_accepts_matching_upstream_policy_echoes"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q parse_upstream_outcome_"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_submit_rejects_non_boolean_upstream_ok_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q handle_submit_rejects_non_boolean_upstream_retryable_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q verify_submit_signature_uses_fallback_after_primary_non_object_status_row"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-adapter -q verify_submit_signature_rejects_invalid_confirmation_status_type_when_strict"
    ...
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q upstream_outcome_"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q submit_response_policy_echoes_"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q handle_submit_rejects_non_boolean_upstream_retryable_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q handle_submit_rejects_slippage_bps_mismatch_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q handle_submit_rejects_compute_budget_mismatch_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q handle_submit_rejects_tip_policy_mismatch_before_send_rpc"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q handle_submit_accepts_matching_upstream_policy_echoes"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q verify_submit_signature_uses_fallback_after_primary_non_object_status_row"
    assert_contains "$tests_enabled_artifact_text" "cargo test -p copybot-executor -q verify_submit_signature_rejects_invalid_confirmation_status_type_when_strict"
  fi
...
run_executor_rollout_evidence_case() {
  ...
  assert_field_equals "$pass_output" "rehearsal_nested_go_nogo_require_jito_rpc_policy" "false"
  ...
  assert_field_equals "$pass_output" "rehearsal_nested_go_nogo_require_confirmed_execution_sample" "true"
  assert_field_equals "$pass_output" "rehearsal_nested_go_nogo_min_confirmed_orders" "1"
  assert_field_equals "$pass_output" "rehearsal_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$pass_output" "rehearsal_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$pass_output" "rehearsal_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$pass_output" "rehearsal_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$pass_output" "rehearsal_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$pass_output" "rehearsal_nested_confirmed_execution_sample_guard_verdict" "PASS"
  assert_field_equals "$pass_output" "rehearsal_nested_confirmed_execution_sample_guard_reason_code" "confirmed_orders_sufficient"
  ...
  assert_field_equals "$rollout_bundle_output" "go_nogo_require_submit_verify_strict" "false"
  ...
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_go_nogo_require_jito_rpc_policy" "false"
  ...
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  if invalid_submit_verify_bool_output="$(
    ...
    echo "expected NO_GO exit for executor rollout helper when GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT token is invalid" >&2
    exit 1
  else
    local invalid_submit_verify_bool_exit_code=$?
    if [[ "$invalid_submit_verify_bool_exit_code" -ne 3 ]]; then
      echo "expected NO_GO exit code 3 for invalid executor rollout submit-verify bool token, got $invalid_submit_verify_bool_exit_code" >&2
      echo "$invalid_submit_verify_bool_output" >&2
      exit 1
    fi
  fi
  assert_contains "$invalid_submit_verify_bool_output" "GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT must be a boolean token"
  assert_field_equals "$invalid_submit_verify_bool_output" "executor_rollout_reason_code" "input_error"
  ...
  assert_field_equals "$precheck_profile_output" "go_nogo_require_submit_verify_strict" "false"
  ...
  assert_field_equals "$precheck_profile_output" "rehearsal_nested_go_nogo_require_jito_rpc_policy" "n/a"
  ...
  assert_field_equals "$precheck_profile_output" "rehearsal_nested_jito_rpc_policy_verdict" "n/a"
  assert_field_equals "$precheck_profile_output" "rehearsal_nested_jito_rpc_policy_reason_code" "n/a"
  assert_field_equals "$precheck_profile_output" "rehearsal_nested_go_nogo_require_fastlane_disabled" "n/a"
  assert_field_equals "$precheck_profile_output" "rehearsal_nested_fastlane_feature_flag_verdict" "n/a"
  assert_field_equals "$precheck_profile_output" "rehearsal_nested_fastlane_feature_flag_reason_code" "n/a"
  ...
  assert_field_equals "$rehearsal_only_profile_output" "go_nogo_require_submit_verify_strict" "false"
  ...
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_go_nogo_require_jito_rpc_policy" "false"
  ...
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$final_output" "go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$final_output" "go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$final_output" "rollout_nested_go_nogo_require_jito_rpc_policy" "false"
  ...
  assert_field_equals "$final_output" "rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$final_output" "rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$final_output" "rollout_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$final_output" "rollout_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$final_output" "rollout_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  assert_field_equals "$final_output" "rollout_nested_go_nogo_require_submit_verify_strict" "false"
  ...
  assert_field_equals "$final_bundle_output" "rollout_nested_go_nogo_require_jito_rpc_policy" "false"
  ...
  assert_field_equals "$final_bundle_output" "rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$final_bundle_output" "rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$final_bundle_output" "rollout_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$final_bundle_output" "rollout_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$final_bundle_output" "rollout_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  assert_field_equals "$final_bundle_output" "rollout_nested_go_nogo_require_submit_verify_strict" "false"
  ...
  assert_field_equals "$final_upstream_override_output" "go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$final_upstream_override_output" "go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$final_upstream_override_output" "go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$final_upstream_override_output" "rollout_nested_go_nogo_require_executor_upstream" "false"
  assert_field_equals "$final_upstream_override_output" "rollout_nested_go_nogo_require_jito_rpc_policy" "false"
  ...
  assert_field_equals "$final_upstream_override_output" "rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$final_upstream_override_output" "rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$final_upstream_override_output" "rollout_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$final_upstream_override_output" "rollout_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$final_upstream_override_output" "rollout_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  assert_field_equals "$final_upstream_override_output" "rollout_nested_go_nogo_require_submit_verify_strict" "false"
  ...
  local final_invalid_submit_verify_bool_output=""
  if final_invalid_submit_verify_bool_output="$(
    PATH="$fake_curl_bin:$FAKE_BIN_DIR:$PATH" \
      DB_PATH="$db_path" \
      EXECUTOR_ENV_PATH="$executor_env_path" \
      ADAPTER_ENV_PATH="$adapter_env_path" \
      CONFIG_PATH="$config_path" \
      SERVICE="copybot-smoke-service" \
      OUTPUT_ROOT="$TMP_DIR/executor-final-package-invalid-submit-verify-bool" \
      GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT="sometimes" \
      bash "$ROOT_DIR/tools/executor_final_evidence_report.sh" 24 60 2>&1
  )"; then
    echo "expected NO_GO exit for executor final package helper when GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT token is invalid" >&2
    exit 1
  else
    local final_invalid_submit_verify_bool_exit_code=$?
    if [[ "$final_invalid_submit_verify_bool_exit_code" -ne 3 ]]; then
      echo "expected NO_GO exit code 3 for executor final invalid submit-verify bool token, got $final_invalid_submit_verify_bool_exit_code" >&2
      echo "$final_invalid_submit_verify_bool_output" >&2
      exit 1
    fi
  fi
  assert_contains "$final_invalid_submit_verify_bool_output" "GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT must be a boolean token"
  assert_field_equals "$final_invalid_submit_verify_bool_output" "final_executor_package_reason_code" "input_error"
...
run_execution_server_rollout_report_case() {
  ...
  assert_field_equals "$output" "go_nogo_non_bootstrap_signer_guard_verdict" "SKIP"
  assert_field_equals "$output" "go_nogo_non_bootstrap_signer_guard_reason_code" "gate_disabled"
  assert_field_equals "$output" "go_nogo_confirmed_execution_sample_guard_verdict" "PASS"
  assert_field_equals "$output" "go_nogo_confirmed_execution_sample_guard_reason_code" "confirmed_orders_sufficient"
  ...
  assert_field_equals "$output" "executor_final_rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$output" "executor_final_rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$output" "executor_final_rollout_nested_go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$output" "adapter_final_rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$output" "adapter_final_rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$output" "adapter_final_rollout_nested_go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$skip_direct_output" "go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$skip_direct_output" "go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$skip_direct_output" "go_nogo_confirmed_execution_sample_guard_verdict" "SKIP"
  assert_field_equals "$skip_direct_output" "go_nogo_confirmed_execution_sample_guard_reason_code" "stage_disabled"
  ...
  assert_field_equals "$profile_skip_output" "go_nogo_require_confirmed_execution_sample" "true"
  assert_field_equals "$profile_skip_output" "go_nogo_min_confirmed_orders" "1"
  assert_field_equals "$profile_skip_output" "go_nogo_confirmed_execution_sample_guard_verdict" "SKIP"
  assert_field_equals "$profile_skip_output" "go_nogo_confirmed_execution_sample_guard_reason_code" "stage_disabled"
  ...
  assert_field_equals "$bundle_output" "go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$bundle_output" "go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$bundle_output" "go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$bundle_output" "package_bundle_artifacts_written" "true"
  assert_field_equals "$bundle_output" "package_bundle_exit_code" "0"
  ...
  assert_field_equals "$bundle_output" "executor_final_rollout_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$bundle_output" "executor_final_rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$bundle_output" "executor_final_rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$bundle_output" "executor_final_rollout_nested_go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$bundle_output" "adapter_final_rollout_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$bundle_output" "adapter_final_rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$bundle_output" "adapter_final_rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$bundle_output" "adapter_final_rollout_nested_go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$bundle_output" "adapter_final_rollout_nested_submit_verify_guard_reason_code" "gate_disabled"
  assert_sha256_field "$bundle_output" "package_bundle_sha256"
  assert_field_non_empty "$bundle_output" "package_bundle_path"
  assert_field_non_empty "$bundle_output" "package_bundle_sha256_path"
  assert_field_non_empty "$bundle_output" "package_bundle_contents_manifest"
  ...
  if invalid_submit_verify_bool_output="$(
    ...
    echo "expected server rollout report to fail for invalid GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT token" >&2
    exit 1
  else
    local invalid_submit_verify_bool_exit_code=$?
    if [[ "$invalid_submit_verify_bool_exit_code" -ne 3 ]]; then
      echo "expected server rollout invalid submit-verify bool exit code 3, got $invalid_submit_verify_bool_exit_code" >&2
      echo "$invalid_submit_verify_bool_output" >&2
      exit 1
    fi
  fi
  assert_contains "$invalid_submit_verify_bool_output" "GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT must be a boolean token"
  assert_field_equals "$invalid_submit_verify_bool_output" "server_rollout_verdict" "NO_GO"
  assert_field_equals "$invalid_submit_verify_bool_output" "server_rollout_reason_code" "input_error"
  ...
  assert_field_equals "$mock_backend_allowed_output" "go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$mock_backend_allowed_output" "go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$mock_backend_allowed_output" "executor_final_rollout_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$mock_backend_allowed_output" "executor_final_rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$mock_backend_allowed_output" "executor_final_rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$mock_backend_allowed_output" "executor_final_rollout_nested_go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$mock_backend_allowed_output" "adapter_final_rollout_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$mock_backend_allowed_output" "adapter_final_rollout_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$mock_backend_allowed_output" "adapter_final_rollout_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$mock_backend_allowed_output" "adapter_final_rollout_nested_go_nogo_require_fastlane_disabled" "false"
  ...
  assert_field_equals "$mock_backend_allowed_output" "adapter_final_rollout_nested_submit_verify_guard_reason_code" "gate_disabled"
...
EOF_ADAPTER_ROLLOUT_EXECUTOR_ENV
  ...
  assert_field_equals "$pass_output" "rehearsal_nested_go_nogo_require_ingestion_grpc" "false"
  assert_field_equals "$pass_output" "rehearsal_nested_go_nogo_require_non_bootstrap_signer" "false"
  assert_field_equals "$pass_output" "rehearsal_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$pass_output" "rehearsal_nested_executor_env_path" "$executor_env_path"
  assert_field_equals "$pass_output" "rehearsal_nested_executor_backend_mode_guard_verdict" "PASS"
  assert_field_equals "$pass_output" "rehearsal_nested_executor_backend_mode_guard_reason_code" "backend_mode_upstream"
  assert_field_equals "$pass_output" "rehearsal_nested_executor_upstream_endpoint_guard_verdict" "PASS"
  ...
  assert_field_equals "$pass_output" "rehearsal_nested_non_bootstrap_signer_guard_verdict" "SKIP"
  assert_field_equals "$pass_output" "rehearsal_nested_non_bootstrap_signer_guard_reason_code" "gate_disabled"
  assert_field_equals "$pass_output" "rehearsal_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$pass_output" "rehearsal_nested_submit_verify_guard_reason_code" "gate_disabled"
  ...
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_go_nogo_require_ingestion_grpc" "false"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_go_nogo_require_non_bootstrap_signer" "false"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_executor_env_path" "$executor_env_path"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_executor_backend_mode_guard_verdict" "PASS"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_executor_backend_mode_guard_reason_code" "backend_mode_upstream"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_executor_upstream_endpoint_guard_verdict" "PASS"
  ...
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_non_bootstrap_signer_guard_verdict" "SKIP"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_non_bootstrap_signer_guard_reason_code" "gate_disabled"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$rollout_bundle_output" "rehearsal_nested_submit_verify_guard_reason_code" "gate_disabled"
  ...
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_go_nogo_require_ingestion_grpc" "false"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_go_nogo_require_non_bootstrap_signer" "false"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_ingestion_grpc_guard_verdict" "SKIP"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_ingestion_grpc_guard_reason_code" "gate_disabled"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_non_bootstrap_signer_guard_verdict" "SKIP"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_non_bootstrap_signer_guard_reason_code" "gate_disabled"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$rehearsal_only_profile_output" "rehearsal_nested_submit_verify_guard_reason_code" "gate_disabled"
  ...
  assert_field_equals "$route_fee_only_profile_output" "rehearsal_nested_go_nogo_require_submit_verify_strict" "n/a"
  ...
  assert_field_equals "$route_fee_only_profile_output" "rehearsal_nested_submit_verify_guard_verdict" "n/a"
  assert_field_equals "$route_fee_only_profile_output" "rehearsal_nested_submit_verify_guard_reason_code" "n/a"
  ...
  assert_field_equals "$final_output" "rollout_nested_non_bootstrap_signer_guard_verdict" "SKIP"
  assert_field_equals "$final_output" "rollout_nested_non_bootstrap_signer_guard_reason_code" "gate_disabled"
  assert_field_equals "$final_output" "rollout_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$final_output" "rollout_nested_submit_verify_guard_reason_code" "gate_disabled"
  ...
  assert_field_equals "$final_bundle_output" "rollout_nested_non_bootstrap_signer_guard_verdict" "SKIP"
  assert_field_equals "$final_bundle_output" "rollout_nested_non_bootstrap_signer_guard_reason_code" "gate_disabled"
  assert_field_equals "$final_bundle_output" "rollout_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$final_bundle_output" "rollout_nested_submit_verify_guard_reason_code" "gate_disabled"
  assert_sha256_field "$final_bundle_output" "package_bundle_sha256"
  assert_sha256_field_matches_file "$final_bundle_output" "summary_sha256" "artifact_summary"
  assert_sha256_field_matches_file "$final_bundle_output" "manifest_sha256" "artifact_manifest"
  assert_field_non_empty "$final_bundle_output" "package_bundle_path"
...
EOF_RUNTIME_READINESS_EXECUTOR_ENV
  ...
  assert_field_equals "$pass_output" "adapter_final_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$pass_output" "adapter_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$pass_output" "adapter_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$pass_output" "adapter_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$pass_output" "adapter_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$pass_output" "adapter_final_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$pass_output" "adapter_final_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$pass_output" "adapter_final_nested_submit_verify_guard_reason_code" "gate_disabled"
  assert_field_equals "$pass_output" "adapter_final_nested_go_nogo_require_confirmed_execution_sample" "true"
  ...
  assert_field_equals "$pass_output" "route_fee_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$pass_output" "route_fee_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$pass_output" "route_fee_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$pass_output" "route_fee_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$pass_output" "route_fee_final_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$pass_output" "route_fee_final_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$pass_output" "route_fee_final_nested_submit_verify_guard_reason_code" "gate_disabled"
  assert_field_equals "$pass_output" "route_fee_final_nested_go_nogo_require_confirmed_execution_sample" "true"
  ...
  assert_field_equals "$strict_mock_output" "adapter_final_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$strict_mock_output" "adapter_final_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$strict_mock_output" "adapter_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$strict_mock_output" "adapter_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$strict_mock_output" "adapter_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$strict_mock_output" "adapter_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$strict_mock_output" "adapter_final_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$strict_mock_output" "adapter_final_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$strict_mock_output" "adapter_final_nested_submit_verify_guard_reason_code" "gate_disabled"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_go_nogo_require_executor_upstream" "true"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$strict_mock_output" "route_fee_final_nested_submit_verify_guard_reason_code" "gate_disabled"
  ...
  assert_field_equals "$strict_override_output" "adapter_final_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$strict_override_output" "adapter_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$strict_override_output" "adapter_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$strict_override_output" "adapter_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$strict_override_output" "adapter_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$strict_override_output" "route_fee_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$strict_override_output" "route_fee_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$strict_override_output" "route_fee_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$strict_override_output" "route_fee_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
...
EOF_RUNTIME_READINESS_EXECUTOR_ENV_RESET
  ...
  assert_field_equals "$skip_route_fee_output" "adapter_final_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$skip_route_fee_output" "adapter_final_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$skip_route_fee_output" "adapter_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$skip_route_fee_output" "adapter_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$skip_route_fee_output" "adapter_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$skip_route_fee_output" "adapter_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$skip_route_fee_output" "route_fee_final_nested_jito_rpc_policy_reason_code" "n/a"
  assert_field_equals "$skip_route_fee_output" "route_fee_final_nested_go_nogo_require_fastlane_disabled" "n/a"
  assert_field_equals "$skip_route_fee_output" "route_fee_final_nested_fastlane_feature_flag_verdict" "n/a"
  assert_field_equals "$skip_route_fee_output" "route_fee_final_nested_fastlane_feature_flag_reason_code" "n/a"
  ...
  assert_field_equals "$profile_adapter_only_output" "adapter_final_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$profile_adapter_only_output" "adapter_final_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$profile_adapter_only_output" "adapter_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$profile_adapter_only_output" "adapter_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$profile_adapter_only_output" "adapter_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$profile_adapter_only_output" "adapter_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$profile_adapter_only_output" "route_fee_final_nested_jito_rpc_policy_reason_code" "n/a"
  assert_field_equals "$profile_adapter_only_output" "route_fee_final_nested_go_nogo_require_fastlane_disabled" "n/a"
  assert_field_equals "$profile_adapter_only_output" "route_fee_final_nested_fastlane_feature_flag_verdict" "n/a"
  assert_field_equals "$profile_adapter_only_output" "route_fee_final_nested_fastlane_feature_flag_reason_code" "n/a"
  ...
  assert_field_equals "$profile_route_fee_only_output" "adapter_final_nested_go_nogo_require_jito_rpc_policy" "n/a"
  assert_field_equals "$profile_route_fee_only_output" "adapter_final_nested_jito_rpc_policy_verdict" "n/a"
  assert_field_equals "$profile_route_fee_only_output" "adapter_final_nested_jito_rpc_policy_reason_code" "n/a"
  assert_field_equals "$profile_route_fee_only_output" "adapter_final_nested_go_nogo_require_fastlane_disabled" "n/a"
  assert_field_equals "$profile_route_fee_only_output" "adapter_final_nested_fastlane_feature_flag_verdict" "n/a"
  assert_field_equals "$profile_route_fee_only_output" "adapter_final_nested_fastlane_feature_flag_reason_code" "n/a"
  ...
  assert_field_equals "$profile_route_fee_only_output" "route_fee_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$profile_route_fee_only_output" "route_fee_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$profile_route_fee_only_output" "route_fee_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$profile_route_fee_only_output" "route_fee_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$bundle_output" "adapter_final_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$bundle_output" "adapter_final_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$bundle_output" "adapter_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$bundle_output" "adapter_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$bundle_output" "adapter_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$bundle_output" "adapter_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$bundle_output" "adapter_final_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$bundle_output" "adapter_final_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$bundle_output" "adapter_final_nested_submit_verify_guard_reason_code" "gate_disabled"
  assert_field_equals "$bundle_output" "route_fee_final_nested_go_nogo_require_jito_rpc_policy" "false"
  assert_field_equals "$bundle_output" "route_fee_final_nested_jito_rpc_policy_verdict" "SKIP"
  assert_field_equals "$bundle_output" "route_fee_final_nested_jito_rpc_policy_reason_code" "gate_disabled"
  assert_field_equals "$bundle_output" "route_fee_final_nested_go_nogo_require_fastlane_disabled" "false"
  assert_field_equals "$bundle_output" "route_fee_final_nested_fastlane_feature_flag_verdict" "SKIP"
  assert_field_equals "$bundle_output" "route_fee_final_nested_fastlane_feature_flag_reason_code" "gate_disabled"
  ...
  assert_field_equals "$bundle_output" "route_fee_final_nested_go_nogo_require_submit_verify_strict" "false"
  assert_field_equals "$bundle_output" "route_fee_final_nested_submit_verify_guard_verdict" "SKIP"
  assert_field_equals "$bundle_output" "route_fee_final_nested_submit_verify_guard_reason_code" "gate_disabled"
...
run_refactor_phase_gate_case() {
  ...
  assert_contains "$normalized_go_nogo_text" "go_nogo_require_submit_verify_strict: false"
  assert_contains "$normalized_go_nogo_text" "submit_verify_guard_verdict: SKIP"
  assert_contains "$normalized_go_nogo_text" "submit_verify_guard_reason_code: gate_disabled"
  assert_contains "$normalized_rehearsal_text" "go_nogo_require_submit_verify_strict: false"
  assert_contains "$normalized_rehearsal_text" "go_nogo_submit_verify_guard_verdict: SKIP"
  assert_contains "$normalized_rehearsal_text" "go_nogo_submit_verify_guard_reason_code: gate_disabled"
  assert_contains "$normalized_rollout_text" "rehearsal_nested_go_nogo_require_submit_verify_strict: false"
  assert_contains "$normalized_rollout_text" "rehearsal_nested_submit_verify_guard_verdict: SKIP"
  assert_contains "$normalized_rollout_text" "rehearsal_nested_submit_verify_guard_reason_code: gate_disabled"
  ...
  if REFACTOR_PHASE_GATE_REQUIRE_SUBMIT_VERIFY_STRICT="true" \
    bash "$ROOT_DIR/tools/refactor_phase_gate.sh" baseline --output-dir "$phase_output_dir.strict-submit-verify" --fixture-dir "$phase_fixture_dir.strict-submit-verify" >"$phase_strict_submit_verify_output_path" 2>&1; then
    echo "expected refactor_phase_gate to fail-close when strict submit-verify is enabled against baseline executor submit-verify config" >&2
    exit 1
  fi
  phase_strict_submit_verify_output="$(cat "$phase_strict_submit_verify_output_path")"
  assert_contains "$phase_strict_submit_verify_output" "phase-gate error: execution_go_nogo_report.sh failed for stage=go_nogo"
  ...
  if phase_invalid_submit_verify_bool_output="$(
    REFACTOR_PHASE_GATE_REQUIRE_SUBMIT_VERIFY_STRICT="sometimes" \
      bash "$ROOT_DIR/tools/refactor_phase_gate.sh" baseline --output-dir "$phase_output_dir.invalid-submit-verify-bool" --fixture-dir "$phase_fixture_dir.invalid-submit-verify-bool" 2>&1
  )"; then
    echo "expected refactor_phase_gate to fail-close for invalid REFACTOR_PHASE_GATE_REQUIRE_SUBMIT_VERIFY_STRICT token" >&2
    exit 1
  fi
