...
profile_skip_workspace_tests_default="false"
...
if [[ "$audit_profile" == "ops_fast" ]]; then
  ...
  profile_skip_workspace_tests_default="true"
...
SKIP_WORKSPACE_TESTS_RAW="${AUDIT_SKIP_WORKSPACE_TESTS:-$profile_skip_workspace_tests_default}"
...
echo "[audit:full] running quick baseline (profile=$audit_profile, AUDIT_SKIP_CONTRACT_SMOKE=$skip_contract_smoke)"
