...
parse_rollout_bool_setting_into "GO_NOGO_REQUIRE_PRETRADE_FEE_POLICY" "$GO_NOGO_REQUIRE_PRETRADE_FEE_POLICY" go_nogo_require_pretrade_fee_policy_norm
parse_rollout_positive_u64_setting_into "GO_NOGO_MIN_PRETRADE_SOL_RESERVE_LAMPORTS" "$GO_NOGO_MIN_PRETRADE_SOL_RESERVE_LAMPORTS" go_nogo_min_pretrade_sol_reserve_lamports_norm
parse_rollout_positive_u64_setting_into "GO_NOGO_MAX_PRETRADE_FEE_OVERHEAD_BPS" "$GO_NOGO_MAX_PRETRADE_FEE_OVERHEAD_BPS" go_nogo_max_pretrade_fee_overhead_bps_norm
...
rehearsal_nested_go_nogo_require_pretrade_fee_policy="n/a"
rehearsal_nested_go_nogo_min_pretrade_sol_reserve_lamports="n/a"
rehearsal_nested_go_nogo_max_pretrade_fee_overhead_bps="n/a"
...
rehearsal_nested_submit_verify_guard_reason_code="n/a"
rehearsal_nested_pretrade_fee_policy_guard_verdict="unknown"
...
if [[ "$adapter_rollout_run_rehearsal_norm" != "true" ]]; then
  ...
  rehearsal_nested_submit_verify_guard_reason_code="n/a"
  rehearsal_nested_pretrade_fee_policy_guard_verdict="n/a"
  rehearsal_nested_pretrade_fee_policy_guard_reason_code="n/a"
  ...
  go_nogo_require_executor_upstream_raw="$(trim_string "$(extract_field "go_nogo_require_executor_upstream" "$rehearsal_output")")"
  if ! go_nogo_require_executor_upstream="$(extract_bool_field_strict "go_nogo_require_executor_upstream" "$rehearsal_output")"; then
    input_errors+=("nested rehearsal go_nogo_require_executor_upstream must be boolean token, got: ${go_nogo_require_executor_upstream_raw:-<empty>}")
    go_nogo_require_executor_upstream="unknown"
  elif [[ "$go_nogo_require_executor_upstream" != "$go_nogo_require_executor_upstream_norm" ]]; then
  ...
  if ! go_nogo_require_non_bootstrap_signer="$(extract_bool_field_strict "go_nogo_require_non_bootstrap_signer" "$rehearsal_output")"; then
    ...
    input_errors+=("nested rehearsal go_nogo_require_non_bootstrap_signer mismatch: nested=${go_nogo_require_non_bootstrap_signer} expected=${go_nogo_require_non_bootstrap_signer_norm}")
  fi
  rehearsal_nested_go_nogo_require_non_bootstrap_signer="$go_nogo_require_non_bootstrap_signer"
  go_nogo_require_submit_verify_strict_raw="$(trim_string "$(extract_field "go_nogo_require_submit_verify_strict" "$rehearsal_output")")"
  if ! go_nogo_require_submit_verify_strict="$(extract_bool_field_strict "go_nogo_require_submit_verify_strict" "$rehearsal_output")"; then
    input_errors+=("nested rehearsal go_nogo_require_submit_verify_strict must be boolean token, got: ${go_nogo_require_submit_verify_strict_raw:-<empty>}")
    ...
    input_errors+=("nested rehearsal go_nogo_require_submit_verify_strict mismatch: nested=${go_nogo_require_submit_verify_strict} expected=${go_nogo_require_submit_verify_strict_norm}")
  fi
  rehearsal_nested_go_nogo_require_submit_verify_strict="$go_nogo_require_submit_verify_strict"
  go_nogo_require_confirmed_execution_sample_raw="$(trim_string "$(extract_field "go_nogo_require_confirmed_execution_sample" "$rehearsal_output")")"
  if ! go_nogo_require_confirmed_execution_sample="$(extract_bool_field_strict "go_nogo_require_confirmed_execution_sample" "$rehearsal_output")"; then
    input_errors+=("nested rehearsal go_nogo_require_confirmed_execution_sample must be boolean token, got: ${go_nogo_require_confirmed_execution_sample_raw:-<empty>}")
    ...
    input_errors+=("nested rehearsal go_nogo_require_confirmed_execution_sample mismatch: nested=${go_nogo_require_confirmed_execution_sample} expected=${go_nogo_require_confirmed_execution_sample_norm}")
  fi
  rehearsal_nested_go_nogo_require_confirmed_execution_sample="$go_nogo_require_confirmed_execution_sample"
  go_nogo_min_confirmed_orders_raw="$(trim_string "$(extract_field "go_nogo_min_confirmed_orders" "$rehearsal_output")")"
  if ! go_nogo_min_confirmed_orders="$(parse_positive_u64_token_strict "$go_nogo_min_confirmed_orders_raw")"; then
    input_errors+=("nested rehearsal go_nogo_min_confirmed_orders must be an integer >= 1, got: ${go_nogo_min_confirmed_orders_raw:-<empty>}")
    go_nogo_min_confirmed_orders="0"
  elif [[ "$go_nogo_min_confirmed_orders" != "$go_nogo_min_confirmed_orders_norm" ]]; then
    input_errors+=("nested rehearsal go_nogo_min_confirmed_orders mismatch: nested=${go_nogo_min_confirmed_orders} expected=${go_nogo_min_confirmed_orders_norm}")
  fi
  rehearsal_nested_go_nogo_min_confirmed_orders="$go_nogo_min_confirmed_orders"
  go_nogo_require_pretrade_fee_policy_raw="$(trim_string "$(extract_field "go_nogo_require_pretrade_fee_policy" "$rehearsal_output")")"
  if ! go_nogo_require_pretrade_fee_policy="$(extract_bool_field_strict "go_nogo_require_pretrade_fee_policy" "$rehearsal_output")"; then
    input_errors+=("nested rehearsal go_nogo_require_pretrade_fee_policy must be boolean token, got: ${go_nogo_require_pretrade_fee_policy_raw:-<empty>}")
    ...
    input_errors+=("nested rehearsal go_nogo_require_pretrade_fee_policy mismatch: nested=${go_nogo_require_pretrade_fee_policy} expected=${go_nogo_require_pretrade_fee_policy_norm}")
  fi
  rehearsal_nested_go_nogo_require_pretrade_fee_policy="$go_nogo_require_pretrade_fee_policy"
  go_nogo_min_pretrade_sol_reserve_lamports_raw="$(trim_string "$(extract_field "go_nogo_min_pretrade_sol_reserve_lamports" "$rehearsal_output")")"
  if ! go_nogo_min_pretrade_sol_reserve_lamports="$(parse_positive_u64_token_strict "$go_nogo_min_pretrade_sol_reserve_lamports_raw")"; then
    input_errors+=("nested rehearsal go_nogo_min_pretrade_sol_reserve_lamports must be an integer >= 1, got: ${go_nogo_min_pretrade_sol_reserve_lamports_raw:-<empty>}")
    ...
    input_errors+=("nested rehearsal go_nogo_min_pretrade_sol_reserve_lamports mismatch: nested=${go_nogo_min_pretrade_sol_reserve_lamports} expected=${go_nogo_min_pretrade_sol_reserve_lamports_norm}")
  fi
  rehearsal_nested_go_nogo_min_pretrade_sol_reserve_lamports="$go_nogo_min_pretrade_sol_reserve_lamports"
  go_nogo_max_pretrade_fee_overhead_bps_raw="$(trim_string "$(extract_field "go_nogo_max_pretrade_fee_overhead_bps" "$rehearsal_output")")"
  if ! go_nogo_max_pretrade_fee_overhead_bps="$(parse_positive_u64_token_strict "$go_nogo_max_pretrade_fee_overhead_bps_raw")"; then
    input_errors+=("nested rehearsal go_nogo_max_pretrade_fee_overhead_bps must be an integer >= 1, got: ${go_nogo_max_pretrade_fee_overhead_bps_raw:-<empty>}")
    ...
    input_errors+=("nested rehearsal go_nogo_max_pretrade_fee_overhead_bps mismatch: nested=${go_nogo_max_pretrade_fee_overhead_bps} expected=${go_nogo_max_pretrade_fee_overhead_bps_norm}")
  fi
  rehearsal_nested_go_nogo_max_pretrade_fee_overhead_bps="$go_nogo_max_pretrade_fee_overhead_bps"
  ...
  if [[ -z "$rehearsal_nested_executor_env_path" ]]; then
    ...
    input_errors+=("nested rehearsal executor_env_path mismatch: nested=${rehearsal_nested_executor_env_path} expected=${EXECUTOR_ENV_PATH}")
  fi
  ...
  if [[ -z "$rehearsal_nested_executor_backend_mode_guard_verdict_raw" ]]; then
    input_errors+=("nested rehearsal go_nogo_executor_backend_mode_guard_verdict must be non-empty")
    rehearsal_nested_executor_backend_mode_guard_verdict="UNKNOWN"
    ...
    input_errors+=("nested rehearsal go_nogo_executor_backend_mode_guard_verdict must be one of PASS,WARN,UNKNOWN,SKIP (got: ${rehearsal_nested_executor_backend_mode_guard_verdict_raw})")
    rehearsal_nested_executor_backend_mode_guard_verdict="UNKNOWN"
  fi
  ...
  if [[ -z "$rehearsal_nested_executor_backend_mode_guard_reason_code" ]]; then
    input_errors+=("nested rehearsal go_nogo_executor_backend_mode_guard_reason_code must be non-empty")
    rehearsal_nested_executor_backend_mode_guard_reason_code="n/a"
  fi
  ...
  if [[ -z "$rehearsal_nested_executor_upstream_endpoint_guard_verdict_raw" ]]; then
    input_errors+=("nested rehearsal go_nogo_executor_upstream_endpoint_guard_verdict must be non-empty")
    rehearsal_nested_executor_upstream_endpoint_guard_verdict="UNKNOWN"
    ...
    input_errors+=("nested rehearsal go_nogo_executor_upstream_endpoint_guard_verdict must be one of PASS,WARN,UNKNOWN,SKIP (got: ${rehearsal_nested_executor_upstream_endpoint_guard_verdict_raw})")
    rehearsal_nested_executor_upstream_endpoint_guard_verdict="UNKNOWN"
  fi
  ...
  if [[ -z "$rehearsal_nested_non_bootstrap_signer_guard_verdict_raw" ]]; then
    input_errors+=("nested rehearsal go_nogo_non_bootstrap_signer_guard_verdict must be non-empty")
    rehearsal_nested_non_bootstrap_signer_guard_verdict="UNKNOWN"
    ...
    input_errors+=("nested rehearsal go_nogo_non_bootstrap_signer_guard_verdict must be one of PASS,WARN,UNKNOWN,SKIP (got: ${rehearsal_nested_non_bootstrap_signer_guard_verdict_raw})")
    rehearsal_nested_non_bootstrap_signer_guard_verdict="UNKNOWN"
  fi
  ...
  if [[ -z "$rehearsal_nested_non_bootstrap_signer_guard_reason_code" ]]; then
    input_errors+=("nested rehearsal go_nogo_non_bootstrap_signer_guard_reason_code must be non-empty")
    rehearsal_nested_non_bootstrap_signer_guard_reason_code="n/a"
  fi
  rehearsal_nested_submit_verify_guard_verdict_raw="$(trim_string "$(extract_field "go_nogo_submit_verify_guard_verdict" "$rehearsal_output")")"
  rehearsal_nested_submit_verify_guard_verdict_raw_upper="$(printf '%s' "$rehearsal_nested_submit_verify_guard_verdict_raw" | tr '[:lower:]' '[:upper:]')"
  rehearsal_nested_submit_verify_guard_verdict="$(normalize_strict_guard_verdict "$rehearsal_nested_submit_verify_guard_verdict_raw")"
  if [[ -z "$rehearsal_nested_submit_verify_guard_verdict_raw" ]]; then
    input_errors+=("nested rehearsal go_nogo_submit_verify_guard_verdict must be non-empty")
    rehearsal_nested_submit_verify_guard_verdict="UNKNOWN"
  elif [[ "$rehearsal_nested_submit_verify_guard_verdict_raw_upper" != "PASS" && "$rehearsal_nested_submit_verify_guard_verdict_raw_upper" != "WARN" && "$rehearsal_nested_submit_verify_guard_verdict_raw_upper" != "UNKNOWN" && "$rehearsal_nested_submit_verify_guard_verdict_raw_upper" != "SKIP" ]]; then
    input_errors+=("nested rehearsal go_nogo_submit_verify_guard_verdict must be one of PASS,WARN,UNKNOWN,SKIP (got: ${rehearsal_nested_submit_verify_guard_verdict_raw})")
    rehearsal_nested_submit_verify_guard_verdict="UNKNOWN"
  fi
  rehearsal_nested_submit_verify_guard_reason_code="$(trim_string "$(extract_field "go_nogo_submit_verify_guard_reason_code" "$rehearsal_output")")"
  if [[ -z "$rehearsal_nested_submit_verify_guard_reason_code" ]]; then
    input_errors+=("nested rehearsal go_nogo_submit_verify_guard_reason_code must be non-empty")
    rehearsal_nested_submit_verify_guard_reason_code="n/a"
  fi
  ...
  if [[ -z "$rehearsal_nested_confirmed_execution_sample_guard_verdict_raw" ]]; then
    input_errors+=("nested rehearsal go_nogo_confirmed_execution_sample_guard_verdict must be non-empty")
    rehearsal_nested_confirmed_execution_sample_guard_verdict="UNKNOWN"
    ...
    input_errors+=("nested rehearsal go_nogo_confirmed_execution_sample_guard_verdict must be one of PASS,WARN,UNKNOWN,SKIP (got: ${rehearsal_nested_confirmed_execution_sample_guard_verdict_raw})")
    rehearsal_nested_confirmed_execution_sample_guard_verdict="UNKNOWN"
  fi
  ...
  if [[ -z "$rehearsal_nested_confirmed_execution_sample_guard_reason_code" ]]; then
    input_errors+=("nested rehearsal go_nogo_confirmed_execution_sample_guard_reason_code must be non-empty")
    rehearsal_nested_confirmed_execution_sample_guard_reason_code="n/a"
  fi
  rehearsal_nested_pretrade_fee_policy_guard_verdict_raw="$(trim_string "$(extract_field "go_nogo_pretrade_fee_policy_guard_verdict" "$rehearsal_output")")"
  rehearsal_nested_pretrade_fee_policy_guard_verdict_raw_upper="$(printf '%s' "$rehearsal_nested_pretrade_fee_policy_guard_verdict_raw" | tr '[:lower:]' '[:upper:]')"
  rehearsal_nested_pretrade_fee_policy_guard_verdict="$(normalize_strict_guard_verdict "$rehearsal_nested_pretrade_fee_policy_guard_verdict_raw")"
  if [[ -z "$rehearsal_nested_pretrade_fee_policy_guard_verdict_raw" ]]; then
    input_errors+=("nested rehearsal go_nogo_pretrade_fee_policy_guard_verdict must be non-empty")
    rehearsal_nested_pretrade_fee_policy_guard_verdict="UNKNOWN"
  elif [[ "$rehearsal_nested_pretrade_fee_policy_guard_verdict_raw_upper" != "PASS" && "$rehearsal_nested_pretrade_fee_policy_guard_verdict_raw_upper" != "WARN" && "$rehearsal_nested_pretrade_fee_policy_guard_verdict_raw_upper" != "UNKNOWN" && "$rehearsal_nested_pretrade_fee_policy_guard_verdict_raw_upper" != "SKIP" ]]; then
    input_errors+=("nested rehearsal go_nogo_pretrade_fee_policy_guard_verdict must be one of PASS,WARN,UNKNOWN,SKIP (got: ${rehearsal_nested_pretrade_fee_policy_guard_verdict_raw})")
    rehearsal_nested_pretrade_fee_policy_guard_verdict="UNKNOWN"
  fi
  rehearsal_nested_pretrade_fee_policy_guard_reason_code="$(trim_string "$(extract_field "go_nogo_pretrade_fee_policy_guard_reason_code" "$rehearsal_output")")"
  if [[ -z "$rehearsal_nested_pretrade_fee_policy_guard_reason_code" ]]; then
    input_errors+=("nested rehearsal go_nogo_pretrade_fee_policy_guard_reason_code must be non-empty")
    rehearsal_nested_pretrade_fee_policy_guard_reason_code="n/a"
  fi
  if [[ "$go_nogo_require_executor_upstream_norm" == "true" ]]; then
    ...
    if [[ "$rehearsal_nested_executor_upstream_endpoint_guard_verdict" == "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_executor_upstream_endpoint_guard_verdict cannot be SKIP when GO_NOGO_REQUIRE_EXECUTOR_UPSTREAM=true")
    fi
  else
    if [[ "$rehearsal_nested_executor_backend_mode_guard_verdict" != "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_executor_backend_mode_guard_verdict must be SKIP when GO_NOGO_REQUIRE_EXECUTOR_UPSTREAM=false (got: ${rehearsal_nested_executor_backend_mode_guard_verdict})")
    fi
    if [[ "$rehearsal_nested_executor_upstream_endpoint_guard_verdict" != "SKIP" ]]; then
  ...
  if [[ "$go_nogo_require_non_bootstrap_signer_norm" == "true" ]]; then
    if [[ "$rehearsal_nested_non_bootstrap_signer_guard_verdict" == "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_non_bootstrap_signer_guard_verdict cannot be SKIP when GO_NOGO_REQUIRE_NON_BOOTSTRAP_SIGNER=true")
    fi
  else
    if [[ "$rehearsal_nested_non_bootstrap_signer_guard_verdict" != "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_non_bootstrap_signer_guard_verdict must be SKIP when GO_NOGO_REQUIRE_NON_BOOTSTRAP_SIGNER=false (got: ${rehearsal_nested_non_bootstrap_signer_guard_verdict})")
    fi
  fi
  if [[ "$go_nogo_require_submit_verify_strict_norm" == "true" ]]; then
    if [[ "$rehearsal_nested_submit_verify_guard_verdict" == "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_submit_verify_guard_verdict cannot be SKIP when GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT=true")
    fi
  else
    if [[ "$rehearsal_nested_submit_verify_guard_verdict" != "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_submit_verify_guard_verdict must be SKIP when GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT=false (got: ${rehearsal_nested_submit_verify_guard_verdict})")
    fi
  fi
  if [[ "$go_nogo_require_pretrade_fee_policy_norm" == "true" ]]; then
    if [[ "$rehearsal_nested_pretrade_fee_policy_guard_verdict" == "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_pretrade_fee_policy_guard_verdict cannot be SKIP when GO_NOGO_REQUIRE_PRETRADE_FEE_POLICY=true")
    fi
  else
    if [[ "$rehearsal_nested_pretrade_fee_policy_guard_verdict" != "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_pretrade_fee_policy_guard_verdict must be SKIP when GO_NOGO_REQUIRE_PRETRADE_FEE_POLICY=false (got: ${rehearsal_nested_pretrade_fee_policy_guard_verdict})")
    fi
  fi
  if [[ "$go_nogo_require_confirmed_execution_sample_norm" == "true" ]]; then
    if [[ "$rehearsal_nested_confirmed_execution_sample_guard_verdict" == "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_confirmed_execution_sample_guard_verdict cannot be SKIP when GO_NOGO_REQUIRE_CONFIRMED_EXECUTION_SAMPLE=true")
    fi
  else
    if [[ "$rehearsal_nested_confirmed_execution_sample_guard_verdict" != "SKIP" ]]; then
      input_errors+=("nested rehearsal go_nogo_confirmed_execution_sample_guard_verdict must be SKIP when GO_NOGO_REQUIRE_CONFIRMED_EXECUTION_SAMPLE=false (got: ${rehearsal_nested_confirmed_execution_sample_guard_verdict})")
    fi
  fi
...
go_nogo_require_pretrade_fee_policy: ${go_nogo_require_pretrade_fee_policy:-false}
go_nogo_min_pretrade_sol_reserve_lamports: ${go_nogo_min_pretrade_sol_reserve_lamports:-0}
go_nogo_max_pretrade_fee_overhead_bps: ${go_nogo_max_pretrade_fee_overhead_bps:-0}
executor_env_path: $EXECUTOR_ENV_PATH
...
rehearsal_nested_go_nogo_require_pretrade_fee_policy: ${rehearsal_nested_go_nogo_require_pretrade_fee_policy:-n/a}
rehearsal_nested_go_nogo_min_pretrade_sol_reserve_lamports: ${rehearsal_nested_go_nogo_min_pretrade_sol_reserve_lamports:-n/a}
rehearsal_nested_go_nogo_max_pretrade_fee_overhead_bps: ${rehearsal_nested_go_nogo_max_pretrade_fee_overhead_bps:-n/a}
...
rehearsal_nested_submit_verify_guard_reason_code: ${rehearsal_nested_submit_verify_guard_reason_code:-n/a}
rehearsal_nested_pretrade_fee_policy_guard_verdict: ${rehearsal_nested_pretrade_fee_policy_guard_verdict:-unknown}
rehearsal_nested_pretrade_fee_policy_guard_reason_code: ${rehearsal_nested_pretrade_fee_policy_guard_reason_code:-n/a}
