...
scorecard AS (
  SELECT
    ...
    k.confirmed_orders,
    k.failed_orders,
    k.reconcile_pending_orders,
    k.confirm_timeout_orders,
    k.confirm_error_orders,
    k.confirm_price_unavailable_orders,
    k.confirm_observed_fill_unavailable_orders,
    k.success_rate_pct,
    k.failure_rate_pct,
    k.timeout_rate_pct,
...
SELECT
  ...
  confirm_price_unavailable_orders,
  confirm_observed_fill_unavailable_orders,
  success_rate_pct,
  failure_rate_pct,
  timeout_rate_pct,
