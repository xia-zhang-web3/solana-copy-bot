...
parse_runtime_bool_setting_into "EXACT_MONEY_CUTOVER_REQUIRED" "$EXACT_MONEY_CUTOVER_REQUIRED" exact_money_cutover_required_norm
...
exact_money_capture_sha256="$(sha256_file_value "$exact_money_capture_path")"
