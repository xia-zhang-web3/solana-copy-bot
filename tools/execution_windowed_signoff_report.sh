...
parse_windowed_bool_setting_into "GO_NOGO_REQUIRE_FOLLOWLIST_ACTIVITY" "$GO_NOGO_REQUIRE_FOLLOWLIST_ACTIVITY" go_nogo_require_followlist_activity
...
parse_windowed_bool_setting_into "GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT" "$GO_NOGO_REQUIRE_SUBMIT_VERIFY_STRICT" go_nogo_require_submit_verify_strict
...
if ((${#input_errors[@]} == 0)); then
  for window_hours in "${windows[@]}"; do
    ...
    window_go_nogo_require_followlist_activity+=("$go_nogo_require_followlist_activity_nested")
    window_followlist_activity_guard_verdicts+=("$followlist_activity_guard_verdict")
    window_followlist_activity_guard_reason_codes+=("$followlist_activity_guard_reason_code")
    ...
    window_go_nogo_require_submit_verify_strict+=("$go_nogo_require_submit_verify_strict_nested")
    window_submit_verify_guard_verdicts+=("$submit_verify_guard_verdict")
    window_submit_verify_guard_reason_codes+=("$submit_verify_guard_reason_code")
