...
#[path = "06_discovery_runtime_scoring_checkpoint_types.rs"]
mod discovery_runtime_scoring_checkpoint_types;
...
pub use self::discovery_runtime_scoring_checkpoint_types::*;
