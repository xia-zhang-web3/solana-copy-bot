...
impl SqliteStore {
    pub(crate) fn upsert_discovery_scoring_state_ts(
        &self,
        state_key: &str,
        value: DateTime<Utc>,
    ) -> Result<()> {
    ...
    pub(crate) fn load_discovery_scoring_state_ts(
        &self,
        state_key: &str,
    ...
    pub(crate) fn load_discovery_scoring_state_value(
        &self,
        state_key: &str,
    ...
    pub(crate) fn load_discovery_scoring_cursor_state_exact(
        &self,
        ts_key: &str,
        slot_key: &str,
        signature_key: &str,
