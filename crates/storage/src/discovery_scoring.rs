use super::{
    DiscoveryAggregateWriteConfig, DiscoveryRuntimeCursor, SqliteStore, TokenMarketStats,
    WalletScoringBuyFactRow, WalletScoringCloseFactRow, WalletScoringDayRow,
...
impl SqliteStore {
    ...
    pub fn prune_discovery_scoring_before(&self, cutoff: DateTime<Utc>) -> Result<usize> {
        self.with_immediate_transaction_retry("discovery scoring retention prune", |conn| {
