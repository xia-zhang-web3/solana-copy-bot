...
pub(crate) fn parse_upstream_outcome(body: &Value, default_reject_code: &str) -> UpstreamOutcome {
    ...
    // Unknown non-empty status always wins over flag/type parsing to keep
    // status-domain classification deterministic.
...
mod tests {
    ...
    #[test]
    fn upstream_outcome_rejects_unknown_status_before_invalid_ok_type() {
        let payload = json!({
            "status": "pending",
            "ok": "true",
            "accepted": true
    ...
    #[test]
    fn upstream_outcome_rejects_unknown_status_before_invalid_accepted_type() {
        let payload = json!({
            "status": "pending",
            "ok": true,
            "accepted": "true"
    ...
    #[test]
    fn upstream_outcome_rejects_unknown_status_before_invalid_retryable_type() {
        let payload = json!({
            "status": "pending",
            "ok": false,
            "accepted": false,
