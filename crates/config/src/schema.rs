...
pub struct ExecutionConfig {
    ...
    pub submit_fastlane_enabled: bool,
...
#[derive(Debug, Clone, Deserialize)]
#[serde(default)]
pub struct RecentRawGapFillConfig {
    pub source: String,
    ...
    pub max_signature_pages_per_wallet: usize,
}

impl Default for RecentRawGapFillConfig {
    fn default() -> Self {
        Self {
            source: "helius_rpc".to_string(),
            helius_http_url: String::new(),
            output_dir: "state/discovery_restore/gap_fill".to_string(),
            output_retention: 16,
...
pub struct ProgramHistoryValidationConfig {
    ...
    pub phase_a_max_slots_to_scan: usize,
    pub phase_a_sampling_segments: usize,
    pub phase_a_max_blocks_per_window: usize,
    pub phase_b_max_blocks_to_fetch: usize,
    pub phase_b_max_candidate_transactions_to_parse: usize,
    pub phase_b_parseable_rows_target: usize,
...
impl Default for ProgramHistoryValidationConfig {
    fn default() -> Self {
        Self {
            ...
            phase_a_max_slots_to_scan: 4_096,
            phase_a_sampling_segments: 8,
            phase_a_max_blocks_per_window: 12,
            phase_b_max_blocks_to_fetch: 1_024,
            phase_b_max_candidate_transactions_to_parse: 2_048,
...
pub struct ProgramHistoryGapFillConfig {
    ...
    pub max_slot_batches_per_attempt: usize,
