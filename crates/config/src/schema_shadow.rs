...
pub struct RiskConfig {
    ...
    pub shadow_max_open_lots_per_token: u64,
    ...
    pub shadow_token_recent_close_cooldown_enabled: bool,
    pub shadow_token_recent_close_cooldown_minutes: u64,
    pub shadow_token_recent_loss_cooldown_minutes: u64,
    pub shadow_token_recent_loss_cooldown_max_roi: f64,
    ...
    pub shadow_wallet_token_fast_loss_cooldown_enabled: bool,
    pub shadow_wallet_token_fast_loss_cooldown_window_minutes: u64,
    pub shadow_wallet_token_fast_loss_cooldown_max_hold_seconds: u64,
    pub shadow_wallet_token_fast_loss_cooldown_min_entry_sol: f64,
    pub shadow_wallet_token_fast_loss_cooldown_max_roi: f64,
...
impl Default for RiskConfig {
    fn default() -> Self {
        Self {
            ...
            shadow_max_open_lots_per_token: 1,
            ...
            shadow_token_loss_cooldown_catastrophe_max_roi: -0.50,
            shadow_token_recent_close_cooldown_enabled: true,
            shadow_token_recent_close_cooldown_minutes: 5,
            shadow_token_recent_loss_cooldown_minutes: 60,
            shadow_token_recent_loss_cooldown_max_roi: -0.05,
            ...
            shadow_wallet_loss_cooldown_catastrophe_max_roi: -0.20,
            shadow_wallet_token_fast_loss_cooldown_enabled: true,
            shadow_wallet_token_fast_loss_cooldown_window_minutes: 60,
            shadow_wallet_token_fast_loss_cooldown_max_hold_seconds: 5 * 60,
            shadow_wallet_token_fast_loss_cooldown_min_entry_sol: 0.15,
            shadow_wallet_token_fast_loss_cooldown_max_roi: -0.08,
