...
pub struct ExecutionTinyEntryFunnel {
    ...
    pub actionable_quote_would_execute_events: u64,
    pub actionable_tiny_ordered_events: u64,
    pub actionable_tiny_confirmed_events: u64,
    pub actionable_tiny_missing_order_events: u64,
