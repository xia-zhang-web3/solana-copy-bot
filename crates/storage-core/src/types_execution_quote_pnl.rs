...
pub struct ExecutionCanaryQuotePnlSummary {
    ...
    /// Financial totals below describe selected market closes, not a full portfolio.
    ...
    /// Compatibility count of selected closes (equal to sampled_closed_trades).
    pub total_closed_trades: u64,
    pub matched_quote_trades: u64,
    /// Confirmed after-fee samples; unknown fees are excluded.
    pub pnl_counted_trades: u64,
    pub gross_pnl_counted_trades: u64,
    pub unknown_priority_fee_trades: u64,
    ...
    /// None if any non-skipped net or any sampled fee total is unknown.
    ...
    /// Complete hypothetical gross total; None if any skipped exit is unknown.
    ...
    pub priority_fee_lamports_sum: Option<u64>,
...
pub struct ExecutionCanaryQuoteSideDiagnostics {
    ...
    pub decision_delay_ms_unknown: u64,
    pub decision_delay_ms_avg: Option<f64>,
    pub decision_delay_ms_max: Option<u64>,
    pub quote_latency_ms_samples: u64,
    pub quote_latency_ms_unknown: u64,
    pub quote_latency_ms_avg: Option<f64>,
    pub quote_latency_ms_max: Option<u64>,
...
pub struct ExecutionCanaryQuoteBucketSummary {
    pub bucket: String,
    pub trades: u64,
    pub after_fee_known_trades: u64,
    pub after_fee_unknown_trades: u64,
    pub shadow_pnl_sol: f64,
    pub quote_adjusted_pnl_after_priority_fee_sol: Option<f64>,
    pub buy_slippage_bps_avg: f64,
    pub sell_slippage_bps_avg: f64,
    pub entry_decision_delay_ms_samples: u64,
    pub entry_decision_delay_ms_unknown: u64,
    pub entry_decision_delay_ms_avg: Option<f64>,
    pub exit_decision_delay_ms_samples: u64,
    pub exit_decision_delay_ms_unknown: u64,
    pub exit_decision_delay_ms_avg: Option<f64>,
...
pub struct ExecutionQuoteCanaryProviderComparisonSummary {
    ...
    pub generic_latency_samples: u64,
    pub generic_latency_unknown: u64,
    pub avg_generic_latency_ms: Option<f64>,
    pub pump_fun_latency_samples: u64,
    pub pump_fun_latency_unknown: u64,
    pub avg_pump_fun_latency_ms: Option<f64>,
...
pub struct ExecutionQuoteCanaryPublicPaidComparisonSummary {
    ...
    pub equal_slippage_events: u64,
    pub public_latency_samples: u64,
    pub public_latency_unknown: u64,
    pub avg_public_latency_ms: Option<f64>,
    pub paid_latency_samples: u64,
    pub paid_latency_unknown: u64,
    pub avg_paid_latency_ms: Option<f64>,
...
pub struct ExecutionCanaryQuoteReadinessGate {
    ...
    pub quote_after_fee_pnl_sol: Option<f64>,
    pub quote_win_rate_pct: f64,
    pub skip_rate_pct: f64,
    pub unknown_rate_pct: f64,
    pub entry_shadow_gate_drop_rate_pct: f64,
    pub non_ok_priority_fee_rate_pct: f64,
    pub avg_entry_quote_latency_ms: Option<f64>,
    pub avg_entry_decision_delay_ms: Option<f64>,
...
pub struct ExecutionCanaryQuotePnlTrade {
    pub fee_allocation: ExecutionQuoteFeeAllocation,
    ...
    pub quote_after_fee_vs_shadow_delta_sol: Option<f64>,
    /// None for non-skipped trades; otherwise the bounded counterfactual coverage reason.
    /// The primary reason remains the known BUY decision.
    pub skipped_counterfactual_reason: Option<String>,
    pub skipped_counterfactual_pnl_sol: Option<f64>,
    pub skipped_counterfactual_pnl_after_priority_fee_sol: Option<f64>,
    pub skipped_counterfactual_after_fee_vs_shadow_delta_sol: Option<f64>,
...
/// Quote-only inference over retained closes, not a persisted physical lot identity.
/// Exact raw integers are decimal strings in JSON; None is never a known zero.
#[derive(Debug, Clone, Default, PartialEq, Serialize)]
pub struct ExecutionQuoteFeeAllocation {
    pub entry_attribution: Option<String>,
    pub reason: String,
    pub entry_quantity_raw: Option<String>,
    pub exit_quantity_raw: Option<String>,
    pub cumulative_exit_quantity_raw: Option<String>,
    pub observed_buy_fee_lamports: Option<String>,
    pub observed_sell_fee_lamports: Option<String>,
    pub buy_fee_allocated_lamports: Option<String>,
    pub buy_fee_remaining_lamports: Option<String>,
}
