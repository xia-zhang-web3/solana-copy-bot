...
pub struct TrackBEntryQuoteSummary {
    ...
    pub by_hold_time_bucket: Vec<BucketSummary>,
...
pub struct SummaryCounts {
    ...
    pub market_exit_dead_error_events: u64,
    pub market_exit_transient_error_events: u64,
    pub market_exit_missing_quote_events: u64,
    pub market_exit_ratio_outlier_events: u64,
...
pub struct BucketSummary {
    ...
    pub fully_executable_shadow_pnl_sol: Option<f64>,
    pub fully_executable_delta_sol: Option<f64>,
    pub fully_executable_coverage: Option<f64>,
    pub fully_executable_delta_stats: NumericStats,
    pub market_exit_quote_events: u64,
    pub market_exit_error_events: u64,
    pub market_exit_dead_error_events: u64,
    pub market_exit_transient_error_events: u64,
