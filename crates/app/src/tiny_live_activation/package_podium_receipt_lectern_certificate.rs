...
pub struct LivePackagePodiumReceiptContractView {
...
#[derive(Debug, Clone)]
pub struct VerifiedLivePackagePodiumReceiptLecternCertificateStep {
    pub report_json: serde_json::Value,
    pub verdict: String,
    pub reason: String,
    pub generated_at: DateTime<Utc>,
    pub contract: LivePackagePodiumReceiptContractView,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PackagePodiumReceiptArtifactPaths {
    pub session_path: PathBuf,
    pub status_path: PathBuf,
    pub rostrum_certificate_report_path: PathBuf,
}

#[derive(Debug, Deserialize)]
struct StoredPodiumReceiptSession {
...
#[derive(Debug, Deserialize)]
struct StoredPodiumReceiptStatus {
...
#[derive(Debug, Deserialize)]
struct StoredRostrumCertificateReportView {
    decision_packet_session_dir: String,
}

#[derive(Debug, Deserialize)]
struct PodiumReceiptVerifyReportView {
...
pub fn load_live_package_podium_receipt_contract_for_lectern_certificate(
    podium_receipt_session_dir: &Path,
) -> Result<LivePackagePodiumReceiptContractView> {
    let paths = podium_receipt_artifact_paths(podium_receipt_session_dir);
    let session: StoredPodiumReceiptSession = load_json(&paths.session_path)?;
    let status: StoredPodiumReceiptStatus = load_json(&paths.status_path)?;
    Ok(LivePackagePodiumReceiptContractView {
        podium_receipt_session_dir: podium_receipt_session_dir.to_path_buf(),
...
pub fn verify_live_package_podium_receipt_for_lectern_certificate(
    podium_receipt_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
) -> Result<VerifiedLivePackagePodiumReceiptLecternCertificateStep> {
    let contract = load_live_package_podium_receipt_contract_for_lectern_certificate(
        podium_receipt_session_dir,
    )?;
    let trusted_decision_packet_session_dir =
        load_confirmed_decision_packet_session_dir_for_rostrum_verify(
            podium_receipt_session_dir,
    ...
    let report: PodiumReceiptVerifyReportView = serde_json::from_value(raw_report.clone())
        .context("failed parsing podium-receipt verify report")?;
    ...
    if reported_rostrum_certificate_session_dir != contract.rostrum_certificate_session_dir {
        bail!(
            "podium-receipt verify report rostrum_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_pedestal_certificate_session_dir != contract.pedestal_certificate_session_dir {
        bail!(
            "podium-receipt verify report pedestal_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_plinth_receipt_session_dir != contract.plinth_receipt_session_dir {
        bail!(
            "podium-receipt verify report plinth_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    {
        bail!(
            "podium-receipt verify report substructure_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_bedrock_certificate_session_dir != contract.bedrock_certificate_session_dir {
        bail!(
            "podium-receipt verify report bedrock_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_basal_receipt_session_dir != contract.basal_receipt_session_dir {
        bail!(
            "podium-receipt verify report basal_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_foundation_receipt_session_dir != contract.foundation_receipt_session_dir {
        bail!(
            "podium-receipt verify report foundation_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_decision_packet_session_dir != trusted_decision_packet_session_dir {
        bail!(
            "podium-receipt verify report decision_packet_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_registry_entry_session_dir != contract.registry_entry_session_dir {
        bail!(
            "podium-receipt verify report registry_entry_session_dir {:?} does not match trusted {:?}",
            reported_registry_entry_session_dir.display(),
            contract.registry_entry_session_dir.display()
        );
    }
    Ok(VerifiedLivePackagePodiumReceiptLecternCertificateStep {
...
pub fn podium_receipt_verify_args(
    podium_receipt_session_dir: &Path,
...
fn load_confirmed_decision_packet_session_dir_for_rostrum_verify(
    podium_receipt_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
    contract: &LivePackagePodiumReceiptContractView,
) -> Result<PathBuf> {
    ...
    if confirmed_decision_packet_session_dir != archived_decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match archived nested rostrum-certificate report {:?}",
            confirmed_decision_packet_session_dir.display(),
...
fn required_string_field(value: Option<String>, field: &str) -> Result<String> {
    value.ok_or_else(|| anyhow!("podium-receipt verify report is missing {field}"))
}
...
mod tests {
    ...
    #[test]
    fn load_contract_reads_stored_podium_receipt_files() {
        let dir = temp_dir("podium_receipt_contract");
        fs::write(
            dir.join("tiny_live_activation_package_podium_receipt.session.json"),
            serde_json::to_vec_pretty(&stored_podium_receipt_session_value(
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_podium_receipt.status.json"),
            serde_json::to_vec_pretty(&stored_podium_receipt_status_value(
        ...
        let contract =
            load_live_package_podium_receipt_contract_for_lectern_certificate(&dir).unwrap();
        assert_eq!(contract.podium_receipt_session_dir, dir);
        assert_eq!(
            contract.rostrum_certificate_session_dir,
    ...
    #[test]
    fn podium_receipt_verify_args_are_exact_and_bounded() {
        let args = podium_receipt_verify_args(
    ...
    fn confirmed_decision_packet_session_dir_must_match_stored_contract_and_archive() {
        let dir = temp_dir("podium_receipt_confirmed_decision_packet");
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_podium_receipt.rostrum_certificate.report.json"),
        ...
        let contract =
            load_live_package_podium_receipt_contract_for_lectern_certificate(&dir).unwrap();
        let error = load_confirmed_decision_packet_session_dir_for_rostrum_verify(
            &dir,
            &trusted_decision_packet_session_dir,
            &contract,
        )
    ...
    fn stored_podium_receipt_session_value(decision_packet_session_dir: &str) -> Value {
