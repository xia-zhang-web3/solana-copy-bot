...
pub struct LivePackageSanctuaryCertificateContractView {
    pub sanctuary_certificate_session_dir: PathBuf,
    pub lectern_certificate_session_dir: PathBuf,
    pub apse_receipt_session_dir: PathBuf,
    ...
    pub verify_apse_receipt_command_summary: String,
...
#[derive(Debug, Clone)]
pub struct VerifiedLivePackageSanctuaryCertificateNaveReceiptStep {
    pub report_json: serde_json::Value,
    pub verdict: String,
    pub reason: String,
    pub generated_at: DateTime<Utc>,
    pub contract: LivePackageSanctuaryCertificateContractView,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PackageSanctuaryCertificateArtifactPaths {
    pub session_path: PathBuf,
    pub status_path: PathBuf,
    pub apse_receipt_report_path: PathBuf,
}

#[derive(Debug, Deserialize)]
struct StoredSanctuaryCertificateSession {
...
#[derive(Debug, Deserialize)]
struct StoredSanctuaryCertificateStatus {
    lectern_certificate_session_dir: Option<String>,
    apse_receipt_session_dir: Option<String>,
...
#[derive(Debug, Deserialize)]
struct SanctuaryCertificateVerifyReportView {
...
pub fn load_live_package_sanctuary_certificate_contract_for_nave_receipt(
    sanctuary_certificate_session_dir: &Path,
) -> Result<LivePackageSanctuaryCertificateContractView> {
    let paths = sanctuary_certificate_artifact_paths(sanctuary_certificate_session_dir);
    let session: StoredSanctuaryCertificateSession = load_json(&paths.session_path)?;
    let status: StoredSanctuaryCertificateStatus = load_json(&paths.status_path)?;
    Ok(LivePackageSanctuaryCertificateContractView {
        sanctuary_certificate_session_dir: sanctuary_certificate_session_dir.to_path_buf(),
        ...
        apse_receipt_session_dir: PathBuf::from(
            status
                .apse_receipt_session_dir
                .unwrap_or(session.apse_receipt_session_dir),
        ),
        ...
        verify_apse_receipt_command_summary: session.verify_apse_receipt_command_summary,
...
pub fn verify_live_package_sanctuary_certificate_for_nave_receipt(
    sanctuary_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
) -> Result<VerifiedLivePackageSanctuaryCertificateNaveReceiptStep> {
    let contract = load_live_package_sanctuary_certificate_contract_for_nave_receipt(
        sanctuary_certificate_session_dir,
    )?;
    let trusted_decision_packet_session_dir =
        load_confirmed_decision_packet_session_dir_for_apse_verify(
            sanctuary_certificate_session_dir,
    ...
    let raw_report = run_json_command(
        ...
        &sanctuary_certificate_verify_args(
            sanctuary_certificate_session_dir,
            &contract.apse_receipt_session_dir,
            &trusted_decision_packet_session_dir,
        ),
    )?;
    let report: SanctuaryCertificateVerifyReportView =
        serde_json::from_value(raw_report.clone())
            .context("failed parsing sanctuary-certificate verify report")?;
    let reported_lectern_certificate_session_dir = PathBuf::from(required_string_field(
        report.lectern_certificate_session_dir,
        "lectern_certificate_session_dir",
    )?);
    let reported_apse_receipt_session_dir = PathBuf::from(required_string_field(
    ...
    if reported_lectern_certificate_session_dir != contract.lectern_certificate_session_dir {
        bail!(
            "sanctuary-certificate verify report lectern_certificate_session_dir {:?} does not match trusted {:?}",
            reported_lectern_certificate_session_dir.display(),
            contract.lectern_certificate_session_dir.display()
        );
    }
    if reported_apse_receipt_session_dir != contract.apse_receipt_session_dir {
        bail!(
            "sanctuary-certificate verify report apse_receipt_session_dir {:?} does not match trusted {:?}",
            reported_apse_receipt_session_dir.display(),
            contract.apse_receipt_session_dir.display()
        );
    }
    if reported_pedestal_certificate_session_dir != contract.pedestal_certificate_session_dir {
        bail!(
            "sanctuary-certificate verify report pedestal_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_plinth_receipt_session_dir != contract.plinth_receipt_session_dir {
        bail!(
            "sanctuary-certificate verify report plinth_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    {
        bail!(
            "sanctuary-certificate verify report substructure_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_bedrock_certificate_session_dir != contract.bedrock_certificate_session_dir {
        bail!(
            "sanctuary-certificate verify report bedrock_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_basal_receipt_session_dir != contract.basal_receipt_session_dir {
        bail!(
            "sanctuary-certificate verify report basal_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_foundation_receipt_session_dir != contract.foundation_receipt_session_dir {
        bail!(
            "sanctuary-certificate verify report foundation_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_decision_packet_session_dir != trusted_decision_packet_session_dir {
        bail!(
            "sanctuary-certificate verify report decision_packet_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_registry_entry_session_dir != contract.registry_entry_session_dir {
        bail!(
            "sanctuary-certificate verify report registry_entry_session_dir {:?} does not match trusted {:?}",
            reported_registry_entry_session_dir.display(),
            contract.registry_entry_session_dir.display()
        );
    }
    Ok(VerifiedLivePackageSanctuaryCertificateNaveReceiptStep {
        report_json: raw_report,
        verdict: report.verdict.clone(),
        reason: report.reason.clone(),
        generated_at: report.generated_at,
        contract: LivePackageSanctuaryCertificateContractView {
            sanctuary_certificate_session_dir: sanctuary_certificate_session_dir.to_path_buf(),
            lectern_certificate_session_dir: reported_lectern_certificate_session_dir,
            apse_receipt_session_dir: reported_apse_receipt_session_dir,
            ...
            verify_apse_receipt_command_summary: required_string_field(
                report.verify_apse_receipt_command_summary,
...
pub fn sanctuary_certificate_verify_args(
    sanctuary_certificate_session_dir: &Path,
...
pub fn sanctuary_certificate_artifact_paths(
    session_dir: &Path,
) -> PackageSanctuaryCertificateArtifactPaths {
    PackageSanctuaryCertificateArtifactPaths {
...
fn load_confirmed_decision_packet_session_dir_for_apse_verify(
    sanctuary_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
    contract: &LivePackageSanctuaryCertificateContractView,
) -> Result<PathBuf> {
    ...
    let archived_report: StoredPulpitReceiptReportView =
        load_json(&paths.apse_receipt_report_path)?;
    ...
    if confirmed_decision_packet_session_dir != contract.decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match stored sanctuary-certificate contract {:?}",
    ...
    if confirmed_decision_packet_session_dir != archived_decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match archived nested apse-receipt report {:?}",
            confirmed_decision_packet_session_dir.display(),
...
fn required_string_field(value: Option<String>, field: &str) -> Result<String> {
    value.ok_or_else(|| anyhow!("sanctuary-certificate verify report is missing {field}"))
}
...
mod tests {
    ...
    #[test]
    fn load_contract_reads_stored_sanctuary_certificate_files() {
        let dir = temp_dir("sanctuary_certificate_contract");
        fs::write(
            dir.join("tiny_live_activation_package_sanctuary_certificate.session.json"),
            serde_json::to_vec_pretty(&stored_sanctuary_certificate_session_value(
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_sanctuary_certificate.status.json"),
            serde_json::to_vec_pretty(&stored_sanctuary_certificate_status_value(
        ...
        let contract =
            load_live_package_sanctuary_certificate_contract_for_nave_receipt(&dir).unwrap();
        assert_eq!(contract.sanctuary_certificate_session_dir, dir);
        assert_eq!(
    ...
    #[test]
    fn sanctuary_certificate_verify_args_are_exact_and_bounded() {
        let args = sanctuary_certificate_verify_args(
            Path::new("/tmp/sanctuary-certificate-session"),
        ...
        assert_eq!(
            ...
            vec![
                ...
                "/tmp/decision-packet-session",
                "--session-dir",
                "/tmp/sanctuary-certificate-session",
    ...
    fn confirmed_decision_packet_session_dir_must_match_stored_contract_and_archive() {
        let dir = temp_dir("sanctuary_certificate_confirmed_decision_packet");
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_sanctuary_certificate.apse_receipt.report.json"),
        ...
        let contract =
            load_live_package_sanctuary_certificate_contract_for_nave_receipt(&dir).unwrap();
        let error = load_confirmed_decision_packet_session_dir_for_apse_verify(
            &dir,
            &trusted_decision_packet_session_dir,
            &contract,
        )
    ...
    fn stored_sanctuary_certificate_session_value(decision_packet_session_dir: &str) -> Value {
    ...
    fn stored_sanctuary_certificate_status_value(
        result: &str,
