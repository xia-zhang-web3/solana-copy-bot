...
pub struct LivePackageTranseptCertificateContractView {
    pub transept_certificate_session_dir: PathBuf,
    pub nave_receipt_session_dir: PathBuf,
    ...
    pub verify_transept_certificate_command_summary: String,
...
#[derive(Debug, Clone)]
pub struct VerifiedLivePackageTranseptCertificateChoirReceiptStep {
    pub report_json: serde_json::Value,
    pub verdict: String,
    pub reason: String,
    pub generated_at: DateTime<Utc>,
    pub contract: LivePackageTranseptCertificateContractView,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PackageTranseptCertificateArtifactPaths {
    pub session_path: PathBuf,
    pub status_path: PathBuf,
    pub nave_receipt_report_path: PathBuf,
}

#[derive(Debug, Deserialize)]
struct StoredTranseptCertificateSession {
    ...
    #[serde(alias = "verify_nave_receipt_command_summary")]
...
#[derive(Debug, Deserialize)]
struct StoredTranseptCertificateStatus {
    nave_receipt_session_dir: Option<String>,
...
#[derive(Debug, Deserialize)]
struct StoredTranseptCertificateReportView {
    decision_packet_session_dir: String,
}

#[derive(Debug, Deserialize)]
struct TranseptCertificateVerifyReportView {
...
pub fn load_live_package_transept_certificate_contract_for_choir_receipt(
    transept_certificate_session_dir: &Path,
) -> Result<LivePackageTranseptCertificateContractView> {
    let paths = transept_certificate_artifact_paths(transept_certificate_session_dir);
    let session: StoredTranseptCertificateSession = load_json(&paths.session_path)?;
    let status: StoredTranseptCertificateStatus = load_json(&paths.status_path)?;
    Ok(LivePackageTranseptCertificateContractView {
        transept_certificate_session_dir: transept_certificate_session_dir.to_path_buf(),
        nave_receipt_session_dir: PathBuf::from(
            status
                .nave_receipt_session_dir
                .unwrap_or(session.nave_receipt_session_dir),
        ),
        ...
        verify_transept_certificate_command_summary: session
...
pub fn verify_live_package_transept_certificate_for_choir_receipt(
    transept_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
) -> Result<VerifiedLivePackageTranseptCertificateChoirReceiptStep> {
    let contract = load_live_package_transept_certificate_contract_for_choir_receipt(
        transept_certificate_session_dir,
    )?;
    let trusted_decision_packet_session_dir =
        load_confirmed_decision_packet_session_dir_for_transept_verify(
            transept_certificate_session_dir,
    ...
    let raw_report = run_json_command(
        ...
        &transept_certificate_verify_args(
            &contract.nave_receipt_session_dir,
            transept_certificate_session_dir,
            &trusted_decision_packet_session_dir,
        ),
    )?;
    let report: TranseptCertificateVerifyReportView = serde_json::from_value(raw_report.clone())
        .context("failed parsing transept-certificate verify report")?;
    let reported_nave_receipt_session_dir = PathBuf::from(required_string_field(
        report.nave_receipt_session_dir,
        "nave_receipt_session_dir",
    )?);
    if reported_nave_receipt_session_dir != contract.nave_receipt_session_dir {
        bail!(
            "transept-certificate verify report nave_receipt_session_dir {:?} does not match trusted {:?}",
            reported_nave_receipt_session_dir.display(),
            contract.nave_receipt_session_dir.display()
        );
    }
    ...
    if reported_lectern_certificate_session_dir != contract.lectern_certificate_session_dir {
        bail!(
            "transept-certificate verify report lectern_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_sanctuary_certificate_session_dir != contract.sanctuary_certificate_session_dir {
        bail!(
            "transept-certificate verify report sanctuary_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_pedestal_certificate_session_dir != contract.pedestal_certificate_session_dir {
        bail!(
            "transept-certificate verify report pedestal_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_plinth_receipt_session_dir != contract.plinth_receipt_session_dir {
        bail!(
            "transept-certificate verify report plinth_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    {
        bail!(
            "transept-certificate verify report substructure_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_bedrock_certificate_session_dir != contract.bedrock_certificate_session_dir {
        bail!(
            "transept-certificate verify report bedrock_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_basal_receipt_session_dir != contract.basal_receipt_session_dir {
        bail!(
            "transept-certificate verify report basal_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_foundation_receipt_session_dir != contract.foundation_receipt_session_dir {
        bail!(
            "transept-certificate verify report foundation_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_decision_packet_session_dir != trusted_decision_packet_session_dir {
        bail!(
            "transept-certificate verify report decision_packet_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_registry_entry_session_dir != contract.registry_entry_session_dir {
        bail!(
            "transept-certificate verify report registry_entry_session_dir {:?} does not match trusted {:?}",
            reported_registry_entry_session_dir.display(),
            contract.registry_entry_session_dir.display()
        );
    }
    Ok(VerifiedLivePackageTranseptCertificateChoirReceiptStep {
        report_json: raw_report,
        verdict: report.verdict.clone(),
        reason: report.reason.clone(),
        generated_at: report.generated_at,
        contract: LivePackageTranseptCertificateContractView {
            transept_certificate_session_dir: transept_certificate_session_dir.to_path_buf(),
            nave_receipt_session_dir: reported_nave_receipt_session_dir,
            ...
            verify_transept_certificate_command_summary: required_string_field(
                report.verify_transept_certificate_command_summary,
                "verify_transept_certificate_command_summary",
            )?,
...
pub fn transept_certificate_verify_args(
...
pub fn transept_certificate_artifact_paths(
    session_dir: &Path,
) -> PackageTranseptCertificateArtifactPaths {
    PackageTranseptCertificateArtifactPaths {
...
fn load_confirmed_decision_packet_session_dir_for_transept_verify(
    transept_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
    contract: &LivePackageTranseptCertificateContractView,
) -> Result<PathBuf> {
    let paths = transept_certificate_artifact_paths(transept_certificate_session_dir);
    let archived_report: StoredTranseptCertificateReportView =
        load_json(&paths.nave_receipt_report_path)?;
    ...
    if confirmed_decision_packet_session_dir != contract.decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match stored transept-certificate contract {:?}",
    ...
    if confirmed_decision_packet_session_dir != archived_decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match archived nested transept-certificate report {:?}",
            confirmed_decision_packet_session_dir.display(),
...
fn required_string_field(value: Option<String>, field: &str) -> Result<String> {
    value.ok_or_else(|| anyhow!("transept-certificate verify report is missing {field}"))
}
...
mod tests {
    ...
    #[test]
    fn load_contract_reads_stored_transept_certificate_files() {
        let dir = temp_dir("transept_certificate_contract");
        fs::write(
            dir.join("tiny_live_activation_package_transept_certificate.session.json"),
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_transept_certificate.status.json"),
        ...
        let contract =
            load_live_package_transept_certificate_contract_for_choir_receipt(&dir).unwrap();
        assert_eq!(contract.transept_certificate_session_dir, dir);
        assert_eq!(
            contract.nave_receipt_session_dir,
            PathBuf::from("/tmp/nave-receipt-session")
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            PathBuf::from("/tmp/apse-receipt-session")
        );
        assert_eq!(
        ...
        assert_eq!(contract.transept_certificate_sha256, "guidon-sha256");
        assert_eq!(contract.transept_certificate_algorithm, "sha256");
    }

    #[test]
    fn transept_certificate_verify_args_are_exact_and_bounded() {
        let args = transept_certificate_verify_args(
            Path::new("/tmp/nave-receipt-session"),
    ...
    fn confirmed_decision_packet_session_dir_must_match_stored_contract_and_archive() {
        let dir = temp_dir("transept_certificate_confirmed_decision_packet");
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_transept_certificate.nave_receipt.report.json"),
        ...
        let contract =
            load_live_package_transept_certificate_contract_for_choir_receipt(&dir).unwrap();
        let error = load_confirmed_decision_packet_session_dir_for_transept_verify(
            &dir,
            &trusted_decision_packet_session_dir,
            &contract,
        )
    ...
    fn stored_nave_receipt_session_value(decision_packet_session_dir: &str) -> Value {
        ...
        object.insert(
            ...
            json!("verify transept certificate"),
        );
        object.insert(
