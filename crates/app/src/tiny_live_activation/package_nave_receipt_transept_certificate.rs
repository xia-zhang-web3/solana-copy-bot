...
pub struct LivePackageNaveReceiptContractView {
    ...
    pub verify_sanctuary_certificate_command_summary: String,
...
#[derive(Debug, Clone)]
pub struct VerifiedLivePackageNaveReceiptTranseptCertificateStep {
    pub report_json: serde_json::Value,
    pub verdict: String,
    pub reason: String,
    pub generated_at: DateTime<Utc>,
    pub contract: LivePackageNaveReceiptContractView,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PackageNaveReceiptArtifactPaths {
    pub session_path: PathBuf,
    pub status_path: PathBuf,
    pub sanctuary_certificate_report_path: PathBuf,
}

#[derive(Debug, Deserialize)]
struct StoredNaveReceiptSession {
...
#[derive(Debug, Deserialize)]
struct StoredNaveReceiptStatus {
...
#[derive(Debug, Deserialize)]
struct NaveReceiptVerifyReportView {
...
pub fn load_live_package_nave_receipt_contract_for_transept_certificate(
    nave_receipt_session_dir: &Path,
) -> Result<LivePackageNaveReceiptContractView> {
    let paths = nave_receipt_artifact_paths(nave_receipt_session_dir);
    let session: StoredNaveReceiptSession = load_json(&paths.session_path)?;
    let status: StoredNaveReceiptStatus = load_json(&paths.status_path)?;
    Ok(LivePackageNaveReceiptContractView {
        nave_receipt_session_dir: nave_receipt_session_dir.to_path_buf(),
        ...
        verify_sanctuary_certificate_command_summary: session
...
pub fn verify_live_package_nave_receipt_for_transept_certificate(
    nave_receipt_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
) -> Result<VerifiedLivePackageNaveReceiptTranseptCertificateStep> {
    let contract =
        load_live_package_nave_receipt_contract_for_transept_certificate(nave_receipt_session_dir)?;
    let trusted_decision_packet_session_dir =
        load_confirmed_decision_packet_session_dir_for_sanctuary_verify(
    ...
    let report: NaveReceiptVerifyReportView = serde_json::from_value(raw_report.clone())
        .context("failed parsing nave-receipt verify report")?;
    ...
    if reported_lectern_certificate_session_dir != contract.lectern_certificate_session_dir {
        bail!(
            "nave-receipt verify report lectern_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_sanctuary_certificate_session_dir != contract.sanctuary_certificate_session_dir {
        bail!(
            "nave-receipt verify report sanctuary_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_pedestal_certificate_session_dir != contract.pedestal_certificate_session_dir {
        bail!(
            "nave-receipt verify report pedestal_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_plinth_receipt_session_dir != contract.plinth_receipt_session_dir {
        bail!(
            "nave-receipt verify report plinth_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    {
        bail!(
            "nave-receipt verify report substructure_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_bedrock_certificate_session_dir != contract.bedrock_certificate_session_dir {
        bail!(
            "nave-receipt verify report bedrock_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_basal_receipt_session_dir != contract.basal_receipt_session_dir {
        bail!(
            "nave-receipt verify report basal_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_foundation_receipt_session_dir != contract.foundation_receipt_session_dir {
        bail!(
            "nave-receipt verify report foundation_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_decision_packet_session_dir != trusted_decision_packet_session_dir {
        bail!(
            "nave-receipt verify report decision_packet_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_registry_entry_session_dir != contract.registry_entry_session_dir {
        bail!(
            "nave-receipt verify report registry_entry_session_dir {:?} does not match trusted {:?}",
            reported_registry_entry_session_dir.display(),
            contract.registry_entry_session_dir.display()
        );
    }
    Ok(VerifiedLivePackageNaveReceiptTranseptCertificateStep {
        report_json: raw_report,
        verdict: report.verdict.clone(),
        reason: report.reason.clone(),
        generated_at: report.generated_at,
        contract: LivePackageNaveReceiptContractView {
            nave_receipt_session_dir: nave_receipt_session_dir.to_path_buf(),
            ...
            verify_sanctuary_certificate_command_summary: required_string_field(
                report.verify_sanctuary_certificate_command_summary,
                "verify_sanctuary_certificate_command_summary",
            )?,
...
pub fn nave_receipt_verify_args(
    nave_receipt_session_dir: &Path,
...
pub fn nave_receipt_artifact_paths(session_dir: &Path) -> PackageNaveReceiptArtifactPaths {
    PackageNaveReceiptArtifactPaths {
...
fn load_confirmed_decision_packet_session_dir_for_sanctuary_verify(
    nave_receipt_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
    contract: &LivePackageNaveReceiptContractView,
) -> Result<PathBuf> {
    ...
    let archived_report: StoredPulpitReceiptReportView =
        load_json(&paths.sanctuary_certificate_report_path)?;
    ...
    if confirmed_decision_packet_session_dir != contract.decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match stored nave-receipt contract {:?}",
    ...
    if confirmed_decision_packet_session_dir != archived_decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match archived nested nave-receipt report {:?}",
            confirmed_decision_packet_session_dir.display(),
...
fn required_string_field(value: Option<String>, field: &str) -> Result<String> {
    value.ok_or_else(|| anyhow!("nave-receipt verify report is missing {field}"))
}
...
mod tests {
    ...
    #[test]
    fn load_contract_reads_stored_nave_receipt_files() {
        let dir = temp_dir("nave_receipt_contract");
        fs::write(
            dir.join("tiny_live_activation_package_nave_receipt.session.json"),
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_nave_receipt.status.json"),
        ...
        let contract =
            load_live_package_nave_receipt_contract_for_transept_certificate(&dir).unwrap();
        assert_eq!(contract.nave_receipt_session_dir, dir);
        assert_eq!(
    ...
    #[test]
    fn nave_receipt_verify_args_are_exact_and_bounded() {
        let args = nave_receipt_verify_args(
            Path::new("/tmp/nave-receipt-session"),
            Path::new("/tmp/apse-receipt-session"),
    ...
    fn confirmed_decision_packet_session_dir_must_match_stored_contract_and_archive() {
        let dir = temp_dir("nave_receipt_confirmed_decision_packet");
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_nave_receipt.sanctuary_certificate.report.json"),
        ...
        let contract =
            load_live_package_nave_receipt_contract_for_transept_certificate(&dir).unwrap();
        let error = load_confirmed_decision_packet_session_dir_for_sanctuary_verify(
            &dir,
            &trusted_decision_packet_session_dir,
            &contract,
        )
