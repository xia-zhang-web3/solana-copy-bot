...
pub struct LivePackageSubstructureCertificateContractView {
    ...
    pub verify_substructure_certificate_command_summary: String,
...
#[derive(Debug, Clone)]
pub struct VerifiedLivePackageSubstructureCertificatePlinthReceiptStep {
    pub report_json: serde_json::Value,
    pub verdict: String,
    pub reason: String,
    pub generated_at: DateTime<Utc>,
    pub contract: LivePackageSubstructureCertificateContractView,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PackageSubstructureCertificateArtifactPaths {
    pub session_path: PathBuf,
    pub status_path: PathBuf,
    pub basal_receipt_report_path: PathBuf,
}

#[derive(Debug, Deserialize)]
struct StoredSubstructureCertificateSession {
    ...
    #[serde(alias = "verify_basal_receipt_command_summary")]
...
#[derive(Debug, Deserialize)]
struct StoredSubstructureCertificateStatus {
    result: String,
...
#[derive(Debug, Deserialize)]
struct StoredSubstructureCertificateReportView {
    decision_packet_session_dir: String,
}

#[derive(Debug, Deserialize)]
struct SubstructureCertificateVerifyReportView {
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    #[serde(alias = "verify_foundation_receipt_command_summary")]
...
pub fn load_live_package_substructure_certificate_contract_for_plinth_receipt(
    substructure_certificate_session_dir: &Path,
) -> Result<LivePackageSubstructureCertificateContractView> {
    let paths = substructure_certificate_artifact_paths(substructure_certificate_session_dir);
    let session: StoredSubstructureCertificateSession = load_json(&paths.session_path)?;
    let status: StoredSubstructureCertificateStatus = load_json(&paths.status_path)?;
    Ok(LivePackageSubstructureCertificateContractView {
        substructure_certificate_session_dir: substructure_certificate_session_dir.to_path_buf(),
        ...
        verify_substructure_certificate_command_summary: session
...
pub fn verify_live_package_substructure_certificate_for_plinth_receipt(
    substructure_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
) -> Result<VerifiedLivePackageSubstructureCertificatePlinthReceiptStep> {
    let contract = load_live_package_substructure_certificate_contract_for_plinth_receipt(
        substructure_certificate_session_dir,
    )?;
    let trusted_decision_packet_session_dir =
        load_confirmed_decision_packet_session_dir_for_substructure_verify(
            substructure_certificate_session_dir,
    ...
    let report: SubstructureCertificateVerifyReportView =
        serde_json::from_value(raw_report.clone())
            .context("failed parsing substructure-certificate verify report")?;
    ...
    if reported_bedrock_certificate_session_dir != contract.bedrock_certificate_session_dir {
        bail!(
            "substructure-certificate verify report bedrock_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_basal_receipt_session_dir != contract.basal_receipt_session_dir {
        bail!(
            "substructure-certificate verify report basal_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_foundation_receipt_session_dir != contract.foundation_receipt_session_dir {
        bail!(
            "substructure-certificate verify report foundation_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_decision_packet_session_dir != trusted_decision_packet_session_dir {
        bail!(
            "substructure-certificate verify report decision_packet_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_registry_entry_session_dir != contract.registry_entry_session_dir {
        bail!(
            "substructure-certificate verify report registry_entry_session_dir {:?} does not match trusted {:?}",
            reported_registry_entry_session_dir.display(),
            contract.registry_entry_session_dir.display()
        );
    }
    Ok(
        VerifiedLivePackageSubstructureCertificatePlinthReceiptStep {
            report_json: raw_report,
            verdict: report.verdict.clone(),
            reason: report.reason.clone(),
            generated_at: report.generated_at,
            contract: LivePackageSubstructureCertificateContractView {
                substructure_certificate_session_dir: substructure_certificate_session_dir
                    .to_path_buf(),
                ...
                verify_substructure_certificate_command_summary: required_string_field(
                    report.verify_substructure_certificate_command_summary,
                    "verify_substructure_certificate_command_summary",
                )?,
...
pub fn substructure_certificate_verify_args(
    substructure_certificate_session_dir: &Path,
...
pub fn substructure_certificate_artifact_paths(
    session_dir: &Path,
) -> PackageSubstructureCertificateArtifactPaths {
    PackageSubstructureCertificateArtifactPaths {
...
fn load_confirmed_decision_packet_session_dir_for_substructure_verify(
    substructure_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
    contract: &LivePackageSubstructureCertificateContractView,
) -> Result<PathBuf> {
    let paths = substructure_certificate_artifact_paths(substructure_certificate_session_dir);
    let archived_report: StoredSubstructureCertificateReportView =
        load_json(&paths.basal_receipt_report_path)?;
    ...
    if confirmed_decision_packet_session_dir != contract.decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match stored substructure-certificate contract {:?}",
    ...
    if confirmed_decision_packet_session_dir != archived_decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match archived nested basal-receipt report {:?}",
            confirmed_decision_packet_session_dir.display(),
...
fn required_string_field(value: Option<String>, field: &str) -> Result<String> {
    value.ok_or_else(|| anyhow!("substructure-certificate verify report is missing {field}"))
}
...
mod tests {
    ...
    #[test]
    fn load_contract_reads_stored_substructure_certificate_files() {
        let dir = temp_dir("substructure_certificate_contract");
        fs::write(
            dir.join("tiny_live_activation_package_substructure_certificate.session.json"),
            serde_json::to_vec_pretty(&stored_substructure_certificate_session_value(
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_substructure_certificate.status.json"),
            serde_json::to_vec_pretty(&stored_substructure_certificate_status_value(
        ...
        let contract =
            load_live_package_substructure_certificate_contract_for_plinth_receipt(&dir).unwrap();
        assert_eq!(contract.substructure_certificate_session_dir, dir);
        assert_eq!(
            contract.basal_receipt_session_dir,
    ...
    #[test]
    fn substructure_certificate_verify_args_are_exact_and_bounded() {
        let args = substructure_certificate_verify_args(
            Path::new("/tmp/substructure-certificate-session"),
            Path::new("/tmp/basal-receipt-session"),
        ...
        assert_eq!(
            ...
            vec![
                ...
                "/tmp/basal-receipt-session",
                "--confirm-decision-packet-session-dir",
                "/tmp/decision-packet-session",
                "--session-dir",
                "/tmp/substructure-certificate-session",
    ...
    fn confirmed_decision_packet_session_dir_must_match_stored_contract_and_archive() {
        let dir = temp_dir("substructure_certificate_confirmed_decision_packet");
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_substructure_certificate.basal_receipt.report.json"),
        ...
        let contract =
            load_live_package_substructure_certificate_contract_for_plinth_receipt(&dir).unwrap();
        let error = load_confirmed_decision_packet_session_dir_for_substructure_verify(
            &dir,
            &trusted_decision_packet_session_dir,
            &contract,
        )
    ...
    fn stored_substructure_certificate_session_value(decision_packet_session_dir: &str) -> Value {
    ...
    fn stored_substructure_certificate_status_value(
        result: &str,
