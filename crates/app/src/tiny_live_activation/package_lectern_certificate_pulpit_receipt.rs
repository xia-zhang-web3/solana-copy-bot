...
pub struct LivePackageLecternCertificateContractView {
    pub lectern_certificate_session_dir: PathBuf,
    pub podium_receipt_session_dir: PathBuf,
    pub rostrum_certificate_session_dir: PathBuf,
    ...
    pub verify_podium_receipt_command_summary: String,
...
#[derive(Debug, Clone)]
pub struct VerifiedLivePackageLecternCertificatePulpitReceiptStep {
    pub report_json: serde_json::Value,
    pub verdict: String,
    pub reason: String,
    pub generated_at: DateTime<Utc>,
    pub contract: LivePackageLecternCertificateContractView,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PackageLecternCertificateArtifactPaths {
    pub session_path: PathBuf,
    pub status_path: PathBuf,
    pub podium_receipt_report_path: PathBuf,
}

#[derive(Debug, Deserialize)]
struct StoredLecternCertificateSession {
...
#[derive(Debug, Deserialize)]
struct StoredLecternCertificateStatus {
    podium_receipt_session_dir: Option<String>,
    rostrum_certificate_session_dir: Option<String>,
...
#[derive(Debug, Deserialize)]
struct StoredPodiumReceiptReportView {
    decision_packet_session_dir: String,
}

#[derive(Debug, Deserialize)]
struct LecternCertificateVerifyReportView {
...
pub fn load_live_package_lectern_certificate_contract_for_pulpit_receipt(
    lectern_certificate_session_dir: &Path,
) -> Result<LivePackageLecternCertificateContractView> {
    let paths = lectern_certificate_artifact_paths(lectern_certificate_session_dir);
    let session: StoredLecternCertificateSession = load_json(&paths.session_path)?;
    let status: StoredLecternCertificateStatus = load_json(&paths.status_path)?;
    Ok(LivePackageLecternCertificateContractView {
        lectern_certificate_session_dir: lectern_certificate_session_dir.to_path_buf(),
        podium_receipt_session_dir: PathBuf::from(
            status
                .podium_receipt_session_dir
                .unwrap_or(session.podium_receipt_session_dir),
        ),
        rostrum_certificate_session_dir: PathBuf::from(
            status
                .rostrum_certificate_session_dir
                .unwrap_or(session.rostrum_certificate_session_dir),
        ),
...
pub fn verify_live_package_lectern_certificate_for_pulpit_receipt(
    lectern_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
) -> Result<VerifiedLivePackageLecternCertificatePulpitReceiptStep> {
    let contract = load_live_package_lectern_certificate_contract_for_pulpit_receipt(
        lectern_certificate_session_dir,
    )?;
    let trusted_decision_packet_session_dir =
        load_confirmed_decision_packet_session_dir_for_lectern_verify(
            lectern_certificate_session_dir,
    ...
    let raw_report = run_json_command(
        ...
        &lectern_certificate_verify_args(
            lectern_certificate_session_dir,
            &contract.podium_receipt_session_dir,
            &trusted_decision_packet_session_dir,
        ),
    )?;
    let report: LecternCertificateVerifyReportView = serde_json::from_value(raw_report.clone())
        .context("failed parsing lectern-certificate verify report")?;
    let reported_podium_receipt_session_dir = PathBuf::from(required_string_field(
        report.podium_receipt_session_dir,
        "podium_receipt_session_dir",
    )?);
    let reported_rostrum_certificate_session_dir = PathBuf::from(required_string_field(
    ...
    if reported_podium_receipt_session_dir != contract.podium_receipt_session_dir {
        bail!(
            "lectern-certificate verify report podium_receipt_session_dir {:?} does not match trusted {:?}",
            reported_podium_receipt_session_dir.display(),
            contract.podium_receipt_session_dir.display()
        );
    }
    if reported_rostrum_certificate_session_dir != contract.rostrum_certificate_session_dir {
        bail!(
            "lectern-certificate verify report rostrum_certificate_session_dir {:?} does not match trusted {:?}",
            reported_rostrum_certificate_session_dir.display(),
            contract.rostrum_certificate_session_dir.display()
        );
    }
    if reported_pedestal_certificate_session_dir != contract.pedestal_certificate_session_dir {
        bail!(
            "lectern-certificate verify report pedestal_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_plinth_receipt_session_dir != contract.plinth_receipt_session_dir {
        bail!(
            "lectern-certificate verify report plinth_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    {
        bail!(
            "lectern-certificate verify report substructure_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_bedrock_certificate_session_dir != contract.bedrock_certificate_session_dir {
        bail!(
            "lectern-certificate verify report bedrock_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_basal_receipt_session_dir != contract.basal_receipt_session_dir {
        bail!(
            "lectern-certificate verify report basal_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_foundation_receipt_session_dir != contract.foundation_receipt_session_dir {
        bail!(
            "lectern-certificate verify report foundation_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_decision_packet_session_dir != trusted_decision_packet_session_dir {
        bail!(
            "lectern-certificate verify report decision_packet_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_registry_entry_session_dir != contract.registry_entry_session_dir {
        bail!(
            "lectern-certificate verify report registry_entry_session_dir {:?} does not match trusted {:?}",
            reported_registry_entry_session_dir.display(),
            contract.registry_entry_session_dir.display()
        );
    }
    Ok(VerifiedLivePackageLecternCertificatePulpitReceiptStep {
        report_json: raw_report,
        verdict: report.verdict.clone(),
        reason: report.reason.clone(),
        generated_at: report.generated_at,
        contract: LivePackageLecternCertificateContractView {
            lectern_certificate_session_dir: lectern_certificate_session_dir.to_path_buf(),
            podium_receipt_session_dir: reported_podium_receipt_session_dir,
            rostrum_certificate_session_dir: reported_rostrum_certificate_session_dir,
            ...
            verify_podium_receipt_command_summary: required_string_field(
                report.verify_podium_receipt_command_summary,
...
pub fn lectern_certificate_verify_args(
    lectern_certificate_session_dir: &Path,
...
pub fn lectern_certificate_artifact_paths(
    session_dir: &Path,
) -> PackageLecternCertificateArtifactPaths {
    PackageLecternCertificateArtifactPaths {
...
fn load_confirmed_decision_packet_session_dir_for_lectern_verify(
    lectern_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
    contract: &LivePackageLecternCertificateContractView,
) -> Result<PathBuf> {
    let paths = lectern_certificate_artifact_paths(lectern_certificate_session_dir);
    let archived_report: StoredPodiumReceiptReportView =
        load_json(&paths.podium_receipt_report_path)?;
    ...
    if confirmed_decision_packet_session_dir != contract.decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match stored lectern-certificate contract {:?}",
    ...
    if confirmed_decision_packet_session_dir != archived_decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match archived nested podium-receipt report {:?}",
            confirmed_decision_packet_session_dir.display(),
...
fn required_string_field(value: Option<String>, field: &str) -> Result<String> {
    value.ok_or_else(|| anyhow!("lectern-certificate verify report is missing {field}"))
}
...
mod tests {
    ...
    #[test]
    fn load_contract_reads_stored_lectern_certificate_files() {
        let dir = temp_dir("lectern_certificate_contract");
        fs::write(
            dir.join("tiny_live_activation_package_lectern_certificate.session.json"),
            serde_json::to_vec_pretty(&stored_lectern_certificate_session_value(
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_lectern_certificate.status.json"),
            serde_json::to_vec_pretty(&stored_lectern_certificate_status_value(
        ...
        let contract =
            load_live_package_lectern_certificate_contract_for_pulpit_receipt(&dir).unwrap();
        assert_eq!(contract.lectern_certificate_session_dir, dir);
        assert_eq!(
            contract.podium_receipt_session_dir,
            PathBuf::from("/tmp/podium-receipt-session")
        );
        assert_eq!(
            contract.rostrum_certificate_session_dir,
    ...
    #[test]
    fn lectern_certificate_verify_args_are_exact_and_bounded() {
        let args = lectern_certificate_verify_args(
            Path::new("/tmp/lectern-certificate-session"),
            Path::new("/tmp/podium-receipt-session"),
        ...
        assert_eq!(
            ...
            vec![
                ...
                "/tmp/podium-receipt-session",
                "--confirm-decision-packet-session-dir",
                "/tmp/decision-packet-session",
                "--session-dir",
                "/tmp/lectern-certificate-session",
    ...
    fn confirmed_decision_packet_session_dir_must_match_stored_contract_and_archive() {
        let dir = temp_dir("lectern_certificate_confirmed_decision_packet");
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_lectern_certificate.podium_receipt.report.json"),
        ...
        let contract =
            load_live_package_lectern_certificate_contract_for_pulpit_receipt(&dir).unwrap();
        let error = load_confirmed_decision_packet_session_dir_for_lectern_verify(
            &dir,
            &trusted_decision_packet_session_dir,
            &contract,
        )
    ...
    fn stored_lectern_certificate_session_value(decision_packet_session_dir: &str) -> Value {
        let mut object = Map::new();
        object.insert(
            "podium_receipt_session_dir".to_string(),
            json!("/tmp/podium-receipt-session"),
        );
        object.insert(
    ...
    fn stored_lectern_certificate_status_value(
        result: &str,
