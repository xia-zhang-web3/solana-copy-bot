...
pub struct LivePackageRostrumCertificateContractView {
    ...
    pub verify_rostrum_certificate_command_summary: String,
...
#[derive(Debug, Clone)]
pub struct VerifiedLivePackageRostrumCertificatePodiumReceiptStep {
    pub report_json: serde_json::Value,
    pub verdict: String,
    pub reason: String,
    pub generated_at: DateTime<Utc>,
    pub contract: LivePackageRostrumCertificateContractView,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct PackageRostrumCertificateArtifactPaths {
    pub session_path: PathBuf,
    pub status_path: PathBuf,
    pub dais_receipt_report_path: PathBuf,
}

#[derive(Debug, Deserialize)]
struct StoredRostrumCertificateSession {
...
#[derive(Debug, Deserialize)]
struct StoredRostrumCertificateStatus {
...
#[derive(Debug, Deserialize)]
struct StoredDaisReceiptReportView {
    decision_packet_session_dir: String,
}

#[derive(Debug, Deserialize)]
struct RostrumCertificateVerifyReportView {
...
pub fn load_live_package_rostrum_certificate_contract_for_podium_receipt(
    rostrum_certificate_session_dir: &Path,
) -> Result<LivePackageRostrumCertificateContractView> {
    let paths = rostrum_certificate_artifact_paths(rostrum_certificate_session_dir);
    let session: StoredRostrumCertificateSession = load_json(&paths.session_path)?;
    let status: StoredRostrumCertificateStatus = load_json(&paths.status_path)?;
    Ok(LivePackageRostrumCertificateContractView {
        rostrum_certificate_session_dir: rostrum_certificate_session_dir.to_path_buf(),
        ...
        verify_rostrum_certificate_command_summary: session
...
pub fn verify_live_package_rostrum_certificate_for_podium_receipt(
    rostrum_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
) -> Result<VerifiedLivePackageRostrumCertificatePodiumReceiptStep> {
    let contract = load_live_package_rostrum_certificate_contract_for_podium_receipt(
        rostrum_certificate_session_dir,
    )?;
    let trusted_decision_packet_session_dir =
        load_confirmed_decision_packet_session_dir_for_dais_verify(
            rostrum_certificate_session_dir,
    ...
    let report: RostrumCertificateVerifyReportView = serde_json::from_value(raw_report.clone())
        .context("failed parsing rostrum-certificate verify report")?;
    let reported_dais_receipt_session_dir = PathBuf::from(required_string_field(
    ...
    if reported_dais_receipt_session_dir != contract.dais_receipt_session_dir {
        bail!(
            "rostrum-certificate verify report dais_receipt_session_dir {:?} does not match trusted {:?}",
            reported_dais_receipt_session_dir.display(),
            contract.dais_receipt_session_dir.display()
        );
    }
    if reported_pedestal_certificate_session_dir != contract.pedestal_certificate_session_dir {
        bail!(
            "rostrum-certificate verify report pedestal_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_plinth_receipt_session_dir != contract.plinth_receipt_session_dir {
        bail!(
            "rostrum-certificate verify report plinth_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    {
        bail!(
            "rostrum-certificate verify report substructure_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_bedrock_certificate_session_dir != contract.bedrock_certificate_session_dir {
        bail!(
            "rostrum-certificate verify report bedrock_certificate_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_basal_receipt_session_dir != contract.basal_receipt_session_dir {
        bail!(
            "rostrum-certificate verify report basal_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_foundation_receipt_session_dir != contract.foundation_receipt_session_dir {
        bail!(
            "rostrum-certificate verify report foundation_receipt_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_decision_packet_session_dir != trusted_decision_packet_session_dir {
        bail!(
            "rostrum-certificate verify report decision_packet_session_dir {:?} does not match trusted {:?}",
    ...
    if reported_registry_entry_session_dir != contract.registry_entry_session_dir {
        bail!(
            "rostrum-certificate verify report registry_entry_session_dir {:?} does not match trusted {:?}",
            reported_registry_entry_session_dir.display(),
            contract.registry_entry_session_dir.display()
        );
    }
    Ok(VerifiedLivePackageRostrumCertificatePodiumReceiptStep {
        report_json: raw_report,
        verdict: report.verdict.clone(),
        reason: report.reason.clone(),
        generated_at: report.generated_at,
        contract: LivePackageRostrumCertificateContractView {
            rostrum_certificate_session_dir: rostrum_certificate_session_dir.to_path_buf(),
            dais_receipt_session_dir: reported_dais_receipt_session_dir,
            ...
            verify_rostrum_certificate_command_summary: required_string_field(
                report.verify_rostrum_certificate_command_summary,
                "verify_rostrum_certificate_command_summary",
            )?,
...
pub fn rostrum_certificate_verify_args(
    rostrum_certificate_session_dir: &Path,
...
pub fn rostrum_certificate_artifact_paths(
    session_dir: &Path,
) -> PackageRostrumCertificateArtifactPaths {
    PackageRostrumCertificateArtifactPaths {
...
fn load_confirmed_decision_packet_session_dir_for_dais_verify(
    rostrum_certificate_session_dir: &Path,
    confirmed_decision_packet_session_dir: &Path,
    contract: &LivePackageRostrumCertificateContractView,
) -> Result<PathBuf> {
    let paths = rostrum_certificate_artifact_paths(rostrum_certificate_session_dir);
    let archived_report: StoredDaisReceiptReportView = load_json(&paths.dais_receipt_report_path)?;
    ...
    if confirmed_decision_packet_session_dir != contract.decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match stored rostrum-certificate contract {:?}",
    ...
    if confirmed_decision_packet_session_dir != archived_decision_packet_session_dir {
        bail!(
            "confirmed decision-packet session dir {:?} does not match archived nested dais-receipt report {:?}",
            confirmed_decision_packet_session_dir.display(),
...
fn required_string_field(value: Option<String>, field: &str) -> Result<String> {
    value.ok_or_else(|| anyhow!("rostrum-certificate verify report is missing {field}"))
}
...
mod tests {
    ...
    #[test]
    fn load_contract_reads_stored_rostrum_certificate_files() {
        let dir = temp_dir("rostrum_certificate_contract");
        fs::write(
            dir.join("tiny_live_activation_package_rostrum_certificate.session.json"),
            serde_json::to_vec_pretty(&stored_rostrum_certificate_session_value(
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_rostrum_certificate.status.json"),
            serde_json::to_vec_pretty(&stored_rostrum_certificate_status_value(
        ...
        let contract =
            load_live_package_rostrum_certificate_contract_for_podium_receipt(&dir).unwrap();
        assert_eq!(contract.rostrum_certificate_session_dir, dir);
        assert_eq!(
            contract.dais_receipt_session_dir,
    ...
    #[test]
    fn rostrum_certificate_verify_args_are_exact_and_bounded() {
        let args = rostrum_certificate_verify_args(
            Path::new("/tmp/rostrum-certificate-session"),
            Path::new("/tmp/dais-receipt-session"),
        ...
        assert_eq!(
            ...
            vec![
                ...
                "/tmp/dais-receipt-session",
                "--confirm-decision-packet-session-dir",
                "/tmp/decision-packet-session",
                "--session-dir",
                "/tmp/rostrum-certificate-session",
    ...
    fn confirmed_decision_packet_session_dir_must_match_stored_contract_and_archive() {
        let dir = temp_dir("rostrum_certificate_confirmed_decision_packet");
        ...
        .unwrap();
        fs::write(
            dir.join("tiny_live_activation_package_rostrum_certificate.dais_receipt.report.json"),
        ...
        let contract =
            load_live_package_rostrum_certificate_contract_for_podium_receipt(&dir).unwrap();
        let error = load_confirmed_decision_packet_session_dir_for_dais_verify(
            &dir,
            &trusted_decision_packet_session_dir,
            &contract,
        )
    ...
    fn stored_rostrum_certificate_session_value(decision_packet_session_dir: &str) -> Value {
    ...
    fn stored_rostrum_certificate_status_value(
        result: &str,
