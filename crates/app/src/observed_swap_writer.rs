...
const OBSERVED_SWAP_RECENT_RAW_JOURNAL_PRUNE_BATCH_SIZE: usize = 50_000;
const OBSERVED_SWAP_WRITER_LATENCY_SAMPLE_CAPACITY: usize = 512;
const OBSERVED_SWAP_RETENTION_DELETE_BATCH_SIZE: usize = 10_000;
const OBSERVED_SWAP_RETENTION_MAX_RAW_DELETE_BATCHES_PER_RUN: usize = 12;
const OBSERVED_SWAP_RETENTION_MAX_DURATION_PER_RUN: StdDuration = StdDuration::from_secs(20);
