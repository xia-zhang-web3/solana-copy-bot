...
const RECENT_RAW_JOURNAL_RETENTION_DELETE_BATCH_SIZE: usize = 25_000;
const RECENT_RAW_JOURNAL_RETENTION_MAX_DELETE_BATCHES_PER_RUN: usize = 8;
const RECENT_RAW_JOURNAL_RETENTION_MAX_DURATION_PER_RUN: StdDuration = StdDuration::from_secs(8);
