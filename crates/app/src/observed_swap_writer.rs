...
const OBSERVED_SWAP_RETENTION_DELETE_BATCH_SIZE: usize = 2_000;
const OBSERVED_SWAP_RETENTION_MAX_RAW_DELETE_BATCHES_PER_RUN: usize = 25;
const OBSERVED_SWAP_RETENTION_MAX_DURATION_PER_RUN: StdDuration = StdDuration::from_secs(10);
