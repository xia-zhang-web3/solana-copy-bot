...
struct RoutePolicyAuditRow {
    route: String,
    current_allowed: bool,
    policy_allowed: bool,
    current_route_ordered: bool,
    current_slippage_bps: Option<f64>,
    policy_max_slippage_bps: Option<f64>,
    slippage_within_bound: bool,
    current_tip_lamports: Option<u64>,
    policy_max_tip_lamports: Option<u64>,
    tip_within_bound: bool,
    current_compute_unit_limit: Option<u32>,
    current_compute_unit_price_micro_lamports: Option<u64>,
    policy_max_compute_unit_price_micro_lamports: Option<u64>,
    compute_unit_price_within_bound: bool,
}
...
pub(crate) struct TinyLivePolicyAuditReport {
    ...
    current_config_bounded_for_later_tiny_live_discussion: bool,
    suitable_only_for_paper_or_dry_run: bool,
    verdict: TinyLivePolicyVerdict,
    reason: String,
    blockers: Vec<String>,
    warnings: Vec<String>,
    tiny_live_policy_enabled: bool,
    current_default_route: String,
    current_allowed_routes: Vec<String>,
    current_route_order: Vec<String>,
    policy_allowed_routes: Vec<String>,
    current_shadow_copy_notional_sol: f64,
    current_risk_max_position_sol: f64,
    policy_max_trade_notional_sol: f64,
    current_execution_batch_size: u32,
    policy_max_batch_size: u32,
    current_risk_max_concurrent_positions: u32,
    policy_max_concurrent_positions: u32,
    current_risk_daily_loss_limit_pct: f64,
    policy_max_daily_loss_limit_pct: f64,
    current_pretrade_max_fee_overhead_bps: u32,
    policy_max_pretrade_fee_overhead_bps: u32,
    current_pretrade_max_priority_fee_lamports: u64,
    policy_max_pretrade_priority_fee_lamports: u64,
    current_policy_echo_required: bool,
    policy_echo_required_for_tiny_live: bool,
    route_policy_rows: Vec<RoutePolicyAuditRow>,
}
