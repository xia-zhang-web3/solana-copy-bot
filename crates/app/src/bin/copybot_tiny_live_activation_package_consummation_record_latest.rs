...
const USAGE: &str = "usage: copybot_tiny_live_activation_package_consummation_record_latest --root <path> [--session-dir <path>] [--output <path>] [--json] (--plan-latest-consummation-record | --render-latest-consummation-record-script | --run-latest-consummation-record | --verify-latest-consummation-record)";
const CONSUMMATION_RECORD_LATEST_SESSION_VERSION: &str = "1";
const CONSUMMATION_RECORD_LATEST_STATUS_VERSION: &str = "1";
const FINALITY_RECEIPT_LATEST_BIN: &str =
    "copybot_tiny_live_activation_package_finality_receipt_latest";
const CONSUMMATION_RECORD_BIN: &str = "copybot_tiny_live_activation_package_consummation_record";
const FINALITY_RECEIPT_LATEST_PLAN_READY: &str =
    "tiny_live_package_finality_receipt_latest_plan_ready";
const FINALITY_RECEIPT_LATEST_VERIFY_OK: &str =
    "tiny_live_package_finality_receipt_latest_verify_ok";
const CONSUMMATION_RECORD_VERIFY_OK: &str = "tiny_live_package_consummation_record_verify_ok";
const TOP_ACCEPTED_PACKAGE_STEP: &str = "clerestory_certificate";
const PLANNING_SAFE_STATEMENT: &str =
    "this latest-consummation-record handoff binds the latest persisted immutable package chain to the accepted consummation-record contract, but it never overrides Stage 3 or pre-activation refusal truth, it stays archival and read-only, it never runs the frozen live cutover controller by itself, and activation_authorized remains false";
...
enum Mode {
    PlanLatestConsummationRecord,
    RenderLatestConsummationRecordScript,
    RunLatestConsummationRecord,
    VerifyLatestConsummationRecord,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum TinyLivePackageConsummationRecordLatestVerdict {
    TinyLivePackageConsummationRecordLatestPlanReady,
    TinyLivePackageConsummationRecordLatestScriptRendered,
    TinyLivePackageConsummationRecordLatestRefusedByMissingLatestChain,
    TinyLivePackageConsummationRecordLatestRefusedByInvalidLatestChain,
    TinyLivePackageConsummationRecordLatestRefusedByDriftedConsummationRecordContract,
    TinyLivePackageConsummationRecordLatestRefusedNowByStage3,
    TinyLivePackageConsummationRecordLatestRefusedNowByPreActivationGate,
    TinyLivePackageConsummationRecordLatestReadyForManualExecutionWhenGateTurnsGreen,
    TinyLivePackageConsummationRecordLatestVerifyOk,
    TinyLivePackageConsummationRecordLatestVerifyInvalid,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum LivePackageConsummationRecordLatestResult {
    RefusedByMissingLatestChain,
    RefusedByInvalidLatestChain,
    RefusedByDriftedConsummationRecordContract,
    RefusedNowByStage3,
...
struct PackageConsummationRecordLatestStepArtifact {
    path: String,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageConsummationRecordLatestSession {
    session_version: String,
    planned_at: DateTime<Utc>,
    root: String,
    session_dir: String,
    nested_finality_receipt_latest_session_dir: String,
    nested_consummation_record_session_dir: String,
    ...
    resolve_latest_finality_receipt_command_summary: String,
    run_latest_finality_receipt_command_summary: String,
    verify_latest_finality_receipt_command_summary: String,
    downstream_consummation_record_command_summary: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageConsummationRecordLatestStatus {
    ...
    nested_consummation_record_session_dir: String,
    downstream_decision_packet_session_dir: String,
    result: LivePackageConsummationRecordLatestResult,
    reason: String,
    latest_finality_receipt_plan_verdict: Option<String>,
    latest_finality_receipt_verdict: Option<String>,
    consummation_record_verdict: Option<String>,
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    latest_finality_receipt_plan_step: Option<PackageConsummationRecordLatestStepArtifact>,
    latest_finality_receipt_step: Option<PackageConsummationRecordLatestStepArtifact>,
    consummation_record_step: Option<PackageConsummationRecordLatestStepArtifact>,
...
#[derive(Debug, Clone)]
struct PackageConsummationRecordLatestPaths {
    session_path: PathBuf,
    status_path: PathBuf,
    report_path: PathBuf,
    latest_finality_receipt_plan_report_path: PathBuf,
    latest_finality_receipt_report_path: PathBuf,
    consummation_record_report_path: PathBuf,
    nested_finality_receipt_latest_session_dir: PathBuf,
    nested_consummation_record_session_dir: PathBuf,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageConsummationRecordLatestReport {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: TinyLivePackageConsummationRecordLatestVerdict,
    reason: String,
    root: Option<String>,
    latest_top_step_name: Option<String>,
    latest_top_session_dir: Option<String>,
    ...
    consummation_record_latest_session_path: Option<String>,
    consummation_record_latest_status_path: Option<String>,
    consummation_record_latest_report_path: Option<String>,
    latest_finality_receipt_plan_report_path: Option<String>,
    latest_finality_receipt_report_path: Option<String>,
    consummation_record_report_path: Option<String>,
    nested_finality_receipt_latest_session_dir: Option<String>,
    nested_consummation_record_session_dir: Option<String>,
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    resolve_latest_finality_receipt_command_summary: Option<String>,
    run_latest_finality_receipt_command_summary: Option<String>,
    verify_latest_finality_receipt_command_summary: Option<String>,
    downstream_consummation_record_command_summary: Option<String>,
...
#[derive(Debug, Clone)]
struct LatestFinalityReceiptSnapshot {
...
#[derive(Debug, Clone)]
struct ResolvedLatestFinalityReceipt {
    snapshot: LatestFinalityReceiptSnapshot,
    latest_finality_receipt_plan_raw: Value,
    latest_finality_receipt_plan: FinalityReceiptLatestReportView,
}
...
enum ResolutionFailureKind {
    MissingLatestChain,
    InvalidLatestChain,
    DriftedConsummationRecordContract,
}

#[derive(Debug, Clone)]
struct LatestFinalityReceiptResolutionFailure {
    kind: ResolutionFailureKind,
    reason: String,
    snapshot: Option<LatestFinalityReceiptSnapshot>,
    latest_finality_receipt_plan_raw: Option<Value>,
    latest_finality_receipt_plan_verdict: Option<String>,
    latest_finality_receipt_plan_reason: Option<String>,
    latest_finality_receipt_plan_generated_at: Option<DateTime<Utc>>,
}

#[derive(Debug, Clone, Deserialize)]
struct FinalityReceiptLatestReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Deserialize)]
struct ConsummationRecordReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    finality_receipt_step: Option<PackageConsummationRecordLatestStepArtifact>,
    verify_finality_receipt_command_summary: Option<String>,
    reviewed_frozen_live_cutover_controller_command_summary: Option<String>,
...
#[derive(Debug, Clone, Deserialize)]
struct ConsummationRecordSessionView {
    finality_receipt_session_dir: String,
...
#[derive(Debug, Clone, Deserialize)]
struct ConsummationRecordStatusView {
    session_dir: String,
    finality_receipt_session_dir: String,
    result: String,
    reason: String,
    ...
    I: IntoIterator<Item = String>,
{
    ...
    while let Some(arg) = iter.next() {
        match arg.as_str() {
            ...
            "--json" => json = true,
            "--plan-latest-consummation-record" => {
                set_mode(&mut mode, Mode::PlanLatestConsummationRecord, arg.as_str())?
            }
            "--render-latest-consummation-record-script" => set_mode(
                &mut mode,
                Mode::RenderLatestConsummationRecordScript,
                arg.as_str(),
            )?,
            "--run-latest-consummation-record" => {
                set_mode(&mut mode, Mode::RunLatestConsummationRecord, arg.as_str())?
            }
            "--verify-latest-consummation-record" => set_mode(
                &mut mode,
                Mode::VerifyLatestConsummationRecord,
                arg.as_str(),
            )?,
    ...
    if matches!(
        mode,
        Mode::PlanLatestConsummationRecord
            | Mode::RenderLatestConsummationRecordScript
            | Mode::RunLatestConsummationRecord
    ) && root.is_none()
    {
        bail!("missing --root");
    }
    if matches!(mode, Mode::RenderLatestConsummationRecordScript) && output_path.is_none() {
        bail!("missing --output for render mode");
    }
    if matches!(
        mode,
        Mode::RunLatestConsummationRecord | Mode::VerifyLatestConsummationRecord
    ) && session_dir.is_none()
    {
...
fn run(config: Config) -> Result<String> {
    let report = match config.mode {
        Mode::PlanLatestConsummationRecord => plan_latest_consummation_record_report(&config)?,
        Mode::RenderLatestConsummationRecordScript => {
            render_latest_consummation_record_script_report(&config)?
        }
        Mode::RunLatestConsummationRecord => run_latest_consummation_record_report(&config)?,
        Mode::VerifyLatestConsummationRecord => verify_latest_consummation_record_report(&config)?,
    };
    if config.json {
...
fn plan_latest_consummation_record_report(
    config: &Config,
) -> Result<PackageConsummationRecordLatestReport> {
    let root = config
        .root
        .as_ref()
        .ok_or_else(|| anyhow!("missing --root"))?;
    let suggested_session_dir = config.session_dir.clone().unwrap_or_else(|| {
        root.join("tiny_live_activation_package_consummation_record_latest.session")
    });
    let paths = consummation_record_latest_paths(&suggested_session_dir);

    match resolve_latest_finality_receipt(root, &paths) {
        Ok(resolved) => Ok(plan_report_from_resolution(
            "plan_latest_consummation_record",
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestPlanReady,
            format!(
                "latest immutable {} chain under {} resolves to exact latest-finality-receipt {} lineage, exact decision-packet confirmation anchor {}, and the accepted consummation-record contract remains current",
                resolved.snapshot.latest_top_step_name,
                root.display(),
                paths.nested_finality_receipt_latest_session_dir.display(),
        ...
        Ok(resolved) => {
            write_script(
                ...
                &format!(
                    ...
                    run_latest = run_latest_finality_receipt_command_summary(
                        root,
                        &paths.nested_finality_receipt_latest_session_dir,
                    ),
                    verify_latest = verify_latest_finality_receipt_command_summary(
                        &paths.nested_finality_receipt_latest_session_dir,
                    ),
                    run_handoff_bundle = downstream_consummation_record_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_finality_receipt_session_dir(&paths),
                        &paths.nested_consummation_record_session_dir,
                    ),
                    verify_handoff_bundle = verify_finality_receipt_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_finality_receipt_session_dir(&paths),
                        &paths.nested_consummation_record_session_dir,
                    ),
            ...
            Ok(plan_report_from_resolution(
                ...
                TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestScriptRendered,
                format!(
                    "rendered latest-consummation-record handoff script to {} using the accepted latest-finality-receipt and consummation-record contracts",
                    output_path.display()
                ),
                root,
                &suggested_session_dir,
...
fn run_latest_consummation_record_report(
    config: &Config,
) -> Result<PackageConsummationRecordLatestReport> {
    let root = config
        .root
    ...
    let paths = consummation_record_latest_paths(session_dir);
    create_clean_session_dir(session_dir, "latest-consummation-record")?;

    let resolution = resolve_latest_finality_receipt(root, &paths);
    match resolution {
        Ok(resolved) => {
            run_latest_finality_receipt_with_resolution(root, session_dir, &paths, &resolved)
        }
        Err(failure) => run_latest_finality_receipt_failure(root, session_dir, &paths, &failure),
    }
}

fn verify_latest_consummation_record_report(
    config: &Config,
) -> Result<PackageConsummationRecordLatestReport> {
    let session_dir = config
        .session_dir
    ...
    let session: PackageConsummationRecordLatestSession = match load_json(&paths.session_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_finality_receipt_latest_report_without_session(
                    session_dir,
                    vec![format!(
    ...
    let status: PackageConsummationRecordLatestStatus = match load_json(&paths.status_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_finality_receipt_latest_report_without_session(
    ...
    let stored_report: PackageConsummationRecordLatestReport = match load_json(&paths.report_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_finality_receipt_latest_report_without_session(
    ...
    compare_string(
        &session.nested_finality_receipt_latest_session_dir,
        &paths
            .nested_finality_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-consummation-record session nested_finality_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_finality_receipt_latest_session_dir,
        &paths
            .nested_finality_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-consummation-record status nested_finality_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-consummation-record report nested_finality_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_consummation_record_session_dir,
        &paths
            .nested_consummation_record_session_dir
            .display()
            .to_string(),
        "latest-consummation-record session nested_consummation_record_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_consummation_record_session_dir,
        &paths
            .nested_consummation_record_session_dir
            .display()
            .to_string(),
        "latest-consummation-record status nested_consummation_record_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-consummation-record report nested_consummation_record_session_dir",
        &mut mismatches,
    );
    compare_string(
    ...
    compare_option_string(
        stored_report
            .consummation_record_latest_session_path
            .as_deref(),
    ...
    compare_option_string(
        stored_report
            .consummation_record_latest_status_path
            .as_deref(),
    ...
    compare_option_string(
        stored_report
            .consummation_record_latest_report_path
            .as_deref(),
    ...
    compare_string(
        ...
        "latest-consummation-record stored report mode",
        &mut mismatches,
    );
    compare_string(
    ...
    compare_option_string(
        stored_report
            .latest_finality_receipt_plan_verdict
            .as_deref(),
        status.latest_finality_receipt_plan_verdict.as_deref(),
        "stored report latest_finality_receipt_plan_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.latest_finality_receipt_verdict.as_deref(),
        status.latest_finality_receipt_verdict.as_deref(),
        "stored report latest_finality_receipt_verdict",
        &mut mismatches,
    );
    compare_option_string(
    ...
    match resolution {
        Ok(resolved) => {
            ...
            let stored_latest_plan: FinalityReceiptLatestReportView = load_required_step_json(
                &status.latest_finality_receipt_plan_step,
                &paths.latest_finality_receipt_plan_report_path,
                "latest_finality_receipt_plan_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_finality_receipt_plan_step.as_ref(),
                &paths.latest_finality_receipt_plan_report_path,
                "plan_latest_finality_receipt",
                &stored_latest_plan.verdict,
                &stored_latest_plan.reason,
                stored_latest_plan.generated_at,
                "stored latest_finality_receipt_plan_step",
                &mut mismatches,
            );
            compare_finality_receipt_latest_plan_against_snapshot(
                &stored_latest_plan,
                &resolved.snapshot,
                &paths.nested_finality_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_finality_receipt_plan_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report
            ...
            let stored_latest_run: FinalityReceiptLatestReportView = load_required_step_json(
                &status.latest_finality_receipt_step,
                &paths.latest_finality_receipt_report_path,
                "latest_finality_receipt_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_finality_receipt_step.as_ref(),
                &paths.latest_finality_receipt_report_path,
                "run_latest_finality_receipt",
                &stored_latest_run.verdict,
                &stored_latest_run.reason,
                stored_latest_run.generated_at,
                "stored latest_finality_receipt_step",
                &mut mismatches,
            );
            compare_finality_receipt_latest_run_against_snapshot(
                &stored_latest_run,
                &resolved.snapshot,
                &paths.nested_finality_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_finality_receipt_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_finality_receipt_verdict.as_deref(),
            ...
            let actual_latest_run: FinalityReceiptLatestReportView = match load_json(
                &nested_finality_receipt_latest_report_path(
                    &paths.nested_finality_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed loading actual nested latest-finality-receipt report under {}: {error}",
                        paths.nested_finality_receipt_latest_session_dir.display()
                    ));
                    fallback_finality_receipt_latest_copy()
                }
            };
            compare_finality_receipt_latest_copy_matches_actual(
                &stored_latest_run,
                &actual_latest_run,
                &mut mismatches,
            );
            ...
            let latest_verify_raw = match run_json_command(
                FINALITY_RECEIPT_LATEST_BIN,
                &latest_finality_receipt_verify_args(
                    &paths.nested_finality_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested latest-finality-receipt session under {}: {error}",
                        paths.nested_finality_receipt_latest_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !latest_verify_raw.is_null() {
                let latest_verify: FinalityReceiptLatestReportView =
                    serde_json::from_value(latest_verify_raw)
                        .context("failed parsing nested latest-finality-receipt verify json")?;
                if latest_verify.verdict != FINALITY_RECEIPT_LATEST_VERIFY_OK {
                    mismatches.push(format!(
                        "nested latest-finality-receipt verification is non-green: {}",
                        latest_verify.reason
                    ));
                }
            }

            let stored_handoff_bundle: ConsummationRecordReportView = load_required_step_json(
                &status.consummation_record_step,
                &paths.consummation_record_report_path,
            ...
            compare_step_artifact_against_report_metadata(
                ...
                &paths.consummation_record_report_path,
                "run_live_package_consummation_record",
            ...
            let nested_handoff_bundle_session: ConsummationRecordSessionView =
                match load_json(&nested_consummation_record_session_path(
                    &paths.nested_consummation_record_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                            ...
                            paths.nested_consummation_record_session_dir.display()
                        ));
            ...
            let nested_handoff_bundle_status: ConsummationRecordStatusView =
                match load_json(&nested_consummation_record_status_path(
                    &paths.nested_consummation_record_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
            ...
            let handoff_bundle_verify_raw = match run_json_command(
                CONSUMMATION_RECORD_BIN,
                &finality_receipt_verify_args(
                    &resolved.snapshot,
                    &expected_downstream_finality_receipt_session_dir(&paths),
                    &paths.nested_consummation_record_session_dir,
                ),
            ...
            if !handoff_bundle_verify_raw.is_null() {
                let handoff_bundle_verify: ConsummationRecordReportView =
                ...
                if handoff_bundle_verify.verdict != CONSUMMATION_RECORD_VERIFY_OK {
                    mismatches.push(format!(
            ...
            let expected_result = finality_receipt_latest_result_from_nested_status(
                nested_handoff_bundle_status.result.as_str(),
            )
            .unwrap_or(
                LivePackageConsummationRecordLatestResult::RefusedByDriftedConsummationRecordContract,
            );
        ...
        Err(failure) => {
            ...
            if failure.latest_finality_receipt_plan_raw.is_some() {
                let stored_latest_plan: FinalityReceiptLatestReportView = load_required_step_json(
                    &status.latest_finality_receipt_plan_step,
                    &paths.latest_finality_receipt_plan_report_path,
                    "latest_finality_receipt_plan_step",
                ...
                compare_option_string(
                    status.latest_finality_receipt_plan_verdict.as_deref(),
                    failure.latest_finality_receipt_plan_verdict.as_deref(),
                    "stored status latest_finality_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_report
                        ...
                        .as_deref(),
                    failure.latest_finality_receipt_plan_verdict.as_deref(),
                    "stored report latest_finality_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
            }
            compare_option_string(
                status.latest_finality_receipt_verdict.as_deref(),
                None,
                "stored status latest_finality_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_finality_receipt_verdict.as_deref(),
                None,
                "stored report latest_finality_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.consummation_record_verdict.as_deref(),
    ...
    let verdict = if mismatches.is_empty() {
        TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestVerifyOk
    } else {
        TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestVerifyInvalid
    };
    let reason = if mismatches.is_empty() {
        format!(
            "latest-consummation-record session under {} is coherent with the current latest immutable chain and the accepted consummation-record contract",
            session_dir.display()
        )
    } else {
        mismatches
    ...
    Ok(PackageConsummationRecordLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_consummation_record".to_string(),
        verdict,
        reason,
        ...
        consummation_record_latest_session_path: Some(paths.session_path.display().to_string()),
        consummation_record_latest_status_path: Some(paths.status_path.display().to_string()),
        consummation_record_latest_report_path: Some(paths.report_path.display().to_string()),
        latest_finality_receipt_plan_report_path: Some(
            paths
                .latest_finality_receipt_plan_report_path
                .display()
                .to_string(),
        ),
        latest_finality_receipt_report_path: Some(
            paths.latest_finality_receipt_report_path.display().to_string(),
        ),
        consummation_record_report_path: Some(paths.consummation_record_report_path.display().to_string()),
        nested_finality_receipt_latest_session_dir: Some(
            paths
                .nested_finality_receipt_latest_session_dir
                .display()
                .to_string(),
        ),
        nested_consummation_record_session_dir: Some(
            paths.nested_consummation_record_session_dir.display().to_string(),
        ),
        ...
        latest_finality_receipt_plan_verdict: status.latest_finality_receipt_plan_verdict.clone(),
        latest_finality_receipt_verdict: status.latest_finality_receipt_verdict.clone(),
        ...
        resolve_latest_finality_receipt_command_summary: Some(
            session.resolve_latest_finality_receipt_command_summary.clone(),
        ),
        run_latest_finality_receipt_command_summary: Some(
            session.run_latest_finality_receipt_command_summary.clone(),
        ),
        verify_latest_finality_receipt_command_summary: Some(
            session.verify_latest_finality_receipt_command_summary.clone(),
        ),
        downstream_consummation_record_command_summary: Some(
            session.downstream_consummation_record_command_summary.clone(),
        ),
        verify_finality_receipt_command_summary: Some(session.verify_finality_receipt_command_summary.clone()),
        ...
        explicit_statement:
            "this verification proves only whether the latest immutable chain still resolves cleanly into the accepted consummation-record contract; it never runs the frozen controller"
                .to_string(),
    })
}

fn run_latest_finality_receipt_with_resolution(
    root: &Path,
    session_dir: &Path,
    paths: &PackageConsummationRecordLatestPaths,
    resolved: &ResolvedLatestFinalityReceipt,
) -> Result<PackageConsummationRecordLatestReport> {
    let session = planned_session(root, session_dir, paths, Some(resolved), None);
    persist_json(&paths.session_path, &session)?;
    persist_json(
        &paths.latest_finality_receipt_plan_report_path,
        &resolved.latest_finality_receipt_plan_raw,
    )?;

    let latest_finality_receipt_plan_step = Some(step_artifact(
        &paths.latest_finality_receipt_plan_report_path,
        "plan_latest_finality_receipt",
        &resolved.latest_finality_receipt_plan.verdict,
        &resolved.latest_finality_receipt_plan.reason,
        resolved.latest_finality_receipt_plan.generated_at,
    ));

    let latest_finality_receipt_run_raw = match run_json_command(
        FINALITY_RECEIPT_LATEST_BIN,
        &latest_finality_receipt_run_args(root, &paths.nested_finality_receipt_latest_session_dir),
    ) {
        Ok(value) => value,
        Err(error) => {
            let status =
                refusal_status(
                    ...
                    LivePackageConsummationRecordLatestResult::RefusedByDriftedConsummationRecordContract,
                    format!(
                    "failed running nested latest-finality-receipt handoff under {}: {error}",
                    paths.nested_finality_receipt_latest_session_dir.display()
                ),
                    latest_finality_receipt_plan_step,
                    None,
    ...
    persist_json(
        &paths.latest_finality_receipt_report_path,
        &latest_finality_receipt_run_raw,
    )?;
    let latest_finality_receipt_run: FinalityReceiptLatestReportView =
        serde_json::from_value(latest_finality_receipt_run_raw)
            .context("failed parsing nested latest-finality-receipt run json")?;
    let latest_finality_receipt_step = Some(step_artifact(
        &paths.latest_finality_receipt_report_path,
        "run_latest_finality_receipt",
        &latest_finality_receipt_run.verdict,
        &latest_finality_receipt_run.reason,
        latest_finality_receipt_run.generated_at,
    ));

    if let Some(terminal_failure) =
        latest_finality_receipt_terminal_failure(&latest_finality_receipt_run)
    {
        let status = refusal_status(
            ...
            Some(resolved),
            terminal_failure,
            latest_finality_receipt_run.reason.clone(),
            latest_finality_receipt_plan_step,
            latest_finality_receipt_step,
            None,
        );
    ...
    let latest_finality_receipt_verify: FinalityReceiptLatestReportView = match run_json_command(
        FINALITY_RECEIPT_LATEST_BIN,
        &latest_finality_receipt_verify_args(&paths.nested_finality_receipt_latest_session_dir),
    ) {
        ...
        Err(error) => {
            let status =
                refusal_status(
                    ...
                    LivePackageConsummationRecordLatestResult::RefusedByDriftedConsummationRecordContract,
                    format!(
                    "failed verifying nested latest-finality-receipt handoff under {}: {error}",
                    paths.nested_finality_receipt_latest_session_dir.display()
                ),
                    latest_finality_receipt_plan_step,
                    latest_finality_receipt_step,
    ...
    if latest_finality_receipt_verify.verdict != FINALITY_RECEIPT_LATEST_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
            Some(resolved),
            LivePackageConsummationRecordLatestResult::RefusedByDriftedConsummationRecordContract,
            latest_finality_receipt_verify.reason,
            latest_finality_receipt_plan_step,
            latest_finality_receipt_step,
            None,
        );
    ...
    let provenance_certificate_run: ConsummationRecordReportView =
    ...
    let provenance_certificate_verify: ConsummationRecordReportView = match run_json_command(
        CONSUMMATION_RECORD_BIN,
        &finality_receipt_verify_args(
            &resolved.snapshot,
            &expected_downstream_finality_receipt_session_dir(paths),
    ...
    if provenance_certificate_verify.verdict != CONSUMMATION_RECORD_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
    ...
    let result = finality_receipt_latest_result_from_nested_status(
        provenance_certificate_run
            .result
            .as_deref()
            .unwrap_or_default(),
    ...
    let status = PackageConsummationRecordLatestStatus {
        status_version: CONSUMMATION_RECORD_LATEST_STATUS_VERSION.to_string(),
        updated_at: Utc::now(),
        ...
        nested_finality_receipt_latest_session_dir: paths
            .nested_finality_receipt_latest_session_dir
            .display()
            .to_string(),
        nested_consummation_record_session_dir: paths
            .nested_consummation_record_session_dir
            .display()
            .to_string(),
        ...
        latest_finality_receipt_plan_verdict: Some(
            resolved.latest_finality_receipt_plan.verdict.clone(),
        ),
        latest_finality_receipt_verdict: Some(latest_finality_receipt_run.verdict.clone()),
...
fn run_latest_finality_receipt_failure(
    root: &Path,
    session_dir: &Path,
    paths: &PackageConsummationRecordLatestPaths,
    failure: &LatestFinalityReceiptResolutionFailure,
) -> Result<PackageConsummationRecordLatestReport> {
    let session = planned_session(root, session_dir, paths, None, Some(failure));
    persist_json(&paths.session_path, &session)?;
    if let Some(value) = &failure.latest_finality_receipt_plan_raw {
        persist_json(&paths.latest_finality_receipt_plan_report_path, value)?;
    }
...
fn resolve_latest_finality_receipt(
    root: &Path,
    paths: &PackageConsummationRecordLatestPaths,
) -> std::result::Result<ResolvedLatestFinalityReceipt, LatestFinalityReceiptResolutionFailure> {
    let latest_finality_receipt_plan_raw = match run_json_command(
        FINALITY_RECEIPT_LATEST_BIN,
        &latest_finality_receipt_plan_args(root, &paths.nested_finality_receipt_latest_session_dir),
    ) {
        Ok(value) => value,
        Err(error) => {
            return Err(LatestFinalityReceiptResolutionFailure {
                ...
                snapshot: None,
                latest_finality_receipt_plan_raw: None,
                latest_finality_receipt_plan_verdict: None,
                latest_finality_receipt_plan_reason: None,
                latest_finality_receipt_plan_generated_at: None,
            });
        }
    };
    let latest_finality_receipt_plan: FinalityReceiptLatestReportView =
        serde_json::from_value(latest_finality_receipt_plan_raw.clone()).map_err(|error| {
            LatestFinalityReceiptResolutionFailure {
                kind: ResolutionFailureKind::InvalidLatestChain,
                reason: format!(
                    "failed parsing latest-finality-receipt plan json for {}: {error}",
                    root.display()
                ),
                snapshot: None,
                latest_finality_receipt_plan_raw: Some(latest_finality_receipt_plan_raw.clone()),
                latest_finality_receipt_plan_verdict: None,
                latest_finality_receipt_plan_reason: None,
                latest_finality_receipt_plan_generated_at: None,
            }
    ...
    let snapshot = parse_snapshot_from_finality_receipt_latest(&latest_finality_receipt_plan).ok();
    if latest_finality_receipt_plan.verdict != FINALITY_RECEIPT_LATEST_PLAN_READY {
        return Err(LatestFinalityReceiptResolutionFailure {
            kind: map_finality_receipt_latest_failure_kind(&latest_finality_receipt_plan.verdict),
            reason: latest_finality_receipt_plan.reason.clone(),
            snapshot,
            latest_finality_receipt_plan_raw: Some(latest_finality_receipt_plan_raw),
            latest_finality_receipt_plan_verdict: Some(latest_finality_receipt_plan.verdict),
            latest_finality_receipt_plan_reason: Some(latest_finality_receipt_plan.reason),
            latest_finality_receipt_plan_generated_at: Some(
                latest_finality_receipt_plan.generated_at,
            ),
        });
    }

    let snapshot = parse_snapshot_from_finality_receipt_latest(&latest_finality_receipt_plan)
        .map_err(|error| LatestFinalityReceiptResolutionFailure {
            kind: ResolutionFailureKind::InvalidLatestChain,
            reason: error.to_string(),
            snapshot: None,
            latest_finality_receipt_plan_raw: Some(latest_finality_receipt_plan_raw.clone()),
            latest_finality_receipt_plan_verdict: Some(
                latest_finality_receipt_plan.verdict.clone(),
            ),
            latest_finality_receipt_plan_reason: Some(latest_finality_receipt_plan.reason.clone()),
            latest_finality_receipt_plan_generated_at: Some(
                latest_finality_receipt_plan.generated_at,
            ),
        })?;
    ...
    if !mismatches.is_empty() {
        return Err(LatestFinalityReceiptResolutionFailure {
            kind: ResolutionFailureKind::DriftedConsummationRecordContract,
    ...
    Ok(ResolvedLatestFinalityReceipt {
        snapshot,
        latest_finality_receipt_plan_raw,
        latest_finality_receipt_plan,
    })
}

fn parse_snapshot_from_finality_receipt_latest(
    view: &FinalityReceiptLatestReportView,
) -> Result<LatestFinalityReceiptSnapshot> {
    ...
    if latest_top_step_name != TOP_ACCEPTED_PACKAGE_STEP {
        bail!(
            "latest-finality-receipt plan top accepted step is {} instead of {}",
    ...
    if view.activation_authorized {
        bail!(
            "latest-finality-receipt plan must remain planning-safe with activation_authorized=false"
        );
    }
    Ok(LatestFinalityReceiptSnapshot {
        latest_top_step_name,
        ...
        wrapper_timeout_ms: view
            .wrapper_timeout_ms
            .ok_or_else(|| anyhow!("latest-finality-receipt plan is missing wrapper_timeout_ms"))?,
        service_status_max_staleness_ms: view.service_status_max_staleness_ms.ok_or_else(|| {
            anyhow!("latest-finality-receipt plan is missing service_status_max_staleness_ms")
        })?,
...
fn plan_report_from_resolution(
    ...
    paths: &PackageConsummationRecordLatestPaths,
    resolved: &ResolvedLatestFinalityReceipt,
) -> PackageConsummationRecordLatestReport {
    PackageConsummationRecordLatestReport {
        generated_at: Utc::now(),
        ...
        latest_finality_receipt_report_path: Some(
            paths
                .latest_finality_receipt_report_path
                .display()
                .to_string(),
        ),
        consummation_record_report_path: Some(
            paths.consummation_record_report_path.display().to_string(),
        ),
        nested_finality_receipt_latest_session_dir: Some(
            paths
                .nested_finality_receipt_latest_session_dir
        ...
        latest_finality_receipt_verdict: None,
        consummation_record_verdict: None,
        result: None,
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_finality_receipt_command_summary: Some(
            resolve_latest_finality_receipt_command_summary(
                root,
                &paths.nested_finality_receipt_latest_session_dir,
            ),
        ),
        run_latest_finality_receipt_command_summary: Some(
            run_latest_finality_receipt_command_summary(
                root,
                &paths.nested_finality_receipt_latest_session_dir,
            ),
        ),
        verify_latest_finality_receipt_command_summary: Some(
            verify_latest_finality_receipt_command_summary(
                &paths.nested_finality_receipt_latest_session_dir,
            ),
        ),
        downstream_consummation_record_command_summary: Some(
            downstream_consummation_record_command_summary(
                &resolved.snapshot,
                &expected_downstream_finality_receipt_session_dir(paths),
                &paths.nested_consummation_record_session_dir,
            ),
...
fn report_from_resolution_failure(
    ...
    PackageConsummationRecordLatestReport {
        ...
        latest_finality_receipt_plan_verdict: failure.latest_finality_receipt_plan_verdict.clone(),
        latest_finality_receipt_verdict: None,
        consummation_record_verdict: None,
        ...
        downstream_consummation_record_command_summary: snapshot.map(|value| {
            downstream_consummation_record_command_summary(
                value,
                &expected_downstream_finality_receipt_session_dir(paths),
                &paths.nested_consummation_record_session_dir,
        ...
        verify_finality_receipt_command_summary: snapshot.map(|value| {
            verify_finality_receipt_command_summary(
                value,
                &expected_downstream_finality_receipt_session_dir(paths),
                &paths.nested_consummation_record_session_dir,
            )
...
fn planned_session(
    ...
    session_dir: &Path,
    paths: &PackageConsummationRecordLatestPaths,
    resolved: Option<&ResolvedLatestFinalityReceipt>,
    failure: Option<&LatestFinalityReceiptResolutionFailure>,
) -> PackageConsummationRecordLatestSession {
    let snapshot = resolved
        .map(|value| &value.snapshot)
        .or_else(|| failure.and_then(|value| value.snapshot.as_ref()));
    PackageConsummationRecordLatestSession {
        session_version: CONSUMMATION_RECORD_LATEST_SESSION_VERSION.to_string(),
        planned_at: Utc::now(),
        root: root.display().to_string(),
        session_dir: session_dir.display().to_string(),
        nested_finality_receipt_latest_session_dir: paths
        ...
        run_latest_finality_receipt_command_summary: run_latest_finality_receipt_command_summary(
            root,
            &paths.nested_finality_receipt_latest_session_dir,
        ),
        verify_latest_finality_receipt_command_summary:
        ...
        downstream_consummation_record_command_summary: snapshot
            .map(|value| {
                downstream_consummation_record_command_summary(
                    value,
                    &expected_downstream_finality_receipt_session_dir(paths),
        ...
        verify_finality_receipt_command_summary: snapshot
            .map(|value| {
                verify_finality_receipt_command_summary(
                    value,
                    &expected_downstream_finality_receipt_session_dir(paths),
...
fn report_from_status(
    ...
    session_dir: &Path,
    paths: &PackageConsummationRecordLatestPaths,
    session: &PackageConsummationRecordLatestSession,
    status: &PackageConsummationRecordLatestStatus,
    verification_mismatches: Vec<String>,
) -> PackageConsummationRecordLatestReport {
    PackageConsummationRecordLatestReport {
        generated_at: Utc::now(),
        ...
        nested_finality_receipt_latest_session_dir: Some(
            session.nested_finality_receipt_latest_session_dir.clone(),
        ),
        nested_consummation_record_session_dir: Some(
            session.nested_consummation_record_session_dir.clone(),
        ),
        downstream_decision_packet_session_dir: Some(
        ...
        verify_finality_receipt_command_summary: Some(
            session.verify_finality_receipt_command_summary.clone(),
        ),
        reviewed_frozen_live_cutover_controller_command_summary: session
            .reviewed_frozen_live_cutover_controller_command_summary
            .clone(),
...
fn consummation_record_latest_paths(session_dir: &Path) -> PackageConsummationRecordLatestPaths {
    PackageConsummationRecordLatestPaths {
        session_path: session_dir
            .join("tiny_live_activation_package_consummation_record_latest.session.json"),
        status_path: session_dir
            .join("tiny_live_activation_package_consummation_record_latest.status.json"),
        report_path: session_dir
            .join("tiny_live_activation_package_consummation_record_latest.report.json"),
        latest_finality_receipt_plan_report_path: session_dir.join(
            "tiny_live_activation_package_consummation_record_latest.finality_receipt_latest_plan.report.json",
        ),
        latest_finality_receipt_report_path: session_dir.join(
            "tiny_live_activation_package_consummation_record_latest.finality_receipt_latest.report.json",
        ),
        consummation_record_report_path: session_dir.join(
            "tiny_live_activation_package_consummation_record_latest.consummation_record.report.json",
        ),
        nested_finality_receipt_latest_session_dir: session_dir
            .join("tiny_live_activation_package_consummation_record_latest.finality_receipt_latest_session"),
        nested_consummation_record_session_dir: session_dir.join(
            "tiny_live_activation_package_consummation_record_latest.consummation_record_session",
        ),
    }
}
...
fn expected_downstream_decision_packet_session_dir(
    ...
    paths
        .nested_finality_receipt_latest_session_dir
        .join("tiny_live_activation_package_finality_receipt_latest.decision_packet_session")
}

fn expected_downstream_finality_receipt_session_dir(
    paths: &PackageConsummationRecordLatestPaths,
) -> PathBuf {
    paths
        .nested_finality_receipt_latest_session_dir
        .join("tiny_live_activation_package_finality_receipt_latest.finality_receipt_session")
}
...
fn expected_downstream_review_receipt_session_dir(
    ...
    paths
        .nested_finality_receipt_latest_session_dir
        .join("tiny_live_activation_package_finality_receipt_latest.review_receipt_session")
}

fn latest_finality_receipt_plan_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--plan-latest-finality-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn latest_finality_receipt_run_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-latest-finality-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn latest_finality_receipt_verify_args(session_dir: &Path) -> Vec<String> {
    vec![
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-latest-finality-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn consummation_record_run_args(
    snapshot: &LatestFinalityReceiptSnapshot,
    finality_receipt_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        "--finality-receipt-session-dir".to_string(),
        finality_receipt_session_dir.display().to_string(),
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-live-package-consummation-record".to_string(),
        "--json".to_string(),
    ]
}

fn finality_receipt_verify_args(
    snapshot: &LatestFinalityReceiptSnapshot,
    finality_receipt_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-live-package-consummation-record".to_string(),
        "--json".to_string(),
    ]
}

fn resolve_latest_finality_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{FINALITY_RECEIPT_LATEST_BIN} --root {} --session-dir {} --plan-latest-finality-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn run_latest_finality_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{FINALITY_RECEIPT_LATEST_BIN} --root {} --session-dir {} --run-latest-finality-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn verify_latest_finality_receipt_command_summary(session_dir: &Path) -> String {
    format!(
        "{FINALITY_RECEIPT_LATEST_BIN} --session-dir {} --verify-latest-finality-receipt --json",
        shell_escape_path(session_dir),
    )
}

fn downstream_consummation_record_command_summary(
    snapshot: &LatestFinalityReceiptSnapshot,
    finality_receipt_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{CONSUMMATION_RECORD_BIN} --finality-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --run-live-package-consummation-record --json",
...
fn verify_finality_receipt_command_summary(
    snapshot: &LatestFinalityReceiptSnapshot,
    finality_receipt_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{CONSUMMATION_RECORD_BIN} --finality-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --verify-live-package-consummation-record --json",
        shell_escape_path(finality_receipt_session_dir),
        shell_escape_path(&snapshot.downstream_decision_packet_session_dir),
        shell_escape_path(session_dir),
    )
...
fn nested_finality_receipt_latest_report_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_finality_receipt_latest.report.json")
}

fn nested_consummation_record_session_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_consummation_record.session.json")
}

fn nested_consummation_record_status_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_consummation_record.status.json")
}
...
fn step_artifact(
    ...
    reason: &str,
    generated_at: DateTime<Utc>,
) -> PackageConsummationRecordLatestStepArtifact {
    PackageConsummationRecordLatestStepArtifact {
...
fn canonical_wrapper_mode(mode: &str) -> &str {
    match mode {
        "plan_latest_consummation_record" => "plan_latest_consummation_record",
        "render_latest_consummation_record_script" => "render_latest_consummation_record_script",
        "run_latest_consummation_record" => "run_latest_consummation_record",
        "verify_latest_consummation_record" => "verify_latest_consummation_record",
        other => other,
    }
}

fn load_required_step_json<T: for<'de> Deserialize<'de>>(
    step: &Option<PackageConsummationRecordLatestStepArtifact>,
    expected_path: &Path,
    label: &str,
...
fn compare_finality_receipt_latest_plan_against_snapshot(
    stored: &FinalityReceiptLatestReportView,
    snapshot: &LatestFinalityReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        ...
        Some(FINALITY_RECEIPT_LATEST_PLAN_READY),
        "stored latest-finality-receipt plan verdict",
        mismatches,
    );
    compare_string(
        &stored.mode,
        "plan_latest_finality_receipt",
        "stored latest-finality-receipt plan mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-finality-receipt plan latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        ...
        "stored latest-finality-receipt plan latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-finality-receipt plan session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        ...
        "stored latest-finality-receipt plan reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-finality-receipt plan clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-finality-receipt plan clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-finality-receipt plan clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_finality_receipt_latest_run_against_snapshot(
    stored: &FinalityReceiptLatestReportView,
    snapshot: &LatestFinalityReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_latest_finality_receipt",
        "stored latest-finality-receipt run mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-finality-receipt run latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        ...
        "stored latest-finality-receipt run latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-finality-receipt run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        ...
        "stored latest-finality-receipt run downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored latest-finality-receipt run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored latest-finality-receipt run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored latest-finality-receipt run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored latest-finality-receipt run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored latest-finality-receipt run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored latest-finality-receipt run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored latest-finality-receipt run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-finality-receipt run clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-finality-receipt run clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-finality-receipt run clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_finality_receipt_latest_copy_matches_actual(
    stored: &FinalityReceiptLatestReportView,
    actual: &FinalityReceiptLatestReportView,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        Some(stored.verdict.as_str()),
        Some(actual.verdict.as_str()),
        "stored latest-finality-receipt copy verdict",
        mismatches,
    );
    compare_option_string(
        Some(stored.reason.as_str()),
        Some(actual.reason.as_str()),
        "stored latest-finality-receipt copy reason",
        mismatches,
    );
    if stored.generated_at != actual.generated_at {
        mismatches.push(format!(
            "stored latest-finality-receipt copy generated_at {:?} does not match actual {:?}",
    ...
    compare_option_string(
        ...
        "stored latest-finality-receipt copy latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        actual.latest_top_session_dir.as_deref(),
        "stored latest-finality-receipt copy latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        actual.session_dir.as_deref(),
        "stored latest-finality-receipt copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        actual.downstream_decision_packet_session_dir.as_deref(),
        "stored latest-finality-receipt copy downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        actual.result.as_deref(),
        "stored latest-finality-receipt copy result",
        mismatches,
    );
    compare_option_string(
        stored.explicit_statement.as_deref(),
        actual.explicit_statement.as_deref(),
        "stored latest-finality-receipt copy explicit_statement",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        actual.current_pre_activation_gate_verdict.as_deref(),
        "stored latest-finality-receipt copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        actual.current_pre_activation_gate_reason.as_deref(),
        "stored latest-finality-receipt copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        actual
            .reviewed_frozen_live_cutover_controller_command_summary
            .as_deref(),
        "stored latest-finality-receipt copy reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}

fn compare_consummation_record_run_against_snapshot(
    stored: &ConsummationRecordReportView,
    snapshot: &LatestFinalityReceiptSnapshot,
    finality_receipt_session_dir: &Path,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.finality_receipt_session_dir,
        &finality_receipt_session_dir.display().to_string(),
        "stored consummation-record run finality_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        stored.consummation_record_session_path.as_deref(),
        Some(
            nested_consummation_record_session_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored consummation-record run consummation_record_session_path",
        mismatches,
    );
    compare_option_string(
        stored.consummation_record_status_path.as_deref(),
        Some(
            nested_consummation_record_status_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored consummation-record run consummation_record_status_path",
        mismatches,
    );
    compare_option_string(
        stored.archived_finality_receipt_report_path.as_deref(),
        Some(
            session_dir
                .join(
                    "tiny_live_activation_package_consummation_record.finality_receipt.report.json",
                )
                .display()
                .to_string()
                .as_str(),
        ),
        "stored consummation-record run archived_finality_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        stored.verify_finality_receipt_command_summary.as_deref(),
        Some(
            consummation_record_verify_finality_receipt_command_summary(
                finality_receipt_session_dir,
            )
            .as_str(),
        ),
        "stored consummation-record run verify_finality_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
...
fn compare_consummation_record_copy_against_nested_truth(
    stored: &ConsummationRecordReportView,
    nested_session: &ConsummationRecordSessionView,
    nested_status: &ConsummationRecordStatusView,
    mismatches: &mut Vec<String>,
) {
    compare_string(
        &stored.finality_receipt_session_dir,
        &nested_session.finality_receipt_session_dir,
        "stored consummation-record copy finality_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        ...
        "stored consummation-record copy verify_finality_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
...
fn compare_session_against_snapshot(
    ...
    compare_string(
        &session.resolve_latest_finality_receipt_command_summary,
        &resolve_latest_finality_receipt_command_summary(
            root,
            &paths.nested_finality_receipt_latest_session_dir,
        ),
        "stored session resolve_latest_finality_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.run_latest_finality_receipt_command_summary,
        &run_latest_finality_receipt_command_summary(
            root,
            &paths.nested_finality_receipt_latest_session_dir,
        ),
        "stored session run_latest_finality_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_latest_finality_receipt_command_summary,
        &verify_latest_finality_receipt_command_summary(
            &paths.nested_finality_receipt_latest_session_dir,
        ),
        "stored session verify_latest_finality_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.downstream_consummation_record_command_summary,
        &downstream_consummation_record_command_summary(
            snapshot,
            &expected_downstream_finality_receipt_session_dir(paths),
            &paths.nested_consummation_record_session_dir,
        ),
        "stored session downstream_consummation_record_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_finality_receipt_command_summary,
        &verify_finality_receipt_command_summary(
            snapshot,
            &expected_downstream_finality_receipt_session_dir(paths),
            &paths.nested_consummation_record_session_dir,
        ),
        "stored session verify_finality_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_finality_receipt_latest_session_dir",
        mismatches,
    );
    compare_string(
        &session.nested_consummation_record_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_consummation_record_session_dir",
        mismatches,
    );
    compare_string(
        &session.downstream_decision_packet_session_dir,
...
fn compare_report_against_snapshot(
    report: &PackageConsummationRecordLatestReport,
    root: &Path,
    session_dir: &Path,
    paths: &PackageConsummationRecordLatestPaths,
    snapshot: &LatestFinalityReceiptSnapshot,
    ...
    compare_option_string(
        ...
        "stored report resolve_latest_finality_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report run_latest_finality_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report verify_latest_finality_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report downstream_consummation_record_command_summary",
        mismatches,
    );
    compare_option_string(
        report.verify_finality_receipt_command_summary.as_deref(),
        Some(
            verify_finality_receipt_command_summary(
                snapshot,
                &expected_downstream_finality_receipt_session_dir(paths),
        ...
        "stored report verify_finality_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
    ...
    compare_option_string(
        report.consummation_record_latest_session_path.as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "stored report consummation_record_latest_session_path",
        mismatches,
    );
    compare_option_string(
        report.consummation_record_latest_status_path.as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "stored report consummation_record_latest_status_path",
        mismatches,
    );
    compare_option_string(
        report.consummation_record_latest_report_path.as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "stored report consummation_record_latest_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_finality_receipt_plan_report_path.as_deref(),
        Some(
            paths
                .latest_finality_receipt_plan_report_path
                .display()
        ...
        "stored report latest_finality_receipt_plan_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_finality_receipt_report_path.as_deref(),
        Some(
            paths
                .latest_finality_receipt_report_path
                .display()
        ...
        "stored report latest_finality_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        report.consummation_record_report_path.as_deref(),
        Some(
            paths
                .consummation_record_report_path
                .display()
                .to_string()
                .as_str(),
        ),
        "stored report consummation_record_report_path",
        mismatches,
    );
    compare_option_string(
        report.nested_finality_receipt_latest_session_dir.as_deref(),
        Some(
            paths
                .nested_finality_receipt_latest_session_dir
                .display()
        ...
        "stored report nested_finality_receipt_latest_session_dir",
        mismatches,
    );
    compare_option_string(
        report.nested_consummation_record_session_dir.as_deref(),
        Some(
            paths
                .nested_consummation_record_session_dir
                .display()
        ...
        "stored report nested_consummation_record_session_dir",
        mismatches,
    );
    compare_option_string(
...
fn compare_session_against_failure(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_finality_receipt_latest_session_dir on failure",
        mismatches,
    );
    compare_string(
        &session.nested_consummation_record_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_consummation_record_session_dir on failure",
        mismatches,
    );
...
fn map_finality_receipt_latest_failure_kind(verdict: &str) -> ResolutionFailureKind {
    match verdict {
        "tiny_live_package_finality_receipt_latest_refused_by_missing_latest_chain" => {
            ResolutionFailureKind::MissingLatestChain
        }
        "tiny_live_package_finality_receipt_latest_refused_by_drifted_finality_receipt_contract" => {
            ResolutionFailureKind::DriftedConsummationRecordContract
        }
        _ => ResolutionFailureKind::InvalidLatestChain,
    }
}

fn latest_finality_receipt_terminal_failure(
    report: &FinalityReceiptLatestReportView,
) -> Option<LivePackageConsummationRecordLatestResult> {
    match report.result.as_deref() {
        Some("refused_by_missing_latest_chain") => {
            Some(LivePackageConsummationRecordLatestResult::RefusedByMissingLatestChain)
        }
        Some("refused_by_invalid_latest_chain") => {
            Some(LivePackageConsummationRecordLatestResult::RefusedByInvalidLatestChain)
        }
        Some("refused_by_drifted_finality_receipt_contract") => Some(
            LivePackageConsummationRecordLatestResult::RefusedByDriftedConsummationRecordContract,
        ),
        _ => None,
    }
...
fn finality_receipt_latest_result_from_nested_status(
    result: &str,
) -> Option<LivePackageConsummationRecordLatestResult> {
    match result {
        "ready_for_manual_execution_when_gate_turns_green" => Some(
            LivePackageConsummationRecordLatestResult::ReadyForManualExecutionWhenGateTurnsGreen,
        ),
        "refused_now_by_stage3" => {
            Some(LivePackageConsummationRecordLatestResult::RefusedNowByStage3)
        }
        "refused_now_by_pre_activation_gate" => {
            Some(LivePackageConsummationRecordLatestResult::RefusedNowByPreActivationGate)
        }
...
fn consummation_record_run_verdict_for_result(result: &str) -> Option<&'static str> {
    match result {
        ...
        "refused_now_by_stage3" => Some("tiny_live_package_consummation_record_refused_now_by_stage3"),
        "refused_now_by_pre_activation_gate" => {
            Some("tiny_live_package_consummation_record_refused_now_by_pre_activation_gate")
        }
        "refused_now_by_invalid_or_drifted_contract" => {
            Some("tiny_live_package_consummation_record_refused_now_by_invalid_or_drifted_contract")
        }
        _ => None,
    }
}
...
fn result_from_failure_kind(
    kind: ResolutionFailureKind,
) -> LivePackageConsummationRecordLatestResult {
    match kind {
        ResolutionFailureKind::MissingLatestChain => {
            LivePackageConsummationRecordLatestResult::RefusedByMissingLatestChain
        }
        ResolutionFailureKind::InvalidLatestChain => {
            LivePackageConsummationRecordLatestResult::RefusedByInvalidLatestChain
        }
        ResolutionFailureKind::DriftedConsummationRecordContract => {
            LivePackageConsummationRecordLatestResult::RefusedByDriftedConsummationRecordContract
        }
...
fn verdict_for_result(
    result: LivePackageConsummationRecordLatestResult,
) -> TinyLivePackageConsummationRecordLatestVerdict {
    match result {
        LivePackageConsummationRecordLatestResult::RefusedByMissingLatestChain => {
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestRefusedByMissingLatestChain
        }
        LivePackageConsummationRecordLatestResult::RefusedByInvalidLatestChain => {
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestRefusedByInvalidLatestChain
        }
        LivePackageConsummationRecordLatestResult::RefusedByDriftedConsummationRecordContract => {
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestRefusedByDriftedConsummationRecordContract
        }
        LivePackageConsummationRecordLatestResult::RefusedNowByStage3 => {
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestRefusedNowByStage3
        }
        LivePackageConsummationRecordLatestResult::RefusedNowByPreActivationGate => {
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestRefusedNowByPreActivationGate
        }
        LivePackageConsummationRecordLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestReadyForManualExecutionWhenGateTurnsGreen
        }
    }
}
...
fn operator_next_action_summary(result: LivePackageConsummationRecordLatestResult) -> String {
    match result {
        LivePackageConsummationRecordLatestResult::RefusedByMissingLatestChain => {
        ...
        LivePackageConsummationRecordLatestResult::RefusedByInvalidLatestChain => {
            "the latest immutable chain is incomplete or below the accepted clerestory layer; mint a fresh coherent clerestory chain instead of bypassing the accepted latest-finality-receipt / consummation-record path".to_string()
        }
        LivePackageConsummationRecordLatestResult::RefusedByDriftedConsummationRecordContract => {
            "the latest chain no longer resolves cleanly into the accepted latest-finality-receipt / consummation-record contract; repair that drift instead of bypassing the bounded handoff path".to_string()
        }
        LivePackageConsummationRecordLatestResult::RefusedNowByStage3 => {
        ...
        LivePackageConsummationRecordLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            "the latest immutable chain now resolves into the accepted consummation-record contract and one bounded latest consummation-record handoff is ready for manual execution when gate truth turns green; this wrapper still did not run or authorize the frozen controller".to_string()
        }
    }
}
...
fn consummation_record_verify_finality_receipt_command_summary(
    finality_receipt_session_dir: &Path,
) -> String {
    format!(
...
fn refusal_status(
    ...
    latest_finality_receipt_step: Option<PackageConsummationRecordLatestStepArtifact>,
    consummation_record_step: Option<PackageConsummationRecordLatestStepArtifact>,
) -> PackageConsummationRecordLatestStatus {
    ...
    PackageConsummationRecordLatestStatus {
        ...
        result,
        reason,
        latest_finality_receipt_plan_verdict: resolved
            .map(|value| value.latest_finality_receipt_plan.verdict.clone()),
        latest_finality_receipt_verdict: latest_finality_receipt_step
            .as_ref()
...
fn refusal_status_from_resolution_failure(
    ...
    PackageConsummationRecordLatestStatus {
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        latest_finality_receipt_plan_step: failure.latest_finality_receipt_plan_raw.as_ref().map(
            |_| {
                step_artifact(
                    &paths.latest_finality_receipt_plan_report_path,
                    "plan_latest_finality_receipt",
                    failure
                        ...
                        .unwrap_or("<missing>"),
                    failure
                        .latest_finality_receipt_plan_reason
                        .as_deref()
                        .unwrap_or("<missing>"),
                    failure
                        .latest_finality_receipt_plan_generated_at
                        .unwrap_or_else(Utc::now),
                )
            },
        ),
        latest_finality_receipt_step: None,
...
fn verify_invalid_finality_receipt_latest_report_without_session(
    session_dir: &Path,
    verification_mismatches: Vec<String>,
) -> PackageConsummationRecordLatestReport {
    ...
    PackageConsummationRecordLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_consummation_record".to_string(),
        verdict: TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestVerifyInvalid,
        reason,
        root: None,
        ...
        session_dir: Some(session_dir.display().to_string()),
        consummation_record_latest_session_path: Some(
            consummation_record_latest_paths(session_dir)
                .session_path
                .display()
                .to_string(),
        ),
        consummation_record_latest_status_path: Some(
            consummation_record_latest_paths(session_dir)
                .status_path
                .display()
                .to_string(),
        ),
        consummation_record_latest_report_path: Some(
            consummation_record_latest_paths(session_dir)
                .report_path
                .display()
                .to_string(),
        ),
        latest_finality_receipt_plan_report_path: None,
        latest_finality_receipt_report_path: None,
        consummation_record_report_path: None,
        nested_finality_receipt_latest_session_dir: None,
        nested_consummation_record_session_dir: None,
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_finality_receipt_command_summary: None,
        run_latest_finality_receipt_command_summary: None,
        verify_latest_finality_receipt_command_summary: None,
        downstream_consummation_record_command_summary: None,
        verify_finality_receipt_command_summary: None,
...
fn fallback_finality_receipt_latest_copy() -> FinalityReceiptLatestReportView {
    FinalityReceiptLatestReportView {
        generated_at: Utc::now(),
...
fn fallback_notarization_receipt_session(
    snapshot: &LatestFinalityReceiptSnapshot,
    session_dir: &Path,
) -> ConsummationRecordSessionView {
    ConsummationRecordSessionView {
        finality_receipt_session_dir: "<missing>".to_string(),
        ...
        session_dir: session_dir.display().to_string(),
        verify_finality_receipt_command_summary:
            consummation_record_verify_finality_receipt_command_summary(Path::new("<missing>")),
...
fn fallback_notarization_receipt_status(
    _snapshot: &LatestFinalityReceiptSnapshot,
    session_dir: &Path,
) -> ConsummationRecordStatusView {
    ConsummationRecordStatusView {
        session_dir: session_dir.display().to_string(),
        finality_receipt_session_dir: "<missing>".to_string(),
...
fn render_report_lines(report: &PackageConsummationRecordLatestReport) -> String {
    let mut lines = vec![
    ...
    if let Some(value) = &report.nested_finality_receipt_latest_session_dir {
        lines.push(format!(
            "nested_finality_receipt_latest_session_dir={value}"
        ));
    }
    ...
    if let Some(value) = &report.nested_consummation_record_session_dir {
        lines.push(format!("nested_consummation_record_session_dir={value}"));
    }
    if let Some(value) = &report.result {
        lines.push(format!("result={value}"));
    }
    if let Some(value) = &report.downstream_consummation_record_command_summary {
        lines.push(format!(
            "downstream_consummation_record_command_summary={value}"
        ));
    }
...
mod tests {
    ...
    struct FakeNotarizationReceiptLatestFixture {
        ...
        finality_receipt_latest_plan_json_path: PathBuf,
        finality_receipt_latest_run_json_path: PathBuf,
        finality_receipt_latest_verify_json_path: PathBuf,
    ...
    impl FakeNotarizationReceiptLatestFixture {
        fn plan_config(&self) -> Config {
            Config {
                mode: Mode::PlanLatestConsummationRecord,
        ...
        fn render_config(&self) -> Config {
            Config {
                mode: Mode::RenderLatestConsummationRecordScript,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
        ...
        fn run_config(&self) -> Config {
            Config {
                mode: Mode::RunLatestConsummationRecord,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
        ...
        fn verify_config(&self) -> Config {
            Config {
                mode: Mode::VerifyLatestConsummationRecord,
                root: None,
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
    ...
    #[test]
    fn plan_mode_resolves_latest_valid_clerestory_chain_to_exact_expected_nested_latest_finality_receipt_lineage(
    ) {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_plan_ok",
        ...
        let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
        assert_eq!(
            report.verdict,
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestPlanReady
        );
        ...
        assert!(report
            ...
            .as_deref()
            .unwrap()
            .contains(CONSUMMATION_RECORD_BIN));
    }
    ...
    fn render_mode_emits_exact_downstream_provenance_certificate_contract_not_second_controller_path(
        ...
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_render_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(script.contains(FINALITY_RECEIPT_LATEST_BIN));
        assert!(script.contains(CONSUMMATION_RECORD_BIN));
        assert!(script.contains("--finality-receipt-session-dir"));
        assert!(!script.contains("--activation-ticket-session-dir"));
        assert!(script.contains("--run-live-package-consummation-record"));
        assert!(script.contains("--verify-live-package-consummation-record"));
    ...
    fn run_mode_refuses_when_latest_chain_missing_invalid_or_below_clerestory() {
        for (label, verdict, reason, expected) in [
            (
                "finality_receipt_latest_missing",
                "tiny_live_package_finality_receipt_latest_refused_by_missing_latest_chain",
                "no persisted immutable chain exists",
                TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestRefusedByMissingLatestChain,
            ),
            (
                "finality_receipt_latest_invalid",
                "tiny_live_package_finality_receipt_latest_refused_by_invalid_latest_chain",
                "latest immutable chain is incomplete",
                TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestRefusedByInvalidLatestChain,
            ),
            (
                "finality_receipt_latest_below",
                "tiny_live_package_finality_receipt_latest_refused_by_invalid_latest_chain",
            ...
            let mut plan: Value = load_json(&fixture.finality_receipt_latest_plan_json_path).unwrap();
            plan["verdict"] = json!(verdict);
            plan["reason"] = json!(reason);
            if label.ends_with("below") {
                plan["latest_top_step_name"] = json!("choir_receipt");
            }
            persist_json(&fixture.finality_receipt_latest_plan_json_path, &plan).unwrap();

            let report = run_latest_consummation_record_report(&fixture.run_config()).unwrap();
            assert_eq!(report.verdict, expected);
        }
    }

    #[test]
    fn plan_mode_maps_real_latest_finality_receipt_drift_verdict_to_local_drift_refusal() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_plan_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        plan["reason"] = json!("real accepted latest-finality-receipt drift");
        persist_json(&fixture.finality_receipt_latest_plan_json_path, &plan).unwrap();
        ...
        assert_eq!(
            report.result.as_deref(),
            Some("refused_by_drifted_consummation_record_contract")
        );
    }

    #[test]
    fn run_mode_takes_terminal_drift_refusal_when_nested_latest_finality_receipt_reports_real_drift(
    ) {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_run_drift",
            "refused_by_drifted_finality_receipt_contract",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn run_mode_refuses_when_nested_release_capsule_lineage_drifts_from_latest_immutable_chain() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_handoff_bundle_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let mut run: Value = load_json(&fixture.finality_receipt_latest_run_json_path).unwrap();
        run["package_dir"] = json!("/tampered/package");
        persist_json(&fixture.finality_receipt_latest_run_json_path, &run).unwrap();
        ...
        assert!(report
            .reason
            .contains("stored latest-finality-receipt run package_dir"));
    }

    #[test]
    fn verify_mode_fails_when_persisted_latest_finality_receipt_artifacts_are_tampered_or_missing_nested_lineage_truth(
    ) {
        {
            let fixture = fake_finality_receipt_latest_fixture(
                "finality_receipt_latest_verify_tampered_copy",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            run_latest_consummation_record_report(&fixture.run_config()).unwrap();

            let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
            let mut report: Value = load_json(&paths.consummation_record_report_path).unwrap();
            report["reason"] = json!("tampered stored provenance-certificate copy reason");
            persist_json(&paths.consummation_record_report_path, &report).unwrap();

            let verify =
                verify_latest_consummation_record_report(&fixture.verify_config()).unwrap();
            assert_eq!(
                verify.verdict,
                TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestVerifyInvalid
            );
        ...
        {
            let fixture = fake_finality_receipt_latest_fixture(
                "finality_receipt_latest_verify_missing_nested_truth",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            ...
            let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
            fs::remove_file(nested_finality_receipt_latest_report_path(
                &paths.nested_finality_receipt_latest_session_dir,
            ))
            .unwrap();
            ...
            assert!(verify.verification_mismatches.iter().any(|entry| {
                entry.contains("tiny_live_activation_package_finality_receipt_latest.report.json")
            }));
        }
    }
    ...
    fn verify_accepts_real_shaped_native_consummation_identity_layers_on_happy_path() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_real_shaped_finality_paths_green",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let verify = verify_latest_consummation_record_report(&fixture.verify_config()).unwrap();
        assert_eq!(
            verify.verdict,
            TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestVerifyOk,
            "{:#?}",
    ...
    #[test]
    fn verify_fails_when_copied_native_consummation_record_session_path_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_finality_session_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.consummation_record_report_path).unwrap();
        report["consummation_record_session_path"] =
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored consummation-record run consummation_record_session_path")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_consummation_record_status_path_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_finality_status_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.consummation_record_report_path).unwrap();
        report["consummation_record_status_path"] = json!("/tampered/finality-receipt-status.json");
        persist_json(&paths.consummation_record_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored consummation-record run consummation_record_status_path")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_latest_finality_receipt_explicit_statement_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_launch_packet_explicit_statement_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.latest_finality_receipt_report_path).unwrap();
        report["explicit_statement"] =
            json!("tampered nested latest release capsule explicit statement");
        persist_json(&paths.latest_finality_receipt_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored latest-finality-receipt copy explicit_statement")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_decision_packet_result_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_decision_packet_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_attestation_seal_session_dir_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_attestation_seal_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_native_finality_receipt_registry_entry_session_dir_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_registry_entry_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_native_finality_receipt_notarization_receipt_session_dir_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_notarization_receipt_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_summary_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_chain_fingerprint_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_sha256_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_chain_fingerprint_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_algorithm_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_chain_fingerprint_algorithm_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_native_consummation_record_closure_certificate_sha256_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_closure_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_native_finality_receipt_archive_receipt_sha256_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_archive_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_native_finality_receipt_finality_receipt_sha256_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_finality_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_native_consummation_record_consummation_record_sha256_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_consummation_record_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_downstream_decision_packet_confirmation_anchor_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_decision_packet_anchor_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_execute_frozen_result_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_current_authorization_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_nested_consummation_record_verdict_drifts() {
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_release_capsule_verdict_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_current_live_cutover_controller_summary_drifts(
        ...
        let fixture = fake_finality_receipt_latest_fixture(
            "finality_receipt_latest_verify_current_live_cutover_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn all_modes_preserve_stage3_and_pre_activation_refusal_semantics_and_do_not_imply_activation_authorization_by_themselves(
        ...
        {
            let fixture = fake_finality_receipt_latest_fixture(
                "finality_receipt_latest_stage3",
                "refused_now_by_stage3",
                "refused_now_by_stage3",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            ...
            let run = run_latest_consummation_record_report(&fixture.run_config()).unwrap();
            assert_eq!(
                run.verdict,
                TinyLivePackageConsummationRecordLatestVerdict::TinyLivePackageConsummationRecordLatestRefusedNowByStage3
            );
        ...
        {
            let fixture = fake_finality_receipt_latest_fixture(
                "finality_receipt_latest_pre_activation",
                "refused_now_by_pre_activation_gate",
                "refused_now_by_pre_activation_gate",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn fake_finality_receipt_latest_fixture(
        label: &str,
        finality_receipt_latest_run_result: &str,
        ...
        let finality_receipt_latest_plan_json_path =
            temp_dir.join("finality_receipt_latest.plan.json");
        let finality_receipt_latest_run_json_path =
            temp_dir.join("finality_receipt_latest.run.json");
        let finality_receipt_latest_verify_json_path =
            temp_dir.join("finality_receipt_latest.verify.json");
        ...
        let fixture = FakeNotarizationReceiptLatestFixture {
            ...
            install_root,
            backend_command,
            finality_receipt_latest_plan_json_path,
            finality_receipt_latest_run_json_path,
            finality_receipt_latest_verify_json_path,
        ...
        persist_json(
            &fixture.finality_receipt_latest_plan_json_path,
            &default_finality_receipt_latest_plan_report(&fixture),
        )
        .unwrap();
        persist_json(
            &fixture.finality_receipt_latest_run_json_path,
            &default_finality_receipt_latest_run_report(
                &fixture,
                finality_receipt_latest_run_result,
            ),
        )
        .unwrap();
        persist_json(
            &fixture.finality_receipt_latest_verify_json_path,
            &default_finality_receipt_latest_verify_report(
                &fixture,
                finality_receipt_latest_run_result,
            ),
        )
        ...
        let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
        write_fake_finality_receipt_latest_command(
            &fixture.bin_dir.join(FINALITY_RECEIPT_LATEST_BIN),
            &fixture.finality_receipt_latest_plan_json_path,
            &fixture.finality_receipt_latest_run_json_path,
            &fixture.finality_receipt_latest_verify_json_path,
            &fixture.root,
        ...
        write_fake_release_capsule_command(
            &fixture.bin_dir.join(CONSUMMATION_RECORD_BIN),
            &fixture.handoff_bundle_run_json_path,
            &fixture.handoff_bundle_verify_json_path,
            &fixture.handoff_bundle_session_json_path,
            &fixture.handoff_bundle_status_json_path,
    ...
    fn default_finality_receipt_latest_plan_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
    ) -> Value {
        let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
        json!({
            "generated_at": Utc::now(),
            "mode": "plan_latest_finality_receipt",
            "verdict": FINALITY_RECEIPT_LATEST_PLAN_READY,
            "reason": "latest immutable chain resolves cleanly into accepted latest-finality-receipt contract",
            ...
            "session_dir": paths.nested_finality_receipt_latest_session_dir.display().to_string(),
    ...
    fn canonical_finality_receipt_latest_result(result: &str) -> &str {
        match result {
            "runnable_when_gate_truth_turns_green" => {
    ...
    fn default_finality_receipt_latest_run_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let result = canonical_finality_receipt_latest_result(result);
        let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
        let (verdict, gate_verdict, gate_reason) = match result {
            "ready_for_manual_execution_when_gate_turns_green" => (
                "tiny_live_package_finality_receipt_latest_ready_for_manual_execution_when_gate_turns_green",
                Value::Null,
                Value::Null,
            ),
            "refused_now_by_stage3" => (
                "tiny_live_package_finality_receipt_latest_refused_now_by_stage3",
                json!("blocked"),
                json!("stage3 blocked"),
            ),
            "refused_now_by_pre_activation_gate" => (
                "tiny_live_package_finality_receipt_latest_refused_now_by_pre_activation_gate",
                json!("blocked"),
        ...
        json!({
            "generated_at": Utc::now(),
            "mode": "run_latest_finality_receipt",
            "verdict": verdict,
    ...
    fn default_finality_receipt_latest_verify_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let mut report = default_finality_receipt_latest_run_report(fixture, result);
        report["mode"] = json!("verify_latest_finality_receipt");
        report["verdict"] = json!(FINALITY_RECEIPT_LATEST_VERIFY_OK);
    ...
    fn default_provenance_certificate_session(
        ...
        let paths = consummation_record_latest_paths(&fixture.wrapper_session_dir);
        let finality_receipt_session_dir = expected_downstream_finality_receipt_session_dir(&paths);
        ...
        let snapshot = LatestFinalityReceiptSnapshot {
        ...
        json!({
            "session_version": "1",
            "planned_at": Utc::now(),
            "finality_receipt_session_dir": finality_receipt_session_dir.display().to_string(),
            ...
            "release_capsule_session_dir": finality_receipt_session_dir.display().to_string(),
            ...
            "wrapper_timeout_ms": snapshot.wrapper_timeout_ms,
            "service_status_max_staleness_ms": snapshot.service_status_max_staleness_ms,
            "session_dir": consummation_record_latest_paths(&fixture.wrapper_session_dir).nested_consummation_record_session_dir.display().to_string(),
            "verify_finality_receipt_command_summary": consummation_record_verify_finality_receipt_command_summary(&finality_receipt_session_dir),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
            ...
            "explicit_statement": "the verified finality-receipt session is the primary input here; this immutable consummation record freezes one final terminus identity over the fully finalized chain without enabling production execution"
        })
    }
    ...
    fn default_provenance_certificate_status(
        ...
        json!({
            "status_version": "1",
            "updated_at": Utc::now(),
            "session_dir": paths.nested_consummation_record_session_dir.display().to_string(),
            "finality_receipt_session_dir": expected_downstream_finality_receipt_session_dir(&paths).display().to_string(),
            "result": result,
            "reason": reason,
            ...
            "current_pre_activation_gate_verdict": gate_verdict,
            "current_pre_activation_gate_reason": gate_reason,
            "finality_receipt_step": Value::Null,
            ...
            "consummation_record_sha256": "fixture-consummation-record-sha256",
            "consummation_record_algorithm": "sha256",
            "explicit_statement": "this consummation record is archival and read-only; it never executes or enables the frozen controller"
        })
    }
    ...
    fn default_provenance_certificate_run_report(
        ...
        let consummation_record_verdict = match result {
            "ready_for_manual_execution_when_gate_turns_green" => {
                "tiny_live_package_consummation_record_ready_for_manual_execution_when_gate_turns_green"
            }
            "refused_now_by_stage3" => "tiny_live_package_consummation_record_refused_now_by_stage3",
            "refused_now_by_pre_activation_gate" => {
                "tiny_live_package_consummation_record_refused_now_by_pre_activation_gate"
            }
            _ => "tiny_live_package_consummation_record_refused_now_by_invalid_or_drifted_contract",
        };
        json!({
            "generated_at": Utc::now(),
            "mode": "run_live_package_consummation_record",
            "verdict": consummation_record_verdict,
            ...
            "release_capsule_session_dir": expected_downstream_finality_receipt_session_dir(&paths).display().to_string(),
            ...
            "service_status_max_staleness_ms": 4500,
            "session_dir": paths.nested_consummation_record_session_dir.display().to_string(),
            "consummation_record_session_path": nested_consummation_record_session_path(&paths.nested_consummation_record_session_dir).display().to_string(),
            "consummation_record_status_path": nested_consummation_record_status_path(&paths.nested_consummation_record_session_dir).display().to_string(),
            "archived_finality_receipt_report_path": paths.nested_consummation_record_session_dir.join("tiny_live_activation_package_consummation_record.finality_receipt.report.json").display().to_string(),
            "result": result,
            ...
            "finality_receipt_step": Value::Null,
            "verify_finality_receipt_command_summary": consummation_record_verify_finality_receipt_command_summary(&expected_downstream_finality_receipt_session_dir(&paths)),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
    ...
    fn default_provenance_certificate_verify_report(
        ...
        report["mode"] = json!("verify_live_package_consummation_record");
        report["verdict"] = json!(CONSUMMATION_RECORD_VERIFY_OK);
        report["reason"] = json!("verify ok");
    ...
    fn write_fake_finality_receipt_latest_command(
        path: &Path,
        plan_json_path: &Path,
        run_json_path: &Path,
        ...
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected latest-finality-receipt session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --plan-latest-finality-receipt \"*) mode='plan';;\n  *\" --run-latest-finality-receipt \"*) mode='run';;\n  *\" --verify-latest-finality-receipt \"*) mode='verify';;\n  *) echo 'unexpected latest-finality-receipt mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  plan|run)\n    case \" $* \" in\n      *\" --root {} \"*) : ;;\n      *) echo 'unexpected root' >&2; exit 1;;\n    esac\n    ;;\nesac\ncase \"$mode\" in\n  plan) cat '{}';;\n  run) mkdir -p '{}'; cp '{}' '{}/tiny_live_activation_package_finality_receipt_latest.report.json'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
            session_dir.display(),
            root.display(),
