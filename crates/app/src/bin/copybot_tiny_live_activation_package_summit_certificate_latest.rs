...
const USAGE: &str = "usage: copybot_tiny_live_activation_package_summit_certificate_latest --root <path> [--session-dir <path>] [--output <path>] [--json] (--plan-latest-summit-certificate | --render-latest-summit-certificate-script | --run-latest-summit-certificate | --verify-latest-summit-certificate)";
const SUMMIT_CERTIFICATE_LATEST_SESSION_VERSION: &str = "1";
const SUMMIT_CERTIFICATE_LATEST_STATUS_VERSION: &str = "1";
const CULMINATION_RECEIPT_LATEST_BIN: &str =
    "copybot_tiny_live_activation_package_culmination_receipt_latest";
const SUMMIT_CERTIFICATE_BIN: &str = "copybot_tiny_live_activation_package_summit_certificate";
const CULMINATION_RECEIPT_LATEST_PLAN_READY: &str =
    "tiny_live_package_culmination_receipt_latest_plan_ready";
const CULMINATION_RECEIPT_LATEST_VERIFY_OK: &str =
    "tiny_live_package_culmination_receipt_latest_verify_ok";
const SUMMIT_CERTIFICATE_VERIFY_OK: &str = "tiny_live_package_summit_certificate_verify_ok";
const TOP_ACCEPTED_PACKAGE_STEP: &str = "clerestory_certificate";
const PLANNING_SAFE_STATEMENT: &str =
    "this latest-summit-certificate handoff binds the latest persisted immutable package chain to the accepted summit-certificate contract, but it never overrides Stage 3 or pre-activation refusal truth, it stays archival and read-only, it never runs the frozen live cutover controller by itself, and activation_authorized remains false";
...
enum Mode {
    PlanLatestSummitCertificate,
    RenderLatestSummitCertificateScript,
    RunLatestSummitCertificate,
    VerifyLatestSummitCertificate,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum TinyLivePackageSummitCertificateLatestVerdict {
    TinyLivePackageSummitCertificateLatestPlanReady,
    TinyLivePackageSummitCertificateLatestScriptRendered,
    TinyLivePackageSummitCertificateLatestRefusedByMissingLatestChain,
    TinyLivePackageSummitCertificateLatestRefusedByInvalidLatestChain,
    TinyLivePackageSummitCertificateLatestRefusedByDriftedSummitCertificateContract,
    TinyLivePackageSummitCertificateLatestRefusedNowByStage3,
    TinyLivePackageSummitCertificateLatestRefusedNowByPreActivationGate,
    TinyLivePackageSummitCertificateLatestReadyForManualExecutionWhenGateTurnsGreen,
    TinyLivePackageSummitCertificateLatestVerifyOk,
    TinyLivePackageSummitCertificateLatestVerifyInvalid,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum LivePackageSummitCertificateLatestResult {
    RefusedByMissingLatestChain,
    RefusedByInvalidLatestChain,
    RefusedByDriftedSummitCertificateContract,
    RefusedNowByStage3,
...
struct PackageSummitCertificateLatestStepArtifact {
    path: String,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageSummitCertificateLatestSession {
    session_version: String,
    planned_at: DateTime<Utc>,
    root: String,
    session_dir: String,
    nested_culmination_receipt_latest_session_dir: String,
    nested_summit_certificate_session_dir: String,
    ...
    resolve_latest_culmination_receipt_command_summary: String,
    run_latest_culmination_receipt_command_summary: String,
    verify_latest_culmination_receipt_command_summary: String,
    downstream_summit_certificate_command_summary: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageSummitCertificateLatestStatus {
    ...
    nested_summit_certificate_session_dir: String,
    downstream_decision_packet_session_dir: String,
    result: LivePackageSummitCertificateLatestResult,
    reason: String,
    latest_culmination_receipt_plan_verdict: Option<String>,
    latest_culmination_receipt_verdict: Option<String>,
    summit_certificate_verdict: Option<String>,
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    latest_culmination_receipt_plan_step: Option<PackageSummitCertificateLatestStepArtifact>,
    latest_culmination_receipt_step: Option<PackageSummitCertificateLatestStepArtifact>,
    summit_certificate_step: Option<PackageSummitCertificateLatestStepArtifact>,
...
#[derive(Debug, Clone)]
struct PackageSummitCertificateLatestPaths {
    session_path: PathBuf,
    status_path: PathBuf,
    report_path: PathBuf,
    latest_culmination_receipt_plan_report_path: PathBuf,
    latest_culmination_receipt_report_path: PathBuf,
    summit_certificate_report_path: PathBuf,
    nested_culmination_receipt_latest_session_dir: PathBuf,
    nested_summit_certificate_session_dir: PathBuf,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageSummitCertificateLatestReport {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: TinyLivePackageSummitCertificateLatestVerdict,
    reason: String,
    root: Option<String>,
    latest_top_step_name: Option<String>,
    latest_top_session_dir: Option<String>,
    ...
    summit_certificate_latest_session_path: Option<String>,
    summit_certificate_latest_status_path: Option<String>,
    summit_certificate_latest_report_path: Option<String>,
    latest_culmination_receipt_plan_report_path: Option<String>,
    latest_culmination_receipt_report_path: Option<String>,
    summit_certificate_report_path: Option<String>,
    nested_culmination_receipt_latest_session_dir: Option<String>,
    nested_summit_certificate_session_dir: Option<String>,
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    resolve_latest_culmination_receipt_command_summary: Option<String>,
    run_latest_culmination_receipt_command_summary: Option<String>,
    verify_latest_culmination_receipt_command_summary: Option<String>,
    downstream_summit_certificate_command_summary: Option<String>,
...
struct ResolvedLatestCulminationReceipt {
    ...
    latest_culmination_receipt_plan_raw: Value,
    latest_culmination_receipt_plan: SummitCertificateLatestReportView,
}
...
enum ResolutionFailureKind {
    MissingLatestChain,
    InvalidLatestChain,
    DriftedSummitCertificateContract,
}
...
struct LatestCulminationReceiptResolutionFailure {
    ...
    latest_culmination_receipt_plan_raw: Option<Value>,
    latest_culmination_receipt_plan_verdict: Option<String>,
    latest_culmination_receipt_plan_reason: Option<String>,
    latest_culmination_receipt_plan_generated_at: Option<DateTime<Utc>>,
}

#[derive(Debug, Clone, Deserialize)]
struct SummitCertificateLatestReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Deserialize)]
struct SummitCertificateReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
    ...
    service_status_max_staleness_ms: Option<u64>,
    session_dir: Option<String>,
    summit_certificate_session_path: Option<String>,
    summit_certificate_status_path: Option<String>,
    archived_culmination_receipt_report_path: Option<String>,
    result: Option<String>,
    ...
    current_pre_activation_gate_reason: Option<String>,
    summit_certificate_step: Option<PackageSummitCertificateLatestStepArtifact>,
    verify_culmination_receipt_command_summary: Option<String>,
    reviewed_frozen_live_cutover_controller_command_summary: Option<String>,
...
#[derive(Debug, Clone, Deserialize)]
struct SummitCertificateSessionView {
    culmination_receipt_session_dir: String,
    ...
    service_status_max_staleness_ms: u64,
    session_dir: String,
    verify_culmination_receipt_command_summary: String,
    reviewed_frozen_live_cutover_controller_command_summary: String,
...
#[derive(Debug, Clone, Deserialize)]
struct SummitCertificateStatusView {
    session_dir: String,
    culmination_receipt_session_dir: String,
    result: String,
    reason: String,
    ...
    I: IntoIterator<Item = String>,
{
    ...
    while let Some(arg) = iter.next() {
        match arg.as_str() {
            ...
            "--json" => json = true,
            "--plan-latest-summit-certificate" => {
                set_mode(&mut mode, Mode::PlanLatestSummitCertificate, arg.as_str())?
            }
            "--render-latest-summit-certificate-script" => set_mode(
                &mut mode,
                Mode::RenderLatestSummitCertificateScript,
                arg.as_str(),
            )?,
            "--run-latest-summit-certificate" => {
                set_mode(&mut mode, Mode::RunLatestSummitCertificate, arg.as_str())?
            }
            "--verify-latest-summit-certificate" => {
                set_mode(&mut mode, Mode::VerifyLatestSummitCertificate, arg.as_str())?
            }
    ...
    if matches!(
        mode,
        Mode::PlanLatestSummitCertificate
            | Mode::RenderLatestSummitCertificateScript
            | Mode::RunLatestSummitCertificate
    ) && root.is_none()
    {
        bail!("missing --root");
    }
    if matches!(mode, Mode::RenderLatestSummitCertificateScript) && output_path.is_none() {
        bail!("missing --output for render mode");
    }
    if matches!(
        mode,
        Mode::RunLatestSummitCertificate | Mode::VerifyLatestSummitCertificate
    ) && session_dir.is_none()
    {
...
fn run(config: Config) -> Result<String> {
    let report = match config.mode {
        Mode::PlanLatestSummitCertificate => plan_latest_summit_certificate_report(&config)?,
        Mode::RenderLatestSummitCertificateScript => {
            render_latest_summit_certificate_script_report(&config)?
        }
        Mode::RunLatestSummitCertificate => run_latest_summit_certificate_report(&config)?,
        Mode::VerifyLatestSummitCertificate => verify_latest_summit_certificate_report(&config)?,
    };
    if config.json {
...
fn plan_latest_summit_certificate_report(
    config: &Config,
) -> Result<PackageSummitCertificateLatestReport> {
    let root = config
        .root
        .as_ref()
        .ok_or_else(|| anyhow!("missing --root"))?;
    let suggested_session_dir = config.session_dir.clone().unwrap_or_else(|| {
        root.join("tiny_live_activation_package_summit_certificate_latest.session")
    });
    let paths = summit_certificate_latest_paths(&suggested_session_dir);

    match resolve_latest_culmination_receipt(root, &paths) {
        Ok(resolved) => Ok(plan_report_from_resolution(
            "plan_latest_summit_certificate",
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestPlanReady,
            format!(
                "latest immutable {} chain under {} resolves to exact latest-culmination-receipt lineage via accepted latest-culmination-receipt session {}, exact decision-packet confirmation anchor {}, and the accepted summit-certificate contract remains current",
                resolved.snapshot.latest_top_step_name,
                root.display(),
                paths.nested_culmination_receipt_latest_session_dir.display(),
...
fn render_latest_summit_certificate_script_report(
    config: &Config,
) -> Result<PackageSummitCertificateLatestReport> {
    let root = config
        .root
        ...
        Ok(resolved) => {
            write_script(
                ...
                &format!(
                    ...
                    run_latest = run_latest_culmination_receipt_command_summary(
                        root,
                        &paths.nested_culmination_receipt_latest_session_dir,
                    ),
                    verify_latest = verify_latest_culmination_receipt_command_summary(
                        &paths.nested_culmination_receipt_latest_session_dir,
                    ),
                    run_handoff_bundle = downstream_summit_certificate_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_culmination_receipt_session_dir(&paths),
                        &paths.nested_summit_certificate_session_dir,
                    ),
                    verify_handoff_bundle = verify_summit_certificate_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_culmination_receipt_session_dir(&paths),
                        &paths.nested_summit_certificate_session_dir,
                    ),
            ...
            Ok(plan_report_from_resolution(
                "render_latest_summit_certificate_script",
                TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestScriptRendered,
                format!(
                    "rendered latest-summit-certificate handoff script to {} using the accepted latest-culmination-receipt lineage and the accepted summit-certificate contract",
                    output_path.display()
                ),
                root,
                &suggested_session_dir,
...
fn run_latest_summit_certificate_report(
    config: &Config,
) -> Result<PackageSummitCertificateLatestReport> {
    let root = config
        .root
    ...
    if session_dir.exists() {
        bail!(
            "refusing to overwrite existing latest-summit-certificate session dir {}",
            session_dir.display()
        );
    }
    let paths = summit_certificate_latest_paths(session_dir);
    create_clean_session_dir(session_dir, "latest-summit-certificate")?;

    let resolution = resolve_latest_culmination_receipt(root, &paths);
    match resolution {
        Ok(resolved) => {
            run_latest_summit_certificate_with_resolution(root, session_dir, &paths, &resolved)
        }
        Err(failure) => run_latest_summit_certificate_failure(root, session_dir, &paths, &failure),
    }
}

fn verify_latest_summit_certificate_report(
    config: &Config,
) -> Result<PackageSummitCertificateLatestReport> {
    let session_dir = config
        .session_dir
    ...
    let session: PackageSummitCertificateLatestSession = match load_json(&paths.session_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_summit_certificate_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-summit-certificate session artifact {}: {error}",
    ...
    let status: PackageSummitCertificateLatestStatus = match load_json(&paths.status_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_summit_certificate_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-summit-certificate status artifact {}: {error}",
    ...
    let stored_report: PackageSummitCertificateLatestReport = match load_json(&paths.report_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_summit_certificate_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-summit-certificate report artifact {}: {error}",
    ...
    compare_string(
        &session.root,
        &status.root,
        "latest-summit-certificate root consistency",
        &mut mismatches,
    );
    compare_string(
        &session.session_dir,
        &session_dir.display().to_string(),
        "latest-summit-certificate session session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.session_dir,
        &session_dir.display().to_string(),
        "latest-summit-certificate status session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "latest-summit-certificate report session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_culmination_receipt_latest_session_dir,
        &paths
            .nested_culmination_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-summit-certificate session nested_culmination_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_culmination_receipt_latest_session_dir,
        &paths
            .nested_culmination_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-summit-certificate status nested_culmination_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-summit-certificate report nested_culmination_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_summit_certificate_session_dir,
        &paths
            .nested_summit_certificate_session_dir
            .display()
            .to_string(),
        "latest-summit-certificate session nested_summit_certificate_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_summit_certificate_session_dir,
        &paths
            .nested_summit_certificate_session_dir
            .display()
            .to_string(),
        "latest-summit-certificate status nested_summit_certificate_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-summit-certificate report nested_summit_certificate_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-summit-certificate session downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-summit-certificate status downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-summit-certificate report downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .summit_certificate_latest_session_path
            .as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "latest-summit-certificate report session path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .summit_certificate_latest_status_path
            .as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "latest-summit-certificate report status path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .summit_certificate_latest_report_path
            .as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "latest-summit-certificate report report path",
        &mut mismatches,
    );
    compare_string(
        &session.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-summit-certificate session explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &status.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-summit-certificate status explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-summit-certificate report explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.mode,
        "run_latest_summit_certificate",
        "latest-summit-certificate stored report mode",
        &mut mismatches,
    );
    compare_string(
        &serialize_enum(&stored_report.verdict),
        &serialize_enum(&verdict_for_result(status.result)),
        "latest-summit-certificate stored report verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.result.as_deref(),
        Some(serialize_enum(&status.result).as_str()),
        "latest-summit-certificate stored report result consistency",
        &mut mismatches,
    );
    compare_string(
        &stored_report.reason,
        &status.reason,
        "latest-summit-certificate stored report reason consistency",
        &mut mismatches,
    );
    if stored_report.activation_authorized != status.activation_authorized {
        mismatches.push(format!(
            "latest-summit-certificate stored report activation_authorized {} does not match status {}",
            stored_report.activation_authorized, status.activation_authorized
        ));
    }
    compare_option_string(
        stored_report
            .latest_culmination_receipt_plan_verdict
            .as_deref(),
        status.latest_culmination_receipt_plan_verdict.as_deref(),
        "stored report latest_culmination_receipt_plan_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.latest_culmination_receipt_verdict.as_deref(),
        status.latest_culmination_receipt_verdict.as_deref(),
        "stored report latest_culmination_receipt_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.summit_certificate_verdict.as_deref(),
        status.summit_certificate_verdict.as_deref(),
        "stored report summit_certificate_verdict",
        &mut mismatches,
    );
    compare_option_string(
    ...
    match resolution {
        Ok(resolved) => {
            ...
            let stored_latest_plan: SummitCertificateLatestReportView = load_required_step_json(
                &status.latest_culmination_receipt_plan_step,
                &paths.latest_culmination_receipt_plan_report_path,
                "latest_culmination_receipt_plan_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_culmination_receipt_plan_step.as_ref(),
                &paths.latest_culmination_receipt_plan_report_path,
                "plan_latest_culmination_receipt",
                &stored_latest_plan.verdict,
                &stored_latest_plan.reason,
                stored_latest_plan.generated_at,
                "stored latest_culmination_receipt_plan_step",
                &mut mismatches,
            );
            compare_culmination_receipt_latest_plan_against_snapshot(
                &stored_latest_plan,
                &resolved.snapshot,
                &paths.nested_culmination_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_culmination_receipt_plan_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report
            ...
            let stored_latest_run: SummitCertificateLatestReportView = load_required_step_json(
                &status.latest_culmination_receipt_step,
                &paths.latest_culmination_receipt_report_path,
                "latest_culmination_receipt_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_culmination_receipt_step.as_ref(),
                &paths.latest_culmination_receipt_report_path,
                "run_latest_culmination_receipt",
                &stored_latest_run.verdict,
                &stored_latest_run.reason,
                stored_latest_run.generated_at,
                "stored latest_culmination_receipt_step",
                &mut mismatches,
            );
            compare_culmination_receipt_latest_run_against_snapshot(
                &stored_latest_run,
                &resolved.snapshot,
                &paths.nested_culmination_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_culmination_receipt_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_culmination_receipt_verdict.as_deref(),
            ...
            let actual_latest_run: SummitCertificateLatestReportView = match load_json(
                &nested_culmination_receipt_latest_report_path(
                    &paths.nested_culmination_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed loading actual nested latest-culmination-receipt report under {}: {error}",
                        paths.nested_culmination_receipt_latest_session_dir.display()
                    ));
                    fallback_culmination_receipt_latest_copy()
                }
            };
            compare_culmination_receipt_latest_copy_matches_actual(
                &stored_latest_run,
                &actual_latest_run,
                &mut mismatches,
            );
            ...
            let latest_verify_raw = match run_json_command(
                ...
                &latest_culmination_receipt_verify_args(
                    &paths.nested_culmination_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested latest-culmination-receipt session under {}: {error}",
                        paths.nested_culmination_receipt_latest_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !latest_verify_raw.is_null() {
                let latest_verify: SummitCertificateLatestReportView =
                    serde_json::from_value(latest_verify_raw)
                        .context("failed parsing nested latest-culmination-receipt verify json")?;
                if latest_verify.verdict != CULMINATION_RECEIPT_LATEST_VERIFY_OK {
                    mismatches.push(format!(
                        "nested latest-culmination-receipt verification is non-green: {}",
                        latest_verify.reason
                    ));
                }
            }

            let stored_handoff_bundle: SummitCertificateReportView = load_required_step_json(
                &status.summit_certificate_step,
                &paths.summit_certificate_report_path,
                "summit_certificate_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.summit_certificate_step.as_ref(),
                &paths.summit_certificate_report_path,
                "run_live_package_summit_certificate",
                &stored_handoff_bundle.verdict,
                &stored_handoff_bundle.reason,
                stored_handoff_bundle.generated_at,
                "stored summit_certificate_step",
                &mut mismatches,
            );
            compare_summit_certificate_run_against_snapshot(
            ...
            compare_option_string(
                ...
                "stored status summit_certificate_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.summit_certificate_verdict.as_deref(),
            ...
            let nested_handoff_bundle_session: SummitCertificateSessionView =
                match load_json(&nested_summit_certificate_session_path(
                    &paths.nested_summit_certificate_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                            "failed reading nested summit-certificate session under {}: {error}",
                            paths.nested_summit_certificate_session_dir.display()
                        ));
            ...
            let nested_handoff_bundle_status: SummitCertificateStatusView =
                match load_json(&nested_summit_certificate_status_path(
                    &paths.nested_summit_certificate_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                            "failed reading nested summit-certificate status under {}: {error}",
                            paths.nested_summit_certificate_session_dir.display()
                        ));
            ...
            compare_summit_certificate_copy_against_nested_truth(
                &stored_handoff_bundle,
            ...
            let handoff_bundle_verify_raw = match run_json_command(
                SUMMIT_CERTIFICATE_BIN,
                &summit_certificate_verify_args(
                    &resolved.snapshot,
                    &expected_downstream_culmination_receipt_session_dir(&paths),
                    &paths.nested_summit_certificate_session_dir,
                ),
                ...
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested summit-certificate session under {}: {error}",
                        paths.nested_summit_certificate_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !handoff_bundle_verify_raw.is_null() {
                let handoff_bundle_verify: SummitCertificateReportView =
                    serde_json::from_value(handoff_bundle_verify_raw)
                        .context("failed parsing nested summit-certificate verify json")?;
                compare_option_string(
                    stored_handoff_bundle.registry_entry_session_dir.as_deref(),
                    handoff_bundle_verify.registry_entry_session_dir.as_deref(),
                    "stored summit-certificate copy registry_entry_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored summit-certificate copy notarization_receipt_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                ...
                compare_option_string(
                    ...
                    handoff_bundle_verify
                        .consummation_record_summary
                        .as_deref(),
                    "stored summit-certificate copy consummation_record_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .consummation_record_sha256
                        .as_deref(),
                    "stored summit-certificate copy consummation_record_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .consummation_record_algorithm
                        .as_deref(),
                    "stored summit-certificate copy consummation_record_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored summit-certificate copy completion_certificate_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.completion_certificate_sha256.as_deref(),
                    handoff_bundle_verify.completion_certificate_sha256.as_deref(),
                    "stored summit-certificate copy completion_certificate_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                ...
                compare_option_string(
                    ...
                    handoff_bundle_verify
                        .reviewed_frozen_live_cutover_controller_command_summary
                        .as_deref(),
                    "stored summit-certificate copy reviewed_frozen_live_cutover_controller_command_summary",
                    &mut mismatches,
                );
                if handoff_bundle_verify.verdict != SUMMIT_CERTIFICATE_VERIFY_OK {
                    mismatches.push(format!(
                        "nested summit-certificate verification is non-green: {}",
                        handoff_bundle_verify.reason
                    ));
                }
            }

            let expected_result = culmination_receipt_latest_result_from_nested_status(
                nested_handoff_bundle_status.result.as_str(),
            )
            .unwrap_or(
                LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract,
            );
            if status.result != expected_result {
                mismatches.push(format!(
                    "stored latest-summit-certificate result {} does not match nested summit-certificate result {}",
            ...
            if status.activation_authorized {
                mismatches.push(
                    "stored status activation_authorized must remain false for latest-summit-certificate"
                        .to_string(),
                );
            }
            compare_option_string(
        ...
        Err(failure) => {
            ...
            if failure.latest_culmination_receipt_plan_raw.is_some() {
                let stored_latest_plan: SummitCertificateLatestReportView =
                ...
                compare_option_string(
                    status.latest_culmination_receipt_plan_verdict.as_deref(),
                    failure.latest_culmination_receipt_plan_verdict.as_deref(),
                    "stored status latest_culmination_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_report
                        ...
                        .as_deref(),
                    failure.latest_culmination_receipt_plan_verdict.as_deref(),
                    "stored report latest_culmination_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
            }
            compare_option_string(
                status.latest_culmination_receipt_verdict.as_deref(),
                None,
                "stored status latest_culmination_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_culmination_receipt_verdict.as_deref(),
                None,
                "stored report latest_culmination_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.summit_certificate_verdict.as_deref(),
                None,
                "stored status summit_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.summit_certificate_verdict.as_deref(),
                None,
                "stored report summit_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.current_pre_activation_gate_verdict.as_deref(),
    ...
    let verdict = if mismatches.is_empty() {
        TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestVerifyOk
    } else {
        TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestVerifyInvalid
    };
    let reason = if mismatches.is_empty() {
        format!(
            "latest-summit-certificate session under {} is coherent with the current latest immutable chain and the accepted summit-certificate contract",
            session_dir.display()
        )
    } else {
        mismatches
            .first()
            .cloned()
            .unwrap_or_else(|| "latest-summit-certificate verification failed".to_string())
    };

    Ok(PackageSummitCertificateLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_summit_certificate".to_string(),
        verdict,
        reason,
        ...
        summit_certificate_latest_session_path: Some(paths.session_path.display().to_string()),
        summit_certificate_latest_status_path: Some(paths.status_path.display().to_string()),
        summit_certificate_latest_report_path: Some(paths.report_path.display().to_string()),
        latest_culmination_receipt_plan_report_path: Some(
            paths
                .latest_culmination_receipt_plan_report_path
                .display()
                .to_string(),
        ),
        latest_culmination_receipt_report_path: Some(
            paths.latest_culmination_receipt_report_path.display().to_string(),
        ),
        summit_certificate_report_path: Some(paths.summit_certificate_report_path.display().to_string()),
        nested_culmination_receipt_latest_session_dir: Some(
            paths
                .nested_culmination_receipt_latest_session_dir
                .display()
                .to_string(),
        ),
        nested_summit_certificate_session_dir: Some(
            paths.nested_summit_certificate_session_dir.display().to_string(),
        ),
        ...
        latest_culmination_receipt_plan_verdict: status.latest_culmination_receipt_plan_verdict.clone(),
        latest_culmination_receipt_verdict: status.latest_culmination_receipt_verdict.clone(),
        summit_certificate_verdict: status.summit_certificate_verdict.clone(),
        ...
        resolve_latest_culmination_receipt_command_summary: Some(
            session.resolve_latest_culmination_receipt_command_summary.clone(),
        ),
        run_latest_culmination_receipt_command_summary: Some(
            session.run_latest_culmination_receipt_command_summary.clone(),
        ),
        verify_latest_culmination_receipt_command_summary: Some(
            session.verify_latest_culmination_receipt_command_summary.clone(),
        ),
        downstream_summit_certificate_command_summary: Some(
            session.downstream_summit_certificate_command_summary.clone(),
        ),
        verify_summit_certificate_command_summary: Some(
            session.verify_summit_certificate_command_summary.clone(),
        ),
        ...
        explicit_statement:
            "this verification proves only whether the latest immutable chain still resolves cleanly into the accepted summit-certificate contract; it never runs the frozen controller"
                .to_string(),
    })
}

fn run_latest_summit_certificate_with_resolution(
    root: &Path,
    session_dir: &Path,
    paths: &PackageSummitCertificateLatestPaths,
    ...
    persist_json(
        &paths.latest_culmination_receipt_plan_report_path,
        &resolved.latest_culmination_receipt_plan_raw,
    )?;

    let latest_culmination_receipt_plan_step = Some(step_artifact(
        &paths.latest_culmination_receipt_plan_report_path,
        "plan_latest_culmination_receipt",
        &resolved.latest_culmination_receipt_plan.verdict,
        &resolved.latest_culmination_receipt_plan.reason,
        resolved.latest_culmination_receipt_plan.generated_at,
    ));

    let latest_culmination_receipt_run_raw = match run_json_command(
        CULMINATION_RECEIPT_LATEST_BIN,
        &latest_culmination_receipt_run_args(
            root,
            &paths.nested_culmination_receipt_latest_session_dir,
        ),
    ) {
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract,
                format!(
                    "failed running nested latest-culmination-receipt handoff under {}: {error}",
                    paths
                        .nested_culmination_receipt_latest_session_dir
                        .display()
                ),
    ...
    persist_json(
        &paths.latest_culmination_receipt_report_path,
        &latest_culmination_receipt_run_raw,
    )?;
    let latest_culmination_receipt_run: SummitCertificateLatestReportView =
        serde_json::from_value(latest_culmination_receipt_run_raw)
            .context("failed parsing nested latest-culmination-receipt run json")?;
    let latest_culmination_receipt_step = Some(step_artifact(
        &paths.latest_culmination_receipt_report_path,
        "run_latest_culmination_receipt",
        &latest_culmination_receipt_run.verdict,
        &latest_culmination_receipt_run.reason,
        latest_culmination_receipt_run.generated_at,
    ));

    if let Some(terminal_failure) =
        latest_culmination_receipt_terminal_failure(&latest_culmination_receipt_run)
    {
        let status = refusal_status(
            root,
            session_dir,
            ...
            Some(resolved),
            terminal_failure,
            latest_culmination_receipt_run.reason.clone(),
            latest_culmination_receipt_plan_step,
            latest_culmination_receipt_step,
            None,
        );
    ...
    compare_culmination_receipt_latest_run_against_snapshot(
        &latest_culmination_receipt_run,
        &resolved.snapshot,
        &paths.nested_culmination_receipt_latest_session_dir,
        &mut run_mismatches,
    );
    ...
    let latest_culmination_receipt_verify: SummitCertificateLatestReportView =
        match run_json_command(
            ...
            Err(error) => {
                ...
                refusal_status(
                    ...
                    LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract,
                    format!(
                    "failed verifying nested latest-culmination-receipt handoff under {}: {error}",
                    paths.nested_culmination_receipt_latest_session_dir.display()
                ),
                    latest_culmination_receipt_plan_step,
                    latest_culmination_receipt_step,
    ...
    if latest_culmination_receipt_verify.verdict != CULMINATION_RECEIPT_LATEST_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
            Some(resolved),
            LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract,
            latest_culmination_receipt_verify.reason,
            latest_culmination_receipt_plan_step,
            latest_culmination_receipt_step,
            None,
        );
    ...
    let release_capsule_run_raw = match run_json_command(
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract,
                format!(
                    "failed running downstream summit-certificate contract under {}: {error}",
                    paths.nested_summit_certificate_session_dir.display()
                ),
                latest_culmination_receipt_plan_step,
                latest_culmination_receipt_step,
    ...
    let provenance_certificate_run: SummitCertificateReportView =
        serde_json::from_value(release_capsule_run_raw)
            .context("failed parsing nested summit-certificate run json")?;
    let summit_certificate_step = Some(step_artifact(
        &paths.summit_certificate_report_path,
        "run_live_package_summit_certificate",
    ...
    let provenance_certificate_verify: SummitCertificateReportView = match run_json_command(
        SUMMIT_CERTIFICATE_BIN,
        &summit_certificate_verify_args(
            &resolved.snapshot,
            &expected_downstream_culmination_receipt_session_dir(paths),
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract,
                format!(
                    "failed verifying downstream summit-certificate contract under {}: {error}",
                    paths.nested_summit_certificate_session_dir.display()
                ),
                latest_culmination_receipt_plan_step,
                latest_culmination_receipt_step,
    ...
    if provenance_certificate_verify.verdict != SUMMIT_CERTIFICATE_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
    ...
    let result = culmination_receipt_latest_result_from_nested_status(
        provenance_certificate_run
            .result
            .as_deref()
            .unwrap_or_default(),
    )
    .unwrap_or(LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract);
    let status = PackageSummitCertificateLatestStatus {
        status_version: SUMMIT_CERTIFICATE_LATEST_STATUS_VERSION.to_string(),
        updated_at: Utc::now(),
        ...
        nested_culmination_receipt_latest_session_dir: paths
            .nested_culmination_receipt_latest_session_dir
            .display()
            .to_string(),
        nested_summit_certificate_session_dir: paths
            .nested_summit_certificate_session_dir
            .display()
            .to_string(),
        ...
        latest_culmination_receipt_plan_verdict: Some(
            resolved.latest_culmination_receipt_plan.verdict.clone(),
        ),
        latest_culmination_receipt_verdict: Some(latest_culmination_receipt_run.verdict.clone()),
        summit_certificate_verdict: Some(provenance_certificate_run.verdict.clone()),
...
fn run_latest_summit_certificate_failure(
    root: &Path,
    session_dir: &Path,
    paths: &PackageSummitCertificateLatestPaths,
    ...
    persist_json(&paths.session_path, &session)?;
    if let Some(value) = &failure.latest_culmination_receipt_plan_raw {
        persist_json(&paths.latest_culmination_receipt_plan_report_path, value)?;
    }
...
fn resolve_latest_culmination_receipt(
    root: &Path,
    paths: &PackageSummitCertificateLatestPaths,
) -> std::result::Result<ResolvedLatestCulminationReceipt, LatestCulminationReceiptResolutionFailure>
{
    let latest_culmination_receipt_plan_raw = match run_json_command(
        CULMINATION_RECEIPT_LATEST_BIN,
        &latest_culmination_receipt_plan_args(
            root,
            &paths.nested_culmination_receipt_latest_session_dir,
        ),
    ) {
        ...
        Err(error) => {
            return Err(LatestCulminationReceiptResolutionFailure {
                ...
                snapshot: None,
                latest_culmination_receipt_plan_raw: None,
                latest_culmination_receipt_plan_verdict: None,
                latest_culmination_receipt_plan_reason: None,
                latest_culmination_receipt_plan_generated_at: None,
            });
        }
    };
    let latest_culmination_receipt_plan: SummitCertificateLatestReportView =
        serde_json::from_value(latest_culmination_receipt_plan_raw.clone()).map_err(
            |error| LatestCulminationReceiptResolutionFailure {
                kind: ResolutionFailureKind::InvalidLatestChain,
                reason: format!(
                    "failed parsing latest-summit-certificate upstream latest-culmination-receipt plan json for {}: {error}",
                    root.display()
                ),
                snapshot: None,
                latest_culmination_receipt_plan_raw: Some(
                    latest_culmination_receipt_plan_raw.clone(),
                ),
                latest_culmination_receipt_plan_verdict: None,
                latest_culmination_receipt_plan_reason: None,
                latest_culmination_receipt_plan_generated_at: None,
    ...
    let snapshot =
        parse_snapshot_from_latest_culmination_receipt(&latest_culmination_receipt_plan).ok();
    if latest_culmination_receipt_plan.verdict != CULMINATION_RECEIPT_LATEST_PLAN_READY {
        return Err(LatestCulminationReceiptResolutionFailure {
            kind: map_culmination_receipt_latest_failure_kind(
                &latest_culmination_receipt_plan.verdict,
            ),
            reason: format!(
                "latest-summit-certificate resolution refused because nested latest-culmination-receipt reported: {}",
                latest_culmination_receipt_plan.reason
            ),
            snapshot,
            latest_culmination_receipt_plan_raw: Some(latest_culmination_receipt_plan_raw),
            latest_culmination_receipt_plan_verdict: Some(
                latest_culmination_receipt_plan.verdict,
            ),
            latest_culmination_receipt_plan_reason: Some(
                latest_culmination_receipt_plan.reason,
            ),
            latest_culmination_receipt_plan_generated_at: Some(
                latest_culmination_receipt_plan.generated_at,
            ),
        });
    }

    let snapshot = parse_snapshot_from_latest_culmination_receipt(&latest_culmination_receipt_plan)
        .map_err(|error| LatestCulminationReceiptResolutionFailure {
            kind: ResolutionFailureKind::InvalidLatestChain,
            reason: format!("latest-summit-certificate resolution failed: {error}"),
            snapshot: None,
            latest_culmination_receipt_plan_raw: Some(latest_culmination_receipt_plan_raw.clone()),
            latest_culmination_receipt_plan_verdict: Some(
                latest_culmination_receipt_plan.verdict.clone(),
            ),
            latest_culmination_receipt_plan_reason: Some(
                latest_culmination_receipt_plan.reason.clone(),
            ),
            latest_culmination_receipt_plan_generated_at: Some(
                latest_culmination_receipt_plan.generated_at,
            ),
    ...
    let mut mismatches = Vec::new();
    compare_culmination_receipt_latest_plan_against_snapshot(
        &latest_culmination_receipt_plan,
        &snapshot,
        &paths.nested_culmination_receipt_latest_session_dir,
        &mut mismatches,
    );
    if !mismatches.is_empty() {
        return Err(LatestCulminationReceiptResolutionFailure {
            kind: ResolutionFailureKind::DriftedSummitCertificateContract,
            reason: format!(
                "latest-summit-certificate drift detected: {}",
                mismatches[0]
            ),
            snapshot: Some(snapshot),
            latest_culmination_receipt_plan_raw: Some(latest_culmination_receipt_plan_raw),
            latest_culmination_receipt_plan_verdict: Some(latest_culmination_receipt_plan.verdict),
            latest_culmination_receipt_plan_reason: Some(latest_culmination_receipt_plan.reason),
            latest_culmination_receipt_plan_generated_at: Some(
                latest_culmination_receipt_plan.generated_at,
            ),
        });
    ...
    Ok(ResolvedLatestCulminationReceipt {
        snapshot,
        latest_culmination_receipt_plan_raw,
        latest_culmination_receipt_plan,
    })
}

fn parse_snapshot_from_latest_culmination_receipt(
    view: &SummitCertificateLatestReportView,
    ...
    if latest_top_step_name != TOP_ACCEPTED_PACKAGE_STEP {
        bail!(
            "latest-summit-certificate nested latest-culmination-receipt plan top accepted step is {} instead of {}",
    ...
    if view.activation_authorized {
        bail!(
            "latest-summit-certificate nested latest-culmination-receipt plan must remain planning-safe with activation_authorized=false"
        );
    }
    Ok(LatestCulminationReceiptSnapshot {
        ...
        wrapper_timeout_ms: view.wrapper_timeout_ms.ok_or_else(|| {
            anyhow!(
                "latest-summit-certificate nested latest-culmination-receipt plan is missing wrapper_timeout_ms"
            )
        })?,
        service_status_max_staleness_ms: view.service_status_max_staleness_ms.ok_or_else(|| {
            anyhow!(
                "latest-summit-certificate nested latest-culmination-receipt plan is missing service_status_max_staleness_ms"
            )
        })?,
...
fn plan_report_from_resolution(
    ...
    paths: &PackageSummitCertificateLatestPaths,
    resolved: &ResolvedLatestCulminationReceipt,
) -> PackageSummitCertificateLatestReport {
    PackageSummitCertificateLatestReport {
        generated_at: Utc::now(),
        ...
        latest_culmination_receipt_report_path: Some(
            paths
                .latest_culmination_receipt_report_path
                .display()
                .to_string(),
        ),
        summit_certificate_report_path: Some(
            paths.summit_certificate_report_path.display().to_string(),
        ),
        nested_culmination_receipt_latest_session_dir: Some(
            paths
                .nested_culmination_receipt_latest_session_dir
        ...
        latest_culmination_receipt_verdict: None,
        summit_certificate_verdict: None,
        result: None,
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_culmination_receipt_command_summary: Some(
            resolve_latest_culmination_receipt_command_summary(
                root,
                &paths.nested_culmination_receipt_latest_session_dir,
            ),
        ),
        run_latest_culmination_receipt_command_summary: Some(
            run_latest_culmination_receipt_command_summary(
                root,
                &paths.nested_culmination_receipt_latest_session_dir,
            ),
        ),
        verify_latest_culmination_receipt_command_summary: Some(
            verify_latest_culmination_receipt_command_summary(
                &paths.nested_culmination_receipt_latest_session_dir,
            ),
        ),
        downstream_summit_certificate_command_summary: Some(
            downstream_summit_certificate_command_summary(
                &resolved.snapshot,
                &expected_downstream_culmination_receipt_session_dir(paths),
                &paths.nested_summit_certificate_session_dir,
            ),
        ),
        verify_summit_certificate_command_summary: Some(verify_summit_certificate_command_summary(
            &resolved.snapshot,
            &expected_downstream_culmination_receipt_session_dir(paths),
            &paths.nested_summit_certificate_session_dir,
        )),
...
fn report_from_resolution_failure(
    ...
    PackageSummitCertificateLatestReport {
        ...
        latest_culmination_receipt_plan_verdict: failure
            .latest_culmination_receipt_plan_verdict
            .clone(),
        latest_culmination_receipt_verdict: None,
        summit_certificate_verdict: None,
        ...
        downstream_summit_certificate_command_summary: snapshot.map(|value| {
            downstream_summit_certificate_command_summary(
                value,
                &expected_downstream_culmination_receipt_session_dir(paths),
                &paths.nested_summit_certificate_session_dir,
        ...
        verify_summit_certificate_command_summary: snapshot.map(|value| {
...
) -> PackageSummitCertificateLatestSession {
    let snapshot = resolved
        .map(|value| &value.snapshot)
        .or_else(|| failure.and_then(|value| value.snapshot.as_ref()));
    PackageSummitCertificateLatestSession {
        session_version: SUMMIT_CERTIFICATE_LATEST_SESSION_VERSION.to_string(),
        planned_at: Utc::now(),
        root: root.display().to_string(),
        session_dir: session_dir.display().to_string(),
        nested_culmination_receipt_latest_session_dir: paths
        ...
        downstream_summit_certificate_command_summary: snapshot
            .map(|value| {
                downstream_summit_certificate_command_summary(
                    value,
                    &expected_downstream_culmination_receipt_session_dir(paths),
        ...
        verify_summit_certificate_command_summary: snapshot
            .map(|value| {
                verify_summit_certificate_command_summary(
                    value,
                    &expected_downstream_culmination_receipt_session_dir(paths),
...
fn report_from_status(
    ...
    session_dir: &Path,
    paths: &PackageSummitCertificateLatestPaths,
    session: &PackageSummitCertificateLatestSession,
    status: &PackageSummitCertificateLatestStatus,
    verification_mismatches: Vec<String>,
) -> PackageSummitCertificateLatestReport {
    PackageSummitCertificateLatestReport {
        generated_at: Utc::now(),
        ...
        nested_summit_certificate_session_dir: Some(
            session.nested_summit_certificate_session_dir.clone(),
        ),
        downstream_decision_packet_session_dir: Some(
            session.downstream_decision_packet_session_dir.clone(),
        ),
        latest_culmination_receipt_plan_verdict: status
            .latest_culmination_receipt_plan_verdict
            .clone(),
        latest_culmination_receipt_verdict: status.latest_culmination_receipt_verdict.clone(),
        summit_certificate_verdict: status.summit_certificate_verdict.clone(),
...
fn summit_certificate_latest_paths(session_dir: &Path) -> PackageSummitCertificateLatestPaths {
    PackageSummitCertificateLatestPaths {
        session_path: session_dir
            .join("tiny_live_activation_package_summit_certificate_latest.session.json"),
        status_path: session_dir
            .join("tiny_live_activation_package_summit_certificate_latest.status.json"),
        report_path: session_dir
            .join("tiny_live_activation_package_summit_certificate_latest.report.json"),
        latest_culmination_receipt_plan_report_path: session_dir.join(
            "tiny_live_activation_package_summit_certificate_latest.culmination_receipt_latest_plan.report.json",
        ),
        latest_culmination_receipt_report_path: session_dir.join(
            "tiny_live_activation_package_summit_certificate_latest.culmination_receipt_latest.report.json",
        ),
        summit_certificate_report_path: session_dir.join(
            "tiny_live_activation_package_summit_certificate_latest.summit_certificate.report.json",
        ),
        nested_culmination_receipt_latest_session_dir: session_dir
            .join("tiny_live_activation_package_summit_certificate_latest.culmination_receipt_latest_session"),
        nested_summit_certificate_session_dir: session_dir.join(
            "tiny_live_activation_package_summit_certificate_latest.summit_certificate_session",
        ),
    }
}
...
fn expected_downstream_decision_packet_session_dir(
    ...
    paths
        .nested_culmination_receipt_latest_session_dir
        .join("tiny_live_activation_package_culmination_receipt_latest.decision_packet_session")
}

fn expected_downstream_culmination_receipt_session_dir(
    paths: &PackageSummitCertificateLatestPaths,
) -> PathBuf {
    paths
        .nested_culmination_receipt_latest_session_dir
        .join("tiny_live_activation_package_culmination_receipt_latest.culmination_receipt_session")
}
...
fn expected_downstream_review_receipt_session_dir(
    ...
    paths
        .nested_culmination_receipt_latest_session_dir
        .join("tiny_live_activation_package_culmination_receipt_latest.review_receipt_session")
}

fn latest_culmination_receipt_plan_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
...
fn latest_culmination_receipt_run_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
...
fn latest_culmination_receipt_verify_args(session_dir: &Path) -> Vec<String> {
    vec![
        "--session-dir".to_string(),
        session_dir.display().to_string(),
...
fn summit_certificate_run_args(
    snapshot: &LatestCulminationReceiptSnapshot,
    culmination_receipt_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        "--culmination-receipt-session-dir".to_string(),
        culmination_receipt_session_dir.display().to_string(),
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-live-package-summit-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn summit_certificate_verify_args(
    snapshot: &LatestCulminationReceiptSnapshot,
    culmination_receipt_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-live-package-summit-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn resolve_latest_culmination_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{CULMINATION_RECEIPT_LATEST_BIN} --root {} --session-dir {} --plan-latest-culmination-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn run_latest_culmination_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{CULMINATION_RECEIPT_LATEST_BIN} --root {} --session-dir {} --run-latest-culmination-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn verify_latest_culmination_receipt_command_summary(session_dir: &Path) -> String {
    format!(
        "{CULMINATION_RECEIPT_LATEST_BIN} --session-dir {} --verify-latest-culmination-receipt --json",
        shell_escape_path(session_dir),
    )
}

fn downstream_summit_certificate_command_summary(
    snapshot: &LatestCulminationReceiptSnapshot,
    culmination_receipt_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{SUMMIT_CERTIFICATE_BIN} --culmination-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --run-live-package-summit-certificate --json",
        shell_escape_path(culmination_receipt_session_dir),
        shell_escape_path(&snapshot.downstream_decision_packet_session_dir),
        shell_escape_path(session_dir),
    )
}

fn verify_summit_certificate_command_summary(
    snapshot: &LatestCulminationReceiptSnapshot,
    culmination_receipt_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{SUMMIT_CERTIFICATE_BIN} --culmination-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --verify-live-package-summit-certificate --json",
        shell_escape_path(culmination_receipt_session_dir),
        shell_escape_path(&snapshot.downstream_decision_packet_session_dir),
        shell_escape_path(session_dir),
    )
...
fn nested_culmination_receipt_latest_report_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_culmination_receipt_latest.report.json")
}

fn nested_summit_certificate_session_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_summit_certificate.session.json")
}

fn nested_summit_certificate_status_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_summit_certificate.status.json")
}
...
fn write_script(path: &Path, contents: &str) -> Result<()> {
    ...
    fs::write(path, contents).with_context(|| {
        format!(
            "failed writing latest-summit-certificate script to {}",
            path.display()
        )
    })?;
    #[cfg(unix)]
...
fn step_artifact(
    ...
    reason: &str,
    generated_at: DateTime<Utc>,
) -> PackageSummitCertificateLatestStepArtifact {
    PackageSummitCertificateLatestStepArtifact {
...
fn canonical_wrapper_mode(mode: &str) -> &str {
    match mode {
        "plan_latest_summit_certificate" => "plan_latest_summit_certificate",
        "render_latest_summit_certificate_script" => "render_latest_summit_certificate_script",
        "run_latest_summit_certificate" => "run_latest_summit_certificate",
        "verify_latest_summit_certificate" => "verify_latest_summit_certificate",
        other => other,
    }
}

fn load_required_step_json<T: for<'de> Deserialize<'de>>(
    step: &Option<PackageSummitCertificateLatestStepArtifact>,
    expected_path: &Path,
    label: &str,
    ...
    let step = step
        .as_ref()
        .ok_or_else(|| anyhow!("{label} is missing from latest-summit-certificate status"))?;
    compare_string(
        &step.path,
...
fn compare_step_artifact_against_report_metadata(
    ...
    let Some(step) = step else {
        mismatches.push(format!(
            "{label} is missing from latest-summit-certificate status"
        ));
        return;
    };
    compare_string(
...
fn compare_culmination_receipt_latest_plan_against_snapshot(
    stored: &SummitCertificateLatestReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        ...
        "stored latest-culmination-receipt plan verdict",
        mismatches,
    );
    compare_string(
        &stored.mode,
        "plan_latest_culmination_receipt",
        "stored latest-culmination-receipt plan mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-culmination-receipt plan latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        ...
        "stored latest-culmination-receipt plan latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-culmination-receipt plan session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        ...
        "stored latest-culmination-receipt plan reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-culmination-receipt plan clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-culmination-receipt plan clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-culmination-receipt plan clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_culmination_receipt_latest_run_against_snapshot(
    stored: &SummitCertificateLatestReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_latest_culmination_receipt",
        "stored latest-culmination-receipt run mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-culmination-receipt run latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        ...
        "stored latest-culmination-receipt run latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-culmination-receipt run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        ...
        "stored latest-culmination-receipt run downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored latest-culmination-receipt run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored latest-culmination-receipt run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored latest-culmination-receipt run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored latest-culmination-receipt run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored latest-culmination-receipt run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored latest-culmination-receipt run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored latest-culmination-receipt run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-culmination-receipt run clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-culmination-receipt run clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-culmination-receipt run clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_culmination_receipt_latest_copy_matches_actual(
    stored: &SummitCertificateLatestReportView,
    actual: &SummitCertificateLatestReportView,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        Some(stored.verdict.as_str()),
        Some(actual.verdict.as_str()),
        "stored latest-culmination-receipt copy verdict",
        mismatches,
    );
    compare_option_string(
        Some(stored.reason.as_str()),
        Some(actual.reason.as_str()),
        "stored latest-culmination-receipt copy reason",
        mismatches,
    );
    if stored.generated_at != actual.generated_at {
        mismatches.push(format!(
            "stored latest-culmination-receipt copy generated_at {:?} does not match actual {:?}",
    ...
    compare_option_string(
        ...
        "stored latest-culmination-receipt copy latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        actual.latest_top_session_dir.as_deref(),
        "stored latest-culmination-receipt copy latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        actual.session_dir.as_deref(),
        "stored latest-culmination-receipt copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        actual.downstream_decision_packet_session_dir.as_deref(),
        "stored latest-culmination-receipt copy downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        actual.result.as_deref(),
        "stored latest-culmination-receipt copy result",
        mismatches,
    );
    compare_option_string(
        stored.explicit_statement.as_deref(),
        actual.explicit_statement.as_deref(),
        "stored latest-culmination-receipt copy explicit_statement",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        actual.current_pre_activation_gate_verdict.as_deref(),
        "stored latest-culmination-receipt copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        actual.current_pre_activation_gate_reason.as_deref(),
        "stored latest-culmination-receipt copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        actual
            .reviewed_frozen_live_cutover_controller_command_summary
            .as_deref(),
        "stored latest-culmination-receipt copy reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}

fn compare_summit_certificate_run_against_snapshot(
    stored: &SummitCertificateReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    culmination_receipt_session_dir: &Path,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_live_package_summit_certificate",
        "stored summit-certificate run mode",
        mismatches,
    );
    compare_string(
        &stored.culmination_receipt_session_dir,
        &culmination_receipt_session_dir.display().to_string(),
        "stored summit-certificate run culmination_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored summit-certificate run decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored summit-certificate run execute_frozen_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored summit-certificate run turn_green_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored summit-certificate run launch_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored summit-certificate run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored summit-certificate run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored summit-certificate run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored summit-certificate run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored summit-certificate run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored summit-certificate run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored summit-certificate run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.summit_certificate_session_path.as_deref(),
        Some(
            nested_summit_certificate_session_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored summit-certificate run summit_certificate_session_path",
        mismatches,
    );
    compare_option_string(
        stored.summit_certificate_status_path.as_deref(),
        Some(
            nested_summit_certificate_status_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored summit-certificate run summit_certificate_status_path",
        mismatches,
    );
    compare_option_string(
        stored.archived_culmination_receipt_report_path.as_deref(),
        Some(
            session_dir
                .join(
                    "tiny_live_activation_package_summit_certificate.culmination_receipt.report.json",
                )
                .display()
                .to_string()
                .as_str(),
        ),
        "stored summit-certificate run archived_culmination_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        stored.verify_culmination_receipt_command_summary.as_deref(),
        Some(
            culmination_receipt_verify_culmination_receipt_command_summary(
                culmination_receipt_session_dir,
            )
            .as_str(),
        ),
        "stored summit-certificate run verify_culmination_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored summit-certificate run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}

fn compare_summit_certificate_copy_against_nested_truth(
    stored: &SummitCertificateReportView,
    nested_session: &SummitCertificateSessionView,
    nested_status: &SummitCertificateStatusView,
    mismatches: &mut Vec<String>,
) {
    compare_string(
        &stored.culmination_receipt_session_dir,
        &nested_session.culmination_receipt_session_dir,
        "stored summit-certificate copy culmination_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.registry_entry_session_dir.as_deref(),
        Some(nested_session.registry_entry_session_dir.as_str()),
        "stored summit-certificate copy registry_entry_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.notarization_receipt_session_dir.as_deref(),
        Some(nested_session.notarization_receipt_session_dir.as_str()),
        "stored summit-certificate copy notarization_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.provenance_certificate_session_dir.as_deref(),
        Some(nested_session.provenance_certificate_session_dir.as_str()),
        "stored summit-certificate copy provenance_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.attestation_seal_session_dir.as_deref(),
        Some(nested_session.attestation_seal_session_dir.as_str()),
        "stored summit-certificate copy attestation_seal_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.release_capsule_session_dir.as_deref(),
        Some(nested_session.release_capsule_session_dir.as_str()),
        "stored summit-certificate copy release_capsule_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.activation_ticket_session_dir.as_deref(),
        Some(nested_session.activation_ticket_session_dir.as_str()),
        "stored summit-certificate copy activation_ticket_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.review_receipt_session_dir.as_deref(),
        Some(nested_session.review_receipt_session_dir.as_str()),
        "stored summit-certificate copy review_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.handoff_bundle_session_dir.as_deref(),
        Some(nested_session.handoff_bundle_session_dir.as_str()),
        "stored summit-certificate copy handoff_bundle_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.decision_packet_session_dir.as_deref(),
        Some(nested_session.decision_packet_session_dir.as_str()),
        "stored summit-certificate copy decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.execute_frozen_session_dir.as_deref(),
        Some(nested_session.execute_frozen_session_dir.as_str()),
        "stored summit-certificate copy execute_frozen_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.turn_green_session_dir.as_deref(),
        Some(nested_session.turn_green_session_dir.as_str()),
        "stored summit-certificate copy turn_green_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.launch_packet_session_dir.as_deref(),
        Some(nested_session.launch_packet_session_dir.as_str()),
        "stored summit-certificate copy launch_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(nested_session.session_dir.as_str()),
        "stored summit-certificate copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        Some(nested_status.result.as_str()),
        "stored summit-certificate copy result",
        mismatches,
    );
    compare_option_string(
        Some(stored.verdict.as_str()),
        summit_certificate_run_verdict_for_result(&nested_status.result),
        "stored summit-certificate copy verdict",
        mismatches,
    );
    compare_option_string(
        stored.handoff_bundle_result.as_deref(),
        nested_status.handoff_bundle_result.as_deref(),
        "stored summit-certificate copy handoff_bundle_result",
        mismatches,
    );
    compare_option_string(
        stored.decision_packet_result.as_deref(),
        nested_status.decision_packet_result.as_deref(),
        "stored summit-certificate copy decision_packet_result",
        mismatches,
    );
    compare_option_string(
        stored.execute_frozen_result.as_deref(),
        nested_status.execute_frozen_result.as_deref(),
        "stored summit-certificate copy execute_frozen_result",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        nested_status.current_pre_activation_gate_verdict.as_deref(),
        "stored summit-certificate copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        nested_status.current_pre_activation_gate_reason.as_deref(),
        "stored summit-certificate copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored.verify_culmination_receipt_command_summary.as_deref(),
        Some(
            nested_session
                .verify_culmination_receipt_command_summary
                .as_str(),
        ),
        "stored summit-certificate copy verify_culmination_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
    ...
    compare_option_string(
        ...
        "stored summit-certificate copy release_capsule_digest_manifest_sha256",
        mismatches,
    );
...
fn compare_session_against_snapshot(
    ...
    compare_string(
        &session.resolve_latest_culmination_receipt_command_summary,
        &resolve_latest_culmination_receipt_command_summary(
            root,
            &paths.nested_culmination_receipt_latest_session_dir,
        ),
        "stored session resolve_latest_culmination_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.run_latest_culmination_receipt_command_summary,
        &run_latest_culmination_receipt_command_summary(
            root,
            &paths.nested_culmination_receipt_latest_session_dir,
        ),
        "stored session run_latest_culmination_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_latest_culmination_receipt_command_summary,
        &verify_latest_culmination_receipt_command_summary(
            &paths.nested_culmination_receipt_latest_session_dir,
        ),
        "stored session verify_latest_culmination_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.downstream_summit_certificate_command_summary,
        &downstream_summit_certificate_command_summary(
            snapshot,
            &expected_downstream_culmination_receipt_session_dir(paths),
            &paths.nested_summit_certificate_session_dir,
        ),
        "stored session downstream_summit_certificate_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_summit_certificate_command_summary,
        &verify_summit_certificate_command_summary(
            snapshot,
            &expected_downstream_culmination_receipt_session_dir(paths),
            &paths.nested_summit_certificate_session_dir,
        ),
        "stored session verify_summit_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_culmination_receipt_latest_session_dir",
        mismatches,
    );
    compare_string(
        &session.nested_summit_certificate_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_summit_certificate_session_dir",
        mismatches,
    );
    compare_string(
        &session.downstream_decision_packet_session_dir,
...
fn compare_report_against_snapshot(
    report: &PackageSummitCertificateLatestReport,
    root: &Path,
    session_dir: &Path,
    paths: &PackageSummitCertificateLatestPaths,
    snapshot: &LatestCulminationReceiptSnapshot,
    ...
    compare_option_string(
        ...
        "stored report resolve_latest_culmination_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report run_latest_culmination_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report verify_latest_culmination_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report downstream_summit_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report.verify_summit_certificate_command_summary.as_deref(),
        Some(
            verify_summit_certificate_command_summary(
                snapshot,
                &expected_downstream_culmination_receipt_session_dir(paths),
        ...
        "stored report verify_summit_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
    ...
    compare_option_string(
        report.summit_certificate_latest_session_path.as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "stored report summit_certificate_latest_session_path",
        mismatches,
    );
    compare_option_string(
        report.summit_certificate_latest_status_path.as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "stored report summit_certificate_latest_status_path",
        mismatches,
    );
    compare_option_string(
        report.summit_certificate_latest_report_path.as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "stored report summit_certificate_latest_report_path",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report latest_culmination_receipt_plan_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_culmination_receipt_report_path.as_deref(),
        Some(
            paths
                .latest_culmination_receipt_report_path
                .display()
        ...
        "stored report latest_culmination_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        report.summit_certificate_report_path.as_deref(),
        Some(
            paths
                .summit_certificate_report_path
                .display()
                .to_string()
                .as_str(),
        ),
        "stored report summit_certificate_report_path",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report nested_culmination_receipt_latest_session_dir",
        mismatches,
    );
    compare_option_string(
        report.nested_summit_certificate_session_dir.as_deref(),
        Some(
            paths
                .nested_summit_certificate_session_dir
                .display()
        ...
        "stored report nested_summit_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
...
fn compare_session_against_failure(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_culmination_receipt_latest_session_dir on failure",
        mismatches,
    );
    compare_string(
        &session.nested_summit_certificate_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_summit_certificate_session_dir on failure",
        mismatches,
    );
...
fn map_culmination_receipt_latest_failure_kind(verdict: &str) -> ResolutionFailureKind {
    match verdict {
        "tiny_live_package_culmination_receipt_latest_refused_by_missing_latest_chain" => {
            ResolutionFailureKind::MissingLatestChain
        }
        "tiny_live_package_culmination_receipt_latest_refused_by_drifted_culmination_receipt_contract" => {
            ResolutionFailureKind::DriftedSummitCertificateContract
        }
        _ => ResolutionFailureKind::InvalidLatestChain,
    }
}

fn latest_culmination_receipt_terminal_failure(
    report: &SummitCertificateLatestReportView,
) -> Option<LivePackageSummitCertificateLatestResult> {
    match report.result.as_deref() {
        Some("refused_by_missing_latest_chain") => {
            Some(LivePackageSummitCertificateLatestResult::RefusedByMissingLatestChain)
        }
        Some("refused_by_invalid_latest_chain") => {
            Some(LivePackageSummitCertificateLatestResult::RefusedByInvalidLatestChain)
        }
        Some("refused_by_drifted_culmination_receipt_contract") => Some(
            LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract,
        ),
        _ => None,
    }
...
fn culmination_receipt_latest_result_from_nested_status(
    result: &str,
) -> Option<LivePackageSummitCertificateLatestResult> {
    match result {
        "ready_for_manual_execution_when_gate_turns_green" => Some(
            LivePackageSummitCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen,
        ),
        "refused_now_by_stage3" => {
            Some(LivePackageSummitCertificateLatestResult::RefusedNowByStage3)
        }
        "refused_now_by_pre_activation_gate" => {
            Some(LivePackageSummitCertificateLatestResult::RefusedNowByPreActivationGate)
        }
...
fn summit_certificate_run_verdict_for_result(result: &str) -> Option<&'static str> {
    match result {
        "ready_for_manual_execution_when_gate_turns_green" => Some(
            "tiny_live_package_summit_certificate_ready_for_manual_execution_when_gate_turns_green",
        ),
        "refused_now_by_stage3" => {
            Some("tiny_live_package_summit_certificate_refused_now_by_stage3")
        }
        "refused_now_by_pre_activation_gate" => {
            Some("tiny_live_package_summit_certificate_refused_now_by_pre_activation_gate")
        }
        "refused_now_by_invalid_or_drifted_contract" => {
            Some("tiny_live_package_summit_certificate_refused_now_by_invalid_or_drifted_contract")
        }
        _ => None,
    }
}
...
fn result_from_failure_kind(
    kind: ResolutionFailureKind,
) -> LivePackageSummitCertificateLatestResult {
    match kind {
        ResolutionFailureKind::MissingLatestChain => {
            LivePackageSummitCertificateLatestResult::RefusedByMissingLatestChain
        }
        ResolutionFailureKind::InvalidLatestChain => {
            LivePackageSummitCertificateLatestResult::RefusedByInvalidLatestChain
        }
        ResolutionFailureKind::DriftedSummitCertificateContract => {
            LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract
        }
...
fn verdict_for_result(
    result: LivePackageSummitCertificateLatestResult,
) -> TinyLivePackageSummitCertificateLatestVerdict {
    match result {
        LivePackageSummitCertificateLatestResult::RefusedByMissingLatestChain => {
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestRefusedByMissingLatestChain
        }
        LivePackageSummitCertificateLatestResult::RefusedByInvalidLatestChain => {
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestRefusedByInvalidLatestChain
        }
        LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract => {
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestRefusedByDriftedSummitCertificateContract
        }
        LivePackageSummitCertificateLatestResult::RefusedNowByStage3 => {
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestRefusedNowByStage3
        }
        LivePackageSummitCertificateLatestResult::RefusedNowByPreActivationGate => {
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestRefusedNowByPreActivationGate
        }
        LivePackageSummitCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestReadyForManualExecutionWhenGateTurnsGreen
        }
    }
}
...
fn operator_next_action_summary(result: LivePackageSummitCertificateLatestResult) -> String {
    match result {
        LivePackageSummitCertificateLatestResult::RefusedByMissingLatestChain => {
        ...
        LivePackageSummitCertificateLatestResult::RefusedByInvalidLatestChain => {
            "the latest immutable chain is incomplete or below the accepted clerestory layer; mint a fresh coherent clerestory chain instead of bypassing the accepted latest-summit-certificate / culmination-receipt path".to_string()
        }
        LivePackageSummitCertificateLatestResult::RefusedByDriftedSummitCertificateContract => {
            "the latest chain no longer resolves cleanly into the accepted latest-summit-certificate / culmination-receipt contract; repair that drift instead of bypassing the bounded handoff path".to_string()
        }
        LivePackageSummitCertificateLatestResult::RefusedNowByStage3 => {
            "the frozen controller stays refused now by Stage 3; rerun this latest-summit-certificate refresh after current Stage 3 truth turns green".to_string()
        }
        LivePackageSummitCertificateLatestResult::RefusedNowByPreActivationGate => {
            "the frozen controller stays refused now by the pre-activation gate; rerun this latest-summit-certificate refresh after the current pre-activation gate turns green".to_string()
        }
        LivePackageSummitCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            "the latest immutable chain now resolves into the accepted summit-certificate contract and one bounded latest summit-certificate handoff is ready for manual execution when gate truth turns green; this wrapper still did not run or authorize the frozen controller".to_string()
        }
    }
}
...
fn culmination_receipt_verify_culmination_receipt_command_summary(
    culmination_receipt_session_dir: &Path,
) -> String {
    format!(
        "verify immutable culmination-receipt session under {} before freezing the final completion certificate",
        culmination_receipt_session_dir.display()
    )
}
...
fn refusal_status(
    ...
    latest_culmination_receipt_step: Option<PackageSummitCertificateLatestStepArtifact>,
    summit_certificate_step: Option<PackageSummitCertificateLatestStepArtifact>,
) -> PackageSummitCertificateLatestStatus {
    ...
    PackageSummitCertificateLatestStatus {
        ...
        result,
        reason,
        latest_culmination_receipt_plan_verdict: resolved
            .map(|value| value.latest_culmination_receipt_plan.verdict.clone()),
        latest_culmination_receipt_verdict: latest_culmination_receipt_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        summit_certificate_verdict: summit_certificate_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
...
fn refusal_status_from_resolution_failure(
    ...
    PackageSummitCertificateLatestStatus {
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        latest_culmination_receipt_plan_step: failure
            .latest_culmination_receipt_plan_raw
            .as_ref()
            .map(|_| {
                step_artifact(
                    ...
                    failure
                        ...
                        .unwrap_or("<missing>"),
                    failure
                        .latest_culmination_receipt_plan_reason
                        .as_deref()
                        .unwrap_or("<missing>"),
                    failure
                        .latest_culmination_receipt_plan_generated_at
                        .unwrap_or_else(Utc::now),
                )
            }),
        latest_culmination_receipt_step: None,
        summit_certificate_step: None,
...
fn verify_invalid_summit_certificate_latest_report_without_session(
    session_dir: &Path,
    verification_mismatches: Vec<String>,
) -> PackageSummitCertificateLatestReport {
    ...
    PackageSummitCertificateLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_summit_certificate".to_string(),
        verdict: TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestVerifyInvalid,
        reason,
        root: None,
        ...
        session_dir: Some(session_dir.display().to_string()),
        summit_certificate_latest_session_path: Some(
            summit_certificate_latest_paths(session_dir)
                .session_path
                .display()
                .to_string(),
        ),
        summit_certificate_latest_status_path: Some(
            summit_certificate_latest_paths(session_dir)
                .status_path
                .display()
                .to_string(),
        ),
        summit_certificate_latest_report_path: Some(
            summit_certificate_latest_paths(session_dir)
                .report_path
                .display()
                .to_string(),
        ),
        latest_culmination_receipt_plan_report_path: None,
        latest_culmination_receipt_report_path: None,
        summit_certificate_report_path: None,
        nested_culmination_receipt_latest_session_dir: None,
        nested_summit_certificate_session_dir: None,
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_culmination_receipt_command_summary: None,
        run_latest_culmination_receipt_command_summary: None,
        verify_latest_culmination_receipt_command_summary: None,
        downstream_summit_certificate_command_summary: None,
        verify_summit_certificate_command_summary: None,
...
fn fallback_culmination_receipt_latest_copy() -> SummitCertificateLatestReportView {
    SummitCertificateLatestReportView {
        generated_at: Utc::now(),
...
fn fallback_notarization_receipt_session(
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
) -> SummitCertificateSessionView {
    SummitCertificateSessionView {
        culmination_receipt_session_dir: "<missing>".to_string(),
        ...
        session_dir: session_dir.display().to_string(),
        verify_culmination_receipt_command_summary:
            culmination_receipt_verify_culmination_receipt_command_summary(Path::new("<missing>")),
        ...
        explicit_statement:
            "the verified culmination-receipt session is the primary input here; this immutable summit certificate freezes one final zenith identity over the fully culminated chain without enabling production execution"
                .to_string(),
    }
}
...
fn fallback_notarization_receipt_status(
    ...
    SummitCertificateStatusView {
        ...
        summit_certificate_algorithm: "sha256".to_string(),
        explicit_statement:
            "this summit certificate is archival and read-only; it never executes or enables the frozen controller"
                .to_string(),
    }
}

fn render_report_lines(report: &PackageSummitCertificateLatestReport) -> String {
    let mut lines = vec![
    ...
    if let Some(value) = &report.nested_culmination_receipt_latest_session_dir {
        lines.push(format!(
            "nested_culmination_receipt_latest_session_dir={value}"
        ));
    }
    ...
    if let Some(value) = &report.nested_summit_certificate_session_dir {
        lines.push(format!("nested_summit_certificate_session_dir={value}"));
    }
    if let Some(value) = &report.result {
        lines.push(format!("result={value}"));
    }
    if let Some(value) = &report.downstream_summit_certificate_command_summary {
        lines.push(format!(
            "downstream_summit_certificate_command_summary={value}"
        ));
    }
...
mod tests {
    ...
    struct FakeNotarizationReceiptLatestFixture {
        ...
        culmination_receipt_latest_plan_json_path: PathBuf,
        culmination_receipt_latest_run_json_path: PathBuf,
        culmination_receipt_latest_verify_json_path: PathBuf,
    ...
    impl FakeNotarizationReceiptLatestFixture {
        fn plan_config(&self) -> Config {
            Config {
                mode: Mode::PlanLatestSummitCertificate,
        ...
        fn render_config(&self) -> Config {
            Config {
                mode: Mode::RenderLatestSummitCertificateScript,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
        ...
        fn run_config(&self) -> Config {
            Config {
                mode: Mode::RunLatestSummitCertificate,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
        ...
        fn verify_config(&self) -> Config {
            Config {
                mode: Mode::VerifyLatestSummitCertificate,
                root: None,
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
    ...
    #[test]
    fn plan_mode_resolves_latest_valid_clerestory_chain_to_exact_expected_nested_latest_culmination_receipt_lineage(
    ) {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_plan_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let report = plan_latest_summit_certificate_report(&fixture.plan_config()).unwrap();
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        assert_eq!(
            report.verdict,
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestPlanReady
        );
        assert_eq!(report.mode, "plan_latest_summit_certificate");
        assert_eq!(
            report.latest_top_step_name.as_deref(),
        ...
        assert!(report
            ...
            .as_deref()
            .unwrap()
            .contains(SUMMIT_CERTIFICATE_BIN));
    }
    ...
    fn render_mode_emits_exact_downstream_provenance_certificate_contract_not_second_controller_path(
        ...
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_render_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let report =
            render_latest_summit_certificate_script_report(&fixture.render_config()).unwrap();
        assert_eq!(
            report.verdict,
            TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestScriptRendered
        );
        assert_eq!(report.mode, "render_latest_summit_certificate_script");
        let script = fs::read_to_string(&fixture.output_script_path).unwrap();
        assert!(script.contains(CULMINATION_RECEIPT_LATEST_BIN));
        assert!(script.contains(SUMMIT_CERTIFICATE_BIN));
        assert!(script.contains("--culmination-receipt-session-dir"));
        assert!(!script.contains("--activation-ticket-session-dir"));
        assert!(script.contains("--run-live-package-summit-certificate"));
        assert!(script.contains("--verify-live-package-summit-certificate"));
    ...
    fn run_mode_refuses_when_latest_chain_missing_invalid_or_below_clerestory() {
        for (label, verdict, reason, expected) in [
            (
                "culmination_receipt_latest_missing",
                "tiny_live_package_culmination_receipt_latest_refused_by_missing_latest_chain",
                "no persisted immutable chain exists",
                TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestRefusedByMissingLatestChain,
            ),
            (
                "culmination_receipt_latest_invalid",
                "tiny_live_package_culmination_receipt_latest_refused_by_invalid_latest_chain",
                "latest immutable chain is incomplete",
                TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestRefusedByInvalidLatestChain,
            ),
            (
                "culmination_receipt_latest_below",
                "tiny_live_package_culmination_receipt_latest_refused_by_invalid_latest_chain",
            ...
            let mut plan: Value = load_json(&fixture.culmination_receipt_latest_plan_json_path).unwrap();
            plan["verdict"] = json!(verdict);
            plan["reason"] = json!(reason);
            if label.ends_with("below") {
                plan["latest_top_step_name"] = json!("choir_receipt");
            }
            persist_json(&fixture.culmination_receipt_latest_plan_json_path, &plan).unwrap();

            let report = run_latest_summit_certificate_report(&fixture.run_config()).unwrap();
            assert_eq!(report.verdict, expected);
        }
    }

    #[test]
    fn plan_mode_maps_real_latest_culmination_receipt_drift_verdict_to_local_drift_refusal() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_plan_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let mut plan: Value =
            load_json(&fixture.culmination_receipt_latest_plan_json_path).unwrap();
        plan["verdict"] = json!(
            "tiny_live_package_culmination_receipt_latest_refused_by_drifted_culmination_receipt_contract"
        );
        plan["reason"] = json!("real accepted latest-culmination-receipt drift");
        persist_json(&fixture.culmination_receipt_latest_plan_json_path, &plan).unwrap();
    ...
    #[test]
    fn run_mode_takes_terminal_drift_refusal_when_nested_latest_culmination_receipt_reports_real_drift(
    ) {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_run_drift",
            "refused_by_drifted_culmination_receipt_contract",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert_eq!(report.summit_certificate_verdict.as_deref(), None);
    }

    #[test]
    fn run_mode_refuses_when_nested_release_capsule_lineage_drifts_from_latest_immutable_chain() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_handoff_bundle_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let mut run: Value = load_json(&fixture.culmination_receipt_latest_run_json_path).unwrap();
        run["package_dir"] = json!("/tampered/package");
        persist_json(&fixture.culmination_receipt_latest_run_json_path, &run).unwrap();
        ...
        assert!(report
            .reason
            .contains("stored latest-culmination-receipt run package_dir"));
    }

    #[test]
    fn verify_mode_fails_when_persisted_latest_culmination_receipt_artifacts_are_tampered_or_missing_nested_lineage_truth(
    ) {
        {
            let fixture = fake_culmination_receipt_latest_fixture(
                "culmination_receipt_latest_verify_tampered_copy",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            run_latest_summit_certificate_report(&fixture.run_config()).unwrap();

            let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
            let mut report: Value = load_json(&paths.summit_certificate_report_path).unwrap();
            report["reason"] = json!("tampered stored provenance-certificate copy reason");
            persist_json(&paths.summit_certificate_report_path, &report).unwrap();

            let verify = verify_latest_summit_certificate_report(&fixture.verify_config()).unwrap();
            assert_eq!(
                verify.verdict,
                TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestVerifyInvalid
            );
        ...
        {
            let fixture = fake_culmination_receipt_latest_fixture(
                "culmination_receipt_latest_verify_missing_nested_truth",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            ...
            let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
            fs::remove_file(nested_culmination_receipt_latest_report_path(
                &paths.nested_culmination_receipt_latest_session_dir,
            ))
            .unwrap();
            ...
            assert!(verify.verification_mismatches.iter().any(|entry| {
                entry
                    .contains("tiny_live_activation_package_culmination_receipt_latest.report.json")
            }));
        }
    }
    ...
    fn verify_accepts_real_shaped_native_consummation_identity_layers_on_happy_path() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_real_shaped_finality_paths_green",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    #[test]
    fn verify_fails_when_copied_native_summit_certificate_session_path_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_finality_session_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.summit_certificate_report_path).unwrap();
        report["summit_certificate_session_path"] =
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate run summit_certificate_session_path")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_summit_certificate_status_path_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_finality_status_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.summit_certificate_report_path).unwrap();
        report["summit_certificate_status_path"] = json!("/tampered/finality-receipt-status.json");
        persist_json(&paths.summit_certificate_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate run summit_certificate_status_path")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_summit_certificate_sha256_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_summit_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.summit_certificate_report_path).unwrap();
        report["summit_certificate_sha256"] = json!("tampered-summit-certificate-sha256");
        persist_json(&paths.summit_certificate_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy summit_certificate_sha256")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_latest_culmination_receipt_explicit_statement_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_launch_packet_explicit_statement_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.latest_culmination_receipt_report_path).unwrap();
        report["explicit_statement"] =
            json!("tampered nested latest release capsule explicit statement");
        persist_json(&paths.latest_culmination_receipt_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored latest-culmination-receipt copy explicit_statement")
        }));
    }
    ...
    fn verify_rejects_tampered_stale_completion_certificate_wrapper_mode_string() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_wrapper_mode_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        report["mode"] = json!("run_latest_culmination_receipt");
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| { entry.contains("latest-summit-certificate stored report mode") }));
    }

    #[test]
    fn verify_fails_when_copied_nested_provenance_certificate_decision_packet_result_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_decision_packet_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy decision_packet_result")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_attestation_seal_session_dir_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_attestation_seal_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy attestation_seal_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_registry_entry_session_dir_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_registry_entry_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy registry_entry_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_notarization_receipt_session_dir_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_notarization_receipt_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy notarization_receipt_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_summary_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_chain_fingerprint_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy chain_fingerprint_summary")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_sha256_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_chain_fingerprint_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy chain_fingerprint_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_algorithm_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_chain_fingerprint_algorithm_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy chain_fingerprint_algorithm")
        }));
    }
    ...
    fn verify_fails_when_copied_native_completion_certificate_closure_certificate_sha256_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_closure_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy closure_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_archive_receipt_sha256_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_archive_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy archive_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_finality_receipt_sha256_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_finality_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy finality_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_consummation_record_sha256_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_consummation_record_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy consummation_record_sha256")
        }));
    }
    ...
    {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_completion_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy completion_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_downstream_decision_packet_confirmation_anchor_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_decision_packet_anchor_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy decision_packet_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_execute_frozen_result_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_current_authorization_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored summit-certificate copy execute_frozen_result")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_summit_certificate_verdict_drifts() {
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_release_capsule_verdict_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| entry.contains("stored summit-certificate copy verdict")));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_current_live_cutover_controller_summary_drifts(
        ...
        let fixture = fake_culmination_receipt_latest_fixture(
            "culmination_receipt_latest_verify_current_live_cutover_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn all_modes_preserve_stage3_and_pre_activation_refusal_semantics_and_do_not_imply_activation_authorization_by_themselves(
        ...
        {
            let fixture = fake_culmination_receipt_latest_fixture(
                "culmination_receipt_latest_stage3",
                "refused_now_by_stage3",
                "refused_now_by_stage3",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);

            let plan = plan_latest_summit_certificate_report(&fixture.plan_config()).unwrap();
            assert_eq!(
                plan.verdict,
                TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestPlanReady
            );
            assert_eq!(plan.mode, "plan_latest_summit_certificate");
            assert!(!plan.activation_authorized);

            let run = run_latest_summit_certificate_report(&fixture.run_config()).unwrap();
            assert_eq!(
                run.verdict,
                TinyLivePackageSummitCertificateLatestVerdict::TinyLivePackageSummitCertificateLatestRefusedNowByStage3
            );
            assert_eq!(run.mode, "run_latest_summit_certificate");
            ...
            assert_eq!(verify.mode, "verify_latest_summit_certificate");
            assert!(!verify.activation_authorized);
        }

        {
            let fixture = fake_culmination_receipt_latest_fixture(
                "culmination_receipt_latest_pre_activation",
                "refused_now_by_pre_activation_gate",
                "refused_now_by_pre_activation_gate",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        {
            let fixture = fake_culmination_receipt_latest_fixture(
                "culmination_receipt_latest_green",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn fake_culmination_receipt_latest_fixture(
        label: &str,
        culmination_receipt_latest_run_result: &str,
        ...
        let culmination_receipt_latest_plan_json_path =
            temp_dir.join("culmination_receipt_latest.plan.json");
        let culmination_receipt_latest_run_json_path =
            temp_dir.join("culmination_receipt_latest.run.json");
        let culmination_receipt_latest_verify_json_path =
            temp_dir.join("culmination_receipt_latest.verify.json");
        ...
        let fixture = FakeNotarizationReceiptLatestFixture {
            ...
            install_root,
            backend_command,
            culmination_receipt_latest_plan_json_path,
            culmination_receipt_latest_run_json_path,
            culmination_receipt_latest_verify_json_path,
        ...
        persist_json(
            &fixture.culmination_receipt_latest_plan_json_path,
            &default_culmination_receipt_latest_plan_report(&fixture),
        )
        .unwrap();
        persist_json(
            &fixture.culmination_receipt_latest_run_json_path,
            &default_culmination_receipt_latest_run_report(
                &fixture,
                culmination_receipt_latest_run_result,
            ),
        )
        .unwrap();
        persist_json(
            &fixture.culmination_receipt_latest_verify_json_path,
            &default_culmination_receipt_latest_verify_report(
                &fixture,
                culmination_receipt_latest_run_result,
            ),
        )
        ...
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        write_fake_culmination_receipt_latest_command(
        ...
        write_fake_release_capsule_command(
            &fixture.bin_dir.join(SUMMIT_CERTIFICATE_BIN),
            &fixture.handoff_bundle_run_json_path,
            &fixture.handoff_bundle_verify_json_path,
            &fixture.handoff_bundle_session_json_path,
            &fixture.handoff_bundle_status_json_path,
    ...
    fn default_culmination_receipt_latest_plan_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
    ) -> Value {
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        json!({
            "generated_at": Utc::now(),
            "mode": "plan_latest_culmination_receipt",
            "verdict": CULMINATION_RECEIPT_LATEST_PLAN_READY,
            "reason": "latest immutable chain resolves cleanly into accepted latest-culmination-receipt contract",
            ...
            "session_dir": paths.nested_culmination_receipt_latest_session_dir.display().to_string(),
    ...
    fn canonical_culmination_receipt_latest_result(result: &str) -> &str {
        match result {
            "runnable_when_gate_truth_turns_green" => {
    ...
    fn default_culmination_receipt_latest_run_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let result = canonical_culmination_receipt_latest_result(result);
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        let (verdict, gate_verdict, gate_reason) = match result {
            "ready_for_manual_execution_when_gate_turns_green" => (
                "tiny_live_package_culmination_receipt_latest_ready_for_manual_execution_when_gate_turns_green",
                Value::Null,
                Value::Null,
            ),
            "refused_now_by_stage3" => (
                "tiny_live_package_culmination_receipt_latest_refused_now_by_stage3",
                json!("blocked"),
                json!("stage3 blocked"),
            ),
            "refused_now_by_pre_activation_gate" => (
                "tiny_live_package_culmination_receipt_latest_refused_now_by_pre_activation_gate",
                json!("blocked"),
        ...
        json!({
            "generated_at": Utc::now(),
            "mode": "run_latest_culmination_receipt",
            "verdict": verdict,
    ...
    fn default_culmination_receipt_latest_verify_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let mut report = default_culmination_receipt_latest_run_report(fixture, result);
        report["mode"] = json!("verify_latest_culmination_receipt");
    ...
    fn default_provenance_certificate_session(
        ...
        let paths = summit_certificate_latest_paths(&fixture.wrapper_session_dir);
        let culmination_receipt_session_dir =
            expected_downstream_culmination_receipt_session_dir(&paths);
        ...
        json!({
            "session_version": "1",
            "planned_at": Utc::now(),
            "culmination_receipt_session_dir": culmination_receipt_session_dir.display().to_string(),
            ...
            "release_capsule_session_dir": culmination_receipt_session_dir.display().to_string(),
            ...
            "wrapper_timeout_ms": snapshot.wrapper_timeout_ms,
            "service_status_max_staleness_ms": snapshot.service_status_max_staleness_ms,
            "session_dir": summit_certificate_latest_paths(&fixture.wrapper_session_dir).nested_summit_certificate_session_dir.display().to_string(),
            "verify_culmination_receipt_command_summary": culmination_receipt_verify_culmination_receipt_command_summary(&culmination_receipt_session_dir),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
            ...
            "explicit_statement": "the verified culmination-receipt session is the primary input here; this immutable summit certificate freezes one final zenith identity over the fully culminated chain without enabling production execution"
        })
    }
    ...
    fn default_provenance_certificate_status(
        ...
        json!({
            "status_version": "1",
            "updated_at": Utc::now(),
            "session_dir": paths.nested_summit_certificate_session_dir.display().to_string(),
            "culmination_receipt_session_dir": expected_downstream_culmination_receipt_session_dir(&paths).display().to_string(),
            "result": result,
            "reason": reason,
            ...
            "current_pre_activation_gate_verdict": gate_verdict,
            "current_pre_activation_gate_reason": gate_reason,
            "summit_certificate_step": Value::Null,
            ...
            "summit_certificate_sha256": "fixture-summit-certificate-sha256",
            "summit_certificate_algorithm": "sha256",
            "explicit_statement": "this summit certificate is archival and read-only; it never executes or enables the frozen controller"
        })
    }
    ...
    fn default_provenance_certificate_run_report(
        ...
        let summit_certificate_verdict = match result {
            "ready_for_manual_execution_when_gate_turns_green" => {
                "tiny_live_package_summit_certificate_ready_for_manual_execution_when_gate_turns_green"
            }
            "refused_now_by_stage3" => "tiny_live_package_summit_certificate_refused_now_by_stage3",
            "refused_now_by_pre_activation_gate" => {
                "tiny_live_package_summit_certificate_refused_now_by_pre_activation_gate"
            }
            _ => "tiny_live_package_summit_certificate_refused_now_by_invalid_or_drifted_contract",
        };
        json!({
            "generated_at": Utc::now(),
            "mode": "run_live_package_summit_certificate",
            "verdict": summit_certificate_verdict,
            ...
            "release_capsule_session_dir": expected_downstream_culmination_receipt_session_dir(&paths).display().to_string(),
            ...
            "service_status_max_staleness_ms": 4500,
            "session_dir": paths.nested_summit_certificate_session_dir.display().to_string(),
            "summit_certificate_session_path": nested_summit_certificate_session_path(&paths.nested_summit_certificate_session_dir).display().to_string(),
            "summit_certificate_status_path": nested_summit_certificate_status_path(&paths.nested_summit_certificate_session_dir).display().to_string(),
            "archived_culmination_receipt_report_path": paths.nested_summit_certificate_session_dir.join("tiny_live_activation_package_summit_certificate.culmination_receipt.report.json").display().to_string(),
            "result": result,
            ...
            "summit_certificate_step": Value::Null,
            "verify_culmination_receipt_command_summary": culmination_receipt_verify_culmination_receipt_command_summary(&expected_downstream_culmination_receipt_session_dir(&paths)),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
    ...
    fn default_provenance_certificate_verify_report(
        ...
        report["mode"] = json!("verify_live_package_summit_certificate");
        report["verdict"] = json!(SUMMIT_CERTIFICATE_VERIFY_OK);
        report["reason"] = json!("verify ok");
        report["explicit_statement"] = json!("this verification binds one immutable summit certificate to verified culmination-receipt truth, the exact reviewed frozen controller summary, the canonical chain fingerprint, the ledger seal, the registry entry, the filing-certificate identity, the archive-receipt identity, the closure-certificate identity, the finality-receipt identity, the consummation-record identity, the completion-certificate identity, and the culmination-receipt identity");
        report
    }

    fn write_fake_culmination_receipt_latest_command(
        path: &Path,
        plan_json_path: &Path,
        run_json_path: &Path,
        ...
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected latest-culmination-receipt session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --plan-latest-culmination-receipt \"*) mode='plan';;\n  *\" --run-latest-culmination-receipt \"*) mode='run';;\n  *\" --verify-latest-culmination-receipt \"*) mode='verify';;\n  *) echo 'unexpected latest-culmination-receipt mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  plan|run)\n    case \" $* \" in\n      *\" --root {} \"*) : ;;\n      *) echo 'unexpected root' >&2; exit 1;;\n    esac\n    ;;\nesac\ncase \"$mode\" in\n  plan) cat '{}';;\n  run) mkdir -p '{}'; cp '{}' '{}/tiny_live_activation_package_culmination_receipt_latest.report.json'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
            session_dir.display(),
            root.display(),
    ...
    fn write_fake_release_capsule_command(
        ...
        let nested_session_path = nested_summit_certificate_session_path(session_dir);
        let nested_status_path = nested_summit_certificate_status_path(session_dir);
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --culmination-receipt-session-dir {} \"*) : ;;\n  *) echo 'unexpected summit-certificate culmination-receipt-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --confirm-decision-packet-session-dir {} \"*) : ;;\n  *) echo 'unexpected summit-certificate confirm-decision-packet-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected summit-certificate session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --run-live-package-summit-certificate \"*) mode='run';;\n  *\" --verify-live-package-summit-certificate \"*) mode='verify';;\n  *) echo 'unexpected summit-certificate mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  run) mkdir -p '{}'; cp '{}' '{}'; cp '{}' '{}'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
