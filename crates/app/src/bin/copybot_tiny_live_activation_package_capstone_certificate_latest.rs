...
const USAGE: &str = "usage: copybot_tiny_live_activation_package_capstone_certificate_latest --root <path> [--session-dir <path>] [--output <path>] [--json] (--plan-latest-capstone-certificate | --render-latest-capstone-certificate-script | --run-latest-capstone-certificate | --verify-latest-capstone-certificate)";
const CAPSTONE_CERTIFICATE_LATEST_SESSION_VERSION: &str = "1";
const CAPSTONE_CERTIFICATE_LATEST_STATUS_VERSION: &str = "1";
const CULMINATION_RECEIPT_LATEST_BIN: &str =
    "copybot_tiny_live_activation_package_pinnacle_receipt_latest";
const CAPSTONE_CERTIFICATE_BIN: &str = "copybot_tiny_live_activation_package_capstone_certificate";
const CULMINATION_RECEIPT_LATEST_PLAN_READY: &str =
    "tiny_live_package_pinnacle_receipt_latest_plan_ready";
const CULMINATION_RECEIPT_LATEST_VERIFY_OK: &str =
    "tiny_live_package_pinnacle_receipt_latest_verify_ok";
const CAPSTONE_CERTIFICATE_VERIFY_OK: &str = "tiny_live_package_capstone_certificate_verify_ok";
const TOP_ACCEPTED_PACKAGE_STEP: &str = "clerestory_certificate";
const PLANNING_SAFE_STATEMENT: &str =
    "this latest-capstone-certificate handoff binds the latest persisted immutable package chain to the accepted capstone-certificate contract, but it never overrides Stage 3 or pre-activation refusal truth, it stays archival and read-only, it never runs the frozen live cutover controller by itself, and activation_authorized remains false";
...
enum Mode {
    PlanLatestCapstoneCertificate,
    RenderLatestCapstoneCertificateScript,
    RunLatestCapstoneCertificate,
    VerifyLatestCapstoneCertificate,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum TinyLivePackageCapstoneCertificateLatestVerdict {
    TinyLivePackageCapstoneCertificateLatestPlanReady,
    TinyLivePackageCapstoneCertificateLatestScriptRendered,
    TinyLivePackageCapstoneCertificateLatestRefusedByMissingLatestChain,
    TinyLivePackageCapstoneCertificateLatestRefusedByInvalidLatestChain,
    TinyLivePackageCapstoneCertificateLatestRefusedByDriftedCapstoneCertificateContract,
    TinyLivePackageCapstoneCertificateLatestRefusedNowByStage3,
    TinyLivePackageCapstoneCertificateLatestRefusedNowByPreActivationGate,
    TinyLivePackageCapstoneCertificateLatestReadyForManualExecutionWhenGateTurnsGreen,
    TinyLivePackageCapstoneCertificateLatestVerifyOk,
    TinyLivePackageCapstoneCertificateLatestVerifyInvalid,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum LivePackageCapstoneCertificateLatestResult {
    RefusedByMissingLatestChain,
    RefusedByInvalidLatestChain,
    RefusedByDriftedCapstoneCertificateContract,
    RefusedNowByStage3,
...
struct PackageCapstoneCertificateLatestStepArtifact {
    path: String,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageCapstoneCertificateLatestSession {
    session_version: String,
    planned_at: DateTime<Utc>,
    root: String,
    session_dir: String,
    nested_pinnacle_receipt_latest_session_dir: String,
    nested_capstone_certificate_session_dir: String,
    ...
    resolve_latest_pinnacle_receipt_command_summary: String,
    run_latest_pinnacle_receipt_command_summary: String,
    verify_latest_pinnacle_receipt_command_summary: String,
    downstream_capstone_certificate_command_summary: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageCapstoneCertificateLatestStatus {
    ...
    nested_capstone_certificate_session_dir: String,
    downstream_decision_packet_session_dir: String,
    result: LivePackageCapstoneCertificateLatestResult,
    reason: String,
    latest_pinnacle_receipt_plan_verdict: Option<String>,
    latest_pinnacle_receipt_verdict: Option<String>,
    capstone_certificate_verdict: Option<String>,
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    latest_pinnacle_receipt_plan_step: Option<PackageCapstoneCertificateLatestStepArtifact>,
    latest_pinnacle_receipt_step: Option<PackageCapstoneCertificateLatestStepArtifact>,
    capstone_certificate_step: Option<PackageCapstoneCertificateLatestStepArtifact>,
...
#[derive(Debug, Clone)]
struct PackageCapstoneCertificateLatestPaths {
    session_path: PathBuf,
    status_path: PathBuf,
    report_path: PathBuf,
    latest_pinnacle_receipt_plan_report_path: PathBuf,
    latest_pinnacle_receipt_report_path: PathBuf,
    capstone_certificate_report_path: PathBuf,
    nested_pinnacle_receipt_latest_session_dir: PathBuf,
    nested_capstone_certificate_session_dir: PathBuf,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageCapstoneCertificateLatestReport {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: TinyLivePackageCapstoneCertificateLatestVerdict,
    reason: String,
    root: Option<String>,
    latest_top_step_name: Option<String>,
    latest_top_session_dir: Option<String>,
    ...
    capstone_certificate_latest_session_path: Option<String>,
    capstone_certificate_latest_status_path: Option<String>,
    capstone_certificate_latest_report_path: Option<String>,
    latest_pinnacle_receipt_plan_report_path: Option<String>,
    latest_pinnacle_receipt_report_path: Option<String>,
    capstone_certificate_report_path: Option<String>,
    nested_pinnacle_receipt_latest_session_dir: Option<String>,
    nested_capstone_certificate_session_dir: Option<String>,
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    resolve_latest_pinnacle_receipt_command_summary: Option<String>,
    run_latest_pinnacle_receipt_command_summary: Option<String>,
    verify_latest_pinnacle_receipt_command_summary: Option<String>,
    downstream_capstone_certificate_command_summary: Option<String>,
...
struct ResolvedLatestCulminationReceipt {
    ...
    latest_pinnacle_receipt_plan_raw: Value,
    latest_pinnacle_receipt_plan: CapstoneCertificateLatestReportView,
}
...
struct LatestCulminationReceiptResolutionFailure {
    ...
    latest_pinnacle_receipt_plan_raw: Option<Value>,
    latest_pinnacle_receipt_plan_verdict: Option<String>,
    latest_pinnacle_receipt_plan_reason: Option<String>,
    latest_pinnacle_receipt_plan_generated_at: Option<DateTime<Utc>>,
}

#[derive(Debug, Clone, Deserialize)]
struct CapstoneCertificateLatestReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
...
struct CapstoneCertificateReportView {
    ...
    verdict: String,
    reason: String,
    pinnacle_receipt_session_dir: String,
    ...
    service_status_max_staleness_ms: Option<u64>,
    session_dir: Option<String>,
    capstone_certificate_session_path: Option<String>,
    capstone_certificate_status_path: Option<String>,
    archived_pinnacle_receipt_report_path: Option<String>,
    result: Option<String>,
    ...
    I: IntoIterator<Item = String>,
{
    ...
    while let Some(arg) = iter.next() {
        match arg.as_str() {
            ...
            "--json" => json = true,
            "--plan-latest-capstone-certificate" => {
                set_mode(&mut mode, Mode::PlanLatestCapstoneCertificate, arg.as_str())?
            }
            "--render-latest-capstone-certificate-script" => set_mode(
                &mut mode,
                Mode::RenderLatestCapstoneCertificateScript,
                arg.as_str(),
            )?,
            "--run-latest-capstone-certificate" => {
                set_mode(&mut mode, Mode::RunLatestCapstoneCertificate, arg.as_str())?
            }
            "--verify-latest-capstone-certificate" => set_mode(
                &mut mode,
                Mode::VerifyLatestCapstoneCertificate,
                arg.as_str(),
            )?,
    ...
    if matches!(
        mode,
        Mode::PlanLatestCapstoneCertificate
            | Mode::RenderLatestCapstoneCertificateScript
            | Mode::RunLatestCapstoneCertificate
    ) && root.is_none()
    {
        bail!("missing --root");
    }
    if matches!(mode, Mode::RenderLatestCapstoneCertificateScript) && output_path.is_none() {
        bail!("missing --output for render mode");
    }
    if matches!(
        mode,
        Mode::RunLatestCapstoneCertificate | Mode::VerifyLatestCapstoneCertificate
    ) && session_dir.is_none()
    {
...
fn run(config: Config) -> Result<String> {
    let report = match config.mode {
        Mode::PlanLatestCapstoneCertificate => plan_latest_capstone_certificate_report(&config)?,
        Mode::RenderLatestCapstoneCertificateScript => {
            render_latest_capstone_certificate_script_report(&config)?
        }
        Mode::RunLatestCapstoneCertificate => run_latest_capstone_certificate_report(&config)?,
        Mode::VerifyLatestCapstoneCertificate => {
            verify_latest_capstone_certificate_report(&config)?
        }
    };
    if config.json {
...
fn plan_latest_capstone_certificate_report(
    config: &Config,
) -> Result<PackageCapstoneCertificateLatestReport> {
    let root = config
        .root
        .as_ref()
        .ok_or_else(|| anyhow!("missing --root"))?;
    let suggested_session_dir = config.session_dir.clone().unwrap_or_else(|| {
        root.join("tiny_live_activation_package_capstone_certificate_latest.session")
    });
    let paths = capstone_certificate_latest_paths(&suggested_session_dir);

    match resolve_latest_pinnacle_receipt(root, &paths) {
        Ok(resolved) => Ok(plan_report_from_resolution(
            "plan_latest_capstone_certificate",
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestPlanReady,
            format!(
                "latest immutable {} chain under {} resolves to exact latest-pinnacle-receipt lineage via accepted latest-pinnacle-receipt session {}, exact decision-packet confirmation anchor {}, and the accepted latest-capstone-certificate contract remains current",
                resolved.snapshot.latest_top_step_name,
                root.display(),
                paths.nested_pinnacle_receipt_latest_session_dir.display(),
...
fn render_latest_capstone_certificate_script_report(
    config: &Config,
) -> Result<PackageCapstoneCertificateLatestReport> {
    let root = config
        .root
        ...
        Ok(resolved) => {
            write_script(
                ...
                &format!(
                    ...
                    run_latest = run_latest_pinnacle_receipt_command_summary(
                        root,
                        &paths.nested_pinnacle_receipt_latest_session_dir,
                    ),
                    verify_latest = verify_latest_pinnacle_receipt_command_summary(
                        &paths.nested_pinnacle_receipt_latest_session_dir,
                    ),
                    run_handoff_bundle = downstream_capstone_certificate_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_pinnacle_receipt_session_dir(&paths),
                        &paths.nested_capstone_certificate_session_dir,
                    ),
                    verify_handoff_bundle = verify_capstone_certificate_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_pinnacle_receipt_session_dir(&paths),
                        &paths.nested_capstone_certificate_session_dir,
                    ),
            ...
            Ok(plan_report_from_resolution(
                "render_latest_capstone_certificate_script",
                TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestScriptRendered,
                format!(
                    "rendered latest-capstone-certificate handoff script to {} using the accepted latest-pinnacle-receipt lineage and the accepted capstone-certificate contract",
                    output_path.display()
                ),
                root,
                &suggested_session_dir,
...
fn run_latest_capstone_certificate_report(
    config: &Config,
) -> Result<PackageCapstoneCertificateLatestReport> {
    let root = config
        .root
    ...
    if session_dir.exists() {
        bail!(
            "refusing to overwrite existing latest-capstone-certificate session dir {}",
            session_dir.display()
        );
    }
    let paths = capstone_certificate_latest_paths(session_dir);
    create_clean_session_dir(session_dir, "latest-capstone-certificate")?;

    let resolution = resolve_latest_pinnacle_receipt(root, &paths);
    match resolution {
        Ok(resolved) => {
            run_latest_capstone_certificate_with_resolution(root, session_dir, &paths, &resolved)
        }
        Err(failure) => {
            run_latest_capstone_certificate_failure(root, session_dir, &paths, &failure)
        }
    }
}

fn verify_latest_capstone_certificate_report(
    config: &Config,
) -> Result<PackageCapstoneCertificateLatestReport> {
    let session_dir = config
        .session_dir
    ...
    let session: PackageCapstoneCertificateLatestSession = match load_json(&paths.session_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_capstone_certificate_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-capstone-certificate session artifact {}: {error}",
    ...
    let status: PackageCapstoneCertificateLatestStatus = match load_json(&paths.status_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_capstone_certificate_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-capstone-certificate status artifact {}: {error}",
    ...
    let stored_report: PackageCapstoneCertificateLatestReport = match load_json(&paths.report_path)
    {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_capstone_certificate_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-capstone-certificate report artifact {}: {error}",
    ...
    compare_string(
        &session.root,
        &status.root,
        "latest-capstone-certificate root consistency",
        &mut mismatches,
    );
    compare_string(
        &session.session_dir,
        &session_dir.display().to_string(),
        "latest-capstone-certificate session session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.session_dir,
        &session_dir.display().to_string(),
        "latest-capstone-certificate status session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "latest-capstone-certificate report session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_pinnacle_receipt_latest_session_dir,
        &paths
            .nested_pinnacle_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-capstone-certificate session nested_pinnacle_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_pinnacle_receipt_latest_session_dir,
        &paths
            .nested_pinnacle_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-capstone-certificate status nested_pinnacle_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-capstone-certificate report nested_pinnacle_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_capstone_certificate_session_dir,
        &paths
            .nested_capstone_certificate_session_dir
            .display()
            .to_string(),
        "latest-capstone-certificate session nested_capstone_certificate_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_capstone_certificate_session_dir,
        &paths
            .nested_capstone_certificate_session_dir
            .display()
            .to_string(),
        "latest-capstone-certificate status nested_capstone_certificate_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-capstone-certificate report nested_capstone_certificate_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-capstone-certificate session downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-capstone-certificate status downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-capstone-certificate report downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .capstone_certificate_latest_session_path
            .as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "latest-capstone-certificate report session path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .capstone_certificate_latest_status_path
            .as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "latest-capstone-certificate report status path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .capstone_certificate_latest_report_path
            .as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "latest-capstone-certificate report report path",
        &mut mismatches,
    );
    compare_string(
        &session.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-capstone-certificate session explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &status.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-capstone-certificate status explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-capstone-certificate report explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.mode,
        "run_latest_capstone_certificate",
        "latest-capstone-certificate stored report mode",
        &mut mismatches,
    );
    compare_string(
        &serialize_enum(&stored_report.verdict),
        &serialize_enum(&verdict_for_result(status.result)),
        "latest-capstone-certificate stored report verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.result.as_deref(),
        Some(serialize_enum(&status.result).as_str()),
        "latest-capstone-certificate stored report result consistency",
        &mut mismatches,
    );
    compare_string(
        &stored_report.reason,
        &status.reason,
        "latest-capstone-certificate stored report reason consistency",
        &mut mismatches,
    );
    if stored_report.activation_authorized != status.activation_authorized {
        mismatches.push(format!(
            "latest-capstone-certificate stored report activation_authorized {} does not match status {}",
            stored_report.activation_authorized, status.activation_authorized
        ));
    }
    compare_option_string(
        stored_report
            .latest_pinnacle_receipt_plan_verdict
            .as_deref(),
        status.latest_pinnacle_receipt_plan_verdict.as_deref(),
        "stored report latest_pinnacle_receipt_plan_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.latest_pinnacle_receipt_verdict.as_deref(),
        status.latest_pinnacle_receipt_verdict.as_deref(),
        "stored report latest_pinnacle_receipt_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.capstone_certificate_verdict.as_deref(),
        status.capstone_certificate_verdict.as_deref(),
        "stored report capstone_certificate_verdict",
        &mut mismatches,
    );
    compare_option_string(
    ...
    match resolution {
        Ok(resolved) => {
            ...
            let stored_latest_plan: CapstoneCertificateLatestReportView = load_required_step_json(
                &status.latest_pinnacle_receipt_plan_step,
                &paths.latest_pinnacle_receipt_plan_report_path,
                "latest_pinnacle_receipt_plan_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_pinnacle_receipt_plan_step.as_ref(),
                &paths.latest_pinnacle_receipt_plan_report_path,
                "plan_latest_pinnacle_receipt",
                &stored_latest_plan.verdict,
                &stored_latest_plan.reason,
                stored_latest_plan.generated_at,
                "stored latest_pinnacle_receipt_plan_step",
                &mut mismatches,
            );
            compare_pinnacle_receipt_latest_plan_against_snapshot(
                &stored_latest_plan,
                &resolved.snapshot,
                &paths.nested_pinnacle_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_pinnacle_receipt_plan_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report
            ...
            let stored_latest_run: CapstoneCertificateLatestReportView = load_required_step_json(
                &status.latest_pinnacle_receipt_step,
                &paths.latest_pinnacle_receipt_report_path,
                "latest_pinnacle_receipt_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_pinnacle_receipt_step.as_ref(),
                &paths.latest_pinnacle_receipt_report_path,
                "run_latest_pinnacle_receipt",
                &stored_latest_run.verdict,
                &stored_latest_run.reason,
                stored_latest_run.generated_at,
                "stored latest_pinnacle_receipt_step",
                &mut mismatches,
            );
            compare_pinnacle_receipt_latest_run_against_snapshot(
                &stored_latest_run,
                &resolved.snapshot,
                &paths.nested_pinnacle_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_pinnacle_receipt_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_pinnacle_receipt_verdict.as_deref(),
            ...
            let actual_latest_run: CapstoneCertificateLatestReportView = match load_json(
                &nested_pinnacle_receipt_latest_report_path(
                    &paths.nested_pinnacle_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed loading actual nested latest-pinnacle-receipt report under {}: {error}",
                        paths.nested_pinnacle_receipt_latest_session_dir.display()
                    ));
                    fallback_pinnacle_receipt_latest_copy()
                }
            };
            compare_pinnacle_receipt_latest_copy_matches_actual(
                &stored_latest_run,
                &actual_latest_run,
                &mut mismatches,
            );
            ...
            let latest_verify_raw = match run_json_command(
                ...
                &latest_pinnacle_receipt_verify_args(
                    &paths.nested_pinnacle_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested latest-pinnacle-receipt session under {}: {error}",
                        paths.nested_pinnacle_receipt_latest_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !latest_verify_raw.is_null() {
                let latest_verify: CapstoneCertificateLatestReportView =
                    serde_json::from_value(latest_verify_raw)
                        .context("failed parsing nested latest-pinnacle-receipt verify json")?;
                if latest_verify.verdict != CULMINATION_RECEIPT_LATEST_VERIFY_OK {
                    mismatches.push(format!(
                        "nested latest-pinnacle-receipt verification is non-green: {}",
            ...
            compare_option_string(
                ...
                "stored status capstone_certificate_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.capstone_certificate_verdict.as_deref(),
            ...
            let nested_handoff_bundle_session: CapstoneCertificateSessionView =
                match load_json(&nested_capstone_certificate_session_path(
                    &paths.nested_capstone_certificate_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                            "failed reading nested capstone-certificate session under {}: {error}",
                            paths.nested_capstone_certificate_session_dir.display()
                        ));
            ...
            let nested_handoff_bundle_status: CapstoneCertificateStatusView =
                match load_json(&nested_capstone_certificate_status_path(
                    &paths.nested_capstone_certificate_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                            "failed reading nested capstone-certificate status under {}: {error}",
                            paths.nested_capstone_certificate_session_dir.display()
                        ));
            ...
            let handoff_bundle_verify_raw = match run_json_command(
                CAPSTONE_CERTIFICATE_BIN,
                &capstone_certificate_verify_args(
                    &resolved.snapshot,
                    &expected_downstream_pinnacle_receipt_session_dir(&paths),
                    &paths.nested_capstone_certificate_session_dir,
                ),
                ...
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested capstone-certificate session under {}: {error}",
                        paths.nested_capstone_certificate_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !handoff_bundle_verify_raw.is_null() {
                let handoff_bundle_verify: CapstoneCertificateReportView =
                    serde_json::from_value(handoff_bundle_verify_raw)
                        .context("failed parsing nested capstone-certificate verify json")?;
                compare_option_string(
                    stored_handoff_bundle.registry_entry_session_dir.as_deref(),
                    handoff_bundle_verify.registry_entry_session_dir.as_deref(),
                    "stored capstone-certificate copy registry_entry_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored capstone-certificate copy notarization_receipt_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                ...
                compare_option_string(
                    ...
                    handoff_bundle_verify
                        .consummation_record_algorithm
                        .as_deref(),
                    "stored capstone-certificate copy consummation_record_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored capstone-certificate copy completion_certificate_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.completion_certificate_sha256.as_deref(),
                    handoff_bundle_verify.completion_certificate_sha256.as_deref(),
                    "stored capstone-certificate copy completion_certificate_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                ...
                compare_option_string(
                    ...
                    "stored capstone-certificate copy capstone_certificate_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .reviewed_frozen_live_cutover_controller_command_summary
                        .as_deref(),
                    "stored capstone-certificate copy reviewed_frozen_live_cutover_controller_command_summary",
                    &mut mismatches,
                );
                if handoff_bundle_verify.verdict != CAPSTONE_CERTIFICATE_VERIFY_OK {
                    mismatches.push(format!(
            ...
            let expected_result = pinnacle_receipt_latest_result_from_nested_status(
                nested_handoff_bundle_status.result.as_str(),
            )
            .unwrap_or(
                LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract,
            );
            if status.result != expected_result {
                mismatches.push(format!(
                    "stored latest-capstone-certificate result {} does not match nested capstone-certificate result {}",
            ...
            if status.activation_authorized {
                mismatches.push(
                    "stored status activation_authorized must remain false for latest-capstone-certificate"
                        .to_string(),
                );
            }
            compare_option_string(
        ...
        Err(failure) => {
            ...
            if failure.latest_pinnacle_receipt_plan_raw.is_some() {
                let stored_latest_plan: CapstoneCertificateLatestReportView =
                ...
                compare_option_string(
                    status.latest_pinnacle_receipt_plan_verdict.as_deref(),
                    failure.latest_pinnacle_receipt_plan_verdict.as_deref(),
                    "stored status latest_pinnacle_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_report
                        ...
                        .as_deref(),
                    failure.latest_pinnacle_receipt_plan_verdict.as_deref(),
                    "stored report latest_pinnacle_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
            }
            compare_option_string(
                status.latest_pinnacle_receipt_verdict.as_deref(),
                None,
                "stored status latest_pinnacle_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_pinnacle_receipt_verdict.as_deref(),
                None,
                "stored report latest_pinnacle_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.capstone_certificate_verdict.as_deref(),
                None,
                "stored status capstone_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.capstone_certificate_verdict.as_deref(),
                None,
                "stored report capstone_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.current_pre_activation_gate_verdict.as_deref(),
    ...
    let verdict = if mismatches.is_empty() {
        TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestVerifyOk
    } else {
        TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestVerifyInvalid
    };
    let reason = if mismatches.is_empty() {
        format!(
            "latest-capstone-certificate session under {} is coherent with the current latest immutable chain and the accepted capstone-certificate contract",
            session_dir.display()
        )
    } else {
        mismatches
            .first()
            .cloned()
            .unwrap_or_else(|| "latest-capstone-certificate verification failed".to_string())
    };

    Ok(PackageCapstoneCertificateLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_capstone_certificate".to_string(),
        verdict,
        reason,
        ...
        capstone_certificate_latest_session_path: Some(paths.session_path.display().to_string()),
        capstone_certificate_latest_status_path: Some(paths.status_path.display().to_string()),
        capstone_certificate_latest_report_path: Some(paths.report_path.display().to_string()),
        latest_pinnacle_receipt_plan_report_path: Some(
            paths
                .latest_pinnacle_receipt_plan_report_path
                .display()
                .to_string(),
        ),
        latest_pinnacle_receipt_report_path: Some(
            paths.latest_pinnacle_receipt_report_path.display().to_string(),
        ),
        capstone_certificate_report_path: Some(paths.capstone_certificate_report_path.display().to_string()),
        nested_pinnacle_receipt_latest_session_dir: Some(
            paths
                .nested_pinnacle_receipt_latest_session_dir
                .display()
                .to_string(),
        ),
        nested_capstone_certificate_session_dir: Some(
            paths.nested_capstone_certificate_session_dir.display().to_string(),
        ),
        ...
        latest_pinnacle_receipt_plan_verdict: status.latest_pinnacle_receipt_plan_verdict.clone(),
        latest_pinnacle_receipt_verdict: status.latest_pinnacle_receipt_verdict.clone(),
        capstone_certificate_verdict: status.capstone_certificate_verdict.clone(),
        ...
        resolve_latest_pinnacle_receipt_command_summary: Some(
            session.resolve_latest_pinnacle_receipt_command_summary.clone(),
        ),
        run_latest_pinnacle_receipt_command_summary: Some(
            session.run_latest_pinnacle_receipt_command_summary.clone(),
        ),
        verify_latest_pinnacle_receipt_command_summary: Some(
            session.verify_latest_pinnacle_receipt_command_summary.clone(),
        ),
        downstream_capstone_certificate_command_summary: Some(
            session.downstream_capstone_certificate_command_summary.clone(),
        ),
        ...
        explicit_statement:
            "this verification proves only whether the latest immutable chain still resolves cleanly into the accepted capstone-certificate contract; it never runs the frozen controller"
                .to_string(),
    })
}

fn run_latest_capstone_certificate_with_resolution(
    root: &Path,
    session_dir: &Path,
    paths: &PackageCapstoneCertificateLatestPaths,
    ...
    persist_json(
        &paths.latest_pinnacle_receipt_plan_report_path,
        &resolved.latest_pinnacle_receipt_plan_raw,
    )?;

    let latest_pinnacle_receipt_plan_step = Some(step_artifact(
        &paths.latest_pinnacle_receipt_plan_report_path,
        "plan_latest_pinnacle_receipt",
        &resolved.latest_pinnacle_receipt_plan.verdict,
        &resolved.latest_pinnacle_receipt_plan.reason,
        resolved.latest_pinnacle_receipt_plan.generated_at,
    ));

    let latest_pinnacle_receipt_run_raw = match run_json_command(
        CULMINATION_RECEIPT_LATEST_BIN,
        &latest_pinnacle_receipt_run_args(root, &paths.nested_pinnacle_receipt_latest_session_dir),
    ) {
        Ok(value) => value,
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract,
                format!(
                    "failed running nested latest-pinnacle-receipt handoff under {}: {error}",
                    paths.nested_pinnacle_receipt_latest_session_dir.display()
                ),
                latest_pinnacle_receipt_plan_step,
                None,
    ...
    persist_json(
        &paths.latest_pinnacle_receipt_report_path,
        &latest_pinnacle_receipt_run_raw,
    )?;
    let latest_pinnacle_receipt_run: CapstoneCertificateLatestReportView =
        serde_json::from_value(latest_pinnacle_receipt_run_raw)
            .context("failed parsing nested latest-pinnacle-receipt run json")?;
    let latest_pinnacle_receipt_step = Some(step_artifact(
        &paths.latest_pinnacle_receipt_report_path,
        "run_latest_pinnacle_receipt",
        &latest_pinnacle_receipt_run.verdict,
        &latest_pinnacle_receipt_run.reason,
        latest_pinnacle_receipt_run.generated_at,
    ));

    if let Some(terminal_failure) =
        latest_pinnacle_receipt_terminal_failure(&latest_pinnacle_receipt_run)
    {
        let status = refusal_status(
            root,
            session_dir,
            ...
            Some(resolved),
            terminal_failure,
            latest_pinnacle_receipt_run.reason.clone(),
            latest_pinnacle_receipt_plan_step,
            latest_pinnacle_receipt_step,
            None,
        );
    ...
    let latest_pinnacle_receipt_verify: CapstoneCertificateLatestReportView = match run_json_command(
        CULMINATION_RECEIPT_LATEST_BIN,
        &latest_pinnacle_receipt_verify_args(&paths.nested_pinnacle_receipt_latest_session_dir),
    ) {
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract,
                format!(
                    "failed verifying nested latest-pinnacle-receipt handoff under {}: {error}",
                    paths.nested_pinnacle_receipt_latest_session_dir.display()
                ),
                latest_pinnacle_receipt_plan_step,
                latest_pinnacle_receipt_step,
    ...
    if latest_pinnacle_receipt_verify.verdict != CULMINATION_RECEIPT_LATEST_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
            Some(resolved),
            LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract,
            latest_pinnacle_receipt_verify.reason,
            latest_pinnacle_receipt_plan_step,
            latest_pinnacle_receipt_step,
            None,
        );
    ...
    let release_capsule_run_raw = match run_json_command(
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract,
                format!(
                    "failed running downstream capstone-certificate contract under {}: {error}",
                    paths.nested_capstone_certificate_session_dir.display()
                ),
                latest_pinnacle_receipt_plan_step,
                latest_pinnacle_receipt_step,
    ...
    let provenance_certificate_run: CapstoneCertificateReportView =
        serde_json::from_value(release_capsule_run_raw)
            .context("failed parsing nested capstone-certificate run json")?;
    ...
    let provenance_certificate_verify: CapstoneCertificateReportView = match run_json_command(
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract,
                format!(
                    "failed verifying downstream capstone-certificate contract under {}: {error}",
                    paths.nested_capstone_certificate_session_dir.display()
                ),
                latest_pinnacle_receipt_plan_step,
                latest_pinnacle_receipt_step,
    ...
    if provenance_certificate_verify.verdict != CAPSTONE_CERTIFICATE_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
    ...
    let result = pinnacle_receipt_latest_result_from_nested_status(
        provenance_certificate_run
            .result
            .as_deref()
            .unwrap_or_default(),
    ...
    let status = PackageCapstoneCertificateLatestStatus {
        status_version: CAPSTONE_CERTIFICATE_LATEST_STATUS_VERSION.to_string(),
        updated_at: Utc::now(),
        ...
        nested_pinnacle_receipt_latest_session_dir: paths
            .nested_pinnacle_receipt_latest_session_dir
            .display()
            .to_string(),
        nested_capstone_certificate_session_dir: paths
            .nested_capstone_certificate_session_dir
            .display()
            .to_string(),
        ...
        latest_pinnacle_receipt_plan_verdict: Some(
            resolved.latest_pinnacle_receipt_plan.verdict.clone(),
        ),
        latest_pinnacle_receipt_verdict: Some(latest_pinnacle_receipt_run.verdict.clone()),
        capstone_certificate_verdict: Some(provenance_certificate_run.verdict.clone()),
...
fn run_latest_capstone_certificate_failure(
    root: &Path,
    session_dir: &Path,
    paths: &PackageCapstoneCertificateLatestPaths,
    ...
    persist_json(&paths.session_path, &session)?;
    if let Some(value) = &failure.latest_pinnacle_receipt_plan_raw {
        persist_json(&paths.latest_pinnacle_receipt_plan_report_path, value)?;
    }
...
fn resolve_latest_pinnacle_receipt(
    root: &Path,
    paths: &PackageCapstoneCertificateLatestPaths,
) -> std::result::Result<ResolvedLatestCulminationReceipt, LatestCulminationReceiptResolutionFailure>
{
    let latest_pinnacle_receipt_plan_raw = match run_json_command(
        CULMINATION_RECEIPT_LATEST_BIN,
        &latest_pinnacle_receipt_plan_args(root, &paths.nested_pinnacle_receipt_latest_session_dir),
    ) {
        Ok(value) => value,
        Err(error) => {
            return Err(LatestCulminationReceiptResolutionFailure {
                ...
                snapshot: None,
                latest_pinnacle_receipt_plan_raw: None,
                latest_pinnacle_receipt_plan_verdict: None,
                latest_pinnacle_receipt_plan_reason: None,
                latest_pinnacle_receipt_plan_generated_at: None,
            });
        }
    };
    let latest_pinnacle_receipt_plan: CapstoneCertificateLatestReportView =
        serde_json::from_value(latest_pinnacle_receipt_plan_raw.clone()).map_err(
            |error| LatestCulminationReceiptResolutionFailure {
                kind: ResolutionFailureKind::InvalidLatestChain,
                reason: format!(
                    "failed parsing latest-capstone-certificate upstream latest-pinnacle-receipt plan json for {}: {error}",
                    root.display()
                ),
                snapshot: None,
                latest_pinnacle_receipt_plan_raw: Some(
                    latest_pinnacle_receipt_plan_raw.clone(),
                ),
                latest_pinnacle_receipt_plan_verdict: None,
                latest_pinnacle_receipt_plan_reason: None,
                latest_pinnacle_receipt_plan_generated_at: None,
    ...
    let snapshot = parse_snapshot_from_latest_pinnacle_receipt(&latest_pinnacle_receipt_plan).ok();
    if latest_pinnacle_receipt_plan.verdict != CULMINATION_RECEIPT_LATEST_PLAN_READY {
        return Err(LatestCulminationReceiptResolutionFailure {
            kind: map_pinnacle_receipt_latest_failure_kind(
                &latest_pinnacle_receipt_plan.verdict,
            ),
            reason: format!(
                "latest-capstone-certificate resolution refused because nested latest-pinnacle-receipt reported: {}",
                latest_pinnacle_receipt_plan.reason
            ),
            snapshot,
            latest_pinnacle_receipt_plan_raw: Some(latest_pinnacle_receipt_plan_raw),
            latest_pinnacle_receipt_plan_verdict: Some(
                latest_pinnacle_receipt_plan.verdict,
            ),
            latest_pinnacle_receipt_plan_reason: Some(
                latest_pinnacle_receipt_plan.reason,
            ),
            latest_pinnacle_receipt_plan_generated_at: Some(
                latest_pinnacle_receipt_plan.generated_at,
            ),
        });
    }

    let snapshot = parse_snapshot_from_latest_pinnacle_receipt(&latest_pinnacle_receipt_plan)
        .map_err(|error| LatestCulminationReceiptResolutionFailure {
            kind: ResolutionFailureKind::InvalidLatestChain,
            reason: format!("latest-capstone-certificate resolution failed: {error}"),
            snapshot: None,
            latest_pinnacle_receipt_plan_raw: Some(latest_pinnacle_receipt_plan_raw.clone()),
            latest_pinnacle_receipt_plan_verdict: Some(
                latest_pinnacle_receipt_plan.verdict.clone(),
            ),
            latest_pinnacle_receipt_plan_reason: Some(latest_pinnacle_receipt_plan.reason.clone()),
            latest_pinnacle_receipt_plan_generated_at: Some(
                latest_pinnacle_receipt_plan.generated_at,
            ),
        })?;
    ...
    if !mismatches.is_empty() {
        return Err(LatestCulminationReceiptResolutionFailure {
            ...
            reason: format!(
                "latest-capstone-certificate drift detected: {}",
                mismatches[0]
            ),
            snapshot: Some(snapshot),
            latest_pinnacle_receipt_plan_raw: Some(latest_pinnacle_receipt_plan_raw),
            latest_pinnacle_receipt_plan_verdict: Some(latest_pinnacle_receipt_plan.verdict),
            latest_pinnacle_receipt_plan_reason: Some(latest_pinnacle_receipt_plan.reason),
            latest_pinnacle_receipt_plan_generated_at: Some(
                latest_pinnacle_receipt_plan.generated_at,
            ),
        });
    ...
    Ok(ResolvedLatestCulminationReceipt {
        snapshot,
        latest_pinnacle_receipt_plan_raw,
        latest_pinnacle_receipt_plan,
    })
}

fn parse_snapshot_from_latest_pinnacle_receipt(
    view: &CapstoneCertificateLatestReportView,
    ...
    if latest_top_step_name != TOP_ACCEPTED_PACKAGE_STEP {
        bail!(
            "latest-capstone-certificate nested latest-pinnacle-receipt plan top accepted step is {} instead of {}",
    ...
    if view.activation_authorized {
        bail!(
            "latest-capstone-certificate nested latest-pinnacle-receipt plan must remain planning-safe with activation_authorized=false"
        );
    }
    Ok(LatestCulminationReceiptSnapshot {
        ...
        wrapper_timeout_ms: view.wrapper_timeout_ms.ok_or_else(|| {
            anyhow!(
                "latest-capstone-certificate nested latest-pinnacle-receipt plan is missing wrapper_timeout_ms"
            )
        })?,
        service_status_max_staleness_ms: view.service_status_max_staleness_ms.ok_or_else(|| {
            anyhow!(
                "latest-capstone-certificate nested latest-pinnacle-receipt plan is missing service_status_max_staleness_ms"
            )
        })?,
...
fn plan_report_from_resolution(
    ...
    paths: &PackageCapstoneCertificateLatestPaths,
    resolved: &ResolvedLatestCulminationReceipt,
) -> PackageCapstoneCertificateLatestReport {
    PackageCapstoneCertificateLatestReport {
        generated_at: Utc::now(),
        ...
        latest_pinnacle_receipt_report_path: Some(
            paths
                .latest_pinnacle_receipt_report_path
                .display()
                .to_string(),
        ),
        capstone_certificate_report_path: Some(
        ...
        latest_pinnacle_receipt_verdict: None,
        capstone_certificate_verdict: None,
        result: None,
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_pinnacle_receipt_command_summary: Some(
            resolve_latest_pinnacle_receipt_command_summary(
                root,
                &paths.nested_pinnacle_receipt_latest_session_dir,
            ),
        ),
        run_latest_pinnacle_receipt_command_summary: Some(
            run_latest_pinnacle_receipt_command_summary(
                root,
                &paths.nested_pinnacle_receipt_latest_session_dir,
            ),
        ),
        verify_latest_pinnacle_receipt_command_summary: Some(
            verify_latest_pinnacle_receipt_command_summary(
                &paths.nested_pinnacle_receipt_latest_session_dir,
            ),
        ),
        downstream_capstone_certificate_command_summary: Some(
            downstream_capstone_certificate_command_summary(
                &resolved.snapshot,
                &expected_downstream_pinnacle_receipt_session_dir(paths),
                &paths.nested_capstone_certificate_session_dir,
            ),
...
fn report_from_resolution_failure(
    ...
    PackageCapstoneCertificateLatestReport {
        ...
        latest_pinnacle_receipt_plan_verdict: failure.latest_pinnacle_receipt_plan_verdict.clone(),
        latest_pinnacle_receipt_verdict: None,
        capstone_certificate_verdict: None,
        ...
        downstream_capstone_certificate_command_summary: snapshot.map(|value| {
            downstream_capstone_certificate_command_summary(
                value,
                &expected_downstream_pinnacle_receipt_session_dir(paths),
                &paths.nested_capstone_certificate_session_dir,
...
) -> PackageCapstoneCertificateLatestSession {
    let snapshot = resolved
        .map(|value| &value.snapshot)
        .or_else(|| failure.and_then(|value| value.snapshot.as_ref()));
    PackageCapstoneCertificateLatestSession {
        session_version: CAPSTONE_CERTIFICATE_LATEST_SESSION_VERSION.to_string(),
        planned_at: Utc::now(),
        root: root.display().to_string(),
        session_dir: session_dir.display().to_string(),
        nested_pinnacle_receipt_latest_session_dir: paths
        ...
        run_latest_pinnacle_receipt_command_summary: run_latest_pinnacle_receipt_command_summary(
            root,
            &paths.nested_pinnacle_receipt_latest_session_dir,
        ),
        verify_latest_pinnacle_receipt_command_summary:
        ...
        downstream_capstone_certificate_command_summary: snapshot
            .map(|value| {
                downstream_capstone_certificate_command_summary(
                    value,
                    &expected_downstream_pinnacle_receipt_session_dir(paths),
...
fn report_from_status(
    ...
    session_dir: &Path,
    paths: &PackageCapstoneCertificateLatestPaths,
    session: &PackageCapstoneCertificateLatestSession,
    status: &PackageCapstoneCertificateLatestStatus,
    verification_mismatches: Vec<String>,
) -> PackageCapstoneCertificateLatestReport {
    PackageCapstoneCertificateLatestReport {
        generated_at: Utc::now(),
        ...
        nested_pinnacle_receipt_latest_session_dir: Some(
            session.nested_pinnacle_receipt_latest_session_dir.clone(),
        ),
        nested_capstone_certificate_session_dir: Some(
            session.nested_capstone_certificate_session_dir.clone(),
        ),
        downstream_decision_packet_session_dir: Some(
...
fn capstone_certificate_latest_paths(session_dir: &Path) -> PackageCapstoneCertificateLatestPaths {
    PackageCapstoneCertificateLatestPaths {
        session_path: session_dir
            .join("tiny_live_activation_package_capstone_certificate_latest.session.json"),
        status_path: session_dir
            .join("tiny_live_activation_package_capstone_certificate_latest.status.json"),
        report_path: session_dir
            .join("tiny_live_activation_package_capstone_certificate_latest.report.json"),
        latest_pinnacle_receipt_plan_report_path: session_dir.join(
            "tiny_live_activation_package_capstone_certificate_latest.pinnacle_receipt_latest_plan.report.json",
        ),
        latest_pinnacle_receipt_report_path: session_dir.join(
            "tiny_live_activation_package_capstone_certificate_latest.pinnacle_receipt_latest.report.json",
        ),
        capstone_certificate_report_path: session_dir.join(
            "tiny_live_activation_package_capstone_certificate_latest.pinnacle_receipt.report.json",
        ),
        nested_pinnacle_receipt_latest_session_dir: session_dir
            .join("tiny_live_activation_package_capstone_certificate_latest.pinnacle_receipt_latest_session"),
        nested_capstone_certificate_session_dir: session_dir.join(
            "tiny_live_activation_package_capstone_certificate_latest.pinnacle_receipt_session",
        ),
    }
}
...
fn expected_downstream_decision_packet_session_dir(
    ...
    paths
        .nested_pinnacle_receipt_latest_session_dir
        .join("tiny_live_activation_package_pinnacle_receipt_latest.decision_packet_session")
}

fn expected_downstream_pinnacle_receipt_session_dir(
    paths: &PackageCapstoneCertificateLatestPaths,
) -> PathBuf {
    paths
        .nested_pinnacle_receipt_latest_session_dir
        .join("tiny_live_activation_package_pinnacle_receipt_latest.pinnacle_receipt_session")
}
...
fn expected_downstream_review_receipt_session_dir(
    ...
    paths
        .nested_pinnacle_receipt_latest_session_dir
        .join("tiny_live_activation_package_pinnacle_receipt_latest.review_receipt_session")
}

fn latest_pinnacle_receipt_plan_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--plan-latest-pinnacle-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn latest_pinnacle_receipt_run_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-latest-pinnacle-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn latest_pinnacle_receipt_verify_args(session_dir: &Path) -> Vec<String> {
    vec![
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-latest-pinnacle-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn capstone_certificate_run_args(
    snapshot: &LatestCulminationReceiptSnapshot,
    pinnacle_receipt_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        "--pinnacle-receipt-session-dir".to_string(),
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-live-package-capstone-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn capstone_certificate_verify_args(
    snapshot: &LatestCulminationReceiptSnapshot,
    pinnacle_receipt_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-live-package-capstone-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn resolve_latest_pinnacle_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{CULMINATION_RECEIPT_LATEST_BIN} --root {} --session-dir {} --plan-latest-pinnacle-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn run_latest_pinnacle_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{CULMINATION_RECEIPT_LATEST_BIN} --root {} --session-dir {} --run-latest-pinnacle-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn verify_latest_pinnacle_receipt_command_summary(session_dir: &Path) -> String {
    format!(
        "{CULMINATION_RECEIPT_LATEST_BIN} --session-dir {} --verify-latest-pinnacle-receipt --json",
        shell_escape_path(session_dir),
    )
}

fn downstream_capstone_certificate_command_summary(
    snapshot: &LatestCulminationReceiptSnapshot,
    pinnacle_receipt_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{CAPSTONE_CERTIFICATE_BIN} --pinnacle-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --run-live-package-capstone-certificate --json",
        shell_escape_path(pinnacle_receipt_session_dir),
        shell_escape_path(&snapshot.downstream_decision_packet_session_dir),
        shell_escape_path(session_dir),
    )
}

fn verify_capstone_certificate_command_summary(
    snapshot: &LatestCulminationReceiptSnapshot,
    pinnacle_receipt_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{CAPSTONE_CERTIFICATE_BIN} --pinnacle-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --verify-live-package-capstone-certificate --json",
        shell_escape_path(pinnacle_receipt_session_dir),
        shell_escape_path(&snapshot.downstream_decision_packet_session_dir),
        shell_escape_path(session_dir),
    )
...
fn nested_pinnacle_receipt_latest_report_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_pinnacle_receipt_latest.report.json")
}

fn nested_capstone_certificate_session_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_capstone_certificate.session.json")
}

fn nested_capstone_certificate_status_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_capstone_certificate.status.json")
}
...
fn write_script(path: &Path, contents: &str) -> Result<()> {
    ...
    fs::write(path, contents).with_context(|| {
        format!(
            "failed writing latest-capstone-certificate script to {}",
            path.display()
        )
    })?;
    #[cfg(unix)]
...
fn step_artifact(
    ...
    reason: &str,
    generated_at: DateTime<Utc>,
) -> PackageCapstoneCertificateLatestStepArtifact {
    PackageCapstoneCertificateLatestStepArtifact {
...
fn canonical_wrapper_mode(mode: &str) -> &str {
    match mode {
        "plan_latest_capstone_certificate" => "plan_latest_capstone_certificate",
        "render_latest_capstone_certificate_script" => "render_latest_capstone_certificate_script",
        "run_latest_capstone_certificate" => "run_latest_capstone_certificate",
        "verify_latest_capstone_certificate" => "verify_latest_capstone_certificate",
        other => other,
    }
}

fn load_required_step_json<T: for<'de> Deserialize<'de>>(
    step: &Option<PackageCapstoneCertificateLatestStepArtifact>,
    expected_path: &Path,
    label: &str,
    ...
    let step = step
        .as_ref()
        .ok_or_else(|| anyhow!("{label} is missing from latest-capstone-certificate status"))?;
    compare_string(
        &step.path,
...
fn compare_step_artifact_against_report_metadata(
    ...
    let Some(step) = step else {
        mismatches.push(format!(
            "{label} is missing from latest-capstone-certificate status"
        ));
        return;
    };
    compare_string(
...
fn compare_pinnacle_receipt_latest_plan_against_snapshot(
    stored: &CapstoneCertificateLatestReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        ...
        "stored latest-pinnacle-receipt plan verdict",
        mismatches,
    );
    compare_string(
        &stored.mode,
        "plan_latest_pinnacle_receipt",
        "stored latest-pinnacle-receipt plan mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-pinnacle-receipt plan latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        ...
        "stored latest-pinnacle-receipt plan latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-pinnacle-receipt plan session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        ...
        "stored latest-pinnacle-receipt plan reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-pinnacle-receipt plan clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-pinnacle-receipt plan clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-pinnacle-receipt plan clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_pinnacle_receipt_latest_run_against_snapshot(
    stored: &CapstoneCertificateLatestReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_latest_pinnacle_receipt",
        "stored latest-pinnacle-receipt run mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-pinnacle-receipt run latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        ...
        "stored latest-pinnacle-receipt run latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-pinnacle-receipt run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        ...
        "stored latest-pinnacle-receipt run downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored latest-pinnacle-receipt run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored latest-pinnacle-receipt run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored latest-pinnacle-receipt run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored latest-pinnacle-receipt run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored latest-pinnacle-receipt run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored latest-pinnacle-receipt run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored latest-pinnacle-receipt run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-pinnacle-receipt run clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-pinnacle-receipt run clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-pinnacle-receipt run clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_pinnacle_receipt_latest_copy_matches_actual(
    stored: &CapstoneCertificateLatestReportView,
    actual: &CapstoneCertificateLatestReportView,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        Some(stored.verdict.as_str()),
        Some(actual.verdict.as_str()),
        "stored latest-pinnacle-receipt copy verdict",
        mismatches,
    );
    compare_option_string(
        Some(stored.reason.as_str()),
        Some(actual.reason.as_str()),
        "stored latest-pinnacle-receipt copy reason",
        mismatches,
    );
    if stored.generated_at != actual.generated_at {
        mismatches.push(format!(
            "stored latest-pinnacle-receipt copy generated_at {:?} does not match actual {:?}",
    ...
    compare_option_string(
        ...
        "stored latest-pinnacle-receipt copy latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        actual.latest_top_session_dir.as_deref(),
        "stored latest-pinnacle-receipt copy latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        actual.session_dir.as_deref(),
        "stored latest-pinnacle-receipt copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        actual.downstream_decision_packet_session_dir.as_deref(),
        "stored latest-pinnacle-receipt copy downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        actual.result.as_deref(),
        "stored latest-pinnacle-receipt copy result",
        mismatches,
    );
    compare_option_string(
        stored.explicit_statement.as_deref(),
        actual.explicit_statement.as_deref(),
        "stored latest-pinnacle-receipt copy explicit_statement",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        actual.current_pre_activation_gate_verdict.as_deref(),
        "stored latest-pinnacle-receipt copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        actual.current_pre_activation_gate_reason.as_deref(),
        "stored latest-pinnacle-receipt copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        actual
            .reviewed_frozen_live_cutover_controller_command_summary
            .as_deref(),
        "stored latest-pinnacle-receipt copy reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}
...
fn compare_capstone_certificate_run_against_snapshot(
    ...
    compare_string(
        &stored.mode,
        "run_live_package_capstone_certificate",
        "stored capstone-certificate run mode",
        mismatches,
    );
    compare_string(
        &stored.pinnacle_receipt_session_dir,
        &pinnacle_receipt_session_dir.display().to_string(),
        "stored capstone-certificate run pinnacle_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        stored.capstone_certificate_session_path.as_deref(),
        Some(
            nested_capstone_certificate_session_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored capstone-certificate run capstone_certificate_session_path",
        mismatches,
    );
    compare_option_string(
        stored.capstone_certificate_status_path.as_deref(),
        Some(
            nested_capstone_certificate_status_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored capstone-certificate run capstone_certificate_status_path",
        mismatches,
    );
    compare_option_string(
        stored.archived_pinnacle_receipt_report_path.as_deref(),
        Some(
            session_dir
        ...
        "stored capstone-certificate run archived_pinnacle_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        stored.verify_pinnacle_receipt_command_summary.as_deref(),
        Some(
            summit_certificate_verify_pinnacle_receipt_command_summary(
                pinnacle_receipt_session_dir,
            )
            .as_str(),
        ),
        "stored capstone-certificate run verify_pinnacle_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
...
fn compare_capstone_certificate_copy_against_nested_truth(
    ...
    compare_option_string(
        ...
        "stored capstone-certificate copy verify_pinnacle_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
    ...
    compare_option_string(
        ...
        "stored capstone-certificate copy release_capsule_digest_manifest_sha256",
        mismatches,
    );
...
fn compare_session_against_snapshot(
    ...
    compare_string(
        &session.resolve_latest_pinnacle_receipt_command_summary,
        &resolve_latest_pinnacle_receipt_command_summary(
            root,
            &paths.nested_pinnacle_receipt_latest_session_dir,
        ),
        "stored session resolve_latest_pinnacle_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.run_latest_pinnacle_receipt_command_summary,
        &run_latest_pinnacle_receipt_command_summary(
            root,
            &paths.nested_pinnacle_receipt_latest_session_dir,
        ),
        "stored session run_latest_pinnacle_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_latest_pinnacle_receipt_command_summary,
        &verify_latest_pinnacle_receipt_command_summary(
            &paths.nested_pinnacle_receipt_latest_session_dir,
        ),
        "stored session verify_latest_pinnacle_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.downstream_capstone_certificate_command_summary,
        &downstream_capstone_certificate_command_summary(
            snapshot,
            &expected_downstream_pinnacle_receipt_session_dir(paths),
            &paths.nested_capstone_certificate_session_dir,
        ),
        "stored session downstream_capstone_certificate_command_summary",
        mismatches,
    );
    compare_string(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_pinnacle_receipt_latest_session_dir",
        mismatches,
    );
    compare_string(
        &session.nested_capstone_certificate_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_capstone_certificate_session_dir",
        mismatches,
    );
    compare_string(
        &session.downstream_decision_packet_session_dir,
...
fn compare_report_against_snapshot(
    report: &PackageCapstoneCertificateLatestReport,
    root: &Path,
    session_dir: &Path,
    paths: &PackageCapstoneCertificateLatestPaths,
    snapshot: &LatestCulminationReceiptSnapshot,
    ...
    compare_option_string(
        ...
        "stored report resolve_latest_pinnacle_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report run_latest_pinnacle_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report verify_latest_pinnacle_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report downstream_capstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
    ...
    compare_option_string(
        report.capstone_certificate_latest_session_path.as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "stored report capstone_certificate_latest_session_path",
        mismatches,
    );
    compare_option_string(
        report.capstone_certificate_latest_status_path.as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "stored report capstone_certificate_latest_status_path",
        mismatches,
    );
    compare_option_string(
        report.capstone_certificate_latest_report_path.as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "stored report capstone_certificate_latest_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_pinnacle_receipt_plan_report_path.as_deref(),
        Some(
            paths
                .latest_pinnacle_receipt_plan_report_path
                .display()
        ...
        "stored report latest_pinnacle_receipt_plan_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_pinnacle_receipt_report_path.as_deref(),
        Some(
            paths
                .latest_pinnacle_receipt_report_path
                .display()
        ...
        "stored report latest_pinnacle_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        report.capstone_certificate_report_path.as_deref(),
        Some(
            paths
                .capstone_certificate_report_path
                .display()
                .to_string()
                .as_str(),
        ),
        "stored report capstone_certificate_report_path",
        mismatches,
    );
    compare_option_string(
        report.nested_pinnacle_receipt_latest_session_dir.as_deref(),
        Some(
            paths
                .nested_pinnacle_receipt_latest_session_dir
                .display()
        ...
        "stored report nested_pinnacle_receipt_latest_session_dir",
        mismatches,
    );
    compare_option_string(
        report.nested_capstone_certificate_session_dir.as_deref(),
        Some(
            paths
                .nested_capstone_certificate_session_dir
                .display()
        ...
        "stored report nested_capstone_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
...
fn compare_session_against_failure(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_pinnacle_receipt_latest_session_dir on failure",
        mismatches,
    );
    compare_string(
        &session.nested_capstone_certificate_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_capstone_certificate_session_dir on failure",
        mismatches,
    );
...
fn map_pinnacle_receipt_latest_failure_kind(verdict: &str) -> ResolutionFailureKind {
    match verdict {
        "tiny_live_package_pinnacle_receipt_latest_refused_by_missing_latest_chain" => {
            ResolutionFailureKind::MissingLatestChain
        }
        "tiny_live_package_pinnacle_receipt_latest_refused_by_drifted_pinnacle_receipt_contract" => {
...
fn latest_pinnacle_receipt_terminal_failure(
    report: &CapstoneCertificateLatestReportView,
) -> Option<LivePackageCapstoneCertificateLatestResult> {
    match report.result.as_deref() {
        Some("refused_by_missing_latest_chain") => {
            Some(LivePackageCapstoneCertificateLatestResult::RefusedByMissingLatestChain)
        }
        Some("refused_by_invalid_latest_chain") => {
            Some(LivePackageCapstoneCertificateLatestResult::RefusedByInvalidLatestChain)
        }
        Some("refused_by_drifted_pinnacle_receipt_contract") => Some(
            LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract,
        ),
        _ => None,
    }
...
fn pinnacle_receipt_latest_result_from_nested_status(
    result: &str,
) -> Option<LivePackageCapstoneCertificateLatestResult> {
    match result {
        "ready_for_manual_execution_when_gate_turns_green" => Some(
            LivePackageCapstoneCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen,
        ),
        "refused_now_by_stage3" => {
            Some(LivePackageCapstoneCertificateLatestResult::RefusedNowByStage3)
        }
        "refused_now_by_pre_activation_gate" => {
            Some(LivePackageCapstoneCertificateLatestResult::RefusedNowByPreActivationGate)
        }
...
fn pinnacle_receipt_run_verdict_for_result(result: &str) -> Option<&'static str> {
    match result {
        ...
        "refused_now_by_stage3" => Some("tiny_live_package_capstone_certificate_refused_now_by_stage3"),
        "refused_now_by_pre_activation_gate" => {
            Some("tiny_live_package_capstone_certificate_refused_now_by_pre_activation_gate")
        }
        "refused_now_by_invalid_or_drifted_contract" => {
            Some("tiny_live_package_capstone_certificate_refused_now_by_invalid_or_drifted_contract")
        }
        _ => None,
    }
}
...
fn result_from_failure_kind(
    kind: ResolutionFailureKind,
) -> LivePackageCapstoneCertificateLatestResult {
    match kind {
        ResolutionFailureKind::MissingLatestChain => {
            LivePackageCapstoneCertificateLatestResult::RefusedByMissingLatestChain
        }
        ResolutionFailureKind::InvalidLatestChain => {
            LivePackageCapstoneCertificateLatestResult::RefusedByInvalidLatestChain
        }
        ResolutionFailureKind::DriftedCapstoneCertificateContract => {
            LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract
        }
...
fn verdict_for_result(
    result: LivePackageCapstoneCertificateLatestResult,
) -> TinyLivePackageCapstoneCertificateLatestVerdict {
    match result {
        LivePackageCapstoneCertificateLatestResult::RefusedByMissingLatestChain => {
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestRefusedByMissingLatestChain
        }
        LivePackageCapstoneCertificateLatestResult::RefusedByInvalidLatestChain => {
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestRefusedByInvalidLatestChain
        }
        LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract => {
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestRefusedByDriftedCapstoneCertificateContract
        }
        LivePackageCapstoneCertificateLatestResult::RefusedNowByStage3 => {
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestRefusedNowByStage3
        }
        LivePackageCapstoneCertificateLatestResult::RefusedNowByPreActivationGate => {
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestRefusedNowByPreActivationGate
        }
        LivePackageCapstoneCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestReadyForManualExecutionWhenGateTurnsGreen
        }
    }
}
...
fn operator_next_action_summary(result: LivePackageCapstoneCertificateLatestResult) -> String {
    match result {
        LivePackageCapstoneCertificateLatestResult::RefusedByMissingLatestChain => {
        ...
        LivePackageCapstoneCertificateLatestResult::RefusedByInvalidLatestChain => {
            "the latest immutable chain is incomplete or below the accepted clerestory layer; mint a fresh coherent clerestory chain instead of bypassing the accepted latest-capstone-certificate / pinnacle-receipt path".to_string()
        }
        LivePackageCapstoneCertificateLatestResult::RefusedByDriftedCapstoneCertificateContract => {
            "the latest chain no longer resolves cleanly into the accepted latest-capstone-certificate / pinnacle-receipt contract; repair that drift instead of bypassing the bounded handoff path".to_string()
        }
        LivePackageCapstoneCertificateLatestResult::RefusedNowByStage3 => {
            "the frozen controller stays refused now by Stage 3; rerun this latest-capstone-certificate refresh after current Stage 3 truth turns green".to_string()
        }
        LivePackageCapstoneCertificateLatestResult::RefusedNowByPreActivationGate => {
            "the frozen controller stays refused now by the pre-activation gate; rerun this latest-capstone-certificate refresh after the current pre-activation gate turns green".to_string()
        }
        LivePackageCapstoneCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            "the latest immutable chain now resolves into the accepted capstone-certificate contract and one bounded latest-capstone-certificate handoff is ready for manual execution when gate truth turns green; this wrapper still did not run or authorize the frozen controller".to_string()
        }
    }
}
...
fn summit_certificate_verify_pinnacle_receipt_command_summary(
    pinnacle_receipt_session_dir: &Path,
) -> String {
    format!(
...
fn refusal_status(
    ...
    latest_pinnacle_receipt_step: Option<PackageCapstoneCertificateLatestStepArtifact>,
    capstone_certificate_step: Option<PackageCapstoneCertificateLatestStepArtifact>,
) -> PackageCapstoneCertificateLatestStatus {
    ...
    PackageCapstoneCertificateLatestStatus {
        ...
        result,
        reason,
        latest_pinnacle_receipt_plan_verdict: resolved
            .map(|value| value.latest_pinnacle_receipt_plan.verdict.clone()),
        latest_pinnacle_receipt_verdict: latest_pinnacle_receipt_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        capstone_certificate_verdict: capstone_certificate_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
...
fn refusal_status_from_resolution_failure(
    ...
    PackageCapstoneCertificateLatestStatus {
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        latest_pinnacle_receipt_plan_step: failure.latest_pinnacle_receipt_plan_raw.as_ref().map(
            |_| {
                step_artifact(
                    &paths.latest_pinnacle_receipt_plan_report_path,
                    "plan_latest_pinnacle_receipt",
                    failure
                        ...
                        .unwrap_or("<missing>"),
                    failure
                        .latest_pinnacle_receipt_plan_reason
                        .as_deref()
                        .unwrap_or("<missing>"),
                    failure
                        .latest_pinnacle_receipt_plan_generated_at
                        .unwrap_or_else(Utc::now),
                )
            },
        ),
        latest_pinnacle_receipt_step: None,
...
fn verify_invalid_capstone_certificate_latest_report_without_session(
    session_dir: &Path,
    verification_mismatches: Vec<String>,
) -> PackageCapstoneCertificateLatestReport {
    ...
    PackageCapstoneCertificateLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_capstone_certificate".to_string(),
        verdict: TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestVerifyInvalid,
        reason,
        root: None,
        ...
        session_dir: Some(session_dir.display().to_string()),
        capstone_certificate_latest_session_path: Some(
            capstone_certificate_latest_paths(session_dir)
                .session_path
                .display()
                .to_string(),
        ),
        capstone_certificate_latest_status_path: Some(
            capstone_certificate_latest_paths(session_dir)
                .status_path
                .display()
                .to_string(),
        ),
        capstone_certificate_latest_report_path: Some(
            capstone_certificate_latest_paths(session_dir)
                .report_path
                .display()
                .to_string(),
        ),
        latest_pinnacle_receipt_plan_report_path: None,
        latest_pinnacle_receipt_report_path: None,
        capstone_certificate_report_path: None,
        nested_pinnacle_receipt_latest_session_dir: None,
        nested_capstone_certificate_session_dir: None,
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_pinnacle_receipt_command_summary: None,
        run_latest_pinnacle_receipt_command_summary: None,
        verify_latest_pinnacle_receipt_command_summary: None,
        downstream_capstone_certificate_command_summary: None,
...
fn fallback_pinnacle_receipt_latest_copy() -> CapstoneCertificateLatestReportView {
    CapstoneCertificateLatestReportView {
        generated_at: Utc::now(),
...
fn fallback_notarization_receipt_session(
    ...
    CapstoneCertificateSessionView {
        pinnacle_receipt_session_dir: "<missing>".to_string(),
        ...
        session_dir: session_dir.display().to_string(),
        verify_pinnacle_receipt_command_summary:
            summit_certificate_verify_pinnacle_receipt_command_summary(Path::new("<missing>")),
...
fn render_report_lines(report: &PackageCapstoneCertificateLatestReport) -> String {
    let mut lines = vec![
    ...
    if let Some(value) = &report.nested_pinnacle_receipt_latest_session_dir {
        lines.push(format!(
            "nested_pinnacle_receipt_latest_session_dir={value}"
        ));
    }
    ...
    if let Some(value) = &report.nested_capstone_certificate_session_dir {
        lines.push(format!("nested_capstone_certificate_session_dir={value}"));
    }
    if let Some(value) = &report.result {
        lines.push(format!("result={value}"));
    }
    if let Some(value) = &report.downstream_capstone_certificate_command_summary {
        lines.push(format!(
            "downstream_capstone_certificate_command_summary={value}"
        ));
    }
...
mod tests {
    ...
    struct FakeNotarizationReceiptLatestFixture {
        ...
        pinnacle_receipt_latest_plan_json_path: PathBuf,
        pinnacle_receipt_latest_run_json_path: PathBuf,
        pinnacle_receipt_latest_verify_json_path: PathBuf,
    ...
    impl FakeNotarizationReceiptLatestFixture {
        fn plan_config(&self) -> Config {
            Config {
                mode: Mode::PlanLatestCapstoneCertificate,
        ...
        fn render_config(&self) -> Config {
            Config {
                mode: Mode::RenderLatestCapstoneCertificateScript,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
        ...
        fn run_config(&self) -> Config {
            Config {
                mode: Mode::RunLatestCapstoneCertificate,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
        ...
        fn verify_config(&self) -> Config {
            Config {
                mode: Mode::VerifyLatestCapstoneCertificate,
                root: None,
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
    ...
    #[test]
    fn plan_mode_resolves_latest_valid_clerestory_chain_to_exact_expected_nested_latest_pinnacle_receipt_lineage(
    ) {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_plan_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let report = plan_latest_capstone_certificate_report(&fixture.plan_config()).unwrap();
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        assert_eq!(
            report.verdict,
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestPlanReady
        );
        assert_eq!(report.mode, "plan_latest_capstone_certificate");
        assert_eq!(
            report.latest_top_step_name.as_deref(),
        ...
        assert!(report
            ...
            .as_deref()
            .unwrap()
            .contains(CAPSTONE_CERTIFICATE_BIN));
    }
    ...
    fn render_mode_emits_exact_downstream_provenance_certificate_contract_not_second_controller_path(
        ...
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_render_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let report =
            render_latest_capstone_certificate_script_report(&fixture.render_config()).unwrap();
        assert_eq!(
            report.verdict,
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestScriptRendered
        );
        assert_eq!(report.mode, "render_latest_capstone_certificate_script");
        let script = fs::read_to_string(&fixture.output_script_path).unwrap();
        assert!(script.contains(CULMINATION_RECEIPT_LATEST_BIN));
        assert!(script.contains(CAPSTONE_CERTIFICATE_BIN));
        assert!(script.contains("--pinnacle-receipt-session-dir"));
        assert!(!script.contains("--activation-ticket-session-dir"));
        assert!(script.contains("--run-live-package-capstone-certificate"));
        assert!(script.contains("--verify-live-package-capstone-certificate"));
    ...
    fn run_mode_refuses_when_latest_chain_missing_invalid_or_below_clerestory() {
        for (label, verdict, reason, expected) in [
            (
                "pinnacle_receipt_latest_missing",
                "tiny_live_package_pinnacle_receipt_latest_refused_by_missing_latest_chain",
                "no persisted immutable chain exists",
                TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestRefusedByMissingLatestChain,
            ),
            (
                "pinnacle_receipt_latest_invalid",
                "tiny_live_package_pinnacle_receipt_latest_refused_by_invalid_latest_chain",
                "latest immutable chain is incomplete",
                TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestRefusedByInvalidLatestChain,
            ),
            (
                "pinnacle_receipt_latest_below",
                "tiny_live_package_pinnacle_receipt_latest_refused_by_invalid_latest_chain",
            ...
            let mut plan: Value = load_json(&fixture.pinnacle_receipt_latest_plan_json_path).unwrap();
            plan["verdict"] = json!(verdict);
            plan["reason"] = json!(reason);
            if label.ends_with("below") {
                plan["latest_top_step_name"] = json!("choir_receipt");
            }
            persist_json(&fixture.pinnacle_receipt_latest_plan_json_path, &plan).unwrap();

            let report = run_latest_capstone_certificate_report(&fixture.run_config()).unwrap();
            assert_eq!(report.verdict, expected);
        }
    }

    #[test]
    fn plan_mode_maps_real_latest_pinnacle_receipt_drift_verdict_to_local_drift_refusal() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_plan_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        plan["reason"] = json!("real accepted latest-pinnacle-receipt drift");
        persist_json(&fixture.pinnacle_receipt_latest_plan_json_path, &plan).unwrap();
    ...
    #[test]
    fn run_mode_takes_terminal_drift_refusal_when_nested_latest_pinnacle_receipt_reports_real_drift(
    ) {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_run_drift",
            "refused_by_drifted_pinnacle_receipt_contract",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert_eq!(report.capstone_certificate_verdict.as_deref(), None);
    }

    #[test]
    fn run_mode_refuses_when_nested_release_capsule_lineage_drifts_from_latest_immutable_chain() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_handoff_bundle_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let mut run: Value = load_json(&fixture.pinnacle_receipt_latest_run_json_path).unwrap();
        run["package_dir"] = json!("/tampered/package");
        persist_json(&fixture.pinnacle_receipt_latest_run_json_path, &run).unwrap();
        ...
        assert!(report
            .reason
            .contains("stored latest-pinnacle-receipt run package_dir"));
    }

    #[test]
    fn verify_mode_fails_when_persisted_latest_pinnacle_receipt_artifacts_are_tampered_or_missing_nested_lineage_truth(
    ) {
        {
            let fixture = fake_pinnacle_receipt_latest_fixture(
                "pinnacle_receipt_latest_verify_tampered_copy",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            run_latest_capstone_certificate_report(&fixture.run_config()).unwrap();

            let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
            let mut report: Value = load_json(&paths.capstone_certificate_report_path).unwrap();
            ...
            let verify =
                verify_latest_capstone_certificate_report(&fixture.verify_config()).unwrap();
            assert_eq!(
                verify.verdict,
                TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestVerifyInvalid
            );
        ...
        {
            let fixture = fake_pinnacle_receipt_latest_fixture(
                "pinnacle_receipt_latest_verify_missing_nested_truth",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            ...
            let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
            fs::remove_file(nested_pinnacle_receipt_latest_report_path(
                &paths.nested_pinnacle_receipt_latest_session_dir,
            ))
            .unwrap();
            ...
            assert!(verify.verification_mismatches.iter().any(|entry| {
                entry.contains("tiny_live_activation_package_pinnacle_receipt_latest.report.json")
            }));
        }
    }
    ...
    fn verify_accepts_real_shaped_native_consummation_identity_layers_on_happy_path() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_real_shaped_finality_paths_green",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let verify = verify_latest_capstone_certificate_report(&fixture.verify_config()).unwrap();
        assert_eq!(
            verify.verdict,
            TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestVerifyOk,
            "{:#?}",
    ...
    fn verify_names_pinnacle_receipt_when_nested_native_session_load_breaks() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_nested_pinnacle_session_load_break",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        fs::remove_file(nested_capstone_certificate_session_path(
            &paths.nested_capstone_certificate_session_dir,
        ))
        .unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("failed reading nested capstone-certificate session under")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_capstone_certificate_session_path_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_finality_session_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.capstone_certificate_report_path).unwrap();
        report["capstone_certificate_session_path"] =
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate run capstone_certificate_session_path")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_capstone_certificate_status_path_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_finality_status_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.capstone_certificate_report_path).unwrap();
        report["capstone_certificate_status_path"] =
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate run capstone_certificate_status_path")
        }));
    }
    ...
    fn verify_fails_when_copied_native_pinnacle_receipt_sha256_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_pinnacle_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy pinnacle_receipt_sha256")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_latest_pinnacle_receipt_explicit_statement_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_launch_packet_explicit_statement_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.latest_pinnacle_receipt_report_path).unwrap();
        report["explicit_statement"] =
            json!("tampered nested latest release capsule explicit statement");
        persist_json(&paths.latest_pinnacle_receipt_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored latest-pinnacle-receipt copy explicit_statement")
        }));
    }

    #[test]
    fn verify_rejects_tampered_stale_pinnacle_receipt_wrapper_mode_string() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_wrapper_mode_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        report["mode"] = json!("run_latest_pinnacle_receipt");
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| { entry.contains("latest-capstone-certificate stored report mode") }));
    }

    #[test]
    fn downstream_native_pinnacle_session_dir_uses_real_pinnacle_receipt_session_path() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_downstream_session_dir_shape",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);

        let downstream = expected_downstream_pinnacle_receipt_session_dir(&paths);
        let expected = paths
            .nested_pinnacle_receipt_latest_session_dir
            .join("tiny_live_activation_package_pinnacle_receipt_latest.pinnacle_receipt_session");
        ...
        assert!(downstream
            ...
            .unwrap()
            .to_string_lossy()
            .contains("pinnacle_receipt_session"));
        assert!(!downstream
            .file_name()
            .unwrap()
            .to_string_lossy()
    ...
    fn run_persists_copied_native_capstone_session_and_status_under_real_capstone_filenames() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_native_capstone_filenames",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let real_session = nested_capstone_certificate_session_path(
            &paths.nested_capstone_certificate_session_dir,
        );
        let real_status =
            nested_capstone_certificate_status_path(&paths.nested_capstone_certificate_session_dir);
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_decision_packet_result_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_decision_packet_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy decision_packet_result")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_attestation_seal_session_dir_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_attestation_seal_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy attestation_seal_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_registry_entry_session_dir_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_registry_entry_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy registry_entry_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_notarization_receipt_session_dir_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_notarization_receipt_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy notarization_receipt_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_summary_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_chain_fingerprint_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy chain_fingerprint_summary")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_sha256_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_chain_fingerprint_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy chain_fingerprint_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_algorithm_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_chain_fingerprint_algorithm_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy chain_fingerprint_algorithm")
        }));
    }
    ...
    fn verify_fails_when_copied_native_completion_certificate_closure_certificate_sha256_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_closure_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy closure_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_archive_receipt_sha256_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_archive_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy archive_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_finality_receipt_sha256_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_finality_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy finality_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_consummation_record_sha256_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_consummation_record_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy consummation_record_sha256")
        }));
    }
    ...
    {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_completion_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy completion_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_downstream_decision_packet_confirmation_anchor_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_decision_packet_anchor_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy decision_packet_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_execute_frozen_result_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_current_authorization_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored capstone-certificate copy execute_frozen_result")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_capstone_certificate_verdict_drifts() {
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_release_capsule_verdict_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| entry.contains("stored capstone-certificate copy verdict")));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_current_live_cutover_controller_summary_drifts(
        ...
        let fixture = fake_pinnacle_receipt_latest_fixture(
            "pinnacle_receipt_latest_verify_current_live_cutover_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn all_modes_preserve_stage3_and_pre_activation_refusal_semantics_and_do_not_imply_activation_authorization_by_themselves(
        ...
        {
            let fixture = fake_pinnacle_receipt_latest_fixture(
                "pinnacle_receipt_latest_stage3",
                "refused_now_by_stage3",
                "refused_now_by_stage3",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);

            let plan = plan_latest_capstone_certificate_report(&fixture.plan_config()).unwrap();
            assert_eq!(
                plan.verdict,
                TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestPlanReady
            );
            assert_eq!(plan.mode, "plan_latest_capstone_certificate");
            assert!(!plan.activation_authorized);

            let run = run_latest_capstone_certificate_report(&fixture.run_config()).unwrap();
            assert_eq!(
                run.verdict,
                TinyLivePackageCapstoneCertificateLatestVerdict::TinyLivePackageCapstoneCertificateLatestRefusedNowByStage3
            );
            assert_eq!(run.mode, "run_latest_capstone_certificate");
            ...
            assert_eq!(verify.mode, "verify_latest_capstone_certificate");
            assert!(!verify.activation_authorized);
        }

        {
            let fixture = fake_pinnacle_receipt_latest_fixture(
                "pinnacle_receipt_latest_pre_activation",
                "refused_now_by_pre_activation_gate",
                "refused_now_by_pre_activation_gate",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn fake_pinnacle_receipt_latest_fixture(
        label: &str,
        pinnacle_receipt_latest_run_result: &str,
        ...
        let pinnacle_receipt_latest_plan_json_path =
            temp_dir.join("pinnacle_receipt_latest.plan.json");
        let pinnacle_receipt_latest_run_json_path =
            temp_dir.join("pinnacle_receipt_latest.run.json");
        let pinnacle_receipt_latest_verify_json_path =
            temp_dir.join("pinnacle_receipt_latest.verify.json");
        ...
        let fixture = FakeNotarizationReceiptLatestFixture {
            ...
            install_root,
            backend_command,
            pinnacle_receipt_latest_plan_json_path,
            pinnacle_receipt_latest_run_json_path,
            pinnacle_receipt_latest_verify_json_path,
        ...
        persist_json(
            &fixture.pinnacle_receipt_latest_plan_json_path,
            &default_pinnacle_receipt_latest_plan_report(&fixture),
        )
        .unwrap();
        persist_json(
            &fixture.pinnacle_receipt_latest_run_json_path,
            &default_pinnacle_receipt_latest_run_report(
                &fixture,
                pinnacle_receipt_latest_run_result,
            ),
        )
        .unwrap();
        persist_json(
            &fixture.pinnacle_receipt_latest_verify_json_path,
            &default_pinnacle_receipt_latest_verify_report(
                &fixture,
                pinnacle_receipt_latest_run_result,
            ),
        )
        ...
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        write_fake_pinnacle_receipt_latest_command(
        ...
        write_fake_release_capsule_command(
            &fixture.bin_dir.join(CAPSTONE_CERTIFICATE_BIN),
            &fixture.handoff_bundle_run_json_path,
            &fixture.handoff_bundle_verify_json_path,
            &fixture.handoff_bundle_session_json_path,
            &fixture.handoff_bundle_status_json_path,
    ...
    fn default_pinnacle_receipt_latest_plan_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
    ) -> Value {
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        json!({
            "generated_at": Utc::now(),
            "mode": "plan_latest_pinnacle_receipt",
            "verdict": CULMINATION_RECEIPT_LATEST_PLAN_READY,
            "reason": "latest immutable chain resolves cleanly into accepted latest-pinnacle-receipt contract",
            ...
            "session_dir": paths.nested_pinnacle_receipt_latest_session_dir.display().to_string(),
            ...
            "activation_authorized": false,
            "explicit_statement": "latest pinnacle-receipt wrapper plan"
        })
    }

    fn canonical_pinnacle_receipt_latest_result(result: &str) -> &str {
        match result {
            "runnable_when_gate_truth_turns_green" => {
    ...
    fn default_pinnacle_receipt_latest_run_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let result = canonical_pinnacle_receipt_latest_result(result);
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let (verdict, gate_verdict, gate_reason) = match result {
            "ready_for_manual_execution_when_gate_turns_green" => (
                "tiny_live_package_pinnacle_receipt_latest_ready_for_manual_execution_when_gate_turns_green",
                Value::Null,
                Value::Null,
            ),
            "refused_now_by_stage3" => (
                "tiny_live_package_pinnacle_receipt_latest_refused_now_by_stage3",
                json!("blocked"),
                json!("stage3 blocked"),
            ),
            "refused_now_by_pre_activation_gate" => (
                "tiny_live_package_pinnacle_receipt_latest_refused_now_by_pre_activation_gate",
                json!("blocked"),
        ...
        json!({
            "generated_at": Utc::now(),
            "mode": "run_latest_pinnacle_receipt",
            "verdict": verdict,
            "reason": format!("latest pinnacle-receipt {result}"),
            "latest_top_step_name": "clerestory_certificate",
            "latest_top_session_dir": fixture.latest_top_session_dir.display().to_string(),
            "historical_execute_frozen_session_dir": fixture.historical_execute_frozen_session_dir.display().to_string(),
            "turn_green_session_dir": fixture.turn_green_session_dir.display().to_string(),
            ...
            "clerestory_certificate_algorithm": "sha256",
            "activation_authorized": false,
            "explicit_statement": "latest pinnacle-receipt wrapper run"
        })
    }

    fn default_pinnacle_receipt_latest_verify_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let mut report = default_pinnacle_receipt_latest_run_report(fixture, result);
        report["mode"] = json!("verify_latest_pinnacle_receipt");
    ...
    fn default_provenance_certificate_session(
        ...
        let paths = capstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let pinnacle_receipt_session_dir = expected_downstream_pinnacle_receipt_session_dir(&paths);
        ...
        json!({
            "session_version": "1",
            "planned_at": Utc::now(),
            "pinnacle_receipt_session_dir": pinnacle_receipt_session_dir.display().to_string(),
            ...
            "release_capsule_session_dir": pinnacle_receipt_session_dir.display().to_string(),
            ...
            "wrapper_timeout_ms": snapshot.wrapper_timeout_ms,
            "service_status_max_staleness_ms": snapshot.service_status_max_staleness_ms,
            "session_dir": capstone_certificate_latest_paths(&fixture.wrapper_session_dir).nested_capstone_certificate_session_dir.display().to_string(),
            "verify_pinnacle_receipt_command_summary": summit_certificate_verify_pinnacle_receipt_command_summary(&pinnacle_receipt_session_dir),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
    ...
    fn default_provenance_certificate_status(
        ...
        json!({
            "status_version": "1",
            "updated_at": Utc::now(),
            "session_dir": paths.nested_capstone_certificate_session_dir.display().to_string(),
            "pinnacle_receipt_session_dir": expected_downstream_pinnacle_receipt_session_dir(&paths).display().to_string(),
            "result": result,
            "reason": reason,
            ...
            "current_pre_activation_gate_verdict": gate_verdict,
            "current_pre_activation_gate_reason": gate_reason,
            "capstone_certificate_step": Value::Null,
    ...
    fn default_provenance_certificate_run_report(
        ...
        let capstone_certificate_verdict = match result {
            "ready_for_manual_execution_when_gate_turns_green" => {
                "tiny_live_package_capstone_certificate_ready_for_manual_execution_when_gate_turns_green"
            }
            "refused_now_by_stage3" => "tiny_live_package_capstone_certificate_refused_now_by_stage3",
            "refused_now_by_pre_activation_gate" => {
                "tiny_live_package_capstone_certificate_refused_now_by_pre_activation_gate"
            }
            _ => "tiny_live_package_capstone_certificate_refused_now_by_invalid_or_drifted_contract",
        };
        json!({
            "generated_at": Utc::now(),
            "mode": "run_live_package_capstone_certificate",
            "verdict": capstone_certificate_verdict,
            ...
            "release_capsule_session_dir": expected_downstream_pinnacle_receipt_session_dir(&paths).display().to_string(),
            ...
            "service_status_max_staleness_ms": 4500,
            "session_dir": paths.nested_capstone_certificate_session_dir.display().to_string(),
            "capstone_certificate_session_path": nested_capstone_certificate_session_path(&paths.nested_capstone_certificate_session_dir).display().to_string(),
            "capstone_certificate_status_path": nested_capstone_certificate_status_path(&paths.nested_capstone_certificate_session_dir).display().to_string(),
            "archived_pinnacle_receipt_report_path": paths.nested_capstone_certificate_session_dir.join("tiny_live_activation_package_capstone_certificate.pinnacle_receipt.report.json").display().to_string(),
            "result": result,
            ...
            "capstone_certificate_step": Value::Null,
            "verify_pinnacle_receipt_command_summary": summit_certificate_verify_pinnacle_receipt_command_summary(&expected_downstream_pinnacle_receipt_session_dir(&paths)),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
    ...
    fn default_provenance_certificate_verify_report(
        ...
        report["mode"] = json!("verify_live_package_capstone_certificate");
        report["verdict"] = json!(CAPSTONE_CERTIFICATE_VERIFY_OK);
        report["reason"] = json!("verify ok");
    ...
    fn write_fake_pinnacle_receipt_latest_command(
        path: &Path,
        plan_json_path: &Path,
        run_json_path: &Path,
        ...
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected latest-pinnacle-receipt session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --plan-latest-pinnacle-receipt \"*) mode='plan';;\n  *\" --run-latest-pinnacle-receipt \"*) mode='run';;\n  *\" --verify-latest-pinnacle-receipt \"*) mode='verify';;\n  *) echo 'unexpected latest-pinnacle-receipt mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  plan|run)\n    case \" $* \" in\n      *\" --root {} \"*) : ;;\n      *) echo 'unexpected root' >&2; exit 1;;\n    esac\n    ;;\nesac\ncase \"$mode\" in\n  plan) cat '{}';;\n  run) mkdir -p '{}'; cp '{}' '{}/tiny_live_activation_package_pinnacle_receipt_latest.report.json'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
            session_dir.display(),
            root.display(),
    ...
    fn write_fake_release_capsule_command(
        ...
        let nested_session_path = nested_capstone_certificate_session_path(session_dir);
        let nested_status_path = nested_capstone_certificate_status_path(session_dir);
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --pinnacle-receipt-session-dir {} \"*) : ;;\n  *) echo 'unexpected pinnacle-receipt-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --confirm-decision-packet-session-dir {} \"*) : ;;\n  *) echo 'unexpected confirm-decision-packet-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected capstone-certificate session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --run-live-package-capstone-certificate \"*) mode='run';;\n  *\" --verify-live-package-capstone-certificate \"*) mode='verify';;\n  *) echo 'unexpected capstone-certificate mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  run) mkdir -p '{}'; cp '{}' '{}'; cp '{}' '{}'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
