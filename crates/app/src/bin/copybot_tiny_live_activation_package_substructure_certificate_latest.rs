...
const USAGE: &str = "usage: copybot_tiny_live_activation_package_substructure_certificate_latest --root <path> [--session-dir <path>] [--output <path>] [--json] (--plan-latest-substructure-certificate | --render-latest-substructure-certificate-script | --run-latest-substructure-certificate | --verify-latest-substructure-certificate)";
const SUBSTRUCTURE_CERTIFICATE_LATEST_SESSION_VERSION: &str = "1";
const SUBSTRUCTURE_CERTIFICATE_LATEST_STATUS_VERSION: &str = "1";
const SUBSTRUCTURE_CERTIFICATE_LATEST_BIN: &str =
    "copybot_tiny_live_activation_package_substructure_certificate_latest";
const BASAL_RECEIPT_LATEST_BIN: &str = "copybot_tiny_live_activation_package_basal_receipt_latest";
const SUBSTRUCTURE_CERTIFICATE_BIN: &str =
    "copybot_tiny_live_activation_package_substructure_certificate";
const BASAL_RECEIPT_LATEST_PLAN_READY: &str = "tiny_live_package_basal_receipt_latest_plan_ready";
const BASAL_RECEIPT_LATEST_VERIFY_OK: &str = "tiny_live_package_basal_receipt_latest_verify_ok";
const SUBSTRUCTURE_CERTIFICATE_VERIFY_OK: &str =
...
enum Mode {
    PlanLatestSubstructureCertificate,
    RenderLatestSubstructureCertificateScript,
    RunLatestSubstructureCertificate,
    VerifyLatestSubstructureCertificate,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum TinyLivePackageSubstructureCertificateLatestVerdict {
    TinyLivePackageSubstructureCertificateLatestPlanReady,
    TinyLivePackageSubstructureCertificateLatestScriptRendered,
    TinyLivePackageSubstructureCertificateLatestRefusedByMissingLatestChain,
    TinyLivePackageSubstructureCertificateLatestRefusedByInvalidLatestChain,
    TinyLivePackageSubstructureCertificateLatestRefusedByDriftedSubstructureCertificateContract,
    TinyLivePackageSubstructureCertificateLatestRefusedNowByStage3,
    TinyLivePackageSubstructureCertificateLatestRefusedNowByPreActivationGate,
    TinyLivePackageSubstructureCertificateLatestReadyForManualExecutionWhenGateTurnsGreen,
    TinyLivePackageSubstructureCertificateLatestVerifyOk,
    TinyLivePackageSubstructureCertificateLatestVerifyInvalid,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum LivePackageSubstructureCertificateLatestResult {
    RefusedByMissingLatestChain,
    RefusedByInvalidLatestChain,
    RefusedByDriftedSubstructureCertificateContract,
    RefusedNowByStage3,
...
struct PackageSubstructureCertificateLatestStepArtifact {
    path: String,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageSubstructureCertificateLatestSession {
    session_version: String,
    planned_at: DateTime<Utc>,
    root: String,
    session_dir: String,
    nested_basal_receipt_latest_session_dir: String,
    nested_substructure_certificate_session_dir: String,
    ...
    resolve_latest_basal_receipt_command_summary: String,
    run_latest_substructure_certificate_command_summary: String,
    verify_latest_substructure_certificate_command_summary: String,
    downstream_substructure_certificate_command_summary: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageSubstructureCertificateLatestStatus {
    ...
    nested_substructure_certificate_session_dir: String,
    downstream_decision_packet_session_dir: String,
    result: LivePackageSubstructureCertificateLatestResult,
    reason: String,
    latest_basal_receipt_plan_verdict: Option<String>,
    latest_basal_receipt_verdict: Option<String>,
    substructure_certificate_verdict: Option<String>,
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    latest_basal_receipt_plan_step: Option<PackageSubstructureCertificateLatestStepArtifact>,
    latest_basal_receipt_step: Option<PackageSubstructureCertificateLatestStepArtifact>,
    substructure_certificate_step: Option<PackageSubstructureCertificateLatestStepArtifact>,
...
#[derive(Debug, Clone)]
struct PackageSubstructureCertificateLatestPaths {
    session_path: PathBuf,
    status_path: PathBuf,
    report_path: PathBuf,
    latest_basal_receipt_plan_report_path: PathBuf,
    latest_basal_receipt_report_path: PathBuf,
    substructure_certificate_report_path: PathBuf,
    nested_basal_receipt_latest_session_dir: PathBuf,
    nested_substructure_certificate_session_dir: PathBuf,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageSubstructureCertificateLatestReport {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: TinyLivePackageSubstructureCertificateLatestVerdict,
    reason: String,
    root: Option<String>,
    latest_top_step_name: Option<String>,
    latest_top_session_dir: Option<String>,
    ...
    substructure_certificate_latest_session_path: Option<String>,
    substructure_certificate_latest_status_path: Option<String>,
    substructure_certificate_latest_report_path: Option<String>,
    latest_basal_receipt_plan_report_path: Option<String>,
    latest_basal_receipt_report_path: Option<String>,
    substructure_certificate_report_path: Option<String>,
    nested_basal_receipt_latest_session_dir: Option<String>,
    nested_substructure_certificate_session_dir: Option<String>,
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    resolve_latest_basal_receipt_command_summary: Option<String>,
    run_latest_substructure_certificate_command_summary: Option<String>,
    verify_latest_substructure_certificate_command_summary: Option<String>,
    downstream_substructure_certificate_command_summary: Option<String>,
...
#[derive(Debug, Clone)]
struct LatestBasalReceiptSnapshot {
...
#[derive(Debug, Clone)]
struct ResolvedLatestBedrockCertificate {
    snapshot: LatestBasalReceiptSnapshot,
    latest_basal_receipt_plan_raw: Value,
    latest_basal_receipt_plan: BasalReceiptLatestReportView,
}
...
enum ResolutionFailureKind {
    MissingLatestChain,
    InvalidLatestChain,
    DriftedSubstructureCertificateContract,
}

#[derive(Debug, Clone)]
struct LatestBasalReceiptResolutionFailure {
    kind: ResolutionFailureKind,
    reason: String,
    snapshot: Option<LatestBasalReceiptSnapshot>,
    latest_basal_receipt_plan_raw: Option<Value>,
    latest_basal_receipt_plan_verdict: Option<String>,
    latest_basal_receipt_plan_reason: Option<String>,
    latest_basal_receipt_plan_generated_at: Option<DateTime<Utc>>,
}

#[derive(Debug, Clone, Deserialize)]
struct BasalReceiptLatestReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Deserialize)]
struct SubstructureCertificateReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
    ...
    service_status_max_staleness_ms: Option<u64>,
    session_dir: Option<String>,
    substructure_certificate_session_path: Option<String>,
    substructure_certificate_status_path: Option<String>,
    archived_basal_receipt_report_path: Option<String>,
    result: Option<String>,
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    basal_receipt_step: Option<PackageSubstructureCertificateLatestStepArtifact>,
    verify_basal_receipt_command_summary: Option<String>,
    reviewed_frozen_live_cutover_controller_command_summary: Option<String>,
...
#[derive(Debug, Clone, Deserialize)]
struct SubstructureCertificateSessionView {
    basal_receipt_session_dir: String,
    ...
    service_status_max_staleness_ms: u64,
    session_dir: String,
    verify_basal_receipt_command_summary: String,
    reviewed_frozen_live_cutover_controller_command_summary: String,
...
#[derive(Debug, Clone, Deserialize)]
struct SubstructureCertificateStatusView {
    session_dir: String,
    basal_receipt_session_dir: String,
    bedrock_certificate_session_dir: String,
    foundation_receipt_session_dir: String,
    ...
    I: IntoIterator<Item = String>,
{
    ...
    while let Some(arg) = iter.next() {
        match arg.as_str() {
            ...
            "--json" => json = true,
            "--plan-latest-substructure-certificate" => set_mode(
                &mut mode,
                Mode::PlanLatestSubstructureCertificate,
                arg.as_str(),
            )?,
            "--render-latest-substructure-certificate-script" => set_mode(
                &mut mode,
                Mode::RenderLatestSubstructureCertificateScript,
                arg.as_str(),
            )?,
            "--run-latest-substructure-certificate" => set_mode(
                &mut mode,
                Mode::RunLatestSubstructureCertificate,
                arg.as_str(),
            )?,
            "--verify-latest-substructure-certificate" => set_mode(
                &mut mode,
                Mode::VerifyLatestSubstructureCertificate,
                arg.as_str(),
            )?,
    ...
    if matches!(mode, Mode::RenderLatestSubstructureCertificateScript) && output_path.is_none() {
        bail!("missing --output for render mode");
    }
    if matches!(
        mode,
        Mode::RunLatestSubstructureCertificate | Mode::VerifyLatestSubstructureCertificate
    ) && session_dir.is_none()
    {
...
fn run(config: Config) -> Result<String> {
    let report = match config.mode {
        Mode::PlanLatestSubstructureCertificate => {
            plan_latest_substructure_certificate_report(&config)?
        }
        Mode::RenderLatestSubstructureCertificateScript => {
            render_latest_substructure_certificate_script_report(&config)?
        }
        Mode::RunLatestSubstructureCertificate => {
            run_latest_substructure_certificate_report(&config)?
        }
        Mode::VerifyLatestSubstructureCertificate => {
            verify_latest_substructure_certificate_report(&config)?
        }
    };
    if config.json {
...
fn plan_latest_substructure_certificate_report(
    config: &Config,
) -> Result<PackageSubstructureCertificateLatestReport> {
    let root = config
        .root
        .as_ref()
        .ok_or_else(|| anyhow!("missing --root"))?;
    let suggested_session_dir = config.session_dir.clone().unwrap_or_else(|| {
        root.join("tiny_live_activation_package_substructure_certificate_latest.session")
    });
    let paths = substructure_certificate_latest_paths(&suggested_session_dir);

    match resolve_latest_basal_receipt(root, &paths) {
        Ok(resolved) => Ok(plan_report_from_resolution(
            "plan_latest_substructure_certificate",
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestPlanReady,
            format!(
                "latest immutable {} chain under {} resolves to exact latest-basal-receipt lineage via accepted latest-basal-receipt session {}, exact decision-packet confirmation anchor {}, and the accepted substructure-certificate contract remains current",
                resolved.snapshot.latest_top_step_name,
                root.display(),
                paths.nested_basal_receipt_latest_session_dir.display(),
...
fn render_latest_substructure_certificate_script_report(
    config: &Config,
) -> Result<PackageSubstructureCertificateLatestReport> {
    let root = config
        .root
    ...
    match resolve_latest_basal_receipt(root, &paths) {
        Ok(resolved) => {
            write_script(
                ...
                &format!(
                    ...
                    run_latest = command_summary(
                        BASAL_RECEIPT_LATEST_BIN,
                        &latest_basal_receipt_run_args(
                            root,
                            &paths.nested_basal_receipt_latest_session_dir,
                        ),
                    ),
                    verify_latest = command_summary(
                        BASAL_RECEIPT_LATEST_BIN,
                        &latest_basal_receipt_verify_args(
                            &paths.nested_basal_receipt_latest_session_dir,
                        ),
                    ),
                    run_handoff_bundle = downstream_substructure_certificate_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_basal_receipt_session_dir(&paths),
                        &paths.nested_substructure_certificate_session_dir,
                    ),
                    verify_handoff_bundle = verify_substructure_certificate_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_basal_receipt_session_dir(&paths),
                        &paths.nested_substructure_certificate_session_dir,
                    ),
            ...
            Ok(plan_report_from_resolution(
                "render_latest_substructure_certificate_script",
                TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestScriptRendered,
                format!(
                    "rendered latest-substructure-certificate handoff script to {} using the accepted latest-basal-receipt lineage and the accepted substructure-certificate contract",
                    output_path.display()
                ),
                root,
                &suggested_session_dir,
...
fn run_latest_substructure_certificate_report(
    config: &Config,
) -> Result<PackageSubstructureCertificateLatestReport> {
    let root = config
        .root
    ...
    if session_dir.exists() {
        bail!(
            "refusing to overwrite existing latest-substructure-certificate session dir {}",
            session_dir.display()
        );
    }
    let paths = substructure_certificate_latest_paths(session_dir);
    create_clean_session_dir(session_dir, "latest-substructure-certificate")?;

    let resolution = resolve_latest_basal_receipt(root, &paths);
    match resolution {
        Ok(resolved) => run_latest_substructure_certificate_with_resolution(
            root,
            session_dir,
            &paths,
            &resolved,
        ...
        Err(failure) => {
            run_latest_substructure_certificate_failure(root, session_dir, &paths, &failure)
        }
    }
}

fn verify_latest_substructure_certificate_report(
    config: &Config,
) -> Result<PackageSubstructureCertificateLatestReport> {
    let session_dir = config
        .session_dir
    ...
    let session: PackageSubstructureCertificateLatestSession = match load_json(&paths.session_path)
    {
        Ok(value) => value,
        Err(error) => {
            return Ok(verify_invalid_basal_receipt_latest_report_without_session(
                session_dir,
                vec![format!(
                    "failed reading latest-substructure-certificate session artifact {}: {error}",
                    paths.session_path.display()
                )],
            ))
        }
    };
    let status: PackageSubstructureCertificateLatestStatus = match load_json(&paths.status_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(verify_invalid_basal_receipt_latest_report_without_session(
                session_dir,
                vec![format!(
                    "failed reading latest-substructure-certificate status artifact {}: {error}",
                    paths.status_path.display()
                )],
            ))
        }
    };
    let stored_report: PackageSubstructureCertificateLatestReport =
        match load_json(&paths.report_path) {
            ...
            Err(error) => {
                return Ok(verify_invalid_basal_receipt_latest_report_without_session(
                    session_dir,
                    vec![format!(
                    "failed reading latest-substructure-certificate report artifact {}: {error}",
    ...
    compare_string(
        &session.root,
        &status.root,
        "latest-substructure-certificate root consistency",
        &mut mismatches,
    );
    compare_string(
        &session.session_dir,
        &session_dir.display().to_string(),
        "latest-substructure-certificate session session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.session_dir,
        &session_dir.display().to_string(),
        "latest-substructure-certificate status session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "latest-substructure-certificate report session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_basal_receipt_latest_session_dir,
        &paths
            .nested_basal_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-substructure-certificate session nested_basal_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_basal_receipt_latest_session_dir,
        &paths
            .nested_basal_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-substructure-certificate status nested_basal_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-substructure-certificate report nested_basal_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_substructure_certificate_session_dir,
        &paths
            .nested_substructure_certificate_session_dir
            .display()
            .to_string(),
        "latest-substructure-certificate session nested_substructure_certificate_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_substructure_certificate_session_dir,
        &paths
            .nested_substructure_certificate_session_dir
            .display()
            .to_string(),
        "latest-substructure-certificate status nested_substructure_certificate_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-substructure-certificate report nested_substructure_certificate_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-substructure-certificate session downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-substructure-certificate status downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-substructure-certificate report downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .substructure_certificate_latest_session_path
            .as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "latest-substructure-certificate report session path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .substructure_certificate_latest_status_path
            .as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "latest-substructure-certificate report status path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .substructure_certificate_latest_report_path
            .as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "latest-substructure-certificate report report path",
        &mut mismatches,
    );
    compare_string(
        &session.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-substructure-certificate session explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &status.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-substructure-certificate status explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-substructure-certificate report explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.mode,
        "run_latest_substructure_certificate",
        "latest-substructure-certificate stored report mode",
        &mut mismatches,
    );
    compare_string(
        &serialize_enum(&stored_report.verdict),
        &serialize_enum(&verdict_for_result(status.result)),
        "latest-substructure-certificate stored report verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.result.as_deref(),
        Some(serialize_enum(&status.result).as_str()),
        "latest-substructure-certificate stored report result consistency",
        &mut mismatches,
    );
    compare_string(
        &stored_report.reason,
        &status.reason,
        "latest-substructure-certificate stored report reason consistency",
        &mut mismatches,
    );
    if stored_report.activation_authorized != status.activation_authorized {
        mismatches.push(format!(
            "latest-substructure-certificate stored report activation_authorized {} does not match status {}",
            stored_report.activation_authorized, status.activation_authorized
        ));
    }
    compare_option_string(
        stored_report.latest_basal_receipt_plan_verdict.as_deref(),
        status.latest_basal_receipt_plan_verdict.as_deref(),
        "stored report latest_basal_receipt_plan_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.latest_basal_receipt_verdict.as_deref(),
        status.latest_basal_receipt_verdict.as_deref(),
        "stored report latest_basal_receipt_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.substructure_certificate_verdict.as_deref(),
        status.substructure_certificate_verdict.as_deref(),
        "stored report substructure_certificate_verdict",
        &mut mismatches,
    );
    compare_option_string(
    ...
    match resolution {
        Ok(resolved) => {
            ...
            let stored_latest_plan: BasalReceiptLatestReportView = load_required_step_json(
                &status.latest_basal_receipt_plan_step,
                &paths.latest_basal_receipt_plan_report_path,
                "latest_basal_receipt_plan_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_basal_receipt_plan_step.as_ref(),
                &paths.latest_basal_receipt_plan_report_path,
                "plan_latest_basal_receipt",
                &stored_latest_plan.verdict,
                &stored_latest_plan.reason,
                stored_latest_plan.generated_at,
                "stored latest_basal_receipt_plan_step",
                &mut mismatches,
            );
            compare_basal_receipt_latest_plan_against_snapshot(
                &stored_latest_plan,
                &resolved.snapshot,
                &paths.nested_basal_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_basal_receipt_plan_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_basal_receipt_plan_verdict.as_deref(),
            ...
            let stored_latest_run: BasalReceiptLatestReportView = load_required_step_json(
                &status.latest_basal_receipt_step,
                &paths.latest_basal_receipt_report_path,
                "latest_basal_receipt_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_basal_receipt_step.as_ref(),
                &paths.latest_basal_receipt_report_path,
                "run_latest_basal_receipt",
                &stored_latest_run.verdict,
                &stored_latest_run.reason,
                stored_latest_run.generated_at,
                "stored latest_basal_receipt_step",
                &mut mismatches,
            );
            compare_basal_receipt_latest_run_against_snapshot(
                &stored_latest_run,
                &resolved.snapshot,
                &paths.nested_basal_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_basal_receipt_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_basal_receipt_verdict.as_deref(),
            ...
            let actual_latest_run: BasalReceiptLatestReportView = match load_json(
                &nested_substructure_certificate_latest_report_path(
                    &paths.nested_basal_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed loading actual nested latest-basal-receipt report under {}: {error}",
                        paths.nested_basal_receipt_latest_session_dir.display()
                    ));
                    fallback_basal_receipt_latest_copy()
                }
            };
            compare_basal_receipt_latest_copy_matches_actual(
                &stored_latest_run,
                &actual_latest_run,
                &mut mismatches,
            );
            ...
            let latest_verify_raw = match run_json_command(
                BASAL_RECEIPT_LATEST_BIN,
                &latest_basal_receipt_verify_args(&paths.nested_basal_receipt_latest_session_dir),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested latest-basal-receipt session under {}: {error}",
                        paths.nested_basal_receipt_latest_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !latest_verify_raw.is_null() {
                let latest_verify: BasalReceiptLatestReportView =
                    serde_json::from_value(latest_verify_raw)
                        .context("failed parsing nested latest-basal-receipt verify json")?;
                if latest_verify.verdict != BASAL_RECEIPT_LATEST_VERIFY_OK {
                    mismatches.push(format!(
                        "nested latest-basal-receipt verification is non-green: {}",
                        latest_verify.reason
                    ));
                }
            }

            let stored_handoff_bundle: SubstructureCertificateReportView = load_required_step_json(
                &status.substructure_certificate_step,
                &paths.substructure_certificate_report_path,
                "substructure_certificate_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.substructure_certificate_step.as_ref(),
                &paths.substructure_certificate_report_path,
                "run_live_package_substructure_certificate",
                &stored_handoff_bundle.verdict,
                &stored_handoff_bundle.reason,
                stored_handoff_bundle.generated_at,
                "stored substructure_certificate_step",
                &mut mismatches,
            );
            ...
            compare_option_string(
                ...
                "stored status substructure_certificate_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.substructure_certificate_verdict.as_deref(),
            ...
            let nested_handoff_bundle_session: SubstructureCertificateSessionView =
                match load_json(&nested_substructure_certificate_session_path(
                    &paths.nested_substructure_certificate_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                        "failed reading nested substructure-certificate session under {}: {error}",
                        paths.nested_substructure_certificate_session_dir.display()
                    ));
            ...
            let nested_handoff_bundle_status: SubstructureCertificateStatusView =
                match load_json(&nested_substructure_certificate_status_path(
                    &paths.nested_substructure_certificate_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                        "failed reading nested substructure-certificate status under {}: {error}",
                        paths.nested_substructure_certificate_session_dir.display()
                    ));
            ...
            let handoff_bundle_verify_raw = match run_json_command(
                SUBSTRUCTURE_CERTIFICATE_BIN,
                &substructure_certificate_verify_args(
                    &resolved.snapshot,
                    &expected_downstream_basal_receipt_session_dir(&paths),
                    &paths.nested_substructure_certificate_session_dir,
                ),
                ...
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested substructure-certificate session under {}: {error}",
                        paths.nested_substructure_certificate_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !handoff_bundle_verify_raw.is_null() {
                let handoff_bundle_verify: SubstructureCertificateReportView =
                    serde_json::from_value(handoff_bundle_verify_raw)
                        .context("failed parsing nested substructure-certificate verify json")?;
                compare_option_string(
                    stored_handoff_bundle.registry_entry_session_dir.as_deref(),
                    handoff_bundle_verify.registry_entry_session_dir.as_deref(),
                    "stored substructure-certificate copy registry_entry_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored substructure-certificate copy notarization_receipt_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                ...
                compare_option_string(
                    ...
                    handoff_bundle_verify
                        .consummation_record_algorithm
                        .as_deref(),
                    "stored substructure-certificate copy consummation_record_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .completion_certificate_summary
                        .as_deref(),
                    "stored substructure-certificate copy completion_certificate_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .completion_certificate_sha256
                        .as_deref(),
                    "stored substructure-certificate copy completion_certificate_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored substructure-certificate copy completion_certificate_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.culmination_receipt_summary.as_deref(),
                    handoff_bundle_verify.culmination_receipt_summary.as_deref(),
                    "stored substructure-certificate copy culmination_receipt_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.culmination_receipt_sha256.as_deref(),
                    handoff_bundle_verify.culmination_receipt_sha256.as_deref(),
                    "stored substructure-certificate copy culmination_receipt_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .culmination_receipt_algorithm
                        .as_deref(),
                    "stored substructure-certificate copy culmination_receipt_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.summit_certificate_summary.as_deref(),
                    handoff_bundle_verify.summit_certificate_summary.as_deref(),
                    "stored substructure-certificate copy summit_certificate_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.summit_certificate_sha256.as_deref(),
                    handoff_bundle_verify.summit_certificate_sha256.as_deref(),
                    "stored substructure-certificate copy summit_certificate_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                ...
                compare_option_string(
                    ...
                    handoff_bundle_verify
                        .capstone_certificate_summary
                        .as_deref(),
                    "stored substructure-certificate copy capstone_certificate_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.capstone_certificate_sha256.as_deref(),
                    handoff_bundle_verify.capstone_certificate_sha256.as_deref(),
                    "stored substructure-certificate copy capstone_certificate_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .capstone_certificate_algorithm
                        .as_deref(),
                    "stored substructure-certificate copy capstone_certificate_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.foundation_receipt_summary.as_deref(),
                    handoff_bundle_verify.foundation_receipt_summary.as_deref(),
                    "stored substructure-certificate copy foundation_receipt_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.foundation_receipt_sha256.as_deref(),
                    handoff_bundle_verify.foundation_receipt_sha256.as_deref(),
                    "stored substructure-certificate copy foundation_receipt_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .foundation_receipt_algorithm
                        .as_deref(),
                    "stored substructure-certificate copy foundation_receipt_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.bedrock_certificate_summary.as_deref(),
                    handoff_bundle_verify.bedrock_certificate_summary.as_deref(),
                    "stored substructure-certificate copy bedrock_certificate_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.bedrock_certificate_sha256.as_deref(),
                    handoff_bundle_verify.bedrock_certificate_sha256.as_deref(),
                    "stored substructure-certificate copy bedrock_certificate_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .bedrock_certificate_algorithm
                        .as_deref(),
                    "stored substructure-certificate copy bedrock_certificate_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .reviewed_frozen_live_cutover_controller_command_summary
                        .as_deref(),
                    "stored substructure-certificate copy reviewed_frozen_live_cutover_controller_command_summary",
                    &mut mismatches,
                );
                if handoff_bundle_verify.verdict != SUBSTRUCTURE_CERTIFICATE_VERIFY_OK {
                    mismatches.push(format!(
                        "nested basal-receipt verification is non-green: {}",
                        handoff_bundle_verify.reason
                    ));
                }
            }

            let expected_result = basal_receipt_latest_result_from_nested_status(
                nested_handoff_bundle_status.result.as_str(),
            )
            .unwrap_or(LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract);
            if status.result != expected_result {
                mismatches.push(format!(
                    "stored latest-basal-receipt result {} does not match nested basal-receipt result {}",
            ...
            if status.activation_authorized {
                mismatches.push(
                    "stored status activation_authorized must remain false for latest-basal-receipt"
                        .to_string(),
                );
            }
            compare_option_string(
        ...
        Err(failure) => {
            ...
            if failure.latest_basal_receipt_plan_raw.is_some() {
                let stored_latest_plan: BasalReceiptLatestReportView = load_required_step_json(
                    &status.latest_basal_receipt_plan_step,
                    &paths.latest_basal_receipt_plan_report_path,
                    "latest_basal_receipt_plan_step",
                ...
                compare_option_string(
                    status.latest_basal_receipt_plan_verdict.as_deref(),
                    failure.latest_basal_receipt_plan_verdict.as_deref(),
                    "stored status latest_basal_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_report.latest_basal_receipt_plan_verdict.as_deref(),
                    failure.latest_basal_receipt_plan_verdict.as_deref(),
                    "stored report latest_basal_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
            }
            compare_option_string(
                status.latest_basal_receipt_verdict.as_deref(),
                None,
                "stored status latest_basal_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_basal_receipt_verdict.as_deref(),
                None,
                "stored report latest_basal_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.substructure_certificate_verdict.as_deref(),
                None,
                "stored status substructure_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.substructure_certificate_verdict.as_deref(),
                None,
                "stored report substructure_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.current_pre_activation_gate_verdict.as_deref(),
    ...
    let verdict = if mismatches.is_empty() {
        TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestVerifyOk
    } else {
        TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestVerifyInvalid
    };
    let reason = if mismatches.is_empty() {
        format!(
            "latest-substructure-certificate session under {} is coherent with the current latest immutable chain and the accepted substructure-certificate contract",
            session_dir.display()
        )
    } else {
        mismatches
            .first()
            .cloned()
            .unwrap_or_else(|| "latest-substructure-certificate verification failed".to_string())
    };

    Ok(PackageSubstructureCertificateLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_substructure_certificate".to_string(),
        verdict,
        reason,
        ...
        substructure_certificate_latest_session_path: Some(paths.session_path.display().to_string()),
        substructure_certificate_latest_status_path: Some(paths.status_path.display().to_string()),
        substructure_certificate_latest_report_path: Some(paths.report_path.display().to_string()),
        latest_basal_receipt_plan_report_path: Some(
            paths
                .latest_basal_receipt_plan_report_path
                .display()
                .to_string(),
        ),
        latest_basal_receipt_report_path: Some(
            paths.latest_basal_receipt_report_path.display().to_string(),
        ),
        substructure_certificate_report_path: Some(paths.substructure_certificate_report_path.display().to_string()),
        nested_basal_receipt_latest_session_dir: Some(
            paths
                .nested_basal_receipt_latest_session_dir
                .display()
                .to_string(),
        ),
        nested_substructure_certificate_session_dir: Some(
            paths.nested_substructure_certificate_session_dir.display().to_string(),
        ),
        ...
        latest_basal_receipt_plan_verdict: status.latest_basal_receipt_plan_verdict.clone(),
        latest_basal_receipt_verdict: status.latest_basal_receipt_verdict.clone(),
        substructure_certificate_verdict: status.substructure_certificate_verdict.clone(),
        ...
        resolve_latest_basal_receipt_command_summary: Some(
            session.resolve_latest_basal_receipt_command_summary.clone(),
        ),
        run_latest_substructure_certificate_command_summary: Some(
            session.run_latest_substructure_certificate_command_summary.clone(),
        ),
        verify_latest_substructure_certificate_command_summary: Some(
            session.verify_latest_substructure_certificate_command_summary.clone(),
        ),
        downstream_substructure_certificate_command_summary: Some(
            session.downstream_substructure_certificate_command_summary.clone(),
        ),
        verify_substructure_certificate_command_summary: Some(
            session.verify_substructure_certificate_command_summary.clone(),
        ),
        ...
        explicit_statement:
            "this verification proves only whether the latest immutable chain still resolves cleanly into the accepted substructure-certificate contract; it never runs the frozen controller"
                .to_string(),
    })
}

fn run_latest_substructure_certificate_with_resolution(
    root: &Path,
    session_dir: &Path,
    paths: &PackageSubstructureCertificateLatestPaths,
    resolved: &ResolvedLatestBedrockCertificate,
) -> Result<PackageSubstructureCertificateLatestReport> {
    let session = planned_session(root, session_dir, paths, Some(resolved), None);
    persist_json(&paths.session_path, &session)?;
    persist_json(
        &paths.latest_basal_receipt_plan_report_path,
        &resolved.latest_basal_receipt_plan_raw,
    )?;

    let latest_basal_receipt_plan_step = Some(step_artifact(
        &paths.latest_basal_receipt_plan_report_path,
        "plan_latest_basal_receipt",
        &resolved.latest_basal_receipt_plan.verdict,
        &resolved.latest_basal_receipt_plan.reason,
        resolved.latest_basal_receipt_plan.generated_at,
    ));

    let latest_basal_receipt_run_raw = match run_json_command(
        BASAL_RECEIPT_LATEST_BIN,
        &latest_basal_receipt_run_args(root, &paths.nested_basal_receipt_latest_session_dir),
    ) {
        Ok(value) => value,
        Err(error) => {
            let status = refusal_status(
                ...
                paths,
                Some(resolved),
                LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract,
                format!(
                    "failed running nested latest-basal-receipt handoff under {}: {error}",
                    paths
                        .nested_basal_receipt_latest_session_dir
                        .display()
                ),
    ...
    persist_json(
        &paths.latest_basal_receipt_report_path,
        &latest_basal_receipt_run_raw,
    )?;
    let latest_basal_receipt_run: BasalReceiptLatestReportView =
        serde_json::from_value(latest_basal_receipt_run_raw)
            .context("failed parsing nested latest-basal-receipt run json")?;
    let latest_basal_receipt_step = Some(step_artifact(
        &paths.latest_basal_receipt_report_path,
        "run_latest_basal_receipt",
        &latest_basal_receipt_run.verdict,
        &latest_basal_receipt_run.reason,
        latest_basal_receipt_run.generated_at,
    ));

    if let Some(terminal_failure) = latest_basal_receipt_terminal_failure(&latest_basal_receipt_run)
    {
        let status = refusal_status(
            root,
            session_dir,
            ...
            Some(resolved),
            terminal_failure,
            latest_basal_receipt_run.reason.clone(),
            latest_basal_receipt_plan_step,
            latest_basal_receipt_step,
            None,
        );
    ...
    let latest_basal_receipt_verify: BasalReceiptLatestReportView = match run_json_command(
        BASAL_RECEIPT_LATEST_BIN,
        &latest_basal_receipt_verify_args(&paths.nested_basal_receipt_latest_session_dir),
    ) {
        ...
        Err(error) => {
            let status = refusal_status(
                    ...
                    LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract,
                    format!(
                    "failed verifying nested latest-basal-receipt handoff under {}: {error}",
                    paths.nested_basal_receipt_latest_session_dir.display()
                ),
                    latest_basal_receipt_plan_step,
                    latest_basal_receipt_step,
    ...
    if latest_basal_receipt_verify.verdict != BASAL_RECEIPT_LATEST_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
            Some(resolved),
            LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract,
            latest_basal_receipt_verify.reason,
            latest_basal_receipt_plan_step,
            latest_basal_receipt_step,
            None,
        );
    ...
    let release_capsule_run_raw = match run_json_command(
        SUBSTRUCTURE_CERTIFICATE_BIN,
        &substructure_certificate_run_args(
            &resolved.snapshot,
            &expected_downstream_basal_receipt_session_dir(paths),
            &paths.nested_substructure_certificate_session_dir,
        ),
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract,
                format!(
                    "failed running downstream substructure-certificate contract under {}: {error}",
                    paths.nested_substructure_certificate_session_dir.display()
                ),
                latest_basal_receipt_plan_step,
                latest_basal_receipt_step,
    ...
    let provenance_certificate_run: SubstructureCertificateReportView =
        serde_json::from_value(release_capsule_run_raw)
            .context("failed parsing nested substructure-certificate run json")?;
    let substructure_certificate_step = Some(step_artifact(
        &paths.substructure_certificate_report_path,
        "run_live_package_substructure_certificate",
    ...
    let provenance_certificate_verify: SubstructureCertificateReportView = match run_json_command(
        SUBSTRUCTURE_CERTIFICATE_BIN,
        &substructure_certificate_verify_args(
            &resolved.snapshot,
            &expected_downstream_basal_receipt_session_dir(paths),
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract,
                format!(
                    "failed verifying downstream substructure-certificate contract under {}: {error}",
                    paths.nested_substructure_certificate_session_dir.display()
                ),
                latest_basal_receipt_plan_step,
                latest_basal_receipt_step,
    ...
    if provenance_certificate_verify.verdict != SUBSTRUCTURE_CERTIFICATE_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
    ...
    let result = basal_receipt_latest_result_from_nested_status(
        provenance_certificate_run
            .result
            .as_deref()
            .unwrap_or_default(),
    ...
    .unwrap_or(LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract);
    let status = PackageSubstructureCertificateLatestStatus {
        status_version: SUBSTRUCTURE_CERTIFICATE_LATEST_STATUS_VERSION.to_string(),
        updated_at: Utc::now(),
        ...
        nested_basal_receipt_latest_session_dir: paths
            .nested_basal_receipt_latest_session_dir
            .display()
            .to_string(),
        nested_substructure_certificate_session_dir: paths
            .nested_substructure_certificate_session_dir
            .display()
            .to_string(),
        ...
        latest_basal_receipt_plan_verdict: Some(resolved.latest_basal_receipt_plan.verdict.clone()),
        latest_basal_receipt_verdict: Some(latest_basal_receipt_run.verdict.clone()),
        substructure_certificate_verdict: Some(provenance_certificate_run.verdict.clone()),
...
fn run_latest_substructure_certificate_failure(
    root: &Path,
    session_dir: &Path,
    paths: &PackageSubstructureCertificateLatestPaths,
    failure: &LatestBasalReceiptResolutionFailure,
) -> Result<PackageSubstructureCertificateLatestReport> {
    let session = planned_session(root, session_dir, paths, None, Some(failure));
    persist_json(&paths.session_path, &session)?;
    if let Some(value) = &failure.latest_basal_receipt_plan_raw {
        persist_json(&paths.latest_basal_receipt_plan_report_path, value)?;
    }
...
fn resolve_latest_basal_receipt(
    root: &Path,
    paths: &PackageSubstructureCertificateLatestPaths,
) -> std::result::Result<ResolvedLatestBedrockCertificate, LatestBasalReceiptResolutionFailure> {
    let latest_basal_receipt_plan_raw = match run_json_command(
        BASAL_RECEIPT_LATEST_BIN,
        &latest_basal_receipt_plan_args(root, &paths.nested_basal_receipt_latest_session_dir),
    ) {
        Ok(value) => value,
        Err(error) => {
            return Err(LatestBasalReceiptResolutionFailure {
                ...
                snapshot: None,
                latest_basal_receipt_plan_raw: None,
                latest_basal_receipt_plan_verdict: None,
                latest_basal_receipt_plan_reason: None,
                latest_basal_receipt_plan_generated_at: None,
            });
        }
    };
    let latest_basal_receipt_plan: BasalReceiptLatestReportView =
        serde_json::from_value(latest_basal_receipt_plan_raw.clone()).map_err(
            |error| LatestBasalReceiptResolutionFailure {
                kind: ResolutionFailureKind::InvalidLatestChain,
                reason: format!(
                    "failed parsing latest-basal-receipt upstream latest-basal-receipt plan json for {}: {error}",
                    root.display()
                ),
                snapshot: None,
                latest_basal_receipt_plan_raw: Some(
                    latest_basal_receipt_plan_raw.clone(),
                ),
                latest_basal_receipt_plan_verdict: None,
                latest_basal_receipt_plan_reason: None,
                latest_basal_receipt_plan_generated_at: None,
    ...
    let snapshot = parse_snapshot_from_latest_basal_receipt(&latest_basal_receipt_plan).ok();
    if latest_basal_receipt_plan.verdict != BASAL_RECEIPT_LATEST_PLAN_READY {
        return Err(LatestBasalReceiptResolutionFailure {
            kind: map_basal_receipt_latest_failure_kind(
                &latest_basal_receipt_plan.verdict,
            ),
            reason: format!(
                "latest-basal-receipt resolution refused because nested latest-basal-receipt reported: {}",
                latest_basal_receipt_plan.reason
            ),
            snapshot,
            latest_basal_receipt_plan_raw: Some(latest_basal_receipt_plan_raw),
            latest_basal_receipt_plan_verdict: Some(
                latest_basal_receipt_plan.verdict,
            ),
            latest_basal_receipt_plan_reason: Some(
                latest_basal_receipt_plan.reason,
            ),
            latest_basal_receipt_plan_generated_at: Some(
                latest_basal_receipt_plan.generated_at,
            ),
        });
    }

    let snapshot =
        parse_snapshot_from_latest_basal_receipt(&latest_basal_receipt_plan).map_err(|error| {
            LatestBasalReceiptResolutionFailure {
                kind: ResolutionFailureKind::InvalidLatestChain,
                reason: format!("latest-basal-receipt resolution failed: {error}"),
                snapshot: None,
                latest_basal_receipt_plan_raw: Some(latest_basal_receipt_plan_raw.clone()),
                latest_basal_receipt_plan_verdict: Some(latest_basal_receipt_plan.verdict.clone()),
                latest_basal_receipt_plan_reason: Some(latest_basal_receipt_plan.reason.clone()),
                latest_basal_receipt_plan_generated_at: Some(
                    latest_basal_receipt_plan.generated_at,
                ),
            }
    ...
    if !mismatches.is_empty() {
        return Err(LatestBasalReceiptResolutionFailure {
            kind: ResolutionFailureKind::DriftedSubstructureCertificateContract,
            reason: format!("latest-basal-receipt drift detected: {}", mismatches[0]),
            snapshot: Some(snapshot),
            latest_basal_receipt_plan_raw: Some(latest_basal_receipt_plan_raw),
            latest_basal_receipt_plan_verdict: Some(latest_basal_receipt_plan.verdict),
            latest_basal_receipt_plan_reason: Some(latest_basal_receipt_plan.reason),
            latest_basal_receipt_plan_generated_at: Some(latest_basal_receipt_plan.generated_at),
        });
    }

    Ok(ResolvedLatestBedrockCertificate {
        snapshot,
        latest_basal_receipt_plan_raw,
        latest_basal_receipt_plan,
    })
}

fn parse_snapshot_from_latest_basal_receipt(
    view: &BasalReceiptLatestReportView,
) -> Result<LatestBasalReceiptSnapshot> {
    ...
    if latest_top_step_name != TOP_ACCEPTED_PACKAGE_STEP {
        bail!(
            "latest-basal-receipt nested latest-basal-receipt plan top accepted step is {} instead of {}",
    ...
    if view.activation_authorized {
        bail!(
            "latest-basal-receipt nested latest-basal-receipt plan must remain planning-safe with activation_authorized=false"
        );
    }
    Ok(LatestBasalReceiptSnapshot {
        latest_top_step_name,
        ...
        wrapper_timeout_ms: view.wrapper_timeout_ms.ok_or_else(|| {
            anyhow!(
                "latest-basal-receipt nested latest-basal-receipt plan is missing wrapper_timeout_ms"
            )
        })?,
        service_status_max_staleness_ms: view.service_status_max_staleness_ms.ok_or_else(|| {
            anyhow!(
                "latest-basal-receipt nested latest-basal-receipt plan is missing service_status_max_staleness_ms"
            )
        })?,
...
fn plan_report_from_resolution(
    ...
    paths: &PackageSubstructureCertificateLatestPaths,
    resolved: &ResolvedLatestBedrockCertificate,
) -> PackageSubstructureCertificateLatestReport {
    PackageSubstructureCertificateLatestReport {
        generated_at: Utc::now(),
        ...
        session_dir: Some(session_dir.display().to_string()),
        substructure_certificate_latest_session_path: Some(
            paths.session_path.display().to_string(),
        ),
        substructure_certificate_latest_status_path: Some(paths.status_path.display().to_string()),
        substructure_certificate_latest_report_path: Some(paths.report_path.display().to_string()),
        latest_basal_receipt_plan_report_path: Some(
        ...
        substructure_certificate_report_path: Some(
            paths
                .substructure_certificate_report_path
                .display()
                .to_string(),
        ),
        nested_basal_receipt_latest_session_dir: Some(
        ...
        latest_basal_receipt_plan_verdict: Some(resolved.latest_basal_receipt_plan.verdict.clone()),
        latest_basal_receipt_verdict: None,
        substructure_certificate_verdict: None,
        result: None,
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_basal_receipt_command_summary: Some(
            resolve_latest_basal_receipt_command_summary(
                root,
                &paths.nested_basal_receipt_latest_session_dir,
            ),
        ),
        run_latest_substructure_certificate_command_summary: Some(
            run_latest_substructure_certificate_command_summary(root, session_dir),
        ),
        verify_latest_substructure_certificate_command_summary: Some(
            verify_latest_substructure_certificate_command_summary(session_dir),
        ),
        downstream_substructure_certificate_command_summary: Some(
            downstream_substructure_certificate_command_summary(
                &resolved.snapshot,
                &expected_downstream_basal_receipt_session_dir(paths),
                &paths.nested_substructure_certificate_session_dir,
            ),
...
fn report_from_resolution_failure(
    ...
    PackageSubstructureCertificateLatestReport {
        ...
        latest_basal_receipt_plan_verdict: failure.latest_basal_receipt_plan_verdict.clone(),
        latest_basal_receipt_verdict: None,
        substructure_certificate_verdict: None,
        ...
        downstream_substructure_certificate_command_summary: snapshot.map(|value| {
            downstream_substructure_certificate_command_summary(
                value,
                &expected_downstream_basal_receipt_session_dir(paths),
                &paths.nested_substructure_certificate_session_dir,
        ...
        verify_substructure_certificate_command_summary: snapshot.map(|value| {
            verify_substructure_certificate_command_summary(
                value,
                &expected_downstream_basal_receipt_session_dir(paths),
                &paths.nested_substructure_certificate_session_dir,
...
fn planned_session(
    ...
    session_dir: &Path,
    paths: &PackageSubstructureCertificateLatestPaths,
    resolved: Option<&ResolvedLatestBedrockCertificate>,
    failure: Option<&LatestBasalReceiptResolutionFailure>,
) -> PackageSubstructureCertificateLatestSession {
    let snapshot = resolved
        .map(|value| &value.snapshot)
        .or_else(|| failure.and_then(|value| value.snapshot.as_ref()));
    PackageSubstructureCertificateLatestSession {
        session_version: SUBSTRUCTURE_CERTIFICATE_LATEST_SESSION_VERSION.to_string(),
        planned_at: Utc::now(),
        root: root.display().to_string(),
        session_dir: session_dir.display().to_string(),
        nested_basal_receipt_latest_session_dir: paths
        ...
        service_status_max_staleness_ms: snapshot
            .map(|value| value.service_status_max_staleness_ms),
        resolve_latest_basal_receipt_command_summary: resolve_latest_basal_receipt_command_summary(
            root,
            &paths.nested_basal_receipt_latest_session_dir,
        ),
        run_latest_substructure_certificate_command_summary:
            run_latest_substructure_certificate_command_summary(root, session_dir),
        verify_latest_substructure_certificate_command_summary:
            verify_latest_substructure_certificate_command_summary(session_dir),
        downstream_substructure_certificate_command_summary: snapshot
            .map(|value| {
                downstream_substructure_certificate_command_summary(
                    value,
                    &expected_downstream_basal_receipt_session_dir(paths),
            ...
            .unwrap_or_else(|| "<substructure-certificate-run-unavailable>".to_string()),
        verify_substructure_certificate_command_summary: snapshot
            .map(|value| {
                verify_substructure_certificate_command_summary(
                    value,
                    &expected_downstream_basal_receipt_session_dir(paths),
            ...
            .unwrap_or_else(|| "<substructure-certificate-verify-unavailable>".to_string()),
        reviewed_frozen_live_cutover_controller_command_summary: snapshot.map(|value| {
            value
                .reviewed_frozen_live_cutover_controller_command_summary
                .clone()
...
fn report_from_status(
    ...
    session_dir: &Path,
    paths: &PackageSubstructureCertificateLatestPaths,
    session: &PackageSubstructureCertificateLatestSession,
    status: &PackageSubstructureCertificateLatestStatus,
    verification_mismatches: Vec<String>,
) -> PackageSubstructureCertificateLatestReport {
    PackageSubstructureCertificateLatestReport {
        generated_at: Utc::now(),
        ...
        nested_basal_receipt_latest_session_dir: Some(
            session.nested_basal_receipt_latest_session_dir.clone(),
        ),
        nested_substructure_certificate_session_dir: Some(
            session.nested_substructure_certificate_session_dir.clone(),
        ),
        downstream_decision_packet_session_dir: Some(
...
fn substructure_certificate_latest_paths(
    session_dir: &Path,
) -> PackageSubstructureCertificateLatestPaths {
    PackageSubstructureCertificateLatestPaths {
        session_path: session_dir
            .join("tiny_live_activation_package_substructure_certificate_latest.session.json"),
        status_path: session_dir
            .join("tiny_live_activation_package_substructure_certificate_latest.status.json"),
        report_path: session_dir
            .join("tiny_live_activation_package_substructure_certificate_latest.report.json"),
        latest_basal_receipt_plan_report_path: session_dir.join(
            "tiny_live_activation_package_substructure_certificate_latest.basal_receipt_latest_plan.report.json",
        ),
        latest_basal_receipt_report_path: session_dir.join(
            "tiny_live_activation_package_substructure_certificate_latest.basal_receipt_latest.report.json",
        ),
        substructure_certificate_report_path: session_dir.join(
            "tiny_live_activation_package_substructure_certificate_latest.substructure_certificate.report.json",
        ),
        nested_basal_receipt_latest_session_dir: session_dir.join(
            "tiny_live_activation_package_substructure_certificate_latest.basal_receipt_latest_session",
        ),
        nested_substructure_certificate_session_dir: session_dir.join(
            "tiny_live_activation_package_substructure_certificate_latest.substructure_certificate_session",
        ),
    }
}
...
fn expected_downstream_decision_packet_session_dir(
    ...
    paths
        .nested_basal_receipt_latest_session_dir
        .join("tiny_live_activation_package_basal_receipt_latest.decision_packet_session")
}

fn expected_downstream_basal_receipt_session_dir(
    paths: &PackageSubstructureCertificateLatestPaths,
) -> PathBuf {
    paths
        .nested_basal_receipt_latest_session_dir
        .join("tiny_live_activation_package_basal_receipt_latest.basal_receipt_session")
}
...
fn expected_downstream_review_receipt_session_dir(
    ...
    paths
        .nested_basal_receipt_latest_session_dir
        .join("tiny_live_activation_package_basal_receipt_latest.review_receipt_session")
}

fn latest_basal_receipt_plan_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--plan-latest-basal-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn latest_basal_receipt_run_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-latest-basal-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn latest_basal_receipt_verify_args(session_dir: &Path) -> Vec<String> {
    vec![
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-latest-basal-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn substructure_certificate_run_args(
    snapshot: &LatestBasalReceiptSnapshot,
    basal_receipt_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        "--basal-receipt-session-dir".to_string(),
        basal_receipt_session_dir.display().to_string(),
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-live-package-substructure-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn substructure_certificate_verify_args(
    snapshot: &LatestBasalReceiptSnapshot,
    basal_receipt_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-live-package-substructure-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn resolve_latest_basal_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{BASAL_RECEIPT_LATEST_BIN} --root {} --session-dir {} --plan-latest-basal-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn run_latest_substructure_certificate_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{SUBSTRUCTURE_CERTIFICATE_LATEST_BIN} --root {} --session-dir {} --run-latest-substructure-certificate --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn verify_latest_substructure_certificate_command_summary(session_dir: &Path) -> String {
    format!(
        "{SUBSTRUCTURE_CERTIFICATE_LATEST_BIN} --session-dir {} --verify-latest-substructure-certificate --json",
        shell_escape_path(session_dir),
    )
}

fn downstream_substructure_certificate_command_summary(
    snapshot: &LatestBasalReceiptSnapshot,
    basal_receipt_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{SUBSTRUCTURE_CERTIFICATE_BIN} --basal-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --run-live-package-substructure-certificate --json",
        shell_escape_path(basal_receipt_session_dir),
...
fn verify_substructure_certificate_command_summary(
    ...
    format!(
        "{SUBSTRUCTURE_CERTIFICATE_BIN} --basal-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --verify-live-package-substructure-certificate --json",
        shell_escape_path(basal_receipt_session_dir),
        shell_escape_path(&snapshot.downstream_decision_packet_session_dir),
        shell_escape_path(session_dir),
    )
...
fn nested_substructure_certificate_latest_report_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_basal_receipt_latest.report.json")
}

fn nested_substructure_certificate_session_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_substructure_certificate.session.json")
}

fn nested_substructure_certificate_status_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_substructure_certificate.status.json")
}
...
fn write_script(path: &Path, contents: &str) -> Result<()> {
    ...
    fs::write(path, contents).with_context(|| {
        format!(
            "failed writing latest-substructure-certificate script to {}",
            path.display()
        )
    })?;
    #[cfg(unix)]
...
fn step_artifact(
    ...
    reason: &str,
    generated_at: DateTime<Utc>,
) -> PackageSubstructureCertificateLatestStepArtifact {
    PackageSubstructureCertificateLatestStepArtifact {
...
fn canonical_wrapper_mode(mode: &str) -> &str {
    match mode {
        "plan_latest_substructure_certificate" => "plan_latest_substructure_certificate",
        "render_latest_substructure_certificate_script" => {
            "render_latest_substructure_certificate_script"
        }
        "run_latest_substructure_certificate" => "run_latest_substructure_certificate",
        "verify_latest_substructure_certificate" => "verify_latest_substructure_certificate",
        other => other,
    }
}

fn load_required_step_json<T: for<'de> Deserialize<'de>>(
    step: &Option<PackageSubstructureCertificateLatestStepArtifact>,
    expected_path: &Path,
    label: &str,
    ...
    let step = step
        .as_ref()
        .ok_or_else(|| anyhow!("{label} is missing from latest-substructure-certificate status"))?;
    compare_string(
        &step.path,
...
fn compare_step_artifact_against_report_metadata(
    ...
    let Some(step) = step else {
        mismatches.push(format!(
            "{label} is missing from latest-substructure-certificate status"
        ));
        return;
    };
    compare_string(
...
fn compare_basal_receipt_latest_plan_against_snapshot(
    stored: &BasalReceiptLatestReportView,
    snapshot: &LatestBasalReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        ...
        Some(BASAL_RECEIPT_LATEST_PLAN_READY),
        "stored latest-basal-receipt plan verdict",
        mismatches,
    );
    compare_string(
        &stored.mode,
        "plan_latest_basal_receipt",
        "stored latest-basal-receipt plan mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-basal-receipt plan latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        ...
        "stored latest-basal-receipt plan latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-basal-receipt plan session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        ...
        "stored latest-basal-receipt plan reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-basal-receipt plan clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-basal-receipt plan clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-basal-receipt plan clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_basal_receipt_latest_run_against_snapshot(
    stored: &BasalReceiptLatestReportView,
    snapshot: &LatestBasalReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_latest_basal_receipt",
        "stored latest-basal-receipt run mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-basal-receipt run latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        ...
        "stored latest-basal-receipt run latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-basal-receipt run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        ...
        "stored latest-basal-receipt run downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored latest-basal-receipt run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored latest-basal-receipt run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored latest-basal-receipt run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored latest-basal-receipt run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored latest-basal-receipt run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored latest-basal-receipt run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored latest-basal-receipt run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-basal-receipt run clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-basal-receipt run clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-basal-receipt run clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_basal_receipt_latest_copy_matches_actual(
    stored: &BasalReceiptLatestReportView,
    actual: &BasalReceiptLatestReportView,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        Some(stored.verdict.as_str()),
        Some(actual.verdict.as_str()),
        "stored latest-basal-receipt copy verdict",
        mismatches,
    );
    compare_option_string(
        Some(stored.reason.as_str()),
        Some(actual.reason.as_str()),
        "stored latest-basal-receipt copy reason",
        mismatches,
    );
    if stored.generated_at != actual.generated_at {
        mismatches.push(format!(
            "stored latest-basal-receipt copy generated_at {:?} does not match actual {:?}",
    ...
    compare_option_string(
        ...
        "stored latest-basal-receipt copy latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        actual.latest_top_session_dir.as_deref(),
        "stored latest-basal-receipt copy latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        actual.session_dir.as_deref(),
        "stored latest-basal-receipt copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        actual.downstream_decision_packet_session_dir.as_deref(),
        "stored latest-basal-receipt copy downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        actual.result.as_deref(),
        "stored latest-basal-receipt copy result",
        mismatches,
    );
    compare_option_string(
        stored.explicit_statement.as_deref(),
        actual.explicit_statement.as_deref(),
        "stored latest-basal-receipt copy explicit_statement",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        actual.current_pre_activation_gate_verdict.as_deref(),
        "stored latest-basal-receipt copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        actual.current_pre_activation_gate_reason.as_deref(),
        "stored latest-basal-receipt copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        actual
            .reviewed_frozen_live_cutover_controller_command_summary
            .as_deref(),
        "stored latest-basal-receipt copy reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}

fn compare_bedrock_certificate_run_against_snapshot(
    stored: &SubstructureCertificateReportView,
    snapshot: &LatestBasalReceiptSnapshot,
    basal_receipt_session_dir: &Path,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_live_package_substructure_certificate",
        "stored substructure-certificate run mode",
        mismatches,
    );
    compare_string(
        &stored.basal_receipt_session_dir,
        &basal_receipt_session_dir.display().to_string(),
        "stored substructure-certificate run basal_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored substructure-certificate run decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored substructure-certificate run execute_frozen_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored substructure-certificate run turn_green_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored substructure-certificate run launch_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored substructure-certificate run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored substructure-certificate run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored substructure-certificate run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored substructure-certificate run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored substructure-certificate run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored substructure-certificate run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored substructure-certificate run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.substructure_certificate_session_path.as_deref(),
        Some(
            nested_substructure_certificate_session_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored substructure-certificate run substructure_certificate_session_path",
        mismatches,
    );
    compare_option_string(
        stored.substructure_certificate_status_path.as_deref(),
        Some(
            nested_substructure_certificate_status_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored substructure-certificate run substructure_certificate_status_path",
        mismatches,
    );
    compare_option_string(
        stored.archived_basal_receipt_report_path.as_deref(),
        Some(
            session_dir
                .join("tiny_live_activation_package_substructure_certificate.basal_receipt.report.json")
                .display()
                .to_string()
                .as_str(),
        ),
        "stored substructure-certificate run archived_basal_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        stored.verify_basal_receipt_command_summary.as_deref(),
        Some(verify_basal_receipt_command_summary(basal_receipt_session_dir).as_str()),
        "stored substructure-certificate run verify_basal_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored substructure-certificate run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}
...
fn compare_bedrock_certificate_copy_against_nested_truth(
    stored: &SubstructureCertificateReportView,
    nested_session: &SubstructureCertificateSessionView,
    nested_status: &SubstructureCertificateStatusView,
    mismatches: &mut Vec<String>,
) {
    compare_string(
        &stored.basal_receipt_session_dir,
        &nested_session.basal_receipt_session_dir,
        "stored substructure-certificate copy basal_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.registry_entry_session_dir.as_deref(),
        Some(nested_session.registry_entry_session_dir.as_str()),
        "stored substructure-certificate copy registry_entry_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.notarization_receipt_session_dir.as_deref(),
        Some(nested_session.notarization_receipt_session_dir.as_str()),
        "stored substructure-certificate copy notarization_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.provenance_certificate_session_dir.as_deref(),
        Some(nested_session.provenance_certificate_session_dir.as_str()),
        "stored substructure-certificate copy provenance_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.attestation_seal_session_dir.as_deref(),
        Some(nested_session.attestation_seal_session_dir.as_str()),
        "stored substructure-certificate copy attestation_seal_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.release_capsule_session_dir.as_deref(),
        Some(nested_session.release_capsule_session_dir.as_str()),
        "stored substructure-certificate copy release_capsule_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.activation_ticket_session_dir.as_deref(),
        Some(nested_session.activation_ticket_session_dir.as_str()),
        "stored substructure-certificate copy activation_ticket_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.review_receipt_session_dir.as_deref(),
        Some(nested_session.review_receipt_session_dir.as_str()),
        "stored substructure-certificate copy review_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.handoff_bundle_session_dir.as_deref(),
        Some(nested_session.handoff_bundle_session_dir.as_str()),
        "stored substructure-certificate copy handoff_bundle_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.decision_packet_session_dir.as_deref(),
        Some(nested_session.decision_packet_session_dir.as_str()),
        "stored substructure-certificate copy decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.execute_frozen_session_dir.as_deref(),
        Some(nested_session.execute_frozen_session_dir.as_str()),
        "stored substructure-certificate copy execute_frozen_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.turn_green_session_dir.as_deref(),
        Some(nested_session.turn_green_session_dir.as_str()),
        "stored substructure-certificate copy turn_green_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.launch_packet_session_dir.as_deref(),
        Some(nested_session.launch_packet_session_dir.as_str()),
        "stored substructure-certificate copy launch_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(nested_session.session_dir.as_str()),
        "stored substructure-certificate copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        Some(nested_status.result.as_str()),
        "stored substructure-certificate copy result",
        mismatches,
    );
    compare_option_string(
        Some(stored.verdict.as_str()),
        substructure_certificate_run_verdict_for_result(&nested_status.result),
        "stored substructure-certificate copy verdict",
        mismatches,
    );
    compare_option_string(
        stored.handoff_bundle_result.as_deref(),
        nested_status.handoff_bundle_result.as_deref(),
        "stored substructure-certificate copy handoff_bundle_result",
        mismatches,
    );
    compare_option_string(
        stored.decision_packet_result.as_deref(),
        nested_status.decision_packet_result.as_deref(),
        "stored substructure-certificate copy decision_packet_result",
        mismatches,
    );
    compare_option_string(
        stored.execute_frozen_result.as_deref(),
        nested_status.execute_frozen_result.as_deref(),
        "stored substructure-certificate copy execute_frozen_result",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        nested_status.current_pre_activation_gate_verdict.as_deref(),
        "stored substructure-certificate copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        nested_status.current_pre_activation_gate_reason.as_deref(),
        "stored substructure-certificate copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored.verify_basal_receipt_command_summary.as_deref(),
        Some(nested_session.verify_basal_receipt_command_summary.as_str()),
        "stored substructure-certificate copy verify_basal_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
    ...
    compare_option_string(
        ...
        "stored substructure-certificate copy release_capsule_digest_manifest_sha256",
        mismatches,
    );
...
fn compare_session_against_snapshot(
    ...
    compare_string(
        &session.resolve_latest_basal_receipt_command_summary,
        &resolve_latest_basal_receipt_command_summary(
            root,
            &paths.nested_basal_receipt_latest_session_dir,
        ),
        "stored session resolve_latest_basal_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.run_latest_substructure_certificate_command_summary,
        &run_latest_substructure_certificate_command_summary(root, session_dir),
        "stored session run_latest_substructure_certificate_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_latest_substructure_certificate_command_summary,
        &verify_latest_substructure_certificate_command_summary(session_dir),
        "stored session verify_latest_substructure_certificate_command_summary",
        mismatches,
    );
    compare_string(
        &session.downstream_substructure_certificate_command_summary,
        &downstream_substructure_certificate_command_summary(
            snapshot,
            &expected_downstream_basal_receipt_session_dir(paths),
            &paths.nested_substructure_certificate_session_dir,
        ),
        "stored session downstream_substructure_certificate_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_substructure_certificate_command_summary,
        &verify_substructure_certificate_command_summary(
            snapshot,
            &expected_downstream_basal_receipt_session_dir(paths),
            &paths.nested_substructure_certificate_session_dir,
        ),
        "stored session verify_substructure_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_basal_receipt_latest_session_dir",
        mismatches,
    );
    compare_string(
        &session.nested_substructure_certificate_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_substructure_certificate_session_dir",
        mismatches,
    );
    compare_string(
        &session.downstream_decision_packet_session_dir,
...
fn compare_report_against_snapshot(
    report: &PackageSubstructureCertificateLatestReport,
    root: &Path,
    session_dir: &Path,
    paths: &PackageSubstructureCertificateLatestPaths,
    snapshot: &LatestBasalReceiptSnapshot,
    ...
    compare_option_string(
        ...
        "stored report resolve_latest_basal_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
            .run_latest_substructure_certificate_command_summary
            .as_deref(),
        Some(run_latest_substructure_certificate_command_summary(root, session_dir).as_str()),
        "stored report run_latest_substructure_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
            .verify_latest_substructure_certificate_command_summary
            .as_deref(),
        Some(verify_latest_substructure_certificate_command_summary(session_dir).as_str()),
        "stored report verify_latest_substructure_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report downstream_substructure_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report verify_substructure_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
    ...
    compare_option_string(
        report
            ...
            .as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "stored report substructure_certificate_latest_session_path",
        mismatches,
    );
    compare_option_string(
        report
            ...
            .as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "stored report substructure_certificate_latest_status_path",
        mismatches,
    );
    compare_option_string(
        report
            ...
            .as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "stored report substructure_certificate_latest_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_basal_receipt_plan_report_path.as_deref(),
        Some(
            paths
                .latest_basal_receipt_plan_report_path
                .display()
        ...
        "stored report latest_basal_receipt_plan_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_basal_receipt_report_path.as_deref(),
        Some(
            paths
                .latest_basal_receipt_report_path
                .display()
                .to_string()
                .as_str(),
        ),
        "stored report latest_basal_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        report.substructure_certificate_report_path.as_deref(),
        Some(
            paths
                .substructure_certificate_report_path
                .display()
        ...
        "stored report substructure_certificate_report_path",
        mismatches,
    );
    compare_option_string(
        report.nested_basal_receipt_latest_session_dir.as_deref(),
        Some(
            paths
                .nested_basal_receipt_latest_session_dir
                .display()
        ...
        "stored report nested_basal_receipt_latest_session_dir",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report nested_substructure_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
...
fn compare_session_against_failure(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_basal_receipt_latest_session_dir on failure",
        mismatches,
    );
    compare_string(
        &session.nested_substructure_certificate_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_substructure_certificate_session_dir on failure",
        mismatches,
    );
...
fn map_basal_receipt_latest_failure_kind(verdict: &str) -> ResolutionFailureKind {
    match verdict {
        "tiny_live_package_basal_receipt_latest_refused_by_missing_latest_chain" => {
            ResolutionFailureKind::MissingLatestChain
        }
        "tiny_live_package_basal_receipt_latest_refused_by_drifted_basal_receipt_contract" => {
            ResolutionFailureKind::DriftedSubstructureCertificateContract
        }
        _ => ResolutionFailureKind::InvalidLatestChain,
    }
}

fn latest_basal_receipt_terminal_failure(
    report: &BasalReceiptLatestReportView,
) -> Option<LivePackageSubstructureCertificateLatestResult> {
    match report.result.as_deref() {
        Some("refused_by_missing_latest_chain") => {
            Some(LivePackageSubstructureCertificateLatestResult::RefusedByMissingLatestChain)
        }
        Some("refused_by_invalid_latest_chain") => {
            Some(LivePackageSubstructureCertificateLatestResult::RefusedByInvalidLatestChain)
        }
        Some("refused_by_drifted_basal_receipt_contract") => {
            Some(LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract)
        }
        _ => None,
    }
}

fn basal_receipt_latest_result_from_nested_status(
    result: &str,
) -> Option<LivePackageSubstructureCertificateLatestResult> {
    match result {
        "ready_for_manual_execution_when_gate_turns_green" => {
            Some(LivePackageSubstructureCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen)
        }
        "refused_now_by_stage3" => Some(LivePackageSubstructureCertificateLatestResult::RefusedNowByStage3),
        "refused_now_by_pre_activation_gate" => {
            Some(LivePackageSubstructureCertificateLatestResult::RefusedNowByPreActivationGate)
        }
...
fn substructure_certificate_run_verdict_for_result(result: &str) -> Option<&'static str> {
    match result {
        ...
        "refused_now_by_stage3" => {
            Some("tiny_live_package_substructure_certificate_refused_now_by_stage3")
        }
        "refused_now_by_pre_activation_gate" => {
            Some("tiny_live_package_substructure_certificate_refused_now_by_pre_activation_gate")
        }
        "refused_now_by_invalid_or_drifted_contract" => {
            Some("tiny_live_package_substructure_certificate_refused_now_by_invalid_or_drifted_contract")
        }
        _ => None,
    }
}
...
fn result_from_failure_kind(
    kind: ResolutionFailureKind,
) -> LivePackageSubstructureCertificateLatestResult {
    match kind {
        ResolutionFailureKind::MissingLatestChain => {
            LivePackageSubstructureCertificateLatestResult::RefusedByMissingLatestChain
        }
        ResolutionFailureKind::InvalidLatestChain => {
            LivePackageSubstructureCertificateLatestResult::RefusedByInvalidLatestChain
        }
        ResolutionFailureKind::DriftedSubstructureCertificateContract => {
            LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract
        }
...
fn verdict_for_result(
    result: LivePackageSubstructureCertificateLatestResult,
) -> TinyLivePackageSubstructureCertificateLatestVerdict {
    match result {
        LivePackageSubstructureCertificateLatestResult::RefusedByMissingLatestChain => {
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestRefusedByMissingLatestChain
        }
        LivePackageSubstructureCertificateLatestResult::RefusedByInvalidLatestChain => {
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestRefusedByInvalidLatestChain
        }
        LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract => {
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestRefusedByDriftedSubstructureCertificateContract
        }
        LivePackageSubstructureCertificateLatestResult::RefusedNowByStage3 => {
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestRefusedNowByStage3
        }
        LivePackageSubstructureCertificateLatestResult::RefusedNowByPreActivationGate => {
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestRefusedNowByPreActivationGate
        }
        LivePackageSubstructureCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestReadyForManualExecutionWhenGateTurnsGreen
        }
    }
}
...
fn operator_next_action_summary(result: LivePackageSubstructureCertificateLatestResult) -> String {
    match result {
        LivePackageSubstructureCertificateLatestResult::RefusedByMissingLatestChain => {
            "no immutable clerestory chain is available yet; do not manually hunt basal-receipt or substructure-certificate lineage by hand".to_string()
        }
        LivePackageSubstructureCertificateLatestResult::RefusedByInvalidLatestChain => {
            "the latest immutable chain is incomplete or below the accepted clerestory layer; mint a fresh coherent clerestory chain instead of bypassing the accepted latest-basal-receipt / substructure-certificate path".to_string()
        }
        LivePackageSubstructureCertificateLatestResult::RefusedByDriftedSubstructureCertificateContract => {
            "the latest chain no longer resolves cleanly into the accepted latest-basal-receipt / substructure-certificate contract; repair that drift instead of bypassing the bounded handoff path".to_string()
        }
        LivePackageSubstructureCertificateLatestResult::RefusedNowByStage3 => {
            "the frozen controller stays refused now by Stage 3; rerun this latest-substructure-certificate refresh after current Stage 3 truth turns green".to_string()
        }
        LivePackageSubstructureCertificateLatestResult::RefusedNowByPreActivationGate => {
            "the frozen controller stays refused now by the pre-activation gate; rerun this latest-substructure-certificate refresh after the current pre-activation gate turns green".to_string()
        }
        LivePackageSubstructureCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            "the latest immutable chain now resolves into the accepted substructure-certificate contract and one bounded latest-substructure-certificate handoff is ready for manual execution when gate truth turns green; this wrapper still did not run or authorize the frozen controller".to_string()
        }
    }
}
...
fn verify_basal_receipt_command_summary(basal_receipt_session_dir: &Path) -> String {
    format!(
        "verify immutable basal-receipt session under {} before freezing the final substructure certificate",
        basal_receipt_session_dir.display()
    )
}
...
fn refusal_status(
    ...
    latest_basal_receipt_step: Option<PackageSubstructureCertificateLatestStepArtifact>,
    substructure_certificate_step: Option<PackageSubstructureCertificateLatestStepArtifact>,
) -> PackageSubstructureCertificateLatestStatus {
    ...
    PackageSubstructureCertificateLatestStatus {
        ...
        result,
        reason,
        latest_basal_receipt_plan_verdict: resolved
            .map(|value| value.latest_basal_receipt_plan.verdict.clone()),
        latest_basal_receipt_verdict: latest_basal_receipt_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        substructure_certificate_verdict: substructure_certificate_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
...
fn refusal_status_from_resolution_failure(
    ...
    PackageSubstructureCertificateLatestStatus {
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        latest_basal_receipt_plan_step: failure.latest_basal_receipt_plan_raw.as_ref().map(|_| {
            step_artifact(
                &paths.latest_basal_receipt_plan_report_path,
                "plan_latest_basal_receipt",
                failure
                    .latest_basal_receipt_plan_verdict
                    .as_deref()
                    .unwrap_or("<missing>"),
                failure
                    .latest_basal_receipt_plan_reason
                    .as_deref()
                    .unwrap_or("<missing>"),
                failure
                    .latest_basal_receipt_plan_generated_at
                    .unwrap_or_else(Utc::now),
            )
        }),
        latest_basal_receipt_step: None,
...
fn verify_invalid_basal_receipt_latest_report_without_session(
    session_dir: &Path,
    verification_mismatches: Vec<String>,
) -> PackageSubstructureCertificateLatestReport {
    ...
    PackageSubstructureCertificateLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_substructure_certificate".to_string(),
        verdict: TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestVerifyInvalid,
        reason,
        root: None,
        ...
        session_dir: Some(session_dir.display().to_string()),
        substructure_certificate_latest_session_path: Some(
            substructure_certificate_latest_paths(session_dir)
                .session_path
                .display()
                .to_string(),
        ),
        substructure_certificate_latest_status_path: Some(
            substructure_certificate_latest_paths(session_dir)
                .status_path
                .display()
                .to_string(),
        ),
        substructure_certificate_latest_report_path: Some(
            substructure_certificate_latest_paths(session_dir)
                .report_path
                .display()
                .to_string(),
        ),
        latest_basal_receipt_plan_report_path: None,
        latest_basal_receipt_report_path: None,
        substructure_certificate_report_path: None,
        nested_basal_receipt_latest_session_dir: None,
        nested_substructure_certificate_session_dir: None,
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_basal_receipt_command_summary: None,
        run_latest_substructure_certificate_command_summary: None,
        verify_latest_substructure_certificate_command_summary: None,
        downstream_substructure_certificate_command_summary: None,
        verify_substructure_certificate_command_summary: None,
...
fn fallback_basal_receipt_latest_copy() -> BasalReceiptLatestReportView {
    BasalReceiptLatestReportView {
        generated_at: Utc::now(),
...
fn fallback_notarization_receipt_session(
    snapshot: &LatestBasalReceiptSnapshot,
    session_dir: &Path,
) -> SubstructureCertificateSessionView {
    SubstructureCertificateSessionView {
        ...
        session_dir: session_dir.display().to_string(),
        verify_basal_receipt_command_summary:
            verify_basal_receipt_command_summary(Path::new("<missing>")),
        ...
        explicit_statement:
            "the verified basal-receipt session is the primary input here; this immutable substructure certificate freezes one final signet identity over the fully culminated chain without enabling production execution"
                .to_string(),
    }
}

fn fallback_notarization_receipt_status(
    _snapshot: &LatestBasalReceiptSnapshot,
    session_dir: &Path,
) -> SubstructureCertificateStatusView {
    SubstructureCertificateStatusView {
        session_dir: session_dir.display().to_string(),
        basal_receipt_session_dir: "<missing>".to_string(),
        bedrock_certificate_session_dir: "<missing>".to_string(),
        ...
        substructure_certificate_algorithm: "sha256".to_string(),
        explicit_statement:
            "this substructure certificate is archival and read-only; it never executes or enables the frozen controller"
                .to_string(),
    }
}

fn render_report_lines(report: &PackageSubstructureCertificateLatestReport) -> String {
    let mut lines = vec![
    ...
    if let Some(value) = &report.nested_basal_receipt_latest_session_dir {
        lines.push(format!("nested_basal_receipt_latest_session_dir={value}"));
    }
    ...
    if let Some(value) = &report.nested_substructure_certificate_session_dir {
        lines.push(format!(
            "nested_substructure_certificate_session_dir={value}"
        ));
    }
    if let Some(value) = &report.result {
        lines.push(format!("result={value}"));
    }
    if let Some(value) = &report.downstream_substructure_certificate_command_summary {
        lines.push(format!(
            "downstream_substructure_certificate_command_summary={value}"
        ));
    }
...
mod tests {
    ...
    struct FakeNotarizationReceiptLatestFixture {
        ...
        basal_receipt_latest_plan_json_path: PathBuf,
        basal_receipt_latest_run_json_path: PathBuf,
        basal_receipt_latest_verify_json_path: PathBuf,
    ...
    impl FakeNotarizationReceiptLatestFixture {
        fn plan_config(&self) -> Config {
            Config {
                mode: Mode::PlanLatestSubstructureCertificate,
        ...
        fn render_config(&self) -> Config {
            Config {
                mode: Mode::RenderLatestSubstructureCertificateScript,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
        ...
        fn run_config(&self) -> Config {
            Config {
                mode: Mode::RunLatestSubstructureCertificate,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
        ...
        fn verify_config(&self) -> Config {
            Config {
                mode: Mode::VerifyLatestSubstructureCertificate,
                root: None,
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
    ...
    fn plan_mode_resolves_latest_valid_clerestory_chain_to_exact_expected_nested_latest_foundation_receipt_lineage(
        ...
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_plan_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let report = plan_latest_substructure_certificate_report(&fixture.plan_config()).unwrap();
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        assert_eq!(
            report.verdict,
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestPlanReady
        );
        assert_eq!(report.mode, "plan_latest_substructure_certificate");
        assert_eq!(
            report.latest_top_step_name.as_deref(),
        ...
        assert!(report
            ...
            .as_deref()
            .unwrap()
            .contains(SUBSTRUCTURE_CERTIFICATE_BIN));
    }
    ...
    {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_render_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let report =
            render_latest_substructure_certificate_script_report(&fixture.render_config()).unwrap();
        assert_eq!(
            report.verdict,
            TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestScriptRendered
        );
        assert_eq!(report.mode, "render_latest_substructure_certificate_script");
        let script = fs::read_to_string(&fixture.output_script_path).unwrap();
        assert!(script.contains(BASAL_RECEIPT_LATEST_BIN));
        assert!(script.contains(SUBSTRUCTURE_CERTIFICATE_BIN));
        assert!(script.contains("--basal-receipt-session-dir"));
        assert!(!script.contains("--activation-ticket-session-dir"));
        assert!(script.contains("--run-live-package-substructure-certificate"));
        assert!(script.contains("--verify-live-package-substructure-certificate"));
    ...
    fn run_mode_refuses_when_latest_chain_missing_invalid_or_below_clerestory() {
        for (label, verdict, reason, expected) in [
            (
                "basal_receipt_latest_missing",
                "tiny_live_package_basal_receipt_latest_refused_by_missing_latest_chain",
                "no persisted immutable chain exists",
                TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestRefusedByMissingLatestChain,
            ),
            (
                "basal_receipt_latest_invalid",
                "tiny_live_package_basal_receipt_latest_refused_by_invalid_latest_chain",
                "latest immutable chain is incomplete",
                TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestRefusedByInvalidLatestChain,
            ),
            (
                "basal_receipt_latest_below",
                "tiny_live_package_basal_receipt_latest_refused_by_invalid_latest_chain",
            ...
            let mut plan: Value = load_json(&fixture.basal_receipt_latest_plan_json_path).unwrap();
            plan["verdict"] = json!(verdict);
            plan["reason"] = json!(reason);
            if label.ends_with("below") {
                plan["latest_top_step_name"] = json!("choir_receipt");
            }
            persist_json(&fixture.basal_receipt_latest_plan_json_path, &plan).unwrap();

            let report = run_latest_substructure_certificate_report(&fixture.run_config()).unwrap();
    ...
    fn plan_mode_maps_real_latest_foundation_receipt_drift_verdict_to_local_drift_refusal() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_plan_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        plan["reason"] = json!("real accepted latest-basal-receipt drift");
        persist_json(&fixture.basal_receipt_latest_plan_json_path, &plan).unwrap();
    ...
    fn run_mode_takes_terminal_drift_refusal_when_nested_latest_foundation_receipt_reports_real_drift(
        ...
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_run_drift",
            "refused_by_drifted_basal_receipt_contract",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert_eq!(report.substructure_certificate_verdict.as_deref(), None);
    }

    #[test]
    fn run_mode_refuses_when_nested_release_capsule_lineage_drifts_from_latest_immutable_chain() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_handoff_bundle_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let mut run: Value = load_json(&fixture.basal_receipt_latest_run_json_path).unwrap();
        run["package_dir"] = json!("/tampered/package");
        persist_json(&fixture.basal_receipt_latest_run_json_path, &run).unwrap();
        ...
        assert!(report
            .reason
            .contains("stored latest-basal-receipt run package_dir"));
    }
    ...
    fn verify_mode_fails_when_persisted_latest_foundation_receipt_artifacts_are_tampered_or_missing_nested_lineage_truth(
        ...
        {
            let fixture = fake_basal_receipt_latest_fixture(
                "basal_receipt_latest_verify_tampered_copy",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            run_latest_substructure_certificate_report(&fixture.run_config()).unwrap();

            let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
            let mut report: Value = load_json(&paths.substructure_certificate_report_path).unwrap();
            report["decision_packet_session_dir"] = json!("/tampered/run-decision-packet-session");
            persist_json(&paths.substructure_certificate_report_path, &report).unwrap();

            let verify =
                verify_latest_substructure_certificate_report(&fixture.verify_config()).unwrap();
            assert_eq!(
                verify.verdict,
                TinyLivePackageSubstructureCertificateLatestVerdict::TinyLivePackageSubstructureCertificateLatestVerifyInvalid
            );
            assert!(verify.verification_mismatches.iter().any(|entry| {
                entry.contains("stored substructure-certificate run decision_packet_session_dir")
            }));
        }

        {
            let fixture = fake_basal_receipt_latest_fixture(
                "basal_receipt_latest_verify_missing_nested_truth",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            ...
            let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
            fs::remove_file(nested_substructure_certificate_latest_report_path(
                &paths.nested_basal_receipt_latest_session_dir,
            ))
            .unwrap();
            ...
            assert!(verify.verification_mismatches.iter().any(|entry| {
                entry.contains("tiny_live_activation_package_basal_receipt_latest.report.json")
            }));
        }
    }
    ...
    fn verify_accepts_real_shaped_native_foundation_identity_layers_on_happy_path() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_real_shaped_foundation_paths_green",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn run_and_verify_reject_stale_keystone_wrapper_schema_for_downstream_foundation_copy() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_rejects_stale_keystone_wrapper_schema",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        assert!(paths.substructure_certificate_report_path.ends_with(
            "tiny_live_activation_package_substructure_certificate_latest.substructure_certificate.report.json"
        ));
        assert!(paths.substructure_certificate_report_path.exists());
        assert!(!fixture
            .wrapper_session_dir
            .join(
                "tiny_live_activation_package_substructure_certificate_latest.basal_receipt.report.json"
            )
            .exists());

        let mut status: Value = load_json(&paths.status_path).unwrap();
        let stored_step = status
            .get("substructure_certificate_step")
            .cloned()
            .expect("substructure_certificate_step should be present");
        assert!(status.get("keystone_receipt_step").is_none());
        status["keystone_receipt_step"] = stored_step;
        if let Some(object) = status.as_object_mut() {
            object.remove("substructure_certificate_step");
        }
        persist_json(&paths.status_path, &status).unwrap();

        let error =
            verify_latest_substructure_certificate_report(&fixture.verify_config()).unwrap_err();
        assert!(error.to_string().contains("substructure_certificate_step"));
    }

    #[test]
    fn verify_names_bedrock_certificate_when_nested_native_session_load_breaks() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_nested_foundation_session_load_break",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        fs::remove_file(nested_substructure_certificate_session_path(
            &paths.nested_substructure_certificate_session_dir,
        ))
        .unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("failed reading nested substructure-certificate session under")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_substructure_certificate_session_path_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_foundation_session_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.substructure_certificate_report_path).unwrap();
        report["substructure_certificate_session_path"] =
    ...
    #[test]
    fn verify_fails_when_copied_native_substructure_certificate_status_path_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_foundation_status_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.substructure_certificate_report_path).unwrap();
        report["substructure_certificate_status_path"] =
    ...
    fn run_names_latest_foundation_receipt_when_nested_latest_wrapper_run_fails() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_nested_run_failure_wording",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        overwrite_fake_basal_receipt_latest_command(
            &fixture.bin_dir.join(BASAL_RECEIPT_LATEST_BIN),
            &fixture.basal_receipt_latest_plan_json_path,
            &fixture.basal_receipt_latest_run_json_path,
            &fixture.basal_receipt_latest_verify_json_path,
            None,
            Some("forced nested latest-basal-receipt run failure"),
            None,
            &fixture.root,
            &paths.nested_basal_receipt_latest_session_dir,
        );
        ...
        assert!(report
            .reason
            .contains("failed running nested latest-basal-receipt handoff under"));
    }

    #[test]
    fn run_names_latest_foundation_receipt_when_nested_latest_wrapper_verify_fails() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_nested_verify_failure_wording",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        overwrite_fake_basal_receipt_latest_command(
            ...
            None,
            None,
            Some("forced nested latest-basal-receipt verify failure"),
            &fixture.root,
            &paths.nested_basal_receipt_latest_session_dir,
        );
        ...
        assert!(report
            .reason
            .contains("failed verifying nested latest-basal-receipt handoff under"));
    }

    #[test]
    fn run_uses_foundation_placeholders_when_missing_snapshot_blocks_nested_handoff_summaries() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_missing_snapshot_foundation_placeholders",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        overwrite_fake_basal_receipt_latest_command(
            ...
            &fixture.basal_receipt_latest_run_json_path,
            &fixture.basal_receipt_latest_verify_json_path,
            Some("forced latest-basal-receipt plan failure without snapshot"),
            None,
            None,
            &fixture.root,
            &paths.nested_basal_receipt_latest_session_dir,
        ...
        assert_eq!(
            report
                .downstream_substructure_certificate_command_summary
                .as_deref(),
            Some("<substructure-certificate-run-unavailable>")
        );
        assert_eq!(
            report
                .verify_substructure_certificate_command_summary
                .as_deref(),
            Some("<substructure-certificate-verify-unavailable>")
        );

        let session: PackageSubstructureCertificateLatestSession =
            load_json(&paths.session_path).unwrap();
        assert_eq!(
            session.downstream_substructure_certificate_command_summary,
            "<substructure-certificate-run-unavailable>"
        );
        assert_eq!(
            session.verify_substructure_certificate_command_summary,
            "<substructure-certificate-verify-unavailable>"
        );
    }
    ...
    fn verify_fails_when_copied_native_pinnacle_receipt_sha256_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_pinnacle_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy pinnacle_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_latest_foundation_receipt_explicit_statement_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_launch_packet_explicit_statement_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.latest_basal_receipt_report_path).unwrap();
        report["explicit_statement"] =
            json!("tampered nested latest release capsule explicit statement");
        persist_json(&paths.latest_basal_receipt_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored latest-basal-receipt copy explicit_statement")
        }));
    }

    #[test]
    fn verify_rejects_tampered_stale_bedrock_wrapper_mode_string() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_wrapper_mode_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        report["mode"] = json!("run_latest_basal_receipt");
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| { entry.contains("latest-substructure-certificate stored report mode") }));
    }

    #[test]
    fn wrapper_self_modes_and_self_command_summaries_use_basal_latest_contract() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_self_mode_and_summary_shape",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let plan = plan_latest_substructure_certificate_report(&fixture.plan_config()).unwrap();
        assert_eq!(plan.mode, "plan_latest_substructure_certificate");
        assert!(plan
            .run_latest_substructure_certificate_command_summary
            .as_deref()
            .unwrap()
            .contains(SUBSTRUCTURE_CERTIFICATE_LATEST_BIN));
        assert!(plan
            .run_latest_substructure_certificate_command_summary
            .as_deref()
            .unwrap()
        ...
        assert!(!plan
            ...
            .as_deref()
            .unwrap()
            .contains("--run-latest-basal-receipt"));
        assert!(plan
            .verify_latest_substructure_certificate_command_summary
            .as_deref()
            .unwrap()
        ...
        assert!(!plan
            ...
            .as_deref()
            .unwrap()
            .contains("--verify-latest-basal-receipt"));

        let run = run_latest_substructure_certificate_report(&fixture.run_config()).unwrap();
        assert_eq!(run.mode, "run_latest_substructure_certificate");

        let verify =
            verify_latest_substructure_certificate_report(&fixture.verify_config()).unwrap();
        assert_eq!(verify.mode, "verify_latest_substructure_certificate");

        let session: PackageSubstructureCertificateLatestSession = load_json(
            &substructure_certificate_latest_paths(&fixture.wrapper_session_dir).session_path,
        )
        .unwrap();
        assert!(session
            .run_latest_substructure_certificate_command_summary
        ...
        assert!(session_json
            ...
            .is_some());
        assert!(session_json
            .get("verify_basal_receipt_command_summary")
            .is_none());
    ...
    #[test]
    fn downstream_native_bedrock_session_dir_uses_real_bedrock_certificate_session_path() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_downstream_session_dir_shape",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);

        let downstream = expected_downstream_basal_receipt_session_dir(&paths);
        let expected = paths
            .nested_basal_receipt_latest_session_dir
            .join("tiny_live_activation_package_basal_receipt_latest.basal_receipt_session");
        ...
        assert!(downstream
            ...
            .unwrap()
            .to_string_lossy()
            .contains("basal_receipt_session"));
        assert!(!downstream
            .file_name()
            .unwrap()
            .to_string_lossy()
    ...
    {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_native_cornerstone_filenames",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        let real_session = nested_substructure_certificate_session_path(
            &paths.nested_substructure_certificate_session_dir,
        );
        let real_status = nested_substructure_certificate_status_path(
            &paths.nested_substructure_certificate_session_dir,
        );
        let stale_session = paths
            .nested_substructure_certificate_session_dir
            .join("tiny_live_activation_package_basal_receipt.session.json");
        let stale_status = paths
            .nested_substructure_certificate_session_dir
            .join("tiny_live_activation_package_basal_receipt.status.json");

        assert!(
            real_session.exists(),
            "missing real native substructure session path"
        );
        assert!(
            real_status.exists(),
            "missing real native substructure status path"
        );
        assert!(
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_decision_packet_result_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_decision_packet_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy decision_packet_result")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_attestation_seal_session_dir_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_attestation_seal_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy attestation_seal_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_registry_entry_session_dir_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_registry_entry_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy registry_entry_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_notarization_receipt_session_dir_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_notarization_receipt_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy notarization_receipt_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_summary_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_chain_fingerprint_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy chain_fingerprint_summary")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_sha256_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_chain_fingerprint_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy chain_fingerprint_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_algorithm_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_chain_fingerprint_algorithm_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy chain_fingerprint_algorithm")
        }));
    }
    ...
    fn verify_fails_when_copied_native_completion_certificate_closure_certificate_sha256_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_closure_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy closure_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_archive_receipt_sha256_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_archive_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy archive_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_finality_receipt_sha256_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_finality_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy finality_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_consummation_record_sha256_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_consummation_record_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy consummation_record_sha256")
        }));
    }
    ...
    {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_completion_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy completion_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_downstream_decision_packet_confirmation_anchor_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_decision_packet_anchor_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy decision_packet_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_execute_frozen_result_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_current_authorization_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored substructure-certificate copy execute_frozen_result")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_substructure_certificate_verdict_drifts() {
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_release_capsule_verdict_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| entry.contains("stored substructure-certificate copy verdict")));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_current_live_cutover_controller_summary_drifts(
        ...
        let fixture = fake_basal_receipt_latest_fixture(
            "basal_receipt_latest_verify_current_live_cutover_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn all_modes_preserve_stage3_and_pre_activation_refusal_semantics_and_do_not_imply_activation_authorization_by_themselves(
        ...
        {
            let fixture = fake_basal_receipt_latest_fixture(
                "basal_receipt_latest_pre_activation",
                "refused_now_by_pre_activation_gate",
                "refused_now_by_pre_activation_gate",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn fake_basal_receipt_latest_fixture(
        label: &str,
        basal_receipt_latest_run_result: &str,
        ...
        let basal_receipt_latest_plan_json_path = temp_dir.join("basal_receipt_latest.plan.json");
        let basal_receipt_latest_run_json_path = temp_dir.join("basal_receipt_latest.run.json");
        let basal_receipt_latest_verify_json_path =
            temp_dir.join("basal_receipt_latest.verify.json");
        ...
        let fixture = FakeNotarizationReceiptLatestFixture {
            ...
            install_root,
            backend_command,
            basal_receipt_latest_plan_json_path,
            basal_receipt_latest_run_json_path,
            basal_receipt_latest_verify_json_path,
        ...
        persist_json(
            &fixture.basal_receipt_latest_plan_json_path,
            &default_basal_receipt_latest_plan_report(&fixture),
        )
        .unwrap();
        persist_json(
            &fixture.basal_receipt_latest_run_json_path,
            &default_basal_receipt_latest_run_report(&fixture, basal_receipt_latest_run_result),
        )
        .unwrap();
        persist_json(
            &fixture.basal_receipt_latest_verify_json_path,
            &default_basal_receipt_latest_verify_report(&fixture, basal_receipt_latest_run_result),
        )
        .unwrap();
        persist_json(
        ...
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        write_fake_basal_receipt_latest_command(
            &fixture.bin_dir.join(BASAL_RECEIPT_LATEST_BIN),
            &fixture.basal_receipt_latest_plan_json_path,
            &fixture.basal_receipt_latest_run_json_path,
            &fixture.basal_receipt_latest_verify_json_path,
        ...
        write_fake_release_capsule_command(
            &fixture.bin_dir.join(SUBSTRUCTURE_CERTIFICATE_BIN),
            &fixture.handoff_bundle_run_json_path,
            &fixture.handoff_bundle_verify_json_path,
            &fixture.handoff_bundle_session_json_path,
            &fixture.handoff_bundle_status_json_path,
    ...
    fn default_basal_receipt_latest_plan_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
    ) -> Value {
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        json!({
            "generated_at": Utc::now(),
            "mode": "plan_latest_basal_receipt",
            "verdict": BASAL_RECEIPT_LATEST_PLAN_READY,
            "reason": "latest immutable chain resolves cleanly into accepted latest-basal-receipt contract",
            ...
            "session_dir": paths.nested_basal_receipt_latest_session_dir.display().to_string(),
            ...
            "activation_authorized": false,
            "explicit_statement": "latest basal-receipt wrapper plan"
        })
    }

    fn canonical_basal_receipt_latest_result(result: &str) -> &str {
        match result {
            "runnable_when_gate_truth_turns_green" => {
                "ready_for_manual_execution_when_gate_turns_green"
            }
    ...
    fn default_basal_receipt_latest_run_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let result = canonical_basal_receipt_latest_result(result);
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        let (verdict, gate_verdict, gate_reason) = match result {
            "ready_for_manual_execution_when_gate_turns_green" => (
                "tiny_live_package_basal_receipt_latest_ready_for_manual_execution_when_gate_turns_green",
                Value::Null,
                Value::Null,
            ),
            "refused_now_by_stage3" => (
                "tiny_live_package_basal_receipt_latest_refused_now_by_stage3",
                json!("blocked"),
                json!("stage3 blocked"),
            ),
            "refused_now_by_pre_activation_gate" => (
                "tiny_live_package_basal_receipt_latest_refused_now_by_pre_activation_gate",
                json!("blocked"),
        ...
        json!({
            "generated_at": Utc::now(),
            "mode": "run_latest_basal_receipt",
            "verdict": verdict,
            "reason": format!("latest basal-receipt {result}"),
            "latest_top_step_name": "clerestory_certificate",
            "latest_top_session_dir": fixture.latest_top_session_dir.display().to_string(),
            "historical_execute_frozen_session_dir": fixture.historical_execute_frozen_session_dir.display().to_string(),
            "turn_green_session_dir": fixture.turn_green_session_dir.display().to_string(),
            ...
            "clerestory_certificate_algorithm": "sha256",
            "activation_authorized": false,
            "explicit_statement": "latest basal-receipt wrapper run"
        })
    }

    fn default_basal_receipt_latest_verify_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let mut report = default_basal_receipt_latest_run_report(fixture, result);
        report["mode"] = json!("verify_latest_basal_receipt");
        report["verdict"] = json!(BASAL_RECEIPT_LATEST_VERIFY_OK);
    ...
    fn default_provenance_certificate_session(
        ...
        let paths = substructure_certificate_latest_paths(&fixture.wrapper_session_dir);
        let basal_receipt_session_dir = expected_downstream_basal_receipt_session_dir(&paths);
        ...
        let bedrock_certificate_session_dir = fixture
            .temp_dir
            .join("downstream-foundation-receipt-bedrock-certificate-session");
        ...
        let snapshot = LatestBasalReceiptSnapshot {
        ...
        json!({
            ...
            "release_capsule_session_dir": basal_receipt_session_dir.display().to_string(),
            ...
            "wrapper_timeout_ms": snapshot.wrapper_timeout_ms,
            "service_status_max_staleness_ms": snapshot.service_status_max_staleness_ms,
            "session_dir": substructure_certificate_latest_paths(&fixture.wrapper_session_dir).nested_substructure_certificate_session_dir.display().to_string(),
            "verify_basal_receipt_command_summary": verify_basal_receipt_command_summary(&basal_receipt_session_dir),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
            ...
            "bedrock_certificate_summary": "Bedrock certificate identity: fixture immutable coronet seal over verified basal-receipt truth.",
            ...
            "substructure_certificate_summary": "Substructure certificate identity: fixture immutable signet seal over verified basal-receipt truth.",
            "substructure_certificate_sha256": "fixture-substructure-certificate-sha256",
            "substructure_certificate_algorithm": "sha256",
            "explicit_statement": "the verified basal-receipt session is the primary input here; this immutable substructure certificate freezes one final signet identity over the fully culminated chain without enabling production execution"
        })
    }
    ...
    fn default_provenance_certificate_status(
        ...
        json!({
            "status_version": "1",
            "updated_at": Utc::now(),
            "session_dir": paths.nested_substructure_certificate_session_dir.display().to_string(),
            "basal_receipt_session_dir": expected_downstream_basal_receipt_session_dir(&paths).display().to_string(),
            "bedrock_certificate_session_dir": bedrock_certificate_session_dir.display().to_string(),
            "foundation_receipt_session_dir": foundation_receipt_session_dir.display().to_string(),
            "result": result,
            "reason": reason,
            ...
            "capstone_certificate_sha256": "fixture-capstone-certificate-sha256",
            "capstone_certificate_algorithm": "sha256",
            "bedrock_certificate_summary": "Bedrock certificate identity: fixture status immutable coronet seal over verified basal-receipt truth.",
            "bedrock_certificate_sha256": "fixture-bedrock-certificate-sha256",
            "bedrock_certificate_algorithm": "sha256",
            ...
            "basal_receipt_sha256": "fixture-basal-receipt-sha256",
            "basal_receipt_algorithm": "sha256",
            "substructure_certificate_summary": "Substructure certificate identity: fixture status immutable signet seal over verified basal-receipt truth.",
            "substructure_certificate_sha256": "fixture-substructure-certificate-sha256",
            "substructure_certificate_algorithm": "sha256",
            "explicit_statement": "this substructure certificate is archival and read-only; it never executes or enables the frozen controller"
        })
    }
    ...
    fn default_provenance_certificate_run_report(
        ...
        let substructure_certificate_verdict = match result {
            "ready_for_manual_execution_when_gate_turns_green" => {
                "tiny_live_package_substructure_certificate_ready_for_manual_execution_when_gate_turns_green"
            }
            "refused_now_by_stage3" => "tiny_live_package_substructure_certificate_refused_now_by_stage3",
            "refused_now_by_pre_activation_gate" => {
                "tiny_live_package_substructure_certificate_refused_now_by_pre_activation_gate"
            }
            _ => "tiny_live_package_substructure_certificate_refused_now_by_invalid_or_drifted_contract",
        };
        let foundation_receipt_session_dir = fixture
            .temp_dir
            .join("downstream-cornerstone-certificate-foundation-receipt-session");
        ...
        json!({
            "generated_at": Utc::now(),
            "mode": "run_live_package_substructure_certificate",
            "verdict": substructure_certificate_verdict,
            ...
            "release_capsule_session_dir": expected_downstream_basal_receipt_session_dir(&paths).display().to_string(),
            ...
            "service_status_max_staleness_ms": 4500,
            "session_dir": paths.nested_substructure_certificate_session_dir.display().to_string(),
            "substructure_certificate_session_path": nested_substructure_certificate_session_path(&paths.nested_substructure_certificate_session_dir).display().to_string(),
            "substructure_certificate_status_path": nested_substructure_certificate_status_path(&paths.nested_substructure_certificate_session_dir).display().to_string(),
            "archived_basal_receipt_report_path": paths.nested_substructure_certificate_session_dir.join("tiny_live_activation_package_substructure_certificate.basal_receipt.report.json").display().to_string(),
            "result": result,
            ...
            "basal_receipt_step": status["basal_receipt_step"],
            "verify_basal_receipt_command_summary": verify_basal_receipt_command_summary(&expected_downstream_basal_receipt_session_dir(&paths)),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
    ...
    fn write_fake_basal_receipt_latest_command(
        ...
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected latest-basal-receipt session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --plan-latest-basal-receipt \"*) mode='plan';;\n  *\" --run-latest-basal-receipt \"*) mode='run';;\n  *\" --verify-latest-basal-receipt \"*) mode='verify';;\n  *) echo 'unexpected latest-basal-receipt mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  plan|run)\n    case \" $* \" in\n      *\" --root {} \"*) : ;;\n      *) echo 'unexpected root' >&2; exit 1;;\n    esac\n    ;;\nesac\ncase \"$mode\" in\n  plan) cat '{}';;\n  run) mkdir -p '{}'; cp '{}' '{}/tiny_live_activation_package_basal_receipt_latest.report.json'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
            session_dir.display(),
            root.display(),
    ...
    fn overwrite_fake_basal_receipt_latest_command(
        path: &Path,
        plan_json_path: &Path,
        run_json_path: &Path,
        verify_json_path: &Path,
    ...
    fn write_fake_release_capsule_command(
        ...
        let nested_session_path = nested_substructure_certificate_session_path(session_dir);
        let nested_status_path = nested_substructure_certificate_status_path(session_dir);
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --basal-receipt-session-dir {} \"*) : ;;\n  *) echo 'unexpected basal-receipt-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --confirm-decision-packet-session-dir {} \"*) : ;;\n  *) echo 'unexpected confirm-decision-packet-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected substructure-certificate session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --run-live-package-substructure-certificate \"*) mode='run';;\n  *\" --verify-live-package-substructure-certificate \"*) mode='verify';;\n  *) echo 'unexpected substructure-certificate mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  run) mkdir -p '{}'; cp '{}' '{}'; cp '{}' '{}'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
