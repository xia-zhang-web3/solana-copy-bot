...
const USAGE: &str = "usage: copybot_tiny_live_activation_package_cornerstone_certificate_latest --root <path> [--session-dir <path>] [--output <path>] [--json] (--plan-latest-cornerstone-certificate | --render-latest-cornerstone-certificate-script | --run-latest-cornerstone-certificate | --verify-latest-cornerstone-certificate)";
const CORNERSTONE_CERTIFICATE_LATEST_SESSION_VERSION: &str = "1";
const CORNERSTONE_CERTIFICATE_LATEST_STATUS_VERSION: &str = "1";
const KEYSTONE_RECEIPT_LATEST_BIN: &str =
    "copybot_tiny_live_activation_package_keystone_receipt_latest";
const CORNERSTONE_CERTIFICATE_BIN: &str =
    "copybot_tiny_live_activation_package_cornerstone_certificate";
const KEYSTONE_RECEIPT_LATEST_PLAN_READY: &str =
    "tiny_live_package_keystone_receipt_latest_plan_ready";
const KEYSTONE_RECEIPT_LATEST_VERIFY_OK: &str =
    "tiny_live_package_keystone_receipt_latest_verify_ok";
const CORNERSTONE_CERTIFICATE_VERIFY_OK: &str =
...
const PLANNING_SAFE_STATEMENT: &str =
    "this latest-cornerstone-certificate handoff binds the latest persisted immutable package chain to the accepted cornerstone-certificate contract, but it never overrides Stage 3 or pre-activation refusal truth, it stays archival and read-only, it never runs the frozen live cutover controller by itself, and activation_authorized remains false";
...
enum Mode {
    PlanLatestCornerstoneCertificate,
    RenderLatestCornerstoneCertificateScript,
    RunLatestCornerstoneCertificate,
    VerifyLatestCornerstoneCertificate,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum TinyLivePackageCornerstoneCertificateLatestVerdict {
    TinyLivePackageCornerstoneCertificateLatestPlanReady,
    TinyLivePackageCornerstoneCertificateLatestScriptRendered,
    TinyLivePackageCornerstoneCertificateLatestRefusedByMissingLatestChain,
    TinyLivePackageCornerstoneCertificateLatestRefusedByInvalidLatestChain,
    TinyLivePackageCornerstoneCertificateLatestRefusedByDriftedCornerstoneCertificateContract,
    TinyLivePackageCornerstoneCertificateLatestRefusedNowByStage3,
    TinyLivePackageCornerstoneCertificateLatestRefusedNowByPreActivationGate,
    TinyLivePackageCornerstoneCertificateLatestReadyForManualExecutionWhenGateTurnsGreen,
    TinyLivePackageCornerstoneCertificateLatestVerifyOk,
    TinyLivePackageCornerstoneCertificateLatestVerifyInvalid,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum LivePackageCornerstoneCertificateLatestResult {
    RefusedByMissingLatestChain,
    RefusedByInvalidLatestChain,
    RefusedByDriftedCornerstoneCertificateContract,
    RefusedNowByStage3,
...
struct PackageCornerstoneCertificateLatestStepArtifact {
    path: String,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageCornerstoneCertificateLatestSession {
    session_version: String,
    planned_at: DateTime<Utc>,
    root: String,
    session_dir: String,
    nested_keystone_receipt_latest_session_dir: String,
    nested_cornerstone_certificate_session_dir: String,
    ...
    resolve_latest_keystone_receipt_command_summary: String,
    run_latest_cornerstone_certificate_command_summary: String,
    verify_latest_cornerstone_certificate_command_summary: String,
    downstream_cornerstone_certificate_command_summary: String,
    verify_keystone_receipt_command_summary: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageCornerstoneCertificateLatestStatus {
    ...
    nested_cornerstone_certificate_session_dir: String,
    downstream_decision_packet_session_dir: String,
    result: LivePackageCornerstoneCertificateLatestResult,
    reason: String,
    latest_keystone_receipt_plan_verdict: Option<String>,
    latest_keystone_receipt_verdict: Option<String>,
    cornerstone_certificate_verdict: Option<String>,
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    latest_keystone_receipt_plan_step: Option<PackageCornerstoneCertificateLatestStepArtifact>,
    latest_keystone_receipt_step: Option<PackageCornerstoneCertificateLatestStepArtifact>,
    cornerstone_certificate_step: Option<PackageCornerstoneCertificateLatestStepArtifact>,
...
#[derive(Debug, Clone)]
struct PackageCornerstoneCertificateLatestPaths {
    session_path: PathBuf,
    status_path: PathBuf,
    report_path: PathBuf,
    latest_keystone_receipt_plan_report_path: PathBuf,
    latest_keystone_receipt_report_path: PathBuf,
    cornerstone_certificate_report_path: PathBuf,
    nested_keystone_receipt_latest_session_dir: PathBuf,
    nested_cornerstone_certificate_session_dir: PathBuf,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageCornerstoneCertificateLatestReport {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: TinyLivePackageCornerstoneCertificateLatestVerdict,
    reason: String,
    root: Option<String>,
    latest_top_step_name: Option<String>,
    latest_top_session_dir: Option<String>,
    ...
    cornerstone_certificate_latest_session_path: Option<String>,
    cornerstone_certificate_latest_status_path: Option<String>,
    cornerstone_certificate_latest_report_path: Option<String>,
    latest_keystone_receipt_plan_report_path: Option<String>,
    latest_keystone_receipt_report_path: Option<String>,
    cornerstone_certificate_report_path: Option<String>,
    nested_keystone_receipt_latest_session_dir: Option<String>,
    nested_cornerstone_certificate_session_dir: Option<String>,
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    resolve_latest_keystone_receipt_command_summary: Option<String>,
    run_latest_cornerstone_certificate_command_summary: Option<String>,
    verify_latest_cornerstone_certificate_command_summary: Option<String>,
    downstream_cornerstone_certificate_command_summary: Option<String>,
    verify_keystone_receipt_command_summary: Option<String>,
    reviewed_frozen_live_cutover_controller_command_summary: Option<String>,
    clerestory_certificate_summary: Option<String>,
    clerestory_certificate_sha256: Option<String>,
    clerestory_certificate_algorithm: Option<String>,
...
struct ResolvedLatestCulminationReceipt {
    ...
    latest_keystone_receipt_plan_raw: Value,
    latest_keystone_receipt_plan: CornerstoneCertificateLatestReportView,
}
...
enum ResolutionFailureKind {
    MissingLatestChain,
    InvalidLatestChain,
    DriftedKeystoneReceiptContract,
}
...
struct LatestCulminationReceiptResolutionFailure {
    ...
    latest_keystone_receipt_plan_raw: Option<Value>,
    latest_keystone_receipt_plan_verdict: Option<String>,
    latest_keystone_receipt_plan_reason: Option<String>,
    latest_keystone_receipt_plan_generated_at: Option<DateTime<Utc>>,
}
...
#[derive(Debug, Clone, Deserialize)]
struct KeystoneReceiptReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
    keystone_receipt_session_dir: String,
    ...
    service_status_max_staleness_ms: Option<u64>,
    session_dir: Option<String>,
    cornerstone_certificate_session_path: Option<String>,
    cornerstone_certificate_status_path: Option<String>,
    archived_keystone_receipt_report_path: Option<String>,
    result: Option<String>,
...
#[derive(Debug, Clone, Deserialize)]
struct KeystoneReceiptSessionView {
    keystone_receipt_session_dir: String,
...
#[derive(Debug, Clone, Deserialize)]
struct KeystoneReceiptStatusView {
    session_dir: String,
    keystone_receipt_session_dir: String,
    result: String,
    reason: String,
    ...
    I: IntoIterator<Item = String>,
{
    ...
    while let Some(arg) = iter.next() {
        match arg.as_str() {
            ...
            "--json" => json = true,
            "--plan-latest-cornerstone-certificate" => set_mode(
                &mut mode,
                Mode::PlanLatestCornerstoneCertificate,
                arg.as_str(),
            )?,
            "--render-latest-cornerstone-certificate-script" => set_mode(
                &mut mode,
                Mode::RenderLatestCornerstoneCertificateScript,
                arg.as_str(),
            )?,
            "--run-latest-cornerstone-certificate" => set_mode(
                &mut mode,
                Mode::RunLatestCornerstoneCertificate,
                arg.as_str(),
            )?,
            "--verify-latest-cornerstone-certificate" => set_mode(
                &mut mode,
                Mode::VerifyLatestCornerstoneCertificate,
                arg.as_str(),
            )?,
    ...
    if matches!(mode, Mode::RenderLatestCornerstoneCertificateScript) && output_path.is_none() {
        bail!("missing --output for render mode");
    }
    if matches!(
        mode,
        Mode::RunLatestCornerstoneCertificate | Mode::VerifyLatestCornerstoneCertificate
    ) && session_dir.is_none()
    {
...
fn run(config: Config) -> Result<String> {
    let report = match config.mode {
        Mode::PlanLatestCornerstoneCertificate => {
            plan_latest_cornerstone_certificate_report(&config)?
        }
        Mode::RenderLatestCornerstoneCertificateScript => {
            render_latest_cornerstone_certificate_script_report(&config)?
        }
        Mode::RunLatestCornerstoneCertificate => {
            run_latest_cornerstone_certificate_report(&config)?
        }
        Mode::VerifyLatestCornerstoneCertificate => {
            verify_latest_cornerstone_certificate_report(&config)?
        }
    };
    if config.json {
...
fn plan_latest_cornerstone_certificate_report(
    config: &Config,
) -> Result<PackageCornerstoneCertificateLatestReport> {
    let root = config
        .root
        .as_ref()
        .ok_or_else(|| anyhow!("missing --root"))?;
    let suggested_session_dir = config.session_dir.clone().unwrap_or_else(|| {
        root.join("tiny_live_activation_package_cornerstone_certificate_latest.session")
    });
    let paths = cornerstone_certificate_latest_paths(&suggested_session_dir);

    match resolve_latest_keystone_receipt(root, &paths) {
        Ok(resolved) => Ok(plan_report_from_resolution(
            "plan_latest_cornerstone_certificate",
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestPlanReady,
            format!(
                "latest immutable {} chain under {} resolves to exact latest-keystone-receipt lineage via accepted latest-keystone-receipt session {}, exact decision-packet confirmation anchor {}, and the accepted latest-cornerstone-certificate contract remains current",
                resolved.snapshot.latest_top_step_name,
                root.display(),
                paths.nested_keystone_receipt_latest_session_dir.display(),
...
fn render_latest_cornerstone_certificate_script_report(
    config: &Config,
) -> Result<PackageCornerstoneCertificateLatestReport> {
    let root = config
        .root
        ...
        Ok(resolved) => {
            write_script(
                ...
                &format!(
                    ...
                    run_latest = run_latest_cornerstone_certificate_command_summary(
                        root,
                        &paths.nested_keystone_receipt_latest_session_dir,
                    ),
                    verify_latest = verify_latest_cornerstone_certificate_command_summary(
                        &paths.nested_keystone_receipt_latest_session_dir,
                    ),
                    run_handoff_bundle = downstream_cornerstone_certificate_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_keystone_receipt_session_dir(&paths),
                        &paths.nested_cornerstone_certificate_session_dir,
                    ),
            ...
            Ok(plan_report_from_resolution(
                "render_latest_cornerstone_certificate_script",
                TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestScriptRendered,
                format!(
                    "rendered latest-cornerstone-certificate handoff script to {} using the accepted latest-keystone-receipt lineage and the accepted cornerstone-certificate contract",
                    output_path.display()
                ),
                root,
                &suggested_session_dir,
...
fn run_latest_cornerstone_certificate_report(
    config: &Config,
) -> Result<PackageCornerstoneCertificateLatestReport> {
    let root = config
        .root
    ...
    if session_dir.exists() {
        bail!(
            "refusing to overwrite existing latest-cornerstone-certificate session dir {}",
            session_dir.display()
        );
    }
    let paths = cornerstone_certificate_latest_paths(session_dir);
    create_clean_session_dir(session_dir, "latest-cornerstone-certificate")?;

    let resolution = resolve_latest_keystone_receipt(root, &paths);
    match resolution {
        Ok(resolved) => {
            run_latest_cornerstone_certificate_with_resolution(root, session_dir, &paths, &resolved)
        }
        Err(failure) => {
            run_latest_cornerstone_certificate_failure(root, session_dir, &paths, &failure)
        }
    }
}

fn verify_latest_cornerstone_certificate_report(
    config: &Config,
) -> Result<PackageCornerstoneCertificateLatestReport> {
    let session_dir = config
        .session_dir
    ...
    let session: PackageCornerstoneCertificateLatestSession = match load_json(&paths.session_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_cornerstone_certificate_latest_report_without_session(
                    session_dir,
                    vec![format!(
                    "failed reading latest-cornerstone-certificate session artifact {}: {error}",
    ...
    let status: PackageCornerstoneCertificateLatestStatus = match load_json(&paths.status_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_cornerstone_certificate_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-cornerstone-certificate status artifact {}: {error}",
    ...
    let stored_report: PackageCornerstoneCertificateLatestReport =
            ...
            Err(error) => {
                return Ok(
                    verify_invalid_cornerstone_certificate_latest_report_without_session(
                        session_dir,
                        vec![format!(
                        "failed reading latest-cornerstone-certificate report artifact {}: {error}",
    ...
    compare_string(
        &session.root,
        &status.root,
        "latest-cornerstone-certificate root consistency",
        &mut mismatches,
    );
    compare_string(
        &session.session_dir,
        &session_dir.display().to_string(),
        "latest-cornerstone-certificate session session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.session_dir,
        &session_dir.display().to_string(),
        "latest-cornerstone-certificate status session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "latest-cornerstone-certificate report session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_keystone_receipt_latest_session_dir,
        &paths
            .nested_keystone_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-cornerstone-certificate session nested_keystone_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_keystone_receipt_latest_session_dir,
        &paths
            .nested_keystone_receipt_latest_session_dir
            .display()
            .to_string(),
        "latest-cornerstone-certificate status nested_keystone_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-cornerstone-certificate report nested_keystone_receipt_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_cornerstone_certificate_session_dir,
        &paths
            .nested_cornerstone_certificate_session_dir
            .display()
            .to_string(),
        "latest-cornerstone-certificate session nested_cornerstone_certificate_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_cornerstone_certificate_session_dir,
        &paths
            .nested_cornerstone_certificate_session_dir
            .display()
            .to_string(),
        "latest-cornerstone-certificate status nested_cornerstone_certificate_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-cornerstone-certificate report nested_cornerstone_certificate_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-cornerstone-certificate session downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-cornerstone-certificate status downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-cornerstone-certificate report downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .cornerstone_certificate_latest_session_path
            .as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "latest-cornerstone-certificate report session path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .cornerstone_certificate_latest_status_path
            .as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "latest-cornerstone-certificate report status path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .cornerstone_certificate_latest_report_path
            .as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "latest-cornerstone-certificate report report path",
        &mut mismatches,
    );
    compare_string(
        &session.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-cornerstone-certificate session explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &status.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-cornerstone-certificate status explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-cornerstone-certificate report explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.mode,
        "run_latest_cornerstone_certificate",
        "latest-cornerstone-certificate stored report mode",
        &mut mismatches,
    );
    compare_string(
        &serialize_enum(&stored_report.verdict),
        &serialize_enum(&verdict_for_result(status.result)),
        "latest-cornerstone-certificate stored report verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.result.as_deref(),
        Some(serialize_enum(&status.result).as_str()),
        "latest-cornerstone-certificate stored report result consistency",
        &mut mismatches,
    );
    compare_string(
        &stored_report.reason,
        &status.reason,
        "latest-cornerstone-certificate stored report reason consistency",
        &mut mismatches,
    );
    if stored_report.activation_authorized != status.activation_authorized {
        mismatches.push(format!(
            "latest-cornerstone-certificate stored report activation_authorized {} does not match status {}",
            stored_report.activation_authorized, status.activation_authorized
        ));
    }
    compare_option_string(
        stored_report
            .latest_keystone_receipt_plan_verdict
            .as_deref(),
        status.latest_keystone_receipt_plan_verdict.as_deref(),
        "stored report latest_keystone_receipt_plan_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.latest_keystone_receipt_verdict.as_deref(),
        status.latest_keystone_receipt_verdict.as_deref(),
        "stored report latest_keystone_receipt_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.cornerstone_certificate_verdict.as_deref(),
        status.cornerstone_certificate_verdict.as_deref(),
        "stored report cornerstone_certificate_verdict",
        &mut mismatches,
    );
    compare_option_string(
    ...
    match resolution {
        Ok(resolved) => {
            ...
            let stored_latest_plan: CornerstoneCertificateLatestReportView =
                load_required_step_json(
                    &status.latest_keystone_receipt_plan_step,
                    &paths.latest_keystone_receipt_plan_report_path,
                    "latest_keystone_receipt_plan_step",
                    &mut mismatches,
                )?;
            compare_step_artifact_against_report_metadata(
                status.latest_keystone_receipt_plan_step.as_ref(),
                &paths.latest_keystone_receipt_plan_report_path,
                "plan_latest_cornerstone_certificate",
                &stored_latest_plan.verdict,
                &stored_latest_plan.reason,
                stored_latest_plan.generated_at,
                "stored latest_keystone_receipt_plan_step",
                &mut mismatches,
            );
            compare_keystone_receipt_latest_plan_against_snapshot(
                &stored_latest_plan,
                &resolved.snapshot,
                &paths.nested_keystone_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_keystone_receipt_plan_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report
            ...
            let stored_latest_run: CornerstoneCertificateLatestReportView =
                load_required_step_json(
                    &status.latest_keystone_receipt_step,
                    &paths.latest_keystone_receipt_report_path,
                    "latest_keystone_receipt_step",
                    &mut mismatches,
                )?;
            compare_step_artifact_against_report_metadata(
                status.latest_keystone_receipt_step.as_ref(),
                &paths.latest_keystone_receipt_report_path,
                "run_latest_cornerstone_certificate",
                &stored_latest_run.verdict,
                &stored_latest_run.reason,
                stored_latest_run.generated_at,
                "stored latest_keystone_receipt_step",
                &mut mismatches,
            );
            compare_keystone_receipt_latest_run_against_snapshot(
                &stored_latest_run,
                &resolved.snapshot,
                &paths.nested_keystone_receipt_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_keystone_receipt_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_keystone_receipt_verdict.as_deref(),
            ...
            let actual_latest_run: CornerstoneCertificateLatestReportView = match load_json(
                &nested_keystone_receipt_latest_report_path(
                    &paths.nested_keystone_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed loading actual nested latest-keystone-receipt report under {}: {error}",
                        paths.nested_keystone_receipt_latest_session_dir.display()
                    ));
                    fallback_keystone_receipt_latest_copy()
                }
            };
            compare_keystone_receipt_latest_copy_matches_actual(
                &stored_latest_run,
                &actual_latest_run,
                &mut mismatches,
            );
            ...
            let latest_verify_raw = match run_json_command(
                KEYSTONE_RECEIPT_LATEST_BIN,
                &latest_keystone_receipt_verify_args(
                    &paths.nested_keystone_receipt_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested latest-keystone-receipt session under {}: {error}",
                        paths.nested_keystone_receipt_latest_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !latest_verify_raw.is_null() {
                let latest_verify: CornerstoneCertificateLatestReportView =
                    serde_json::from_value(latest_verify_raw)
                        .context("failed parsing nested latest-keystone-receipt verify json")?;
                if latest_verify.verdict != KEYSTONE_RECEIPT_LATEST_VERIFY_OK {
                    mismatches.push(format!(
                        "nested latest-keystone-receipt verification is non-green: {}",
                        latest_verify.reason
                    ));
                }
            }

            let stored_handoff_bundle: KeystoneReceiptReportView = load_required_step_json(
                &status.cornerstone_certificate_step,
                &paths.cornerstone_certificate_report_path,
                "cornerstone_certificate_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.cornerstone_certificate_step.as_ref(),
                &paths.cornerstone_certificate_report_path,
                "run_live_package_cornerstone_certificate",
                &stored_handoff_bundle.verdict,
                &stored_handoff_bundle.reason,
                stored_handoff_bundle.generated_at,
                "stored cornerstone_certificate_step",
                &mut mismatches,
            );
            ...
            compare_option_string(
                ...
                "stored status cornerstone_certificate_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.cornerstone_certificate_verdict.as_deref(),
            ...
            let nested_handoff_bundle_session: KeystoneReceiptSessionView =
                match load_json(&nested_cornerstone_certificate_session_path(
                    &paths.nested_cornerstone_certificate_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                        "failed reading nested cornerstone-certificate session under {}: {error}",
                        paths.nested_cornerstone_certificate_session_dir.display()
                    ));
            ...
            let nested_handoff_bundle_status: KeystoneReceiptStatusView =
                match load_json(&nested_cornerstone_certificate_status_path(
                    &paths.nested_cornerstone_certificate_session_dir,
                )) {
                    Ok(value) => value,
                    Err(error) => {
                        mismatches.push(format!(
                        "failed reading nested cornerstone-certificate status under {}: {error}",
                        paths.nested_cornerstone_certificate_session_dir.display()
                    ));
            ...
            let handoff_bundle_verify_raw = match run_json_command(
                ...
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested cornerstone-certificate session under {}: {error}",
                        paths.nested_cornerstone_certificate_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !handoff_bundle_verify_raw.is_null() {
                let handoff_bundle_verify: KeystoneReceiptReportView =
                    serde_json::from_value(handoff_bundle_verify_raw)
                        .context("failed parsing nested cornerstone-certificate verify json")?;
                compare_option_string(
                    stored_handoff_bundle.registry_entry_session_dir.as_deref(),
                    handoff_bundle_verify.registry_entry_session_dir.as_deref(),
                    "stored cornerstone-certificate copy registry_entry_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored cornerstone-certificate copy notarization_receipt_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                ...
                compare_option_string(
                    ...
                    handoff_bundle_verify
                        .consummation_record_algorithm
                        .as_deref(),
                    "stored cornerstone-certificate copy consummation_record_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored cornerstone-certificate copy completion_certificate_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.completion_certificate_sha256.as_deref(),
                    handoff_bundle_verify.completion_certificate_sha256.as_deref(),
                    "stored cornerstone-certificate copy completion_certificate_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                ...
                compare_option_string(
                    ...
                    handoff_bundle_verify
                        .reviewed_frozen_live_cutover_controller_command_summary
                        .as_deref(),
                    "stored cornerstone-certificate copy reviewed_frozen_live_cutover_controller_command_summary",
                    &mut mismatches,
                );
                if handoff_bundle_verify.verdict != CORNERSTONE_CERTIFICATE_VERIFY_OK {
                    mismatches.push(format!(
                        "nested cornerstone-certificate verification is non-green: {}",
                        handoff_bundle_verify.reason
                    ));
                }
            }

            let expected_result = keystone_receipt_latest_result_from_nested_status(
                nested_handoff_bundle_status.result.as_str(),
            )
            .unwrap_or(
                LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract,
            );
            if status.result != expected_result {
                mismatches.push(format!(
                    "stored latest-cornerstone-certificate result {} does not match nested cornerstone-certificate result {}",
            ...
            if status.activation_authorized {
                mismatches.push(
                    "stored status activation_authorized must remain false for latest-cornerstone-certificate"
                        .to_string(),
                );
            }
            compare_option_string(
        ...
        Err(failure) => {
            ...
            if failure.latest_keystone_receipt_plan_raw.is_some() {
                let stored_latest_plan: CornerstoneCertificateLatestReportView =
                    load_required_step_json(
                        &status.latest_keystone_receipt_plan_step,
                        &paths.latest_keystone_receipt_plan_report_path,
                ...
                compare_option_string(
                    status.latest_keystone_receipt_plan_verdict.as_deref(),
                    failure.latest_keystone_receipt_plan_verdict.as_deref(),
                    "stored status latest_keystone_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_report
                        ...
                        .as_deref(),
                    failure.latest_keystone_receipt_plan_verdict.as_deref(),
                    "stored report latest_keystone_receipt_plan_verdict on failure",
                    &mut mismatches,
                );
            }
            compare_option_string(
                status.latest_keystone_receipt_verdict.as_deref(),
                None,
                "stored status latest_keystone_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_keystone_receipt_verdict.as_deref(),
                None,
                "stored report latest_keystone_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.cornerstone_certificate_verdict.as_deref(),
                None,
                "stored status cornerstone_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.cornerstone_certificate_verdict.as_deref(),
                None,
                "stored report cornerstone_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.current_pre_activation_gate_verdict.as_deref(),
    ...
    let verdict = if mismatches.is_empty() {
        TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestVerifyOk
    } else {
        TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestVerifyInvalid
    };
    let reason = if mismatches.is_empty() {
        format!(
            "latest-cornerstone-certificate session under {} is coherent with the current latest immutable chain and the accepted cornerstone-certificate contract",
            session_dir.display()
        )
    } else {
        mismatches
            .first()
            .cloned()
            .unwrap_or_else(|| "latest-cornerstone-certificate verification failed".to_string())
    };

    Ok(PackageCornerstoneCertificateLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_cornerstone_certificate".to_string(),
        verdict,
        reason,
        ...
        cornerstone_certificate_latest_session_path: Some(paths.session_path.display().to_string()),
        cornerstone_certificate_latest_status_path: Some(paths.status_path.display().to_string()),
        cornerstone_certificate_latest_report_path: Some(paths.report_path.display().to_string()),
        latest_keystone_receipt_plan_report_path: Some(
            paths
                .latest_keystone_receipt_plan_report_path
                .display()
                .to_string(),
        ),
        latest_keystone_receipt_report_path: Some(
            paths.latest_keystone_receipt_report_path.display().to_string(),
        ),
        cornerstone_certificate_report_path: Some(paths.cornerstone_certificate_report_path.display().to_string()),
        nested_keystone_receipt_latest_session_dir: Some(
            paths
                .nested_keystone_receipt_latest_session_dir
                .display()
                .to_string(),
        ),
        nested_cornerstone_certificate_session_dir: Some(
            paths.nested_cornerstone_certificate_session_dir.display().to_string(),
        ),
        ...
        latest_keystone_receipt_plan_verdict: status.latest_keystone_receipt_plan_verdict.clone(),
        latest_keystone_receipt_verdict: status.latest_keystone_receipt_verdict.clone(),
        cornerstone_certificate_verdict: status.cornerstone_certificate_verdict.clone(),
        ...
        resolve_latest_keystone_receipt_command_summary: Some(
            session.resolve_latest_keystone_receipt_command_summary.clone(),
        ),
        run_latest_cornerstone_certificate_command_summary: Some(
            session.run_latest_cornerstone_certificate_command_summary.clone(),
        ),
        verify_latest_cornerstone_certificate_command_summary: Some(
            session.verify_latest_cornerstone_certificate_command_summary.clone(),
        ),
        downstream_cornerstone_certificate_command_summary: Some(
            session.downstream_cornerstone_certificate_command_summary.clone(),
        ),
        verify_keystone_receipt_command_summary: Some(
            session.verify_keystone_receipt_command_summary.clone(),
        ),
        ...
        explicit_statement:
            "this verification proves only whether the latest immutable chain still resolves cleanly into the accepted cornerstone-certificate contract; it never runs the frozen controller"
                .to_string(),
    })
}

fn run_latest_cornerstone_certificate_with_resolution(
    root: &Path,
    session_dir: &Path,
    paths: &PackageCornerstoneCertificateLatestPaths,
    ...
    persist_json(
        &paths.latest_keystone_receipt_plan_report_path,
        &resolved.latest_keystone_receipt_plan_raw,
    )?;

    let latest_keystone_receipt_plan_step = Some(step_artifact(
        &paths.latest_keystone_receipt_plan_report_path,
        "plan_latest_cornerstone_certificate",
        &resolved.latest_keystone_receipt_plan.verdict,
        &resolved.latest_keystone_receipt_plan.reason,
        resolved.latest_keystone_receipt_plan.generated_at,
    ));

    let latest_keystone_receipt_run_raw = match run_json_command(
        KEYSTONE_RECEIPT_LATEST_BIN,
        &latest_keystone_receipt_run_args(root, &paths.nested_keystone_receipt_latest_session_dir),
    ) {
        Ok(value) => value,
        Err(error) => {
            let status =
                refusal_status(
                    ...
                    LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract,
                    format!(
                    "failed running nested latest-keystone-receipt handoff under {}: {error}",
                    paths.nested_keystone_receipt_latest_session_dir.display()
                ),
                    latest_keystone_receipt_plan_step,
                    None,
    ...
    persist_json(
        &paths.latest_keystone_receipt_report_path,
        &latest_keystone_receipt_run_raw,
    )?;
    let latest_keystone_receipt_run: CornerstoneCertificateLatestReportView =
        serde_json::from_value(latest_keystone_receipt_run_raw)
            .context("failed parsing nested latest-keystone-receipt run json")?;
    let latest_keystone_receipt_step = Some(step_artifact(
        &paths.latest_keystone_receipt_report_path,
        "run_latest_cornerstone_certificate",
        &latest_keystone_receipt_run.verdict,
        &latest_keystone_receipt_run.reason,
        latest_keystone_receipt_run.generated_at,
    ));

    if let Some(terminal_failure) =
        latest_keystone_receipt_terminal_failure(&latest_keystone_receipt_run)
    {
        let status = refusal_status(
            ...
            Some(resolved),
            terminal_failure,
            latest_keystone_receipt_run.reason.clone(),
            latest_keystone_receipt_plan_step,
            latest_keystone_receipt_step,
            None,
        );
    ...
    let latest_keystone_receipt_verify: CornerstoneCertificateLatestReportView =
        match run_json_command(
            KEYSTONE_RECEIPT_LATEST_BIN,
            &latest_keystone_receipt_verify_args(&paths.nested_keystone_receipt_latest_session_dir),
        ) {
            ...
            Err(error) => {
                ...
                refusal_status(
                    ...
                    LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract,
                    format!(
                    "failed verifying nested latest-keystone-receipt handoff under {}: {error}",
                    paths.nested_keystone_receipt_latest_session_dir.display()
                ),
                    latest_keystone_receipt_plan_step,
                    latest_keystone_receipt_step,
    ...
    if latest_keystone_receipt_verify.verdict != KEYSTONE_RECEIPT_LATEST_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
            Some(resolved),
            LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract,
            latest_keystone_receipt_verify.reason,
            latest_keystone_receipt_plan_step,
            latest_keystone_receipt_step,
            None,
        );
    ...
    let release_capsule_run_raw = match run_json_command(
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract,
                format!(
                    "failed running downstream cornerstone-certificate contract under {}: {error}",
                    paths.nested_cornerstone_certificate_session_dir.display()
                ),
                latest_keystone_receipt_plan_step,
                latest_keystone_receipt_step,
    ...
    let provenance_certificate_run: KeystoneReceiptReportView =
        serde_json::from_value(release_capsule_run_raw)
            .context("failed parsing nested cornerstone-certificate run json")?;
    let cornerstone_certificate_step = Some(step_artifact(
        &paths.cornerstone_certificate_report_path,
        "run_live_package_cornerstone_certificate",
    ...
    let provenance_certificate_verify: KeystoneReceiptReportView = match run_json_command(
        CORNERSTONE_CERTIFICATE_BIN,
        &cornerstone_certificate_verify_args(
            &resolved.snapshot,
            &expected_downstream_keystone_receipt_session_dir(paths),
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract,
                format!(
                    "failed verifying downstream cornerstone-certificate contract under {}: {error}",
                    paths.nested_cornerstone_certificate_session_dir.display()
                ),
                latest_keystone_receipt_plan_step,
                latest_keystone_receipt_step,
    ...
    if provenance_certificate_verify.verdict != CORNERSTONE_CERTIFICATE_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
    ...
    let result = keystone_receipt_latest_result_from_nested_status(
        provenance_certificate_run
            .result
            .as_deref()
            .unwrap_or_default(),
    )
    .unwrap_or(LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract);
    let status = PackageCornerstoneCertificateLatestStatus {
        status_version: CORNERSTONE_CERTIFICATE_LATEST_STATUS_VERSION.to_string(),
        updated_at: Utc::now(),
        ...
        nested_keystone_receipt_latest_session_dir: paths
            .nested_keystone_receipt_latest_session_dir
            .display()
            .to_string(),
        nested_cornerstone_certificate_session_dir: paths
            .nested_cornerstone_certificate_session_dir
            .display()
            .to_string(),
        ...
        latest_keystone_receipt_plan_verdict: Some(
            resolved.latest_keystone_receipt_plan.verdict.clone(),
        ),
        latest_keystone_receipt_verdict: Some(latest_keystone_receipt_run.verdict.clone()),
        cornerstone_certificate_verdict: Some(provenance_certificate_run.verdict.clone()),
...
fn run_latest_cornerstone_certificate_failure(
    root: &Path,
    session_dir: &Path,
    paths: &PackageCornerstoneCertificateLatestPaths,
    ...
    persist_json(&paths.session_path, &session)?;
    if let Some(value) = &failure.latest_keystone_receipt_plan_raw {
        persist_json(&paths.latest_keystone_receipt_plan_report_path, value)?;
    }
...
fn resolve_latest_keystone_receipt(
    root: &Path,
    paths: &PackageCornerstoneCertificateLatestPaths,
) -> std::result::Result<ResolvedLatestCulminationReceipt, LatestCulminationReceiptResolutionFailure>
{
    let latest_keystone_receipt_plan_raw = match run_json_command(
        KEYSTONE_RECEIPT_LATEST_BIN,
        &latest_keystone_receipt_plan_args(root, &paths.nested_keystone_receipt_latest_session_dir),
    ) {
        Ok(value) => value,
        Err(error) => {
            return Err(LatestCulminationReceiptResolutionFailure {
                ...
                snapshot: None,
                latest_keystone_receipt_plan_raw: None,
                latest_keystone_receipt_plan_verdict: None,
                latest_keystone_receipt_plan_reason: None,
                latest_keystone_receipt_plan_generated_at: None,
            });
        }
    };
    let latest_keystone_receipt_plan: CornerstoneCertificateLatestReportView =
        serde_json::from_value(latest_keystone_receipt_plan_raw.clone()).map_err(
            |error| LatestCulminationReceiptResolutionFailure {
                kind: ResolutionFailureKind::InvalidLatestChain,
                reason: format!(
                    "failed parsing latest-cornerstone-certificate upstream latest-keystone-receipt plan json for {}: {error}",
                    root.display()
                ),
                snapshot: None,
                latest_keystone_receipt_plan_raw: Some(
                    latest_keystone_receipt_plan_raw.clone(),
                ),
                latest_keystone_receipt_plan_verdict: None,
                latest_keystone_receipt_plan_reason: None,
                latest_keystone_receipt_plan_generated_at: None,
    ...
    let snapshot = parse_snapshot_from_latest_keystone_receipt(&latest_keystone_receipt_plan).ok();
    if latest_keystone_receipt_plan.verdict != KEYSTONE_RECEIPT_LATEST_PLAN_READY {
        return Err(LatestCulminationReceiptResolutionFailure {
            kind: map_keystone_receipt_latest_failure_kind(
                &latest_keystone_receipt_plan.verdict,
            ),
            reason: format!(
                "latest-cornerstone-certificate resolution refused because nested latest-keystone-receipt reported: {}",
                latest_keystone_receipt_plan.reason
            ),
            snapshot,
            latest_keystone_receipt_plan_raw: Some(latest_keystone_receipt_plan_raw),
            latest_keystone_receipt_plan_verdict: Some(
                latest_keystone_receipt_plan.verdict,
            ),
            latest_keystone_receipt_plan_reason: Some(
                latest_keystone_receipt_plan.reason,
            ),
            latest_keystone_receipt_plan_generated_at: Some(
                latest_keystone_receipt_plan.generated_at,
            ),
        });
    }

    let snapshot = parse_snapshot_from_latest_keystone_receipt(&latest_keystone_receipt_plan)
        .map_err(|error| LatestCulminationReceiptResolutionFailure {
            kind: ResolutionFailureKind::InvalidLatestChain,
            reason: format!("latest-cornerstone-certificate resolution failed: {error}"),
            snapshot: None,
            latest_keystone_receipt_plan_raw: Some(latest_keystone_receipt_plan_raw.clone()),
            latest_keystone_receipt_plan_verdict: Some(
                latest_keystone_receipt_plan.verdict.clone(),
            ),
            latest_keystone_receipt_plan_reason: Some(latest_keystone_receipt_plan.reason.clone()),
            latest_keystone_receipt_plan_generated_at: Some(
                latest_keystone_receipt_plan.generated_at,
            ),
        })?;
    ...
    if !mismatches.is_empty() {
        return Err(LatestCulminationReceiptResolutionFailure {
            kind: ResolutionFailureKind::DriftedKeystoneReceiptContract,
            reason: format!(
                "latest-cornerstone-certificate drift detected: {}",
                mismatches[0]
            ),
            snapshot: Some(snapshot),
            latest_keystone_receipt_plan_raw: Some(latest_keystone_receipt_plan_raw),
            latest_keystone_receipt_plan_verdict: Some(latest_keystone_receipt_plan.verdict),
            latest_keystone_receipt_plan_reason: Some(latest_keystone_receipt_plan.reason),
            latest_keystone_receipt_plan_generated_at: Some(
                latest_keystone_receipt_plan.generated_at,
            ),
        });
    ...
    Ok(ResolvedLatestCulminationReceipt {
        snapshot,
        latest_keystone_receipt_plan_raw,
        latest_keystone_receipt_plan,
    })
}

fn parse_snapshot_from_latest_keystone_receipt(
    ...
    if latest_top_step_name != TOP_ACCEPTED_PACKAGE_STEP {
        bail!(
            "latest-cornerstone-certificate nested latest-keystone-receipt plan top accepted step is {} instead of {}",
    ...
    if view.activation_authorized {
        bail!(
            "latest-cornerstone-certificate nested latest-keystone-receipt plan must remain planning-safe with activation_authorized=false"
        );
    }
    Ok(LatestCulminationReceiptSnapshot {
        ...
        wrapper_timeout_ms: view.wrapper_timeout_ms.ok_or_else(|| {
            anyhow!(
                "latest-cornerstone-certificate nested latest-keystone-receipt plan is missing wrapper_timeout_ms"
            )
        })?,
        service_status_max_staleness_ms: view.service_status_max_staleness_ms.ok_or_else(|| {
            anyhow!(
                "latest-cornerstone-certificate nested latest-keystone-receipt plan is missing service_status_max_staleness_ms"
            )
        })?,
...
fn plan_report_from_resolution(
    ...
    paths: &PackageCornerstoneCertificateLatestPaths,
    resolved: &ResolvedLatestCulminationReceipt,
) -> PackageCornerstoneCertificateLatestReport {
    PackageCornerstoneCertificateLatestReport {
        generated_at: Utc::now(),
        ...
        latest_keystone_receipt_report_path: Some(
            paths
                .latest_keystone_receipt_report_path
                .display()
                .to_string(),
        ),
        cornerstone_certificate_report_path: Some(
            paths
                .cornerstone_certificate_report_path
                .display()
                .to_string(),
        ),
        nested_keystone_receipt_latest_session_dir: Some(
        ...
        latest_keystone_receipt_verdict: None,
        cornerstone_certificate_verdict: None,
        result: None,
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_keystone_receipt_command_summary: Some(
            resolve_latest_keystone_receipt_command_summary(
                root,
                &paths.nested_keystone_receipt_latest_session_dir,
            ),
        ),
        run_latest_cornerstone_certificate_command_summary: Some(
            run_latest_cornerstone_certificate_command_summary(
                root,
                &paths.nested_keystone_receipt_latest_session_dir,
            ),
        ),
        verify_latest_cornerstone_certificate_command_summary: Some(
            verify_latest_cornerstone_certificate_command_summary(
                &paths.nested_keystone_receipt_latest_session_dir,
            ),
        ),
        downstream_cornerstone_certificate_command_summary: Some(
            downstream_cornerstone_certificate_command_summary(
                &resolved.snapshot,
                &expected_downstream_keystone_receipt_session_dir(paths),
                &paths.nested_cornerstone_certificate_session_dir,
            ),
...
fn report_from_resolution_failure(
    ...
    PackageCornerstoneCertificateLatestReport {
        ...
        latest_keystone_receipt_plan_verdict: failure.latest_keystone_receipt_plan_verdict.clone(),
        latest_keystone_receipt_verdict: None,
        cornerstone_certificate_verdict: None,
        ...
        downstream_cornerstone_certificate_command_summary: snapshot.map(|value| {
            downstream_cornerstone_certificate_command_summary(
                value,
                &expected_downstream_keystone_receipt_session_dir(paths),
                &paths.nested_cornerstone_certificate_session_dir,
        ...
        verify_keystone_receipt_command_summary: snapshot.map(|value| {
            verify_cornerstone_certificate_command_summary(
                value,
                &expected_downstream_keystone_receipt_session_dir(paths),
                &paths.nested_cornerstone_certificate_session_dir,
...
) -> PackageCornerstoneCertificateLatestSession {
    let snapshot = resolved
        .map(|value| &value.snapshot)
        .or_else(|| failure.and_then(|value| value.snapshot.as_ref()));
    PackageCornerstoneCertificateLatestSession {
        session_version: CORNERSTONE_CERTIFICATE_LATEST_SESSION_VERSION.to_string(),
        planned_at: Utc::now(),
        root: root.display().to_string(),
        session_dir: session_dir.display().to_string(),
        nested_keystone_receipt_latest_session_dir: paths
        ...
        downstream_cornerstone_certificate_command_summary: snapshot
            .map(|value| {
                downstream_cornerstone_certificate_command_summary(
                    value,
                    &expected_downstream_keystone_receipt_session_dir(paths),
            ...
            .unwrap_or_else(|| "<keystone-receipt-run-unavailable>".to_string()),
        verify_keystone_receipt_command_summary: snapshot
            .map(|value| {
                verify_cornerstone_certificate_command_summary(
                    value,
                    &expected_downstream_keystone_receipt_session_dir(paths),
            ...
            .unwrap_or_else(|| "<keystone-receipt-verify-unavailable>".to_string()),
        reviewed_frozen_live_cutover_controller_command_summary: snapshot.map(|value| {
            value
                .reviewed_frozen_live_cutover_controller_command_summary
                .clone()
...
fn report_from_status(
    ...
    session_dir: &Path,
    paths: &PackageCornerstoneCertificateLatestPaths,
    session: &PackageCornerstoneCertificateLatestSession,
    status: &PackageCornerstoneCertificateLatestStatus,
    verification_mismatches: Vec<String>,
) -> PackageCornerstoneCertificateLatestReport {
    PackageCornerstoneCertificateLatestReport {
        generated_at: Utc::now(),
        ...
        nested_keystone_receipt_latest_session_dir: Some(
            session.nested_keystone_receipt_latest_session_dir.clone(),
        ),
        nested_cornerstone_certificate_session_dir: Some(
            session.nested_cornerstone_certificate_session_dir.clone(),
        ),
        downstream_decision_packet_session_dir: Some(
...
fn cornerstone_certificate_latest_paths(
    session_dir: &Path,
) -> PackageCornerstoneCertificateLatestPaths {
    PackageCornerstoneCertificateLatestPaths {
        session_path: session_dir
            .join("tiny_live_activation_package_cornerstone_certificate_latest.session.json"),
        status_path: session_dir
            .join("tiny_live_activation_package_cornerstone_certificate_latest.status.json"),
        report_path: session_dir
            .join("tiny_live_activation_package_cornerstone_certificate_latest.report.json"),
        latest_keystone_receipt_plan_report_path: session_dir.join(
            "tiny_live_activation_package_cornerstone_certificate_latest.keystone_receipt_latest_plan.report.json",
        ),
        latest_keystone_receipt_report_path: session_dir.join(
            "tiny_live_activation_package_cornerstone_certificate_latest.keystone_receipt_latest.report.json",
        ),
        cornerstone_certificate_report_path: session_dir.join(
            "tiny_live_activation_package_cornerstone_certificate_latest.cornerstone_certificate.report.json",
        ),
        nested_keystone_receipt_latest_session_dir: session_dir
            .join("tiny_live_activation_package_cornerstone_certificate_latest.keystone_receipt_latest_session"),
        nested_cornerstone_certificate_session_dir: session_dir.join(
...
fn expected_downstream_decision_packet_session_dir(
    ...
    paths
        .nested_keystone_receipt_latest_session_dir
        .join("tiny_live_activation_package_keystone_receipt_latest.decision_packet_session")
}

fn expected_downstream_keystone_receipt_session_dir(
    paths: &PackageCornerstoneCertificateLatestPaths,
) -> PathBuf {
    paths
        .nested_keystone_receipt_latest_session_dir
        .join("tiny_live_activation_package_keystone_receipt_latest.keystone_receipt_session")
}
...
fn expected_downstream_review_receipt_session_dir(
    ...
    paths
        .nested_keystone_receipt_latest_session_dir
        .join("tiny_live_activation_package_keystone_receipt_latest.review_receipt_session")
}

fn latest_keystone_receipt_plan_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--plan-latest-keystone-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn latest_keystone_receipt_run_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-latest-keystone-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn latest_keystone_receipt_verify_args(session_dir: &Path) -> Vec<String> {
    vec![
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-latest-keystone-receipt".to_string(),
        "--json".to_string(),
    ]
}
...
fn cornerstone_certificate_run_args(
    ...
    vec![
        "--keystone-receipt-session-dir".to_string(),
        keystone_receipt_session_dir.display().to_string(),
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-live-package-cornerstone-certificate".to_string(),
        "--json".to_string(),
    ]
}
...
fn cornerstone_certificate_verify_args(
    ...
    vec![
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-live-package-cornerstone-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn resolve_latest_keystone_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{KEYSTONE_RECEIPT_LATEST_BIN} --root {} --session-dir {} --plan-latest-keystone-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn run_latest_cornerstone_certificate_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{KEYSTONE_RECEIPT_LATEST_BIN} --root {} --session-dir {} --run-latest-keystone-receipt --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn verify_latest_cornerstone_certificate_command_summary(session_dir: &Path) -> String {
    format!(
        "{KEYSTONE_RECEIPT_LATEST_BIN} --session-dir {} --verify-latest-keystone-receipt --json",
        shell_escape_path(session_dir),
    )
}

fn downstream_cornerstone_certificate_command_summary(
    snapshot: &LatestCulminationReceiptSnapshot,
    keystone_receipt_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{CORNERSTONE_CERTIFICATE_BIN} --keystone-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --run-live-package-cornerstone-certificate --json",
        shell_escape_path(keystone_receipt_session_dir),
...
fn verify_cornerstone_certificate_command_summary(
    ...
    format!(
        "{CORNERSTONE_CERTIFICATE_BIN} --keystone-receipt-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --verify-live-package-cornerstone-certificate --json",
        shell_escape_path(keystone_receipt_session_dir),
        shell_escape_path(&snapshot.downstream_decision_packet_session_dir),
        shell_escape_path(session_dir),
    )
...
fn nested_keystone_receipt_latest_report_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_keystone_receipt_latest.report.json")
}

fn nested_cornerstone_certificate_session_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_cornerstone_certificate.session.json")
}

fn nested_cornerstone_certificate_status_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_cornerstone_certificate.status.json")
}
...
fn write_script(path: &Path, contents: &str) -> Result<()> {
    ...
    fs::write(path, contents).with_context(|| {
        format!(
            "failed writing latest-cornerstone-certificate script to {}",
            path.display()
        )
    })?;
    #[cfg(unix)]
...
fn step_artifact(
    ...
    reason: &str,
    generated_at: DateTime<Utc>,
) -> PackageCornerstoneCertificateLatestStepArtifact {
    PackageCornerstoneCertificateLatestStepArtifact {
...
fn canonical_wrapper_mode(mode: &str) -> &str {
    match mode {
        "plan_latest_cornerstone_certificate" => "plan_latest_cornerstone_certificate",
        "render_latest_cornerstone_certificate_script" => {
            "render_latest_cornerstone_certificate_script"
        }
        "run_latest_cornerstone_certificate" => "run_latest_cornerstone_certificate",
        "verify_latest_cornerstone_certificate" => "verify_latest_cornerstone_certificate",
        other => other,
    }
}

fn load_required_step_json<T: for<'de> Deserialize<'de>>(
    step: &Option<PackageCornerstoneCertificateLatestStepArtifact>,
    expected_path: &Path,
    label: &str,
    ...
    let step = step
        .as_ref()
        .ok_or_else(|| anyhow!("{label} is missing from latest-cornerstone-certificate status"))?;
    compare_string(
        &step.path,
...
fn compare_step_artifact_against_report_metadata(
    ...
    let Some(step) = step else {
        mismatches.push(format!(
            "{label} is missing from latest-cornerstone-certificate status"
        ));
        return;
    };
    compare_string(
...
fn compare_keystone_receipt_latest_plan_against_snapshot(
    ...
    compare_option_string(
        ...
        Some(KEYSTONE_RECEIPT_LATEST_PLAN_READY),
        "stored latest-keystone-receipt plan verdict",
        mismatches,
    );
    compare_string(
        &stored.mode,
        "plan_latest_cornerstone_certificate",
        "stored latest-keystone-receipt plan mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-keystone-receipt plan latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        ...
        "stored latest-keystone-receipt plan latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-keystone-receipt plan session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        ...
        "stored latest-keystone-receipt plan reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-keystone-receipt plan clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-keystone-receipt plan clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-keystone-receipt plan clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_keystone_receipt_latest_run_against_snapshot(
    stored: &CornerstoneCertificateLatestReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_latest_cornerstone_certificate",
        "stored latest-keystone-receipt run mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-keystone-receipt run latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        ...
        "stored latest-keystone-receipt run latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-keystone-receipt run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        ...
        "stored latest-keystone-receipt run downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored latest-keystone-receipt run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored latest-keystone-receipt run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored latest-keystone-receipt run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored latest-keystone-receipt run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored latest-keystone-receipt run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored latest-keystone-receipt run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored latest-keystone-receipt run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-keystone-receipt run clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-keystone-receipt run clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-keystone-receipt run clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_keystone_receipt_latest_copy_matches_actual(
    stored: &CornerstoneCertificateLatestReportView,
    ...
    compare_option_string(
        ...
        "stored latest-keystone-receipt copy verdict",
        mismatches,
    );
    compare_option_string(
        Some(stored.reason.as_str()),
        Some(actual.reason.as_str()),
        "stored latest-keystone-receipt copy reason",
        mismatches,
    );
    if stored.generated_at != actual.generated_at {
        mismatches.push(format!(
            "stored latest-keystone-receipt copy generated_at {:?} does not match actual {:?}",
    ...
    compare_option_string(
        ...
        "stored latest-keystone-receipt copy latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        actual.latest_top_session_dir.as_deref(),
        "stored latest-keystone-receipt copy latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        actual.session_dir.as_deref(),
        "stored latest-keystone-receipt copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        actual.downstream_decision_packet_session_dir.as_deref(),
        "stored latest-keystone-receipt copy downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        actual.result.as_deref(),
        "stored latest-keystone-receipt copy result",
        mismatches,
    );
    compare_option_string(
        stored.explicit_statement.as_deref(),
        actual.explicit_statement.as_deref(),
        "stored latest-keystone-receipt copy explicit_statement",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        actual.current_pre_activation_gate_verdict.as_deref(),
        "stored latest-keystone-receipt copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        actual.current_pre_activation_gate_reason.as_deref(),
        "stored latest-keystone-receipt copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        actual
            .reviewed_frozen_live_cutover_controller_command_summary
            .as_deref(),
        "stored latest-keystone-receipt copy reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}

fn compare_keystone_receipt_run_against_snapshot(
    stored: &KeystoneReceiptReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    keystone_receipt_session_dir: &Path,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_live_package_cornerstone_certificate",
        "stored cornerstone-certificate run mode",
        mismatches,
    );
    compare_string(
        &stored.keystone_receipt_session_dir,
        &keystone_receipt_session_dir.display().to_string(),
        "stored cornerstone-certificate run keystone_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored cornerstone-certificate run decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored cornerstone-certificate run execute_frozen_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored cornerstone-certificate run turn_green_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored cornerstone-certificate run launch_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored cornerstone-certificate run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored cornerstone-certificate run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored cornerstone-certificate run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored cornerstone-certificate run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored cornerstone-certificate run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored cornerstone-certificate run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored cornerstone-certificate run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.cornerstone_certificate_session_path.as_deref(),
        Some(
            nested_cornerstone_certificate_session_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored cornerstone-certificate run cornerstone_certificate_session_path",
        mismatches,
    );
    compare_option_string(
        stored.cornerstone_certificate_status_path.as_deref(),
        Some(
            nested_cornerstone_certificate_status_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored cornerstone-certificate run cornerstone_certificate_status_path",
        mismatches,
    );
    compare_option_string(
        stored.archived_keystone_receipt_report_path.as_deref(),
        Some(
            session_dir
                .join("tiny_live_activation_package_keystone_receipt.keystone_receipt.report.json")
                .display()
                .to_string()
                .as_str(),
        ),
        "stored cornerstone-certificate run archived_keystone_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        stored.verify_keystone_receipt_command_summary.as_deref(),
        Some(
            cornerstone_certificate_verify_keystone_receipt_command_summary(
                keystone_receipt_session_dir,
            )
            .as_str(),
        ),
        "stored cornerstone-certificate run verify_keystone_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored cornerstone-certificate run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}
...
fn compare_keystone_receipt_copy_against_nested_truth(
    ...
    compare_option_string(
        ...
        "stored cornerstone-certificate copy verify_keystone_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
    ...
    compare_option_string(
        ...
        "stored cornerstone-certificate copy release_capsule_digest_manifest_sha256",
        mismatches,
    );
...
fn compare_session_against_snapshot(
    ...
    compare_string(
        &session.resolve_latest_keystone_receipt_command_summary,
        &resolve_latest_keystone_receipt_command_summary(
            root,
            &paths.nested_keystone_receipt_latest_session_dir,
        ),
        "stored session resolve_latest_keystone_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.run_latest_cornerstone_certificate_command_summary,
        &run_latest_cornerstone_certificate_command_summary(
            root,
            &paths.nested_keystone_receipt_latest_session_dir,
        ),
        "stored session run_latest_cornerstone_certificate_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_latest_cornerstone_certificate_command_summary,
        &verify_latest_cornerstone_certificate_command_summary(
            &paths.nested_keystone_receipt_latest_session_dir,
        ),
        "stored session verify_latest_cornerstone_certificate_command_summary",
        mismatches,
    );
    compare_string(
        &session.downstream_cornerstone_certificate_command_summary,
        &downstream_cornerstone_certificate_command_summary(
            snapshot,
            &expected_downstream_keystone_receipt_session_dir(paths),
            &paths.nested_cornerstone_certificate_session_dir,
        ),
        "stored session downstream_cornerstone_certificate_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_keystone_receipt_command_summary,
        &verify_cornerstone_certificate_command_summary(
            snapshot,
            &expected_downstream_keystone_receipt_session_dir(paths),
            &paths.nested_cornerstone_certificate_session_dir,
        ),
        "stored session verify_keystone_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_keystone_receipt_latest_session_dir",
        mismatches,
    );
    compare_string(
        &session.nested_cornerstone_certificate_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_cornerstone_certificate_session_dir",
        mismatches,
    );
    compare_string(
        &session.downstream_decision_packet_session_dir,
...
fn compare_report_against_snapshot(
    report: &PackageCornerstoneCertificateLatestReport,
    root: &Path,
    session_dir: &Path,
    paths: &PackageCornerstoneCertificateLatestPaths,
    snapshot: &LatestCulminationReceiptSnapshot,
    ...
    compare_option_string(
        ...
        "stored report resolve_latest_keystone_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report run_latest_cornerstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report verify_latest_cornerstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report downstream_cornerstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report.verify_keystone_receipt_command_summary.as_deref(),
        Some(
            verify_cornerstone_certificate_command_summary(
                snapshot,
                &expected_downstream_keystone_receipt_session_dir(paths),
        ...
        "stored report verify_keystone_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
    ...
    compare_option_string(
        report
            ...
            .as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "stored report cornerstone_certificate_latest_session_path",
        mismatches,
    );
    compare_option_string(
        report.cornerstone_certificate_latest_status_path.as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "stored report cornerstone_certificate_latest_status_path",
        mismatches,
    );
    compare_option_string(
        report.cornerstone_certificate_latest_report_path.as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "stored report cornerstone_certificate_latest_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_keystone_receipt_plan_report_path.as_deref(),
        Some(
            paths
                .latest_keystone_receipt_plan_report_path
                .display()
        ...
        "stored report latest_keystone_receipt_plan_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_keystone_receipt_report_path.as_deref(),
        Some(
            paths
                .latest_keystone_receipt_report_path
                .display()
        ...
        "stored report latest_keystone_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        report.cornerstone_certificate_report_path.as_deref(),
        Some(
            paths
                .cornerstone_certificate_report_path
                .display()
        ...
        "stored report cornerstone_certificate_report_path",
        mismatches,
    );
    compare_option_string(
        report.nested_keystone_receipt_latest_session_dir.as_deref(),
        Some(
            paths
                .nested_keystone_receipt_latest_session_dir
                .display()
        ...
        "stored report nested_keystone_receipt_latest_session_dir",
        mismatches,
    );
    compare_option_string(
        report.nested_cornerstone_certificate_session_dir.as_deref(),
        Some(
            paths
                .nested_cornerstone_certificate_session_dir
                .display()
        ...
        "stored report nested_cornerstone_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
...
fn compare_session_against_failure(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_keystone_receipt_latest_session_dir on failure",
        mismatches,
    );
    compare_string(
        &session.nested_cornerstone_certificate_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_cornerstone_certificate_session_dir on failure",
        mismatches,
    );
...
fn map_keystone_receipt_latest_failure_kind(verdict: &str) -> ResolutionFailureKind {
    match verdict {
        "tiny_live_package_keystone_receipt_latest_refused_by_missing_latest_chain" => {
            ResolutionFailureKind::MissingLatestChain
        }
        "tiny_live_package_keystone_receipt_latest_refused_by_drifted_keystone_receipt_contract" => {
            ResolutionFailureKind::DriftedKeystoneReceiptContract
        }
        _ => ResolutionFailureKind::InvalidLatestChain,
    }
}

fn latest_keystone_receipt_terminal_failure(
    report: &CornerstoneCertificateLatestReportView,
) -> Option<LivePackageCornerstoneCertificateLatestResult> {
    match report.result.as_deref() {
        Some("refused_by_missing_latest_chain") => {
            Some(LivePackageCornerstoneCertificateLatestResult::RefusedByMissingLatestChain)
        }
        Some("refused_by_invalid_latest_chain") => {
            Some(LivePackageCornerstoneCertificateLatestResult::RefusedByInvalidLatestChain)
        }
        Some("refused_by_drifted_keystone_receipt_contract") => {
            Some(LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract)
        }
        _ => None,
    }
}

fn keystone_receipt_latest_result_from_nested_status(
    result: &str,
) -> Option<LivePackageCornerstoneCertificateLatestResult> {
    match result {
        "ready_for_manual_execution_when_gate_turns_green" => {
            Some(LivePackageCornerstoneCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen)
        }
        "refused_now_by_stage3" => Some(LivePackageCornerstoneCertificateLatestResult::RefusedNowByStage3),
        "refused_now_by_pre_activation_gate" => {
            Some(LivePackageCornerstoneCertificateLatestResult::RefusedNowByPreActivationGate)
        }
...
fn cornerstone_certificate_run_verdict_for_result(result: &str) -> Option<&'static str> {
    match result {
        ...
        "refused_now_by_stage3" => Some("tiny_live_package_cornerstone_certificate_refused_now_by_stage3"),
        "refused_now_by_pre_activation_gate" => {
            Some("tiny_live_package_cornerstone_certificate_refused_now_by_pre_activation_gate")
        }
        "refused_now_by_invalid_or_drifted_contract" => {
            Some("tiny_live_package_cornerstone_certificate_refused_now_by_invalid_or_drifted_contract")
        }
        _ => None,
    }
}
...
fn result_from_failure_kind(
    kind: ResolutionFailureKind,
) -> LivePackageCornerstoneCertificateLatestResult {
    match kind {
        ResolutionFailureKind::MissingLatestChain => {
            LivePackageCornerstoneCertificateLatestResult::RefusedByMissingLatestChain
        }
        ResolutionFailureKind::InvalidLatestChain => {
            LivePackageCornerstoneCertificateLatestResult::RefusedByInvalidLatestChain
        }
        ResolutionFailureKind::DriftedKeystoneReceiptContract => {
            LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract
        }
...
fn verdict_for_result(
    result: LivePackageCornerstoneCertificateLatestResult,
) -> TinyLivePackageCornerstoneCertificateLatestVerdict {
    match result {
        LivePackageCornerstoneCertificateLatestResult::RefusedByMissingLatestChain => {
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestRefusedByMissingLatestChain
        }
        LivePackageCornerstoneCertificateLatestResult::RefusedByInvalidLatestChain => {
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestRefusedByInvalidLatestChain
        }
        LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract => {
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestRefusedByDriftedCornerstoneCertificateContract
        }
        LivePackageCornerstoneCertificateLatestResult::RefusedNowByStage3 => {
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestRefusedNowByStage3
        }
        LivePackageCornerstoneCertificateLatestResult::RefusedNowByPreActivationGate => {
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestRefusedNowByPreActivationGate
        }
        LivePackageCornerstoneCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestReadyForManualExecutionWhenGateTurnsGreen
        }
    }
}
...
fn operator_next_action_summary(result: LivePackageCornerstoneCertificateLatestResult) -> String {
    match result {
        LivePackageCornerstoneCertificateLatestResult::RefusedByMissingLatestChain => {
            "no immutable clerestory chain is available yet; do not manually hunt pinnacle-receipt or summit-certificate lineage by hand".to_string()
        }
        LivePackageCornerstoneCertificateLatestResult::RefusedByInvalidLatestChain => {
            "the latest immutable chain is incomplete or below the accepted clerestory layer; mint a fresh coherent clerestory chain instead of bypassing the accepted latest-cornerstone-certificate / pinnacle-receipt path".to_string()
        }
        LivePackageCornerstoneCertificateLatestResult::RefusedByDriftedCornerstoneCertificateContract => {
            "the latest chain no longer resolves cleanly into the accepted latest-cornerstone-certificate / pinnacle-receipt contract; repair that drift instead of bypassing the bounded handoff path".to_string()
        }
        LivePackageCornerstoneCertificateLatestResult::RefusedNowByStage3 => {
            "the frozen controller stays refused now by Stage 3; rerun this latest-cornerstone-certificate refresh after current Stage 3 truth turns green".to_string()
        }
        LivePackageCornerstoneCertificateLatestResult::RefusedNowByPreActivationGate => {
            "the frozen controller stays refused now by the pre-activation gate; rerun this latest-cornerstone-certificate refresh after the current pre-activation gate turns green".to_string()
        }
        LivePackageCornerstoneCertificateLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            "the latest immutable chain now resolves into the accepted cornerstone-certificate contract and one bounded latest-cornerstone-certificate handoff is ready for manual execution when gate truth turns green; this wrapper still did not run or authorize the frozen controller".to_string()
        }
    }
}
...
fn cornerstone_certificate_verify_keystone_receipt_command_summary(
    keystone_receipt_session_dir: &Path,
) -> String {
    format!(
        "verify immutable keystone-receipt session under {} before freezing the final cornerstone certificate",
        keystone_receipt_session_dir.display()
    )
}
...
fn refusal_status(
    ...
    latest_keystone_receipt_step: Option<PackageCornerstoneCertificateLatestStepArtifact>,
    cornerstone_certificate_step: Option<PackageCornerstoneCertificateLatestStepArtifact>,
) -> PackageCornerstoneCertificateLatestStatus {
    ...
    PackageCornerstoneCertificateLatestStatus {
        ...
        result,
        reason,
        latest_keystone_receipt_plan_verdict: resolved
            .map(|value| value.latest_keystone_receipt_plan.verdict.clone()),
        latest_keystone_receipt_verdict: latest_keystone_receipt_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        cornerstone_certificate_verdict: cornerstone_certificate_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
...
fn refusal_status_from_resolution_failure(
    ...
    PackageCornerstoneCertificateLatestStatus {
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        latest_keystone_receipt_plan_step: failure.latest_keystone_receipt_plan_raw.as_ref().map(
            |_| {
                step_artifact(
                    &paths.latest_keystone_receipt_plan_report_path,
                    "plan_latest_cornerstone_certificate",
                    failure
                        ...
                        .unwrap_or("<missing>"),
                    failure
                        .latest_keystone_receipt_plan_reason
                        .as_deref()
                        .unwrap_or("<missing>"),
                    failure
                        .latest_keystone_receipt_plan_generated_at
                        .unwrap_or_else(Utc::now),
                )
            },
        ),
        latest_keystone_receipt_step: None,
...
fn verify_invalid_cornerstone_certificate_latest_report_without_session(
    session_dir: &Path,
    verification_mismatches: Vec<String>,
) -> PackageCornerstoneCertificateLatestReport {
    ...
    PackageCornerstoneCertificateLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_cornerstone_certificate".to_string(),
        verdict: TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestVerifyInvalid,
        reason,
        root: None,
        ...
        session_dir: Some(session_dir.display().to_string()),
        cornerstone_certificate_latest_session_path: Some(
            cornerstone_certificate_latest_paths(session_dir)
                .session_path
                .display()
                .to_string(),
        ),
        cornerstone_certificate_latest_status_path: Some(
            cornerstone_certificate_latest_paths(session_dir)
                .status_path
                .display()
                .to_string(),
        ),
        cornerstone_certificate_latest_report_path: Some(
            cornerstone_certificate_latest_paths(session_dir)
                .report_path
                .display()
                .to_string(),
        ),
        latest_keystone_receipt_plan_report_path: None,
        latest_keystone_receipt_report_path: None,
        cornerstone_certificate_report_path: None,
        nested_keystone_receipt_latest_session_dir: None,
        nested_cornerstone_certificate_session_dir: None,
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_keystone_receipt_command_summary: None,
        run_latest_cornerstone_certificate_command_summary: None,
        verify_latest_cornerstone_certificate_command_summary: None,
        downstream_cornerstone_certificate_command_summary: None,
        verify_keystone_receipt_command_summary: None,
...
fn fallback_keystone_receipt_latest_copy() -> CornerstoneCertificateLatestReportView {
...
fn fallback_notarization_receipt_session(
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
) -> KeystoneReceiptSessionView {
    KeystoneReceiptSessionView {
        keystone_receipt_session_dir: "<missing>".to_string(),
        ...
        session_dir: session_dir.display().to_string(),
        verify_keystone_receipt_command_summary:
            cornerstone_certificate_verify_keystone_receipt_command_summary(Path::new("<missing>")),
        ...
        explicit_statement:
            "the verified keystone-receipt session is the primary input here; this immutable cornerstone certificate freezes one final regalia identity over the fully culminated chain without enabling production execution"
                .to_string(),
    }
}
...
fn fallback_notarization_receipt_status(
    ...
    KeystoneReceiptStatusView {
        ...
        cornerstone_certificate_algorithm: "sha256".to_string(),
        explicit_statement:
            "this cornerstone certificate is archival and read-only; it never executes or enables the frozen controller"
                .to_string(),
    }
}

fn render_report_lines(report: &PackageCornerstoneCertificateLatestReport) -> String {
    let mut lines = vec![
    ...
    if let Some(value) = &report.nested_keystone_receipt_latest_session_dir {
        lines.push(format!(
            "nested_keystone_receipt_latest_session_dir={value}"
        ));
    }
    ...
    if let Some(value) = &report.nested_cornerstone_certificate_session_dir {
        lines.push(format!(
            "nested_cornerstone_certificate_session_dir={value}"
        ));
    }
    if let Some(value) = &report.result {
        lines.push(format!("result={value}"));
    }
    if let Some(value) = &report.downstream_cornerstone_certificate_command_summary {
        lines.push(format!(
            "downstream_cornerstone_certificate_command_summary={value}"
        ));
    }
...
mod tests {
    ...
    struct FakeNotarizationReceiptLatestFixture {
        ...
        keystone_receipt_latest_plan_json_path: PathBuf,
        keystone_receipt_latest_run_json_path: PathBuf,
        keystone_receipt_latest_verify_json_path: PathBuf,
    ...
    impl FakeNotarizationReceiptLatestFixture {
        fn plan_config(&self) -> Config {
            Config {
                mode: Mode::PlanLatestCornerstoneCertificate,
        ...
        fn render_config(&self) -> Config {
            Config {
                mode: Mode::RenderLatestCornerstoneCertificateScript,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
        ...
        fn run_config(&self) -> Config {
            Config {
                mode: Mode::RunLatestCornerstoneCertificate,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
        ...
        fn verify_config(&self) -> Config {
            Config {
                mode: Mode::VerifyLatestCornerstoneCertificate,
                root: None,
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
    ...
    #[test]
    fn plan_mode_resolves_latest_valid_clerestory_chain_to_exact_expected_nested_latest_keystone_receipt_lineage(
    ) {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_plan_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let report = plan_latest_cornerstone_certificate_report(&fixture.plan_config()).unwrap();
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        assert_eq!(
            report.verdict,
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestPlanReady
        );
        assert_eq!(report.mode, "plan_latest_cornerstone_certificate");
        assert_eq!(
            report.latest_top_step_name.as_deref(),
        ...
        assert!(report
            ...
            .as_deref()
            .unwrap()
            .contains(CORNERSTONE_CERTIFICATE_BIN));
    }
    ...
    fn render_mode_emits_exact_downstream_provenance_certificate_contract_not_second_controller_path(
        ...
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_render_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let report =
            render_latest_cornerstone_certificate_script_report(&fixture.render_config()).unwrap();
        assert_eq!(
            report.verdict,
            TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestScriptRendered
        );
        assert_eq!(report.mode, "render_latest_cornerstone_certificate_script");
        let script = fs::read_to_string(&fixture.output_script_path).unwrap();
        assert!(script.contains(KEYSTONE_RECEIPT_LATEST_BIN));
        assert!(script.contains(CORNERSTONE_CERTIFICATE_BIN));
        assert!(script.contains("--keystone-receipt-session-dir"));
        assert!(!script.contains("--activation-ticket-session-dir"));
        assert!(script.contains("--run-live-package-cornerstone-certificate"));
        assert!(script.contains("--verify-live-package-cornerstone-certificate"));
    ...
    fn run_mode_refuses_when_latest_chain_missing_invalid_or_below_clerestory() {
        for (label, verdict, reason, expected) in [
            (
                "keystone_receipt_latest_missing",
                "tiny_live_package_keystone_receipt_latest_refused_by_missing_latest_chain",
                "no persisted immutable chain exists",
                TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestRefusedByMissingLatestChain,
            ),
            (
                "keystone_receipt_latest_invalid",
                "tiny_live_package_keystone_receipt_latest_refused_by_invalid_latest_chain",
                "latest immutable chain is incomplete",
                TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestRefusedByInvalidLatestChain,
            ),
            (
                "keystone_receipt_latest_below",
                "tiny_live_package_keystone_receipt_latest_refused_by_invalid_latest_chain",
            ...
            let mut plan: Value = load_json(&fixture.keystone_receipt_latest_plan_json_path).unwrap();
            plan["verdict"] = json!(verdict);
            plan["reason"] = json!(reason);
            if label.ends_with("below") {
                plan["latest_top_step_name"] = json!("choir_receipt");
            }
            persist_json(&fixture.keystone_receipt_latest_plan_json_path, &plan).unwrap();

            let report = run_latest_cornerstone_certificate_report(&fixture.run_config()).unwrap();
            assert_eq!(report.verdict, expected);
        }
    }

    #[test]
    fn plan_mode_maps_real_latest_keystone_receipt_drift_verdict_to_local_drift_refusal() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_plan_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        plan["reason"] = json!("real accepted latest-keystone-receipt drift");
        persist_json(&fixture.keystone_receipt_latest_plan_json_path, &plan).unwrap();
        ...
        assert_eq!(
            report.result.as_deref(),
            Some("refused_by_drifted_cornerstone_certificate_contract")
        );
    }

    #[test]
    fn run_mode_takes_terminal_drift_refusal_when_nested_latest_keystone_receipt_reports_real_drift(
    ) {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_run_drift",
            "refused_by_drifted_keystone_receipt_contract",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert_eq!(report.cornerstone_certificate_verdict.as_deref(), None);
    }

    #[test]
    fn run_mode_refuses_when_nested_release_capsule_lineage_drifts_from_latest_immutable_chain() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_handoff_bundle_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let mut run: Value = load_json(&fixture.keystone_receipt_latest_run_json_path).unwrap();
        run["package_dir"] = json!("/tampered/package");
        persist_json(&fixture.keystone_receipt_latest_run_json_path, &run).unwrap();
        ...
        assert!(report
            .reason
            .contains("stored latest-keystone-receipt run package_dir"));
    }

    #[test]
    fn verify_mode_fails_when_persisted_latest_keystone_receipt_artifacts_are_tampered_or_missing_nested_lineage_truth(
    ) {
        {
            let fixture = fake_keystone_receipt_latest_fixture(
                "keystone_receipt_latest_verify_tampered_copy",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            run_latest_cornerstone_certificate_report(&fixture.run_config()).unwrap();

            let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
            let mut report: Value = load_json(&paths.cornerstone_certificate_report_path).unwrap();
            report["decision_packet_session_dir"] = json!("/tampered/run-decision-packet-session");
            persist_json(&paths.cornerstone_certificate_report_path, &report).unwrap();

            let verify =
                verify_latest_cornerstone_certificate_report(&fixture.verify_config()).unwrap();
            assert_eq!(
                verify.verdict,
                TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestVerifyInvalid
            );
            assert!(verify.verification_mismatches.iter().any(|entry| {
                entry.contains("stored cornerstone-certificate run decision_packet_session_dir")
            }));
        }

        {
            let fixture = fake_keystone_receipt_latest_fixture(
                "keystone_receipt_latest_verify_missing_nested_truth",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            ...
            let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
            fs::remove_file(nested_keystone_receipt_latest_report_path(
                &paths.nested_keystone_receipt_latest_session_dir,
            ))
            .unwrap();
            ...
            assert!(verify.verification_mismatches.iter().any(|entry| {
                entry.contains("tiny_live_activation_package_keystone_receipt_latest.report.json")
            }));
        }
    }

    #[test]
    fn verify_accepts_real_shaped_native_keystone_identity_layers_on_happy_path() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_real_shaped_finality_paths_green",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    #[test]
    fn run_and_verify_reject_stale_capstone_wrapper_schema_for_downstream_keystone_copy() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_rejects_stale_capstone_wrapper_schema",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        assert!(paths.cornerstone_certificate_report_path.ends_with(
            "tiny_live_activation_package_cornerstone_certificate_latest.cornerstone_certificate.report.json"
        ));
        assert!(paths.cornerstone_certificate_report_path.exists());
        assert!(
            !fixture
                .wrapper_session_dir
                .join(
                    "tiny_live_activation_package_cornerstone_certificate_latest.keystone_receipt.report.json"
                )
                .exists()
        );
        ...
        let stored_step = status
            .get("cornerstone_certificate_step")
            .cloned()
            .expect("cornerstone_certificate_step should be present");
        assert!(status.get("keystone_receipt_step").is_none());
        status["keystone_receipt_step"] = stored_step;
        if let Some(object) = status.as_object_mut() {
            object.remove("cornerstone_certificate_step");
        }
        persist_json(&paths.status_path, &status).unwrap();

        let error =
            verify_latest_cornerstone_certificate_report(&fixture.verify_config()).unwrap_err();
        assert!(error.to_string().contains("cornerstone_certificate_step"));
    }

    #[test]
    fn verify_names_cornerstone_certificate_when_nested_native_session_load_breaks() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_nested_pinnacle_session_load_break",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        fs::remove_file(nested_cornerstone_certificate_session_path(
            &paths.nested_cornerstone_certificate_session_dir,
        ))
        .unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("failed reading nested cornerstone-certificate session under")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_cornerstone_certificate_session_path_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_finality_session_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.cornerstone_certificate_report_path).unwrap();
        report["cornerstone_certificate_session_path"] =
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry
                .contains("stored cornerstone-certificate run cornerstone_certificate_session_path")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_cornerstone_certificate_status_path_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_finality_status_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.cornerstone_certificate_report_path).unwrap();
        report["cornerstone_certificate_status_path"] =
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate run cornerstone_certificate_status_path")
        }));
    }
    ...
    fn verify_fails_when_copied_native_pinnacle_receipt_sha256_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_pinnacle_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy pinnacle_receipt_sha256")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_latest_keystone_receipt_explicit_statement_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_launch_packet_explicit_statement_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.latest_keystone_receipt_report_path).unwrap();
        report["explicit_statement"] =
            json!("tampered nested latest release capsule explicit statement");
        persist_json(&paths.latest_keystone_receipt_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored latest-keystone-receipt copy explicit_statement")
        }));
    }
    ...
    fn verify_rejects_tampered_stale_keystone_receipt_wrapper_mode_string() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_wrapper_mode_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        report["mode"] = json!("run_latest_keystone_receipt");
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| { entry.contains("latest-cornerstone-certificate stored report mode") }));
    }

    #[test]
    fn downstream_native_keystone_session_dir_uses_real_keystone_receipt_session_path() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_downstream_session_dir_shape",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);

        let downstream = expected_downstream_keystone_receipt_session_dir(&paths);
        let expected = paths
            .nested_keystone_receipt_latest_session_dir
            .join("tiny_live_activation_package_keystone_receipt_latest.keystone_receipt_session");
        ...
        assert!(!downstream
            ...
            .unwrap()
            .to_string_lossy()
            .contains("summit_certificate_session"));
    ...
    {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_native_cornerstone_filenames",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let real_session = nested_cornerstone_certificate_session_path(
            &paths.nested_cornerstone_certificate_session_dir,
        );
        let real_status = nested_cornerstone_certificate_status_path(
            &paths.nested_cornerstone_certificate_session_dir,
        );
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_decision_packet_result_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_decision_packet_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy decision_packet_result")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_attestation_seal_session_dir_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_attestation_seal_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy attestation_seal_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_registry_entry_session_dir_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_registry_entry_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy registry_entry_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_notarization_receipt_session_dir_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_notarization_receipt_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy notarization_receipt_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_summary_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_chain_fingerprint_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy chain_fingerprint_summary")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_sha256_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_chain_fingerprint_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy chain_fingerprint_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_algorithm_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_chain_fingerprint_algorithm_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy chain_fingerprint_algorithm")
        }));
    }
    ...
    fn verify_fails_when_copied_native_completion_certificate_closure_certificate_sha256_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_closure_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy closure_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_archive_receipt_sha256_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_archive_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy archive_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_finality_receipt_sha256_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_finality_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy finality_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_consummation_record_sha256_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_consummation_record_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy consummation_record_sha256")
        }));
    }
    ...
    {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_completion_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy completion_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_downstream_decision_packet_confirmation_anchor_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_decision_packet_anchor_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy decision_packet_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_execute_frozen_result_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_current_authorization_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored cornerstone-certificate copy execute_frozen_result")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_cornerstone_certificate_verdict_drifts() {
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_release_capsule_verdict_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| entry.contains("stored cornerstone-certificate copy verdict")));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_current_live_cutover_controller_summary_drifts(
        ...
        let fixture = fake_keystone_receipt_latest_fixture(
            "keystone_receipt_latest_verify_current_live_cutover_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn all_modes_preserve_stage3_and_pre_activation_refusal_semantics_and_do_not_imply_activation_authorization_by_themselves(
        ...
        {
            let fixture = fake_keystone_receipt_latest_fixture(
                "keystone_receipt_latest_stage3",
                "refused_now_by_stage3",
                "refused_now_by_stage3",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);

            let plan = plan_latest_cornerstone_certificate_report(&fixture.plan_config()).unwrap();
            assert_eq!(
                plan.verdict,
                TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestPlanReady
            );
            assert_eq!(plan.mode, "plan_latest_cornerstone_certificate");
            assert!(!plan.activation_authorized);

            let run = run_latest_cornerstone_certificate_report(&fixture.run_config()).unwrap();
            assert_eq!(
                run.verdict,
                TinyLivePackageCornerstoneCertificateLatestVerdict::TinyLivePackageCornerstoneCertificateLatestRefusedNowByStage3
            );
            assert_eq!(run.mode, "run_latest_cornerstone_certificate");
            ...
            assert_eq!(verify.mode, "verify_latest_cornerstone_certificate");
            assert!(!verify.activation_authorized);
        }

        {
            let fixture = fake_keystone_receipt_latest_fixture(
                "keystone_receipt_latest_pre_activation",
                "refused_now_by_pre_activation_gate",
                "refused_now_by_pre_activation_gate",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn fake_keystone_receipt_latest_fixture(
        label: &str,
        keystone_receipt_latest_run_result: &str,
        ...
        let keystone_receipt_latest_plan_json_path =
            temp_dir.join("keystone_receipt_latest.plan.json");
        let keystone_receipt_latest_run_json_path =
            temp_dir.join("keystone_receipt_latest.run.json");
        let keystone_receipt_latest_verify_json_path =
            temp_dir.join("keystone_receipt_latest.verify.json");
        ...
        let fixture = FakeNotarizationReceiptLatestFixture {
            ...
            install_root,
            backend_command,
            keystone_receipt_latest_plan_json_path,
            keystone_receipt_latest_run_json_path,
            keystone_receipt_latest_verify_json_path,
        ...
        persist_json(
            &fixture.keystone_receipt_latest_plan_json_path,
            &default_keystone_receipt_latest_plan_report(&fixture),
        )
        .unwrap();
        persist_json(
            &fixture.keystone_receipt_latest_run_json_path,
            &default_keystone_receipt_latest_run_report(
                &fixture,
                keystone_receipt_latest_run_result,
            ),
        )
        .unwrap();
        persist_json(
            &fixture.keystone_receipt_latest_verify_json_path,
            &default_keystone_receipt_latest_verify_report(
                &fixture,
                keystone_receipt_latest_run_result,
            ),
        )
        ...
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        write_fake_keystone_receipt_latest_command(
            &fixture.bin_dir.join(KEYSTONE_RECEIPT_LATEST_BIN),
            &fixture.keystone_receipt_latest_plan_json_path,
            &fixture.keystone_receipt_latest_run_json_path,
            &fixture.keystone_receipt_latest_verify_json_path,
            &fixture.root,
        ...
        write_fake_release_capsule_command(
            &fixture.bin_dir.join(CORNERSTONE_CERTIFICATE_BIN),
            &fixture.handoff_bundle_run_json_path,
            &fixture.handoff_bundle_verify_json_path,
            &fixture.handoff_bundle_session_json_path,
            &fixture.handoff_bundle_status_json_path,
    ...
    fn default_keystone_receipt_latest_plan_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
    ) -> Value {
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        json!({
            "generated_at": Utc::now(),
            "mode": "plan_latest_cornerstone_certificate",
            "verdict": KEYSTONE_RECEIPT_LATEST_PLAN_READY,
            "reason": "latest immutable chain resolves cleanly into accepted latest-keystone-receipt contract",
            ...
            "session_dir": paths.nested_keystone_receipt_latest_session_dir.display().to_string(),
            ...
            "activation_authorized": false,
            "explicit_statement": "latest keystone-receipt wrapper plan"
        })
    }

    fn canonical_keystone_receipt_latest_result(result: &str) -> &str {
        match result {
            "runnable_when_gate_truth_turns_green" => {
                "ready_for_manual_execution_when_gate_turns_green"
            }
    ...
    fn default_keystone_receipt_latest_run_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let result = canonical_keystone_receipt_latest_result(result);
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let (verdict, gate_verdict, gate_reason) = match result {
            "ready_for_manual_execution_when_gate_turns_green" => (
                "tiny_live_package_keystone_receipt_latest_ready_for_manual_execution_when_gate_turns_green",
                Value::Null,
                Value::Null,
            ),
            "refused_now_by_stage3" => (
                "tiny_live_package_keystone_receipt_latest_refused_now_by_stage3",
                json!("blocked"),
                json!("stage3 blocked"),
            ),
            "refused_now_by_pre_activation_gate" => (
                "tiny_live_package_keystone_receipt_latest_refused_now_by_pre_activation_gate",
                json!("blocked"),
        ...
        json!({
            "generated_at": Utc::now(),
            "mode": "run_latest_cornerstone_certificate",
            "verdict": verdict,
            "reason": format!("latest keystone-receipt {result}"),
            "latest_top_step_name": "clerestory_certificate",
            "latest_top_session_dir": fixture.latest_top_session_dir.display().to_string(),
            "historical_execute_frozen_session_dir": fixture.historical_execute_frozen_session_dir.display().to_string(),
            "turn_green_session_dir": fixture.turn_green_session_dir.display().to_string(),
            ...
            "clerestory_certificate_algorithm": "sha256",
            "activation_authorized": false,
            "explicit_statement": "latest keystone-receipt wrapper run"
        })
    }

    fn default_keystone_receipt_latest_verify_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let mut report = default_keystone_receipt_latest_run_report(fixture, result);
        report["mode"] = json!("verify_latest_cornerstone_certificate");
        report["verdict"] = json!(KEYSTONE_RECEIPT_LATEST_VERIFY_OK);
    ...
    fn default_provenance_certificate_session(
        ...
        let paths = cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir);
        let keystone_receipt_session_dir = expected_downstream_keystone_receipt_session_dir(&paths);
        ...
        json!({
            "session_version": "1",
            "planned_at": Utc::now(),
            "keystone_receipt_session_dir": keystone_receipt_session_dir.display().to_string(),
            ...
            "release_capsule_session_dir": keystone_receipt_session_dir.display().to_string(),
            ...
            "wrapper_timeout_ms": snapshot.wrapper_timeout_ms,
            "service_status_max_staleness_ms": snapshot.service_status_max_staleness_ms,
            "session_dir": cornerstone_certificate_latest_paths(&fixture.wrapper_session_dir).nested_cornerstone_certificate_session_dir.display().to_string(),
            "verify_keystone_receipt_command_summary": cornerstone_certificate_verify_keystone_receipt_command_summary(&keystone_receipt_session_dir),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
            ...
            "explicit_statement": "the verified keystone-receipt session is the primary input here; this immutable cornerstone certificate freezes one final regalia identity over the fully culminated chain without enabling production execution"
        })
    }
    ...
    fn default_provenance_certificate_status(
        ...
        json!({
            "status_version": "1",
            "updated_at": Utc::now(),
            "session_dir": paths.nested_cornerstone_certificate_session_dir.display().to_string(),
            "keystone_receipt_session_dir": expected_downstream_keystone_receipt_session_dir(&paths).display().to_string(),
            "result": result,
            "reason": reason,
            ...
            "cornerstone_certificate_sha256": "fixture-cornerstone-certificate-sha256",
            "cornerstone_certificate_algorithm": "sha256",
            "explicit_statement": "this cornerstone certificate is archival and read-only; it never executes or enables the frozen controller"
        })
    }
    ...
    fn default_provenance_certificate_run_report(
        ...
        let cornerstone_certificate_verdict = match result {
            "ready_for_manual_execution_when_gate_turns_green" => {
                "tiny_live_package_cornerstone_certificate_ready_for_manual_execution_when_gate_turns_green"
            }
            "refused_now_by_stage3" => "tiny_live_package_cornerstone_certificate_refused_now_by_stage3",
            "refused_now_by_pre_activation_gate" => {
                "tiny_live_package_cornerstone_certificate_refused_now_by_pre_activation_gate"
            }
            _ => "tiny_live_package_cornerstone_certificate_refused_now_by_invalid_or_drifted_contract",
        };
        json!({
            "generated_at": Utc::now(),
            "mode": "run_live_package_cornerstone_certificate",
            "verdict": cornerstone_certificate_verdict,
            ...
            "release_capsule_session_dir": expected_downstream_keystone_receipt_session_dir(&paths).display().to_string(),
            ...
            "service_status_max_staleness_ms": 4500,
            "session_dir": paths.nested_cornerstone_certificate_session_dir.display().to_string(),
            "cornerstone_certificate_session_path": nested_cornerstone_certificate_session_path(&paths.nested_cornerstone_certificate_session_dir).display().to_string(),
            "cornerstone_certificate_status_path": nested_cornerstone_certificate_status_path(&paths.nested_cornerstone_certificate_session_dir).display().to_string(),
            "archived_keystone_receipt_report_path": paths.nested_cornerstone_certificate_session_dir.join("tiny_live_activation_package_keystone_receipt.keystone_receipt.report.json").display().to_string(),
            "result": result,
            ...
            "cornerstone_certificate_step": Value::Null,
            "verify_keystone_receipt_command_summary": cornerstone_certificate_verify_keystone_receipt_command_summary(&expected_downstream_keystone_receipt_session_dir(&paths)),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
            ...
            "cornerstone_certificate_summary": "Cornerstone certificate identity: fixture run immutable imperial seal over verified keystone-receipt truth.",
            "cornerstone_certificate_sha256": "fixture-cornerstone-certificate-sha256",
            "cornerstone_certificate_algorithm": "sha256",
    ...
    fn write_fake_keystone_receipt_latest_command(
        ...
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected latest-keystone-receipt session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --plan-latest-keystone-receipt \"*) mode='plan';;\n  *\" --run-latest-keystone-receipt \"*) mode='run';;\n  *\" --verify-latest-keystone-receipt \"*) mode='verify';;\n  *) echo 'unexpected latest-keystone-receipt mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  plan|run)\n    case \" $* \" in\n      *\" --root {} \"*) : ;;\n      *) echo 'unexpected root' >&2; exit 1;;\n    esac\n    ;;\nesac\ncase \"$mode\" in\n  plan) cat '{}';;\n  run) mkdir -p '{}'; cp '{}' '{}/tiny_live_activation_package_keystone_receipt_latest.report.json'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
            session_dir.display(),
            root.display(),
    ...
    fn write_fake_release_capsule_command(
        ...
        let nested_session_path = nested_cornerstone_certificate_session_path(session_dir);
        let nested_status_path = nested_cornerstone_certificate_status_path(session_dir);
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --keystone-receipt-session-dir {} \"*) : ;;\n  *) echo 'unexpected keystone-receipt-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --confirm-decision-packet-session-dir {} \"*) : ;;\n  *) echo 'unexpected confirm-decision-packet-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected keystone-receipt session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --run-live-package-cornerstone-certificate \"*) mode='run';;\n  *\" --verify-live-package-cornerstone-certificate \"*) mode='verify';;\n  *) echo 'unexpected cornerstone-certificate mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  run) mkdir -p '{}'; cp '{}' '{}'; cp '{}' '{}'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
