...
const USAGE: &str = "usage: copybot_tiny_live_activation_package_keystone_receipt_latest --root <path> [--session-dir <path>] [--output <path>] [--json] (--plan-latest-keystone-receipt | --render-latest-keystone-receipt-script | --run-latest-keystone-receipt | --verify-latest-keystone-receipt)";
const KEYSTONE_RECEIPT_LATEST_SESSION_VERSION: &str = "1";
const KEYSTONE_RECEIPT_LATEST_STATUS_VERSION: &str = "1";
const CAPSTONE_CERTIFICATE_LATEST_BIN: &str =
    "copybot_tiny_live_activation_package_capstone_certificate_latest";
const KEYSTONE_RECEIPT_BIN: &str = "copybot_tiny_live_activation_package_keystone_receipt";
const CAPSTONE_CERTIFICATE_LATEST_PLAN_READY: &str =
    "tiny_live_package_capstone_certificate_latest_plan_ready";
const CAPSTONE_CERTIFICATE_LATEST_VERIFY_OK: &str =
    "tiny_live_package_capstone_certificate_latest_verify_ok";
const KEYSTONE_RECEIPT_VERIFY_OK: &str = "tiny_live_package_keystone_receipt_verify_ok";
const TOP_ACCEPTED_PACKAGE_STEP: &str = "clerestory_certificate";
const PLANNING_SAFE_STATEMENT: &str =
    "this latest-keystone-receipt handoff binds the latest persisted immutable package chain to the accepted keystone-receipt contract, but it never overrides Stage 3 or pre-activation refusal truth, it stays archival and read-only, it never runs the frozen live cutover controller by itself, and activation_authorized remains false";
...
enum Mode {
    PlanLatestKeystoneReceipt,
    RenderLatestKeystoneReceiptScript,
    RunLatestKeystoneReceipt,
    VerifyLatestKeystoneReceipt,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum TinyLivePackageKeystoneReceiptLatestVerdict {
    TinyLivePackageKeystoneReceiptLatestPlanReady,
    TinyLivePackageKeystoneReceiptLatestScriptRendered,
    TinyLivePackageKeystoneReceiptLatestRefusedByMissingLatestChain,
    TinyLivePackageKeystoneReceiptLatestRefusedByInvalidLatestChain,
    TinyLivePackageKeystoneReceiptLatestRefusedByDriftedKeystoneReceiptContract,
    TinyLivePackageKeystoneReceiptLatestRefusedNowByStage3,
    TinyLivePackageKeystoneReceiptLatestRefusedNowByPreActivationGate,
    TinyLivePackageKeystoneReceiptLatestReadyForManualExecutionWhenGateTurnsGreen,
    TinyLivePackageKeystoneReceiptLatestVerifyOk,
    TinyLivePackageKeystoneReceiptLatestVerifyInvalid,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
enum LivePackageKeystoneReceiptLatestResult {
    RefusedByMissingLatestChain,
    RefusedByInvalidLatestChain,
    RefusedByDriftedKeystoneReceiptContract,
    RefusedNowByStage3,
...
struct PackageKeystoneReceiptLatestStepArtifact {
    path: String,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageKeystoneReceiptLatestSession {
    session_version: String,
    planned_at: DateTime<Utc>,
    root: String,
    session_dir: String,
    nested_capstone_certificate_latest_session_dir: String,
    nested_keystone_receipt_session_dir: String,
    ...
    resolve_latest_capstone_certificate_command_summary: String,
    run_latest_keystone_receipt_command_summary: String,
    verify_latest_keystone_receipt_command_summary: String,
    downstream_keystone_receipt_command_summary: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageKeystoneReceiptLatestStatus {
    ...
    nested_keystone_receipt_session_dir: String,
    downstream_decision_packet_session_dir: String,
    result: LivePackageKeystoneReceiptLatestResult,
    reason: String,
    latest_capstone_certificate_plan_verdict: Option<String>,
    latest_capstone_certificate_verdict: Option<String>,
    keystone_receipt_verdict: Option<String>,
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    latest_capstone_certificate_plan_step: Option<PackageKeystoneReceiptLatestStepArtifact>,
    latest_capstone_certificate_step: Option<PackageKeystoneReceiptLatestStepArtifact>,
    keystone_receipt_step: Option<PackageKeystoneReceiptLatestStepArtifact>,
...
#[derive(Debug, Clone)]
struct PackageKeystoneReceiptLatestPaths {
    session_path: PathBuf,
    status_path: PathBuf,
    report_path: PathBuf,
    latest_capstone_certificate_plan_report_path: PathBuf,
    latest_capstone_certificate_report_path: PathBuf,
    keystone_receipt_report_path: PathBuf,
    nested_capstone_certificate_latest_session_dir: PathBuf,
    nested_keystone_receipt_session_dir: PathBuf,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
struct PackageKeystoneReceiptLatestReport {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: TinyLivePackageKeystoneReceiptLatestVerdict,
    reason: String,
    root: Option<String>,
    latest_top_step_name: Option<String>,
    latest_top_session_dir: Option<String>,
    ...
    keystone_receipt_latest_session_path: Option<String>,
    keystone_receipt_latest_status_path: Option<String>,
    keystone_receipt_latest_report_path: Option<String>,
    latest_capstone_certificate_plan_report_path: Option<String>,
    latest_capstone_certificate_report_path: Option<String>,
    keystone_receipt_report_path: Option<String>,
    nested_capstone_certificate_latest_session_dir: Option<String>,
    nested_keystone_receipt_session_dir: Option<String>,
    ...
    current_pre_activation_gate_verdict: Option<String>,
    current_pre_activation_gate_reason: Option<String>,
    resolve_latest_capstone_certificate_command_summary: Option<String>,
    run_latest_keystone_receipt_command_summary: Option<String>,
    verify_latest_keystone_receipt_command_summary: Option<String>,
    downstream_keystone_receipt_command_summary: Option<String>,
...
struct ResolvedLatestCulminationReceipt {
    ...
    latest_capstone_certificate_plan_raw: Value,
    latest_capstone_certificate_plan: KeystoneReceiptLatestReportView,
}
...
enum ResolutionFailureKind {
    MissingLatestChain,
    InvalidLatestChain,
    DriftedCapstoneCertificateContract,
}
...
struct LatestCulminationReceiptResolutionFailure {
    ...
    latest_capstone_certificate_plan_raw: Option<Value>,
    latest_capstone_certificate_plan_verdict: Option<String>,
    latest_capstone_certificate_plan_reason: Option<String>,
    latest_capstone_certificate_plan_generated_at: Option<DateTime<Utc>>,
}

#[derive(Debug, Clone, Deserialize)]
struct KeystoneReceiptLatestReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Deserialize)]
struct CapstoneCertificateReportView {
    generated_at: DateTime<Utc>,
    mode: String,
    verdict: String,
    reason: String,
...
#[derive(Debug, Clone, Deserialize)]
struct CapstoneCertificateSessionView {
    capstone_certificate_session_dir: String,
...
#[derive(Debug, Clone, Deserialize)]
struct CapstoneCertificateStatusView {
    session_dir: String,
    capstone_certificate_session_dir: String,
    result: String,
    reason: String,
    ...
    I: IntoIterator<Item = String>,
{
    ...
    while let Some(arg) = iter.next() {
        match arg.as_str() {
            ...
            "--json" => json = true,
            "--plan-latest-keystone-receipt" => {
                set_mode(&mut mode, Mode::PlanLatestKeystoneReceipt, arg.as_str())?
            }
            "--render-latest-keystone-receipt-script" => set_mode(
                &mut mode,
                Mode::RenderLatestKeystoneReceiptScript,
                arg.as_str(),
            )?,
            "--run-latest-keystone-receipt" => {
                set_mode(&mut mode, Mode::RunLatestKeystoneReceipt, arg.as_str())?
            }
            "--verify-latest-keystone-receipt" => {
                set_mode(&mut mode, Mode::VerifyLatestKeystoneReceipt, arg.as_str())?
            }
    ...
    if matches!(
        mode,
        Mode::PlanLatestKeystoneReceipt
            | Mode::RenderLatestKeystoneReceiptScript
            | Mode::RunLatestKeystoneReceipt
    ) && root.is_none()
    {
        bail!("missing --root");
    }
    if matches!(mode, Mode::RenderLatestKeystoneReceiptScript) && output_path.is_none() {
        bail!("missing --output for render mode");
    }
    if matches!(
        mode,
        Mode::RunLatestKeystoneReceipt | Mode::VerifyLatestKeystoneReceipt
    ) && session_dir.is_none()
    {
...
fn run(config: Config) -> Result<String> {
    let report = match config.mode {
        Mode::PlanLatestKeystoneReceipt => plan_latest_keystone_receipt_report(&config)?,
        Mode::RenderLatestKeystoneReceiptScript => {
            render_latest_keystone_receipt_script_report(&config)?
        }
        Mode::RunLatestKeystoneReceipt => run_latest_keystone_receipt_report(&config)?,
        Mode::VerifyLatestKeystoneReceipt => verify_latest_keystone_receipt_report(&config)?,
    };
    if config.json {
...
fn plan_latest_keystone_receipt_report(
    config: &Config,
) -> Result<PackageKeystoneReceiptLatestReport> {
    let root = config
        .root
        .as_ref()
        .ok_or_else(|| anyhow!("missing --root"))?;
    let suggested_session_dir = config.session_dir.clone().unwrap_or_else(|| {
        root.join("tiny_live_activation_package_keystone_receipt_latest.session")
    });
    let paths = keystone_receipt_latest_paths(&suggested_session_dir);

    match resolve_latest_capstone_certificate(root, &paths) {
        Ok(resolved) => Ok(plan_report_from_resolution(
            "plan_latest_keystone_receipt",
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestPlanReady,
            format!(
                "latest immutable {} chain under {} resolves to exact latest-capstone-certificate lineage via accepted latest-capstone-certificate session {}, exact decision-packet confirmation anchor {}, and the accepted latest-keystone-receipt contract remains current",
                resolved.snapshot.latest_top_step_name,
                root.display(),
                paths.nested_capstone_certificate_latest_session_dir.display(),
...
fn render_latest_keystone_receipt_script_report(
    config: &Config,
) -> Result<PackageKeystoneReceiptLatestReport> {
    let root = config
        .root
        ...
        Ok(resolved) => {
            write_script(
                ...
                &format!(
                    ...
                    run_latest = run_latest_keystone_receipt_command_summary(
                        root,
                        &paths.nested_capstone_certificate_latest_session_dir,
                    ),
                    verify_latest = verify_latest_keystone_receipt_command_summary(
                        &paths.nested_capstone_certificate_latest_session_dir,
                    ),
                    run_handoff_bundle = downstream_keystone_receipt_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_capstone_certificate_session_dir(&paths),
                        &paths.nested_keystone_receipt_session_dir,
                    ),
                    verify_handoff_bundle = verify_keystone_receipt_command_summary(
                        &resolved.snapshot,
                        &expected_downstream_capstone_certificate_session_dir(&paths),
                        &paths.nested_keystone_receipt_session_dir,
                    ),
            ...
            Ok(plan_report_from_resolution(
                "render_latest_keystone_receipt_script",
                TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestScriptRendered,
                format!(
                    "rendered latest-keystone-receipt handoff script to {} using the accepted latest-capstone-certificate lineage and the accepted keystone-receipt contract",
                    output_path.display()
                ),
                root,
                &suggested_session_dir,
...
fn run_latest_keystone_receipt_report(
    config: &Config,
) -> Result<PackageKeystoneReceiptLatestReport> {
    let root = config
        .root
    ...
    if session_dir.exists() {
        bail!(
            "refusing to overwrite existing latest-keystone-receipt session dir {}",
            session_dir.display()
        );
    }
    let paths = keystone_receipt_latest_paths(session_dir);
    create_clean_session_dir(session_dir, "latest-keystone-receipt")?;

    let resolution = resolve_latest_capstone_certificate(root, &paths);
    match resolution {
        Ok(resolved) => {
            run_latest_keystone_receipt_with_resolution(root, session_dir, &paths, &resolved)
        }
        Err(failure) => run_latest_keystone_receipt_failure(root, session_dir, &paths, &failure),
    }
}

fn verify_latest_keystone_receipt_report(
    config: &Config,
) -> Result<PackageKeystoneReceiptLatestReport> {
    let session_dir = config
        .session_dir
    ...
    let session: PackageKeystoneReceiptLatestSession = match load_json(&paths.session_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_keystone_receipt_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-keystone-receipt session artifact {}: {error}",
    ...
    let status: PackageKeystoneReceiptLatestStatus = match load_json(&paths.status_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_keystone_receipt_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-keystone-receipt status artifact {}: {error}",
    ...
    let stored_report: PackageKeystoneReceiptLatestReport = match load_json(&paths.report_path) {
        Ok(value) => value,
        Err(error) => {
            return Ok(
                verify_invalid_keystone_receipt_latest_report_without_session(
                    session_dir,
                    vec![format!(
                        "failed reading latest-keystone-receipt report artifact {}: {error}",
    ...
    compare_string(
        &session.root,
        &status.root,
        "latest-keystone-receipt root consistency",
        &mut mismatches,
    );
    compare_string(
        &session.session_dir,
        &session_dir.display().to_string(),
        "latest-keystone-receipt session session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.session_dir,
        &session_dir.display().to_string(),
        "latest-keystone-receipt status session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "latest-keystone-receipt report session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_capstone_certificate_latest_session_dir,
        &paths
            .nested_capstone_certificate_latest_session_dir
            .display()
            .to_string(),
        "latest-keystone-receipt session nested_capstone_certificate_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_capstone_certificate_latest_session_dir,
        &paths
            .nested_capstone_certificate_latest_session_dir
            .display()
            .to_string(),
        "latest-keystone-receipt status nested_capstone_certificate_latest_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-keystone-receipt report nested_capstone_certificate_latest_session_dir",
        &mut mismatches,
    );
    compare_string(
        &session.nested_keystone_receipt_session_dir,
        &paths
            .nested_keystone_receipt_session_dir
            .display()
            .to_string(),
        "latest-keystone-receipt session nested_keystone_receipt_session_dir",
        &mut mismatches,
    );
    compare_string(
        &status.nested_keystone_receipt_session_dir,
        &paths
            .nested_keystone_receipt_session_dir
            .display()
            .to_string(),
        "latest-keystone-receipt status nested_keystone_receipt_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.nested_keystone_receipt_session_dir.as_deref(),
        Some(
            paths
                .nested_keystone_receipt_session_dir
                .display()
        ...
        "latest-keystone-receipt report nested_keystone_receipt_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-keystone-receipt session downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_string(
        ...
        &expected_downstream_decision_packet_session_dir(&paths)
            .display()
            .to_string(),
        "latest-keystone-receipt status downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
        ...
        "latest-keystone-receipt report downstream_decision_packet_session_dir",
        &mut mismatches,
    );
    compare_option_string(
        stored_report
            .keystone_receipt_latest_session_path
            .as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "latest-keystone-receipt report session path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.keystone_receipt_latest_status_path.as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "latest-keystone-receipt report status path",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.keystone_receipt_latest_report_path.as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "latest-keystone-receipt report report path",
        &mut mismatches,
    );
    compare_string(
        &session.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-keystone-receipt session explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &status.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-keystone-receipt status explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.explicit_statement,
        PLANNING_SAFE_STATEMENT,
        "latest-keystone-receipt report explicit_statement",
        &mut mismatches,
    );
    compare_string(
        &stored_report.mode,
        "run_latest_keystone_receipt",
        "latest-keystone-receipt stored report mode",
        &mut mismatches,
    );
    compare_string(
        &serialize_enum(&stored_report.verdict),
        &serialize_enum(&verdict_for_result(status.result)),
        "latest-keystone-receipt stored report verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.result.as_deref(),
        Some(serialize_enum(&status.result).as_str()),
        "latest-keystone-receipt stored report result consistency",
        &mut mismatches,
    );
    compare_string(
        &stored_report.reason,
        &status.reason,
        "latest-keystone-receipt stored report reason consistency",
        &mut mismatches,
    );
    if stored_report.activation_authorized != status.activation_authorized {
        mismatches.push(format!(
            "latest-keystone-receipt stored report activation_authorized {} does not match status {}",
            stored_report.activation_authorized, status.activation_authorized
        ));
    }
    compare_option_string(
        stored_report
            .latest_capstone_certificate_plan_verdict
            .as_deref(),
        status.latest_capstone_certificate_plan_verdict.as_deref(),
        "stored report latest_capstone_certificate_plan_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.latest_capstone_certificate_verdict.as_deref(),
        status.latest_capstone_certificate_verdict.as_deref(),
        "stored report latest_capstone_certificate_verdict",
        &mut mismatches,
    );
    compare_option_string(
        stored_report.keystone_receipt_verdict.as_deref(),
        status.keystone_receipt_verdict.as_deref(),
        "stored report keystone_receipt_verdict",
        &mut mismatches,
    );
    compare_option_string(
    ...
    match resolution {
        Ok(resolved) => {
            ...
            let stored_latest_plan: KeystoneReceiptLatestReportView = load_required_step_json(
                &status.latest_capstone_certificate_plan_step,
                &paths.latest_capstone_certificate_plan_report_path,
                "latest_capstone_certificate_plan_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_capstone_certificate_plan_step.as_ref(),
                &paths.latest_capstone_certificate_plan_report_path,
                "plan_latest_keystone_receipt",
                &stored_latest_plan.verdict,
                &stored_latest_plan.reason,
                stored_latest_plan.generated_at,
                "stored latest_capstone_certificate_plan_step",
                &mut mismatches,
            );
            compare_capstone_certificate_latest_plan_against_snapshot(
                &stored_latest_plan,
                &resolved.snapshot,
                &paths.nested_capstone_certificate_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_capstone_certificate_plan_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report
            ...
            let stored_latest_run: KeystoneReceiptLatestReportView = load_required_step_json(
                &status.latest_capstone_certificate_step,
                &paths.latest_capstone_certificate_report_path,
                "latest_capstone_certificate_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.latest_capstone_certificate_step.as_ref(),
                &paths.latest_capstone_certificate_report_path,
                "run_latest_keystone_receipt",
                &stored_latest_run.verdict,
                &stored_latest_run.reason,
                stored_latest_run.generated_at,
                "stored latest_capstone_certificate_step",
                &mut mismatches,
            );
            compare_capstone_certificate_latest_run_against_snapshot(
                &stored_latest_run,
                &resolved.snapshot,
                &paths.nested_capstone_certificate_latest_session_dir,
                &mut mismatches,
            ...
            compare_option_string(
                ...
                "stored status latest_capstone_certificate_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_capstone_certificate_verdict.as_deref(),
            ...
            let actual_latest_run: KeystoneReceiptLatestReportView = match load_json(
                &nested_capstone_certificate_latest_report_path(
                    &paths.nested_capstone_certificate_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed loading actual nested latest-capstone-certificate report under {}: {error}",
                        paths.nested_capstone_certificate_latest_session_dir.display()
                    ));
                    fallback_capstone_certificate_latest_copy()
                }
            };
            compare_capstone_certificate_latest_copy_matches_actual(
                &stored_latest_run,
                &actual_latest_run,
                &mut mismatches,
            );
            ...
            let latest_verify_raw = match run_json_command(
                CAPSTONE_CERTIFICATE_LATEST_BIN,
                &latest_capstone_certificate_verify_args(
                    &paths.nested_capstone_certificate_latest_session_dir,
                ),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested latest-capstone-certificate session under {}: {error}",
                        paths.nested_capstone_certificate_latest_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !latest_verify_raw.is_null() {
                let latest_verify: KeystoneReceiptLatestReportView =
                    serde_json::from_value(latest_verify_raw)
                        .context("failed parsing nested latest-capstone-certificate verify json")?;
                if latest_verify.verdict != CAPSTONE_CERTIFICATE_LATEST_VERIFY_OK {
                    mismatches.push(format!(
                        "nested latest-capstone-certificate verification is non-green: {}",
                        latest_verify.reason
                    ));
                }
            }

            let stored_handoff_bundle: CapstoneCertificateReportView = load_required_step_json(
                &status.keystone_receipt_step,
                &paths.keystone_receipt_report_path,
                "keystone_receipt_step",
                &mut mismatches,
            )?;
            compare_step_artifact_against_report_metadata(
                status.keystone_receipt_step.as_ref(),
                &paths.keystone_receipt_report_path,
                "run_live_package_keystone_receipt",
                &stored_handoff_bundle.verdict,
                &stored_handoff_bundle.reason,
                stored_handoff_bundle.generated_at,
                "stored keystone_receipt_step",
                &mut mismatches,
            );
            compare_capstone_certificate_run_against_snapshot(
            ...
            compare_option_string(
                ...
                "stored status keystone_receipt_verdict",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.keystone_receipt_verdict.as_deref(),
            ...
            let nested_handoff_bundle_session: CapstoneCertificateSessionView = match load_json(
                &nested_keystone_receipt_session_path(&paths.nested_keystone_receipt_session_dir),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed reading nested keystone-receipt session under {}: {error}",
                        paths.nested_keystone_receipt_session_dir.display()
                    ));
            ...
            let nested_handoff_bundle_status: CapstoneCertificateStatusView = match load_json(
                &nested_keystone_receipt_status_path(&paths.nested_keystone_receipt_session_dir),
            ) {
                Ok(value) => value,
                Err(error) => {
                    mismatches.push(format!(
                        "failed reading nested keystone-receipt status under {}: {error}",
                        paths.nested_keystone_receipt_session_dir.display()
                    ));
            ...
            compare_capstone_certificate_copy_against_nested_truth(
                &stored_handoff_bundle,
            ...
            let handoff_bundle_verify_raw = match run_json_command(
                KEYSTONE_RECEIPT_BIN,
                &keystone_receipt_verify_args(
                    &resolved.snapshot,
                    &expected_downstream_capstone_certificate_session_dir(&paths),
                    &paths.nested_keystone_receipt_session_dir,
                ),
                ...
                Err(error) => {
                    mismatches.push(format!(
                        "failed verifying nested keystone-receipt session under {}: {error}",
                        paths.nested_keystone_receipt_session_dir.display()
                    ));
                    Value::Null
                }
            ...
            if !handoff_bundle_verify_raw.is_null() {
                let handoff_bundle_verify: CapstoneCertificateReportView =
                    serde_json::from_value(handoff_bundle_verify_raw)
                        .context("failed parsing nested keystone-receipt verify json")?;
                compare_option_string(
                    stored_handoff_bundle.registry_entry_session_dir.as_deref(),
                    handoff_bundle_verify.registry_entry_session_dir.as_deref(),
                    "stored keystone-receipt copy registry_entry_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored keystone-receipt copy notarization_receipt_session_dir against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                ...
                compare_option_string(
                    ...
                    handoff_bundle_verify
                        .consummation_record_algorithm
                        .as_deref(),
                    "stored keystone-receipt copy consummation_record_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    ...
                    "stored keystone-receipt copy completion_certificate_summary against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle.completion_certificate_sha256.as_deref(),
                    handoff_bundle_verify.completion_certificate_sha256.as_deref(),
                    "stored keystone-receipt copy completion_certificate_sha256 against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                ...
                compare_option_string(
                    ...
                    "stored keystone-receipt copy capstone_certificate_algorithm against verify truth",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_handoff_bundle
                    ...
                    handoff_bundle_verify
                        .reviewed_frozen_live_cutover_controller_command_summary
                        .as_deref(),
                    "stored keystone-receipt copy reviewed_frozen_live_cutover_controller_command_summary",
                    &mut mismatches,
                );
                if handoff_bundle_verify.verdict != KEYSTONE_RECEIPT_VERIFY_OK {
                    mismatches.push(format!(
                        "nested keystone-receipt verification is non-green: {}",
                        handoff_bundle_verify.reason
                    ));
                }
            }

            let expected_result = capstone_certificate_latest_result_from_nested_status(
                nested_handoff_bundle_status.result.as_str(),
            )
            .unwrap_or(
                LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract,
            );
            if status.result != expected_result {
                mismatches.push(format!(
                    "stored latest-keystone-receipt result {} does not match nested keystone-receipt result {}",
            ...
            if status.activation_authorized {
                mismatches.push(
                    "stored status activation_authorized must remain false for latest-keystone-receipt"
                        .to_string(),
                );
            }
            compare_option_string(
        ...
        Err(failure) => {
            ...
            if failure.latest_capstone_certificate_plan_raw.is_some() {
                let stored_latest_plan: KeystoneReceiptLatestReportView = load_required_step_json(
                    &status.latest_capstone_certificate_plan_step,
                    &paths.latest_capstone_certificate_plan_report_path,
                    "latest_capstone_certificate_plan_step",
                ...
                compare_option_string(
                    status.latest_capstone_certificate_plan_verdict.as_deref(),
                    failure.latest_capstone_certificate_plan_verdict.as_deref(),
                    "stored status latest_capstone_certificate_plan_verdict on failure",
                    &mut mismatches,
                );
                compare_option_string(
                    stored_report
                        ...
                        .as_deref(),
                    failure.latest_capstone_certificate_plan_verdict.as_deref(),
                    "stored report latest_capstone_certificate_plan_verdict on failure",
                    &mut mismatches,
                );
            }
            compare_option_string(
                status.latest_capstone_certificate_verdict.as_deref(),
                None,
                "stored status latest_capstone_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.latest_capstone_certificate_verdict.as_deref(),
                None,
                "stored report latest_capstone_certificate_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.keystone_receipt_verdict.as_deref(),
                None,
                "stored status keystone_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                stored_report.keystone_receipt_verdict.as_deref(),
                None,
                "stored report keystone_receipt_verdict on failure",
                &mut mismatches,
            );
            compare_option_string(
                status.current_pre_activation_gate_verdict.as_deref(),
    ...
    let verdict = if mismatches.is_empty() {
        TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestVerifyOk
    } else {
        TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestVerifyInvalid
    };
    let reason = if mismatches.is_empty() {
        format!(
            "latest-keystone-receipt session under {} is coherent with the current latest immutable chain and the accepted keystone-receipt contract",
            session_dir.display()
        )
    } else {
        mismatches
            .first()
            .cloned()
            .unwrap_or_else(|| "latest-keystone-receipt verification failed".to_string())
    };

    Ok(PackageKeystoneReceiptLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_keystone_receipt".to_string(),
        verdict,
        reason,
        ...
        keystone_receipt_latest_session_path: Some(paths.session_path.display().to_string()),
        keystone_receipt_latest_status_path: Some(paths.status_path.display().to_string()),
        keystone_receipt_latest_report_path: Some(paths.report_path.display().to_string()),
        latest_capstone_certificate_plan_report_path: Some(
            paths
                .latest_capstone_certificate_plan_report_path
                .display()
                .to_string(),
        ),
        latest_capstone_certificate_report_path: Some(
            paths.latest_capstone_certificate_report_path.display().to_string(),
        ),
        keystone_receipt_report_path: Some(paths.keystone_receipt_report_path.display().to_string()),
        nested_capstone_certificate_latest_session_dir: Some(
            paths
                .nested_capstone_certificate_latest_session_dir
                .display()
                .to_string(),
        ),
        nested_keystone_receipt_session_dir: Some(
            paths.nested_keystone_receipt_session_dir.display().to_string(),
        ),
        ...
        latest_capstone_certificate_plan_verdict: status.latest_capstone_certificate_plan_verdict.clone(),
        latest_capstone_certificate_verdict: status.latest_capstone_certificate_verdict.clone(),
        keystone_receipt_verdict: status.keystone_receipt_verdict.clone(),
        ...
        resolve_latest_capstone_certificate_command_summary: Some(
            session.resolve_latest_capstone_certificate_command_summary.clone(),
        ),
        run_latest_keystone_receipt_command_summary: Some(
            session.run_latest_keystone_receipt_command_summary.clone(),
        ),
        verify_latest_keystone_receipt_command_summary: Some(
            session.verify_latest_keystone_receipt_command_summary.clone(),
        ),
        downstream_keystone_receipt_command_summary: Some(
            session.downstream_keystone_receipt_command_summary.clone(),
        ),
        verify_capstone_certificate_command_summary: Some(
            session.verify_capstone_certificate_command_summary.clone(),
        ),
        ...
        explicit_statement:
            "this verification proves only whether the latest immutable chain still resolves cleanly into the accepted keystone-receipt contract; it never runs the frozen controller"
                .to_string(),
    })
}

fn run_latest_keystone_receipt_with_resolution(
    root: &Path,
    session_dir: &Path,
    paths: &PackageKeystoneReceiptLatestPaths,
    ...
    persist_json(
        &paths.latest_capstone_certificate_plan_report_path,
        &resolved.latest_capstone_certificate_plan_raw,
    )?;

    let latest_capstone_certificate_plan_step = Some(step_artifact(
        &paths.latest_capstone_certificate_plan_report_path,
        "plan_latest_keystone_receipt",
        &resolved.latest_capstone_certificate_plan.verdict,
        &resolved.latest_capstone_certificate_plan.reason,
        resolved.latest_capstone_certificate_plan.generated_at,
    ));

    let latest_capstone_certificate_run_raw = match run_json_command(
        CAPSTONE_CERTIFICATE_LATEST_BIN,
        &latest_capstone_certificate_run_args(
            root,
            &paths.nested_capstone_certificate_latest_session_dir,
        ),
    ) {
        ...
        Err(error) => {
            let status =
                refusal_status(
                    ...
                    LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract,
                    format!(
                    "failed running nested latest-capstone-certificate handoff under {}: {error}",
                    paths.nested_capstone_certificate_latest_session_dir.display()
                ),
                    latest_capstone_certificate_plan_step,
                    None,
    ...
    persist_json(
        &paths.latest_capstone_certificate_report_path,
        &latest_capstone_certificate_run_raw,
    )?;
    let latest_capstone_certificate_run: KeystoneReceiptLatestReportView =
        serde_json::from_value(latest_capstone_certificate_run_raw)
            .context("failed parsing nested latest-capstone-certificate run json")?;
    let latest_capstone_certificate_step = Some(step_artifact(
        &paths.latest_capstone_certificate_report_path,
        "run_latest_keystone_receipt",
        &latest_capstone_certificate_run.verdict,
        &latest_capstone_certificate_run.reason,
        latest_capstone_certificate_run.generated_at,
    ));

    if let Some(terminal_failure) =
        latest_capstone_certificate_terminal_failure(&latest_capstone_certificate_run)
    {
        let status = refusal_status(
            ...
            Some(resolved),
            terminal_failure,
            latest_capstone_certificate_run.reason.clone(),
            latest_capstone_certificate_plan_step,
            latest_capstone_certificate_step,
            None,
        );
    ...
    compare_capstone_certificate_latest_run_against_snapshot(
        &latest_capstone_certificate_run,
        &resolved.snapshot,
        &paths.nested_capstone_certificate_latest_session_dir,
        &mut run_mismatches,
    );
    ...
    let latest_capstone_certificate_verify: KeystoneReceiptLatestReportView = match run_json_command(
        CAPSTONE_CERTIFICATE_LATEST_BIN,
        &latest_capstone_certificate_verify_args(
            &paths.nested_capstone_certificate_latest_session_dir,
        ),
        ...
        Err(error) => {
            let status =
                refusal_status(
                    ...
                    LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract,
                    format!(
                    "failed verifying nested latest-capstone-certificate handoff under {}: {error}",
                    paths.nested_capstone_certificate_latest_session_dir.display()
                ),
                    latest_capstone_certificate_plan_step,
                    latest_capstone_certificate_step,
    ...
    if latest_capstone_certificate_verify.verdict != CAPSTONE_CERTIFICATE_LATEST_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
            Some(resolved),
            LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract,
            latest_capstone_certificate_verify.reason,
            latest_capstone_certificate_plan_step,
            latest_capstone_certificate_step,
            None,
        );
    ...
    let release_capsule_run_raw = match run_json_command(
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract,
                format!(
                    "failed running downstream keystone-receipt contract under {}: {error}",
                    paths.nested_keystone_receipt_session_dir.display()
                ),
                latest_capstone_certificate_plan_step,
                latest_capstone_certificate_step,
    ...
    let provenance_certificate_run: CapstoneCertificateReportView =
        serde_json::from_value(release_capsule_run_raw)
            .context("failed parsing nested keystone-receipt run json")?;
    let keystone_receipt_step = Some(step_artifact(
        &paths.keystone_receipt_report_path,
        "run_live_package_keystone_receipt",
    ...
    let provenance_certificate_verify: CapstoneCertificateReportView = match run_json_command(
        KEYSTONE_RECEIPT_BIN,
        &keystone_receipt_verify_args(
            &resolved.snapshot,
            &expected_downstream_capstone_certificate_session_dir(paths),
        ...
        Err(error) => {
            let status = refusal_status(
                ...
                LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract,
                format!(
                    "failed verifying downstream keystone-receipt contract under {}: {error}",
                    paths.nested_keystone_receipt_session_dir.display()
                ),
                latest_capstone_certificate_plan_step,
                latest_capstone_certificate_step,
    ...
    if provenance_certificate_verify.verdict != KEYSTONE_RECEIPT_VERIFY_OK {
        let status = refusal_status(
            root,
            session_dir,
            paths,
    ...
    let result = capstone_certificate_latest_result_from_nested_status(
        provenance_certificate_run
            .result
            .as_deref()
            .unwrap_or_default(),
    )
    .unwrap_or(LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract);
    let status = PackageKeystoneReceiptLatestStatus {
        status_version: KEYSTONE_RECEIPT_LATEST_STATUS_VERSION.to_string(),
        updated_at: Utc::now(),
        ...
        nested_capstone_certificate_latest_session_dir: paths
            .nested_capstone_certificate_latest_session_dir
            .display()
            .to_string(),
        nested_keystone_receipt_session_dir: paths
            .nested_keystone_receipt_session_dir
            .display()
            .to_string(),
        ...
        latest_capstone_certificate_plan_verdict: Some(
            resolved.latest_capstone_certificate_plan.verdict.clone(),
        ),
        latest_capstone_certificate_verdict: Some(latest_capstone_certificate_run.verdict.clone()),
        keystone_receipt_verdict: Some(provenance_certificate_run.verdict.clone()),
...
fn run_latest_keystone_receipt_failure(
    root: &Path,
    session_dir: &Path,
    paths: &PackageKeystoneReceiptLatestPaths,
    ...
    persist_json(&paths.session_path, &session)?;
    if let Some(value) = &failure.latest_capstone_certificate_plan_raw {
        persist_json(&paths.latest_capstone_certificate_plan_report_path, value)?;
    }
...
fn resolve_latest_capstone_certificate(
    root: &Path,
    paths: &PackageKeystoneReceiptLatestPaths,
) -> std::result::Result<ResolvedLatestCulminationReceipt, LatestCulminationReceiptResolutionFailure>
{
    let latest_capstone_certificate_plan_raw = match run_json_command(
        CAPSTONE_CERTIFICATE_LATEST_BIN,
        &latest_capstone_certificate_plan_args(
            root,
            &paths.nested_capstone_certificate_latest_session_dir,
        ),
    ) {
        ...
        Err(error) => {
            return Err(LatestCulminationReceiptResolutionFailure {
                ...
                snapshot: None,
                latest_capstone_certificate_plan_raw: None,
                latest_capstone_certificate_plan_verdict: None,
                latest_capstone_certificate_plan_reason: None,
                latest_capstone_certificate_plan_generated_at: None,
            });
        }
    };
    let latest_capstone_certificate_plan: KeystoneReceiptLatestReportView =
        serde_json::from_value(latest_capstone_certificate_plan_raw.clone()).map_err(
            |error| LatestCulminationReceiptResolutionFailure {
                kind: ResolutionFailureKind::InvalidLatestChain,
                reason: format!(
                    "failed parsing latest-keystone-receipt upstream latest-capstone-certificate plan json for {}: {error}",
                    root.display()
                ),
                snapshot: None,
                latest_capstone_certificate_plan_raw: Some(
                    latest_capstone_certificate_plan_raw.clone(),
                ),
                latest_capstone_certificate_plan_verdict: None,
                latest_capstone_certificate_plan_reason: None,
                latest_capstone_certificate_plan_generated_at: None,
    ...
    let snapshot =
        parse_snapshot_from_latest_capstone_certificate(&latest_capstone_certificate_plan).ok();
    if latest_capstone_certificate_plan.verdict != CAPSTONE_CERTIFICATE_LATEST_PLAN_READY {
        return Err(LatestCulminationReceiptResolutionFailure {
            kind: map_capstone_certificate_latest_failure_kind(
                &latest_capstone_certificate_plan.verdict,
            ),
            reason: format!(
                "latest-keystone-receipt resolution refused because nested latest-capstone-certificate reported: {}",
                latest_capstone_certificate_plan.reason
            ),
            snapshot,
            latest_capstone_certificate_plan_raw: Some(latest_capstone_certificate_plan_raw),
            latest_capstone_certificate_plan_verdict: Some(
                latest_capstone_certificate_plan.verdict,
            ),
            latest_capstone_certificate_plan_reason: Some(
                latest_capstone_certificate_plan.reason,
            ),
            latest_capstone_certificate_plan_generated_at: Some(
                latest_capstone_certificate_plan.generated_at,
            ),
        });
    }

    let snapshot =
        parse_snapshot_from_latest_capstone_certificate(&latest_capstone_certificate_plan)
            .map_err(|error| LatestCulminationReceiptResolutionFailure {
                kind: ResolutionFailureKind::InvalidLatestChain,
                reason: format!("latest-keystone-receipt resolution failed: {error}"),
                snapshot: None,
                latest_capstone_certificate_plan_raw: Some(
                    latest_capstone_certificate_plan_raw.clone(),
                ),
                latest_capstone_certificate_plan_verdict: Some(
                    latest_capstone_certificate_plan.verdict.clone(),
                ),
                latest_capstone_certificate_plan_reason: Some(
                    latest_capstone_certificate_plan.reason.clone(),
                ),
                latest_capstone_certificate_plan_generated_at: Some(
                    latest_capstone_certificate_plan.generated_at,
                ),
    ...
    let mut mismatches = Vec::new();
    compare_capstone_certificate_latest_plan_against_snapshot(
        &latest_capstone_certificate_plan,
        &snapshot,
        &paths.nested_capstone_certificate_latest_session_dir,
        &mut mismatches,
    );
    if !mismatches.is_empty() {
        return Err(LatestCulminationReceiptResolutionFailure {
            kind: ResolutionFailureKind::DriftedCapstoneCertificateContract,
            reason: format!("latest-keystone-receipt drift detected: {}", mismatches[0]),
            snapshot: Some(snapshot),
            latest_capstone_certificate_plan_raw: Some(latest_capstone_certificate_plan_raw),
            latest_capstone_certificate_plan_verdict: Some(
                latest_capstone_certificate_plan.verdict,
            ),
            latest_capstone_certificate_plan_reason: Some(latest_capstone_certificate_plan.reason),
            latest_capstone_certificate_plan_generated_at: Some(
                latest_capstone_certificate_plan.generated_at,
            ),
        });
    ...
    Ok(ResolvedLatestCulminationReceipt {
        snapshot,
        latest_capstone_certificate_plan_raw,
        latest_capstone_certificate_plan,
    })
}

fn parse_snapshot_from_latest_capstone_certificate(
    view: &KeystoneReceiptLatestReportView,
    ...
    if latest_top_step_name != TOP_ACCEPTED_PACKAGE_STEP {
        bail!(
            "latest-keystone-receipt nested latest-capstone-certificate plan top accepted step is {} instead of {}",
    ...
    if view.activation_authorized {
        bail!(
            "latest-keystone-receipt nested latest-capstone-certificate plan must remain planning-safe with activation_authorized=false"
        );
    }
    Ok(LatestCulminationReceiptSnapshot {
        ...
        wrapper_timeout_ms: view.wrapper_timeout_ms.ok_or_else(|| {
            anyhow!(
                "latest-keystone-receipt nested latest-capstone-certificate plan is missing wrapper_timeout_ms"
            )
        })?,
        service_status_max_staleness_ms: view.service_status_max_staleness_ms.ok_or_else(|| {
            anyhow!(
                "latest-keystone-receipt nested latest-capstone-certificate plan is missing service_status_max_staleness_ms"
            )
        })?,
...
fn plan_report_from_resolution(
    ...
    paths: &PackageKeystoneReceiptLatestPaths,
    resolved: &ResolvedLatestCulminationReceipt,
) -> PackageKeystoneReceiptLatestReport {
    PackageKeystoneReceiptLatestReport {
        generated_at: Utc::now(),
        ...
        latest_capstone_certificate_report_path: Some(
            paths
                .latest_capstone_certificate_report_path
                .display()
                .to_string(),
        ),
        keystone_receipt_report_path: Some(
            paths.keystone_receipt_report_path.display().to_string(),
        ),
        nested_capstone_certificate_latest_session_dir: Some(
            paths
                .nested_capstone_certificate_latest_session_dir
        ...
        latest_capstone_certificate_verdict: None,
        keystone_receipt_verdict: None,
        result: None,
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_capstone_certificate_command_summary: Some(
            resolve_latest_capstone_certificate_command_summary(
                root,
                &paths.nested_capstone_certificate_latest_session_dir,
            ),
        ),
        run_latest_keystone_receipt_command_summary: Some(
            run_latest_keystone_receipt_command_summary(
                root,
                &paths.nested_capstone_certificate_latest_session_dir,
            ),
        ),
        verify_latest_keystone_receipt_command_summary: Some(
            verify_latest_keystone_receipt_command_summary(
                &paths.nested_capstone_certificate_latest_session_dir,
            ),
        ),
        downstream_keystone_receipt_command_summary: Some(
            downstream_keystone_receipt_command_summary(
                &resolved.snapshot,
                &expected_downstream_capstone_certificate_session_dir(paths),
                &paths.nested_keystone_receipt_session_dir,
            ),
        ),
        verify_capstone_certificate_command_summary: Some(verify_keystone_receipt_command_summary(
            &resolved.snapshot,
            &expected_downstream_capstone_certificate_session_dir(paths),
            &paths.nested_keystone_receipt_session_dir,
        )),
...
fn report_from_resolution_failure(
    ...
    PackageKeystoneReceiptLatestReport {
        ...
        latest_capstone_certificate_plan_verdict: failure
            .latest_capstone_certificate_plan_verdict
            .clone(),
        latest_capstone_certificate_verdict: None,
        keystone_receipt_verdict: None,
        ...
        downstream_keystone_receipt_command_summary: snapshot.map(|value| {
            downstream_keystone_receipt_command_summary(
                value,
                &expected_downstream_capstone_certificate_session_dir(paths),
                &paths.nested_keystone_receipt_session_dir,
        ...
        verify_capstone_certificate_command_summary: snapshot.map(|value| {
...
) -> PackageKeystoneReceiptLatestSession {
    let snapshot = resolved
        .map(|value| &value.snapshot)
        .or_else(|| failure.and_then(|value| value.snapshot.as_ref()));
    PackageKeystoneReceiptLatestSession {
        session_version: KEYSTONE_RECEIPT_LATEST_SESSION_VERSION.to_string(),
        planned_at: Utc::now(),
        root: root.display().to_string(),
        session_dir: session_dir.display().to_string(),
        nested_capstone_certificate_latest_session_dir: paths
        ...
        run_latest_keystone_receipt_command_summary: run_latest_keystone_receipt_command_summary(
            root,
            &paths.nested_capstone_certificate_latest_session_dir,
        ),
        verify_latest_keystone_receipt_command_summary:
        ...
        downstream_keystone_receipt_command_summary: snapshot
            .map(|value| {
                downstream_keystone_receipt_command_summary(
                    value,
                    &expected_downstream_capstone_certificate_session_dir(paths),
            ...
            .unwrap_or_else(|| "<capstone-certificate-run-unavailable>".to_string()),
        verify_capstone_certificate_command_summary: snapshot
            .map(|value| {
                verify_keystone_receipt_command_summary(
                    value,
                    &expected_downstream_capstone_certificate_session_dir(paths),
            ...
            .unwrap_or_else(|| "<capstone-certificate-verify-unavailable>".to_string()),
        reviewed_frozen_live_cutover_controller_command_summary: snapshot.map(|value| {
            value
                .reviewed_frozen_live_cutover_controller_command_summary
                .clone()
...
fn report_from_status(
    ...
    session_dir: &Path,
    paths: &PackageKeystoneReceiptLatestPaths,
    session: &PackageKeystoneReceiptLatestSession,
    status: &PackageKeystoneReceiptLatestStatus,
    verification_mismatches: Vec<String>,
) -> PackageKeystoneReceiptLatestReport {
    PackageKeystoneReceiptLatestReport {
        generated_at: Utc::now(),
        ...
        nested_keystone_receipt_session_dir: Some(
            session.nested_keystone_receipt_session_dir.clone(),
        ),
        downstream_decision_packet_session_dir: Some(
            session.downstream_decision_packet_session_dir.clone(),
        ),
        latest_capstone_certificate_plan_verdict: status
            .latest_capstone_certificate_plan_verdict
            .clone(),
        latest_capstone_certificate_verdict: status.latest_capstone_certificate_verdict.clone(),
        keystone_receipt_verdict: status.keystone_receipt_verdict.clone(),
...
fn keystone_receipt_latest_paths(session_dir: &Path) -> PackageKeystoneReceiptLatestPaths {
    PackageKeystoneReceiptLatestPaths {
        session_path: session_dir
            .join("tiny_live_activation_package_keystone_receipt_latest.session.json"),
        status_path: session_dir
            .join("tiny_live_activation_package_keystone_receipt_latest.status.json"),
        report_path: session_dir
            .join("tiny_live_activation_package_keystone_receipt_latest.report.json"),
        latest_capstone_certificate_plan_report_path: session_dir.join(
            "tiny_live_activation_package_keystone_receipt_latest.capstone_certificate_latest_plan.report.json",
        ),
        latest_capstone_certificate_report_path: session_dir.join(
            "tiny_live_activation_package_keystone_receipt_latest.capstone_certificate_latest.report.json",
        ),
        keystone_receipt_report_path: session_dir.join(
            "tiny_live_activation_package_keystone_receipt_latest.keystone_receipt.report.json",
        ),
        nested_capstone_certificate_latest_session_dir: session_dir
            .join("tiny_live_activation_package_keystone_receipt_latest.capstone_certificate_latest_session"),
        nested_keystone_receipt_session_dir: session_dir.join(
            "tiny_live_activation_package_keystone_receipt_latest.capstone_certificate_session",
        ),
    }
}
...
fn expected_downstream_decision_packet_session_dir(
    ...
    paths
        .nested_capstone_certificate_latest_session_dir
        .join("tiny_live_activation_package_capstone_certificate_latest.decision_packet_session")
}

fn expected_downstream_capstone_certificate_session_dir(
    paths: &PackageKeystoneReceiptLatestPaths,
) -> PathBuf {
    paths.nested_capstone_certificate_latest_session_dir.join(
        "tiny_live_activation_package_capstone_certificate_latest.capstone_certificate_session",
    )
}
...
fn expected_downstream_review_receipt_session_dir(
    ...
    paths
        .nested_capstone_certificate_latest_session_dir
        .join("tiny_live_activation_package_capstone_certificate_latest.review_receipt_session")
}

fn latest_capstone_certificate_plan_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--plan-latest-capstone-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn latest_capstone_certificate_run_args(root: &Path, session_dir: &Path) -> Vec<String> {
    vec![
        "--root".to_string(),
        root.display().to_string(),
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-latest-capstone-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn latest_capstone_certificate_verify_args(session_dir: &Path) -> Vec<String> {
    vec![
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-latest-capstone-certificate".to_string(),
        "--json".to_string(),
    ]
}

fn keystone_receipt_run_args(
    snapshot: &LatestCulminationReceiptSnapshot,
    capstone_certificate_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        "--capstone-certificate-session-dir".to_string(),
        capstone_certificate_session_dir.display().to_string(),
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--run-live-package-keystone-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn keystone_receipt_verify_args(
    snapshot: &LatestCulminationReceiptSnapshot,
    capstone_certificate_session_dir: &Path,
    session_dir: &Path,
) -> Vec<String> {
    vec![
        ...
        "--session-dir".to_string(),
        session_dir.display().to_string(),
        "--verify-live-package-keystone-receipt".to_string(),
        "--json".to_string(),
    ]
}

fn resolve_latest_capstone_certificate_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{CAPSTONE_CERTIFICATE_LATEST_BIN} --root {} --session-dir {} --plan-latest-capstone-certificate --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn run_latest_keystone_receipt_command_summary(root: &Path, session_dir: &Path) -> String {
    format!(
        "{CAPSTONE_CERTIFICATE_LATEST_BIN} --root {} --session-dir {} --run-latest-capstone-certificate --json",
        shell_escape_path(root),
        shell_escape_path(session_dir),
    )
}

fn verify_latest_keystone_receipt_command_summary(session_dir: &Path) -> String {
    format!(
        "{CAPSTONE_CERTIFICATE_LATEST_BIN} --session-dir {} --verify-latest-capstone-certificate --json",
        shell_escape_path(session_dir),
    )
}

fn downstream_keystone_receipt_command_summary(
    snapshot: &LatestCulminationReceiptSnapshot,
    capstone_certificate_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{KEYSTONE_RECEIPT_BIN} --capstone-certificate-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --run-live-package-keystone-receipt --json",
...
fn verify_keystone_receipt_command_summary(
    snapshot: &LatestCulminationReceiptSnapshot,
    capstone_certificate_session_dir: &Path,
    session_dir: &Path,
) -> String {
    format!(
        "{KEYSTONE_RECEIPT_BIN} --capstone-certificate-session-dir {} --confirm-decision-packet-session-dir {} --session-dir {} --verify-live-package-keystone-receipt --json",
        shell_escape_path(capstone_certificate_session_dir),
        shell_escape_path(&snapshot.downstream_decision_packet_session_dir),
        shell_escape_path(session_dir),
    )
...
fn nested_capstone_certificate_latest_report_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_capstone_certificate_latest.report.json")
}

fn nested_keystone_receipt_session_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_keystone_receipt.session.json")
}

fn nested_keystone_receipt_status_path(session_dir: &Path) -> PathBuf {
    session_dir.join("tiny_live_activation_package_keystone_receipt.status.json")
}
...
fn write_script(path: &Path, contents: &str) -> Result<()> {
    ...
    fs::write(path, contents).with_context(|| {
        format!(
            "failed writing latest-keystone-receipt script to {}",
            path.display()
        )
    })?;
    #[cfg(unix)]
...
fn step_artifact(
    ...
    reason: &str,
    generated_at: DateTime<Utc>,
) -> PackageKeystoneReceiptLatestStepArtifact {
    PackageKeystoneReceiptLatestStepArtifact {
...
fn canonical_wrapper_mode(mode: &str) -> &str {
    match mode {
        "plan_latest_keystone_receipt" => "plan_latest_keystone_receipt",
        "render_latest_keystone_receipt_script" => "render_latest_keystone_receipt_script",
        "run_latest_keystone_receipt" => "run_latest_keystone_receipt",
        "verify_latest_keystone_receipt" => "verify_latest_keystone_receipt",
        other => other,
    }
}

fn load_required_step_json<T: for<'de> Deserialize<'de>>(
    step: &Option<PackageKeystoneReceiptLatestStepArtifact>,
    expected_path: &Path,
    label: &str,
    ...
    let step = step
        .as_ref()
        .ok_or_else(|| anyhow!("{label} is missing from latest-keystone-receipt status"))?;
    compare_string(
        &step.path,
...
fn compare_step_artifact_against_report_metadata(
    ...
    let Some(step) = step else {
        mismatches.push(format!(
            "{label} is missing from latest-keystone-receipt status"
        ));
        return;
    };
    compare_string(
...
fn compare_capstone_certificate_latest_plan_against_snapshot(
    stored: &KeystoneReceiptLatestReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        ...
        Some(CAPSTONE_CERTIFICATE_LATEST_PLAN_READY),
        "stored latest-capstone-certificate plan verdict",
        mismatches,
    );
    compare_string(
        &stored.mode,
        "plan_latest_keystone_receipt",
        "stored latest-capstone-certificate plan mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-capstone-certificate plan latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        ...
        "stored latest-capstone-certificate plan latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-capstone-certificate plan session_dir",
        mismatches,
    );
    compare_option_string(
    ...
    compare_option_string(
        ...
        "stored latest-capstone-certificate plan reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-capstone-certificate plan clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-capstone-certificate plan clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-capstone-certificate plan clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_capstone_certificate_latest_run_against_snapshot(
    stored: &KeystoneReceiptLatestReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_latest_keystone_receipt",
        "stored latest-capstone-certificate run mode",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_step_name.as_deref(),
        Some(snapshot.latest_top_step_name.as_str()),
        "stored latest-capstone-certificate run latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        ...
        "stored latest-capstone-certificate run latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored latest-capstone-certificate run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        ...
        "stored latest-capstone-certificate run downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored latest-capstone-certificate run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored latest-capstone-certificate run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored latest-capstone-certificate run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored latest-capstone-certificate run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored latest-capstone-certificate run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored latest-capstone-certificate run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored latest-capstone-certificate run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_summary.as_deref(),
        Some(snapshot.clerestory_certificate_summary.as_str()),
        "stored latest-capstone-certificate run clerestory_certificate_summary",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_sha256.as_deref(),
        Some(snapshot.clerestory_certificate_sha256.as_str()),
        "stored latest-capstone-certificate run clerestory_certificate_sha256",
        mismatches,
    );
    compare_option_string(
        stored.clerestory_certificate_algorithm.as_deref(),
        Some(snapshot.clerestory_certificate_algorithm.as_str()),
        "stored latest-capstone-certificate run clerestory_certificate_algorithm",
        mismatches,
    );
}

fn compare_capstone_certificate_latest_copy_matches_actual(
    stored: &KeystoneReceiptLatestReportView,
    actual: &KeystoneReceiptLatestReportView,
    mismatches: &mut Vec<String>,
) {
    compare_option_string(
        Some(stored.verdict.as_str()),
        Some(actual.verdict.as_str()),
        "stored latest-capstone-certificate copy verdict",
        mismatches,
    );
    compare_option_string(
        Some(stored.reason.as_str()),
        Some(actual.reason.as_str()),
        "stored latest-capstone-certificate copy reason",
        mismatches,
    );
    if stored.generated_at != actual.generated_at {
        mismatches.push(format!(
            "stored latest-capstone-certificate copy generated_at {:?} does not match actual {:?}",
    ...
    compare_option_string(
        ...
        "stored latest-capstone-certificate copy latest_top_step_name",
        mismatches,
    );
    compare_option_string(
        stored.latest_top_session_dir.as_deref(),
        actual.latest_top_session_dir.as_deref(),
        "stored latest-capstone-certificate copy latest_top_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        actual.session_dir.as_deref(),
        "stored latest-capstone-certificate copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.downstream_decision_packet_session_dir.as_deref(),
        actual.downstream_decision_packet_session_dir.as_deref(),
        "stored latest-capstone-certificate copy downstream_decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        actual.result.as_deref(),
        "stored latest-capstone-certificate copy result",
        mismatches,
    );
    compare_option_string(
        stored.explicit_statement.as_deref(),
        actual.explicit_statement.as_deref(),
        "stored latest-capstone-certificate copy explicit_statement",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        actual.current_pre_activation_gate_verdict.as_deref(),
        "stored latest-capstone-certificate copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        actual.current_pre_activation_gate_reason.as_deref(),
        "stored latest-capstone-certificate copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        actual
            .reviewed_frozen_live_cutover_controller_command_summary
            .as_deref(),
        "stored latest-capstone-certificate copy reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}

fn compare_capstone_certificate_run_against_snapshot(
    stored: &CapstoneCertificateReportView,
    snapshot: &LatestCulminationReceiptSnapshot,
    capstone_certificate_session_dir: &Path,
    session_dir: &Path,
    mismatches: &mut Vec<String>,
    ...
    compare_string(
        &stored.mode,
        "run_live_package_keystone_receipt",
        "stored keystone-receipt run mode",
        mismatches,
    );
    compare_string(
        &stored.capstone_certificate_session_dir,
        &capstone_certificate_session_dir.display().to_string(),
        "stored capstone-certificate run capstone_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored capstone-certificate run decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored capstone-certificate run execute_frozen_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored capstone-certificate run turn_green_session_dir",
        mismatches,
    );
    compare_option_string(
        ...
        "stored capstone-certificate run launch_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.package_dir.as_deref(),
        Some(snapshot.package_dir.display().to_string().as_str()),
        "stored capstone-certificate run package_dir",
        mismatches,
    );
    compare_option_string(
        stored.install_root.as_deref(),
        Some(snapshot.install_root.display().to_string().as_str()),
        "stored capstone-certificate run install_root",
        mismatches,
    );
    compare_option_string(
        stored.target_service_name.as_deref(),
        Some(snapshot.target_service_name.as_str()),
        "stored capstone-certificate run target_service_name",
        mismatches,
    );
    compare_option_string(
        stored.backend_command.as_deref(),
        Some(snapshot.backend_command.as_str()),
        "stored capstone-certificate run backend_command",
        mismatches,
    );
    compare_option_u64(
        stored.wrapper_timeout_ms,
        Some(snapshot.wrapper_timeout_ms),
        "stored capstone-certificate run wrapper_timeout_ms",
        mismatches,
    );
    compare_option_u64(
        stored.service_status_max_staleness_ms,
        Some(snapshot.service_status_max_staleness_ms),
        "stored capstone-certificate run service_status_max_staleness_ms",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(session_dir.display().to_string().as_str()),
        "stored capstone-certificate run session_dir",
        mismatches,
    );
    compare_option_string(
        stored.keystone_receipt_session_path.as_deref(),
        Some(
            nested_keystone_receipt_session_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored keystone-receipt run keystone_receipt_session_path",
        mismatches,
    );
    compare_option_string(
        stored.keystone_receipt_status_path.as_deref(),
        Some(
            nested_keystone_receipt_status_path(session_dir)
                .display()
                .to_string()
                .as_str(),
        ),
        "stored keystone-receipt run keystone_receipt_status_path",
        mismatches,
    );
    compare_option_string(
        stored.archived_capstone_certificate_report_path.as_deref(),
        Some(
            session_dir
                .join("tiny_live_activation_package_capstone_certificate.capstone_certificate.report.json")
                .display()
                .to_string()
                .as_str(),
        ),
        "stored keystone-receipt run archived_capstone_certificate_report_path",
        mismatches,
    );
    compare_option_string(
        stored
            .verify_capstone_certificate_command_summary
            .as_deref(),
        Some(
            keystone_receipt_verify_capstone_certificate_command_summary(
                capstone_certificate_session_dir,
            )
            .as_str(),
        ),
        "stored keystone-receipt run verify_capstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored capstone-certificate run reviewed_frozen_live_cutover_controller_command_summary",
        mismatches,
    );
}

fn compare_capstone_certificate_copy_against_nested_truth(
    stored: &CapstoneCertificateReportView,
    nested_session: &CapstoneCertificateSessionView,
    nested_status: &CapstoneCertificateStatusView,
    mismatches: &mut Vec<String>,
) {
    compare_string(
        &stored.capstone_certificate_session_dir,
        &nested_session.capstone_certificate_session_dir,
        "stored keystone-receipt copy capstone_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.registry_entry_session_dir.as_deref(),
        Some(nested_session.registry_entry_session_dir.as_str()),
        "stored keystone-receipt copy registry_entry_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.notarization_receipt_session_dir.as_deref(),
        Some(nested_session.notarization_receipt_session_dir.as_str()),
        "stored keystone-receipt copy notarization_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.provenance_certificate_session_dir.as_deref(),
        Some(nested_session.provenance_certificate_session_dir.as_str()),
        "stored keystone-receipt copy provenance_certificate_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.attestation_seal_session_dir.as_deref(),
        Some(nested_session.attestation_seal_session_dir.as_str()),
        "stored keystone-receipt copy attestation_seal_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.release_capsule_session_dir.as_deref(),
        Some(nested_session.release_capsule_session_dir.as_str()),
        "stored keystone-receipt copy release_capsule_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.activation_ticket_session_dir.as_deref(),
        Some(nested_session.activation_ticket_session_dir.as_str()),
        "stored keystone-receipt copy activation_ticket_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.review_receipt_session_dir.as_deref(),
        Some(nested_session.review_receipt_session_dir.as_str()),
        "stored keystone-receipt copy review_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.handoff_bundle_session_dir.as_deref(),
        Some(nested_session.handoff_bundle_session_dir.as_str()),
        "stored keystone-receipt copy handoff_bundle_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.decision_packet_session_dir.as_deref(),
        Some(nested_session.decision_packet_session_dir.as_str()),
        "stored keystone-receipt copy decision_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.execute_frozen_session_dir.as_deref(),
        Some(nested_session.execute_frozen_session_dir.as_str()),
        "stored keystone-receipt copy execute_frozen_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.turn_green_session_dir.as_deref(),
        Some(nested_session.turn_green_session_dir.as_str()),
        "stored keystone-receipt copy turn_green_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.launch_packet_session_dir.as_deref(),
        Some(nested_session.launch_packet_session_dir.as_str()),
        "stored keystone-receipt copy launch_packet_session_dir",
        mismatches,
    );
    compare_option_string(
        stored.session_dir.as_deref(),
        Some(nested_session.session_dir.as_str()),
        "stored keystone-receipt copy session_dir",
        mismatches,
    );
    compare_option_string(
        stored.result.as_deref(),
        Some(nested_status.result.as_str()),
        "stored keystone-receipt copy result",
        mismatches,
    );
    compare_option_string(
        Some(stored.verdict.as_str()),
        keystone_receipt_run_verdict_for_result(&nested_status.result),
        "stored keystone-receipt copy verdict",
        mismatches,
    );
    compare_option_string(
        stored.handoff_bundle_result.as_deref(),
        nested_status.handoff_bundle_result.as_deref(),
        "stored keystone-receipt copy handoff_bundle_result",
        mismatches,
    );
    compare_option_string(
        stored.decision_packet_result.as_deref(),
        nested_status.decision_packet_result.as_deref(),
        "stored keystone-receipt copy decision_packet_result",
        mismatches,
    );
    compare_option_string(
        stored.execute_frozen_result.as_deref(),
        nested_status.execute_frozen_result.as_deref(),
        "stored keystone-receipt copy execute_frozen_result",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_verdict.as_deref(),
        nested_status.current_pre_activation_gate_verdict.as_deref(),
        "stored keystone-receipt copy current_pre_activation_gate_verdict",
        mismatches,
    );
    compare_option_string(
        stored.current_pre_activation_gate_reason.as_deref(),
        nested_status.current_pre_activation_gate_reason.as_deref(),
        "stored keystone-receipt copy current_pre_activation_gate_reason",
        mismatches,
    );
    compare_option_string(
        stored
        ...
        "stored keystone-receipt copy verify_capstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        stored
    ...
    compare_option_string(
        ...
        "stored keystone-receipt copy release_capsule_digest_manifest_sha256",
        mismatches,
    );
...
fn compare_session_against_snapshot(
    ...
    compare_string(
        &session.resolve_latest_capstone_certificate_command_summary,
        &resolve_latest_capstone_certificate_command_summary(
            root,
            &paths.nested_capstone_certificate_latest_session_dir,
        ),
        "stored session resolve_latest_capstone_certificate_command_summary",
        mismatches,
    );
    compare_string(
        &session.run_latest_keystone_receipt_command_summary,
        &run_latest_keystone_receipt_command_summary(
            root,
            &paths.nested_capstone_certificate_latest_session_dir,
        ),
        "stored session run_latest_keystone_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_latest_keystone_receipt_command_summary,
        &verify_latest_keystone_receipt_command_summary(
            &paths.nested_capstone_certificate_latest_session_dir,
        ),
        "stored session verify_latest_keystone_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.downstream_keystone_receipt_command_summary,
        &downstream_keystone_receipt_command_summary(
            snapshot,
            &expected_downstream_capstone_certificate_session_dir(paths),
            &paths.nested_keystone_receipt_session_dir,
        ),
        "stored session downstream_keystone_receipt_command_summary",
        mismatches,
    );
    compare_string(
        &session.verify_capstone_certificate_command_summary,
        &verify_keystone_receipt_command_summary(
            snapshot,
            &expected_downstream_capstone_certificate_session_dir(paths),
            &paths.nested_keystone_receipt_session_dir,
        ),
        "stored session verify_capstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_capstone_certificate_latest_session_dir",
        mismatches,
    );
    compare_string(
        &session.nested_keystone_receipt_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_keystone_receipt_session_dir",
        mismatches,
    );
    compare_string(
        &session.downstream_decision_packet_session_dir,
...
fn compare_report_against_snapshot(
    report: &PackageKeystoneReceiptLatestReport,
    root: &Path,
    session_dir: &Path,
    paths: &PackageKeystoneReceiptLatestPaths,
    snapshot: &LatestCulminationReceiptSnapshot,
    ...
    compare_option_string(
        ...
        "stored report resolve_latest_capstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report run_latest_keystone_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report verify_latest_keystone_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report downstream_keystone_receipt_command_summary",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report verify_capstone_certificate_command_summary",
        mismatches,
    );
    compare_option_string(
        report
    ...
    compare_option_string(
        report.keystone_receipt_latest_session_path.as_deref(),
        Some(paths.session_path.display().to_string().as_str()),
        "stored report keystone_receipt_latest_session_path",
        mismatches,
    );
    compare_option_string(
        report.keystone_receipt_latest_status_path.as_deref(),
        Some(paths.status_path.display().to_string().as_str()),
        "stored report keystone_receipt_latest_status_path",
        mismatches,
    );
    compare_option_string(
        report.keystone_receipt_latest_report_path.as_deref(),
        Some(paths.report_path.display().to_string().as_str()),
        "stored report keystone_receipt_latest_report_path",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report latest_capstone_certificate_plan_report_path",
        mismatches,
    );
    compare_option_string(
        report.latest_capstone_certificate_report_path.as_deref(),
        Some(
            paths
                .latest_capstone_certificate_report_path
                .display()
        ...
        "stored report latest_capstone_certificate_report_path",
        mismatches,
    );
    compare_option_string(
        report.keystone_receipt_report_path.as_deref(),
        Some(
            paths
                .keystone_receipt_report_path
                .display()
                .to_string()
                .as_str(),
        ),
        "stored report keystone_receipt_report_path",
        mismatches,
    );
    compare_option_string(
        report
        ...
        "stored report nested_capstone_certificate_latest_session_dir",
        mismatches,
    );
    compare_option_string(
        report.nested_keystone_receipt_session_dir.as_deref(),
        Some(
            paths
                .nested_keystone_receipt_session_dir
                .display()
        ...
        "stored report nested_keystone_receipt_session_dir",
        mismatches,
    );
    compare_option_string(
...
fn compare_session_against_failure(
    ...
    compare_string(
        ...
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_capstone_certificate_latest_session_dir on failure",
        mismatches,
    );
    compare_string(
        &session.nested_keystone_receipt_session_dir,
        &paths
            ...
            .display()
            .to_string(),
        "stored session nested_keystone_receipt_session_dir on failure",
        mismatches,
    );
...
fn map_capstone_certificate_latest_failure_kind(verdict: &str) -> ResolutionFailureKind {
    match verdict {
        "tiny_live_package_capstone_certificate_latest_refused_by_missing_latest_chain" => {
            ResolutionFailureKind::MissingLatestChain
        }
        "tiny_live_package_capstone_certificate_latest_refused_by_drifted_capstone_certificate_contract" => {
            ResolutionFailureKind::DriftedCapstoneCertificateContract
        }
        _ => ResolutionFailureKind::InvalidLatestChain,
    }
}

fn latest_capstone_certificate_terminal_failure(
    report: &KeystoneReceiptLatestReportView,
) -> Option<LivePackageKeystoneReceiptLatestResult> {
    match report.result.as_deref() {
        Some("refused_by_missing_latest_chain") => {
            Some(LivePackageKeystoneReceiptLatestResult::RefusedByMissingLatestChain)
        }
        Some("refused_by_invalid_latest_chain") => {
            Some(LivePackageKeystoneReceiptLatestResult::RefusedByInvalidLatestChain)
        }
        Some("refused_by_drifted_capstone_certificate_contract") => {
            Some(LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract)
        }
        _ => None,
    }
}

fn capstone_certificate_latest_result_from_nested_status(
    result: &str,
) -> Option<LivePackageKeystoneReceiptLatestResult> {
    match result {
        "ready_for_manual_execution_when_gate_turns_green" => {
            Some(LivePackageKeystoneReceiptLatestResult::ReadyForManualExecutionWhenGateTurnsGreen)
        }
        "refused_now_by_stage3" => Some(LivePackageKeystoneReceiptLatestResult::RefusedNowByStage3),
        "refused_now_by_pre_activation_gate" => {
            Some(LivePackageKeystoneReceiptLatestResult::RefusedNowByPreActivationGate)
        }
...
fn keystone_receipt_run_verdict_for_result(result: &str) -> Option<&'static str> {
    match result {
        ...
        "refused_now_by_stage3" => Some("tiny_live_package_keystone_receipt_refused_now_by_stage3"),
        "refused_now_by_pre_activation_gate" => {
            Some("tiny_live_package_keystone_receipt_refused_now_by_pre_activation_gate")
        }
        "refused_now_by_invalid_or_drifted_contract" => {
            Some("tiny_live_package_keystone_receipt_refused_now_by_invalid_or_drifted_contract")
        }
        _ => None,
    }
}

fn result_from_failure_kind(kind: ResolutionFailureKind) -> LivePackageKeystoneReceiptLatestResult {
    match kind {
        ResolutionFailureKind::MissingLatestChain => {
            LivePackageKeystoneReceiptLatestResult::RefusedByMissingLatestChain
        }
        ResolutionFailureKind::InvalidLatestChain => {
            LivePackageKeystoneReceiptLatestResult::RefusedByInvalidLatestChain
        }
        ResolutionFailureKind::DriftedCapstoneCertificateContract => {
            LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract
        }
...
fn verdict_for_result(
    result: LivePackageKeystoneReceiptLatestResult,
) -> TinyLivePackageKeystoneReceiptLatestVerdict {
    match result {
        LivePackageKeystoneReceiptLatestResult::RefusedByMissingLatestChain => {
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestRefusedByMissingLatestChain
        }
        LivePackageKeystoneReceiptLatestResult::RefusedByInvalidLatestChain => {
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestRefusedByInvalidLatestChain
        }
        LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract => {
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestRefusedByDriftedKeystoneReceiptContract
        }
        LivePackageKeystoneReceiptLatestResult::RefusedNowByStage3 => {
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestRefusedNowByStage3
        }
        LivePackageKeystoneReceiptLatestResult::RefusedNowByPreActivationGate => {
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestRefusedNowByPreActivationGate
        }
        LivePackageKeystoneReceiptLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestReadyForManualExecutionWhenGateTurnsGreen
        }
    }
}
...
fn operator_next_action_summary(result: LivePackageKeystoneReceiptLatestResult) -> String {
    match result {
        LivePackageKeystoneReceiptLatestResult::RefusedByMissingLatestChain => {
        ...
        LivePackageKeystoneReceiptLatestResult::RefusedByInvalidLatestChain => {
            "the latest immutable chain is incomplete or below the accepted clerestory layer; mint a fresh coherent clerestory chain instead of bypassing the accepted latest-keystone-receipt / pinnacle-receipt path".to_string()
        }
        LivePackageKeystoneReceiptLatestResult::RefusedByDriftedKeystoneReceiptContract => {
            "the latest chain no longer resolves cleanly into the accepted latest-keystone-receipt / pinnacle-receipt contract; repair that drift instead of bypassing the bounded handoff path".to_string()
        }
        LivePackageKeystoneReceiptLatestResult::RefusedNowByStage3 => {
            "the frozen controller stays refused now by Stage 3; rerun this latest-keystone-receipt refresh after current Stage 3 truth turns green".to_string()
        }
        LivePackageKeystoneReceiptLatestResult::RefusedNowByPreActivationGate => {
            "the frozen controller stays refused now by the pre-activation gate; rerun this latest-keystone-receipt refresh after the current pre-activation gate turns green".to_string()
        }
        LivePackageKeystoneReceiptLatestResult::ReadyForManualExecutionWhenGateTurnsGreen => {
            "the latest immutable chain now resolves into the accepted keystone-receipt contract and one bounded latest-keystone-receipt handoff is ready for manual execution when gate truth turns green; this wrapper still did not run or authorize the frozen controller".to_string()
        }
    }
}
...
fn keystone_receipt_verify_capstone_certificate_command_summary(
    capstone_certificate_session_dir: &Path,
) -> String {
    format!(
...
fn refusal_status(
    ...
    latest_capstone_certificate_step: Option<PackageKeystoneReceiptLatestStepArtifact>,
    keystone_receipt_step: Option<PackageKeystoneReceiptLatestStepArtifact>,
) -> PackageKeystoneReceiptLatestStatus {
    ...
    PackageKeystoneReceiptLatestStatus {
        ...
        result,
        reason,
        latest_capstone_certificate_plan_verdict: resolved
            .map(|value| value.latest_capstone_certificate_plan.verdict.clone()),
        latest_capstone_certificate_verdict: latest_capstone_certificate_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        keystone_receipt_verdict: keystone_receipt_step
            .as_ref()
            .map(|value| value.verdict.clone()),
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
...
fn refusal_status_from_resolution_failure(
    ...
    PackageKeystoneReceiptLatestStatus {
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        latest_capstone_certificate_plan_step: failure
            .latest_capstone_certificate_plan_raw
            .as_ref()
            .map(|_| {
                step_artifact(
                    ...
                    failure
                        ...
                        .unwrap_or("<missing>"),
                    failure
                        .latest_capstone_certificate_plan_reason
                        .as_deref()
                        .unwrap_or("<missing>"),
                    failure
                        .latest_capstone_certificate_plan_generated_at
                        .unwrap_or_else(Utc::now),
                )
            }),
        latest_capstone_certificate_step: None,
        keystone_receipt_step: None,
...
fn verify_invalid_keystone_receipt_latest_report_without_session(
    session_dir: &Path,
    verification_mismatches: Vec<String>,
) -> PackageKeystoneReceiptLatestReport {
    ...
    PackageKeystoneReceiptLatestReport {
        generated_at: Utc::now(),
        mode: "verify_latest_keystone_receipt".to_string(),
        verdict: TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestVerifyInvalid,
        reason,
        root: None,
        ...
        session_dir: Some(session_dir.display().to_string()),
        keystone_receipt_latest_session_path: Some(
            keystone_receipt_latest_paths(session_dir)
                .session_path
                .display()
                .to_string(),
        ),
        keystone_receipt_latest_status_path: Some(
            keystone_receipt_latest_paths(session_dir)
                .status_path
                .display()
                .to_string(),
        ),
        keystone_receipt_latest_report_path: Some(
            keystone_receipt_latest_paths(session_dir)
                .report_path
                .display()
                .to_string(),
        ),
        latest_capstone_certificate_plan_report_path: None,
        latest_capstone_certificate_report_path: None,
        keystone_receipt_report_path: None,
        nested_capstone_certificate_latest_session_dir: None,
        nested_keystone_receipt_session_dir: None,
        ...
        current_pre_activation_gate_verdict: None,
        current_pre_activation_gate_reason: None,
        resolve_latest_capstone_certificate_command_summary: None,
        run_latest_keystone_receipt_command_summary: None,
        verify_latest_keystone_receipt_command_summary: None,
        downstream_keystone_receipt_command_summary: None,
        verify_capstone_certificate_command_summary: None,
...
fn fallback_capstone_certificate_latest_copy() -> KeystoneReceiptLatestReportView {
    KeystoneReceiptLatestReportView {
        generated_at: Utc::now(),
...
fn fallback_notarization_receipt_session(
    snapshot: &LatestCulminationReceiptSnapshot,
    session_dir: &Path,
) -> CapstoneCertificateSessionView {
    CapstoneCertificateSessionView {
        capstone_certificate_session_dir: "<missing>".to_string(),
        ...
        session_dir: session_dir.display().to_string(),
        verify_capstone_certificate_command_summary:
            keystone_receipt_verify_capstone_certificate_command_summary(Path::new("<missing>")),
        ...
        explicit_statement:
            "the verified pinnacle-receipt session is the primary input here; this immutable capstone certificate freezes one final sovereign identity over the fully culminated chain without enabling production execution"
                .to_string(),
    }
}
...
fn fallback_notarization_receipt_status(
    ...
    CapstoneCertificateStatusView {
        ...
        keystone_receipt_algorithm: "sha256".to_string(),
        explicit_statement:
            "this capstone certificate is archival and read-only; it never executes or enables the frozen controller"
                .to_string(),
    }
}

fn render_report_lines(report: &PackageKeystoneReceiptLatestReport) -> String {
    let mut lines = vec![
    ...
    if let Some(value) = &report.nested_capstone_certificate_latest_session_dir {
        lines.push(format!(
            "nested_capstone_certificate_latest_session_dir={value}"
        ));
    }
    ...
    if let Some(value) = &report.nested_keystone_receipt_session_dir {
        lines.push(format!("nested_keystone_receipt_session_dir={value}"));
    }
    if let Some(value) = &report.result {
        lines.push(format!("result={value}"));
    }
    if let Some(value) = &report.downstream_keystone_receipt_command_summary {
        lines.push(format!(
            "downstream_keystone_receipt_command_summary={value}"
        ));
    }
...
mod tests {
    ...
    struct FakeNotarizationReceiptLatestFixture {
        ...
        capstone_certificate_latest_plan_json_path: PathBuf,
        capstone_certificate_latest_run_json_path: PathBuf,
        capstone_certificate_latest_verify_json_path: PathBuf,
    ...
    impl FakeNotarizationReceiptLatestFixture {
        fn plan_config(&self) -> Config {
            Config {
                mode: Mode::PlanLatestKeystoneReceipt,
        ...
        fn render_config(&self) -> Config {
            Config {
                mode: Mode::RenderLatestKeystoneReceiptScript,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
        ...
        fn run_config(&self) -> Config {
            Config {
                mode: Mode::RunLatestKeystoneReceipt,
                root: Some(self.root.clone()),
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
        ...
        fn verify_config(&self) -> Config {
            Config {
                mode: Mode::VerifyLatestKeystoneReceipt,
                root: None,
                session_dir: Some(self.wrapper_session_dir.clone()),
                output_path: None,
                json: true,
    ...
    #[test]
    fn plan_mode_resolves_latest_valid_clerestory_chain_to_exact_expected_nested_latest_capstone_certificate_lineage(
    ) {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_plan_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let report = plan_latest_keystone_receipt_report(&fixture.plan_config()).unwrap();
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        assert_eq!(
            report.verdict,
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestPlanReady
        );
        assert_eq!(report.mode, "plan_latest_keystone_receipt");
        assert_eq!(
            report.latest_top_step_name.as_deref(),
    ...
    fn render_mode_emits_exact_downstream_provenance_certificate_contract_not_second_controller_path(
        ...
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_render_ok",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let report =
            render_latest_keystone_receipt_script_report(&fixture.render_config()).unwrap();
        assert_eq!(
            report.verdict,
            TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestScriptRendered
        );
        assert_eq!(report.mode, "render_latest_keystone_receipt_script");
        let script = fs::read_to_string(&fixture.output_script_path).unwrap();
        assert!(script.contains(CAPSTONE_CERTIFICATE_LATEST_BIN));
        assert!(script.contains(KEYSTONE_RECEIPT_BIN));
        assert!(script.contains("--capstone-certificate-session-dir"));
        assert!(!script.contains("--activation-ticket-session-dir"));
        assert!(script.contains("--run-live-package-keystone-receipt"));
        assert!(script.contains("--verify-live-package-keystone-receipt"));
    ...
    fn run_mode_refuses_when_latest_chain_missing_invalid_or_below_clerestory() {
        for (label, verdict, reason, expected) in [
            (
                "capstone_certificate_latest_missing",
                "tiny_live_package_capstone_certificate_latest_refused_by_missing_latest_chain",
                "no persisted immutable chain exists",
                TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestRefusedByMissingLatestChain,
            ),
            (
                "capstone_certificate_latest_invalid",
                "tiny_live_package_capstone_certificate_latest_refused_by_invalid_latest_chain",
                "latest immutable chain is incomplete",
                TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestRefusedByInvalidLatestChain,
            ),
            (
                "capstone_certificate_latest_below",
                "tiny_live_package_capstone_certificate_latest_refused_by_invalid_latest_chain",
            ...
            let mut plan: Value = load_json(&fixture.capstone_certificate_latest_plan_json_path).unwrap();
            plan["verdict"] = json!(verdict);
            plan["reason"] = json!(reason);
            if label.ends_with("below") {
                plan["latest_top_step_name"] = json!("choir_receipt");
            }
            persist_json(&fixture.capstone_certificate_latest_plan_json_path, &plan).unwrap();

            let report = run_latest_keystone_receipt_report(&fixture.run_config()).unwrap();
            assert_eq!(report.verdict, expected);
        }
    }

    #[test]
    fn plan_mode_maps_real_latest_capstone_certificate_drift_verdict_to_local_drift_refusal() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_plan_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let mut plan: Value =
            load_json(&fixture.capstone_certificate_latest_plan_json_path).unwrap();
        plan["verdict"] = json!(
            "tiny_live_package_capstone_certificate_latest_refused_by_drifted_capstone_certificate_contract"
        );
        plan["reason"] = json!("real accepted latest-capstone-certificate drift");
        persist_json(&fixture.capstone_certificate_latest_plan_json_path, &plan).unwrap();
    ...
    #[test]
    fn run_mode_takes_terminal_drift_refusal_when_nested_latest_capstone_certificate_reports_real_drift(
    ) {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_run_drift",
            "refused_by_drifted_capstone_certificate_contract",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert_eq!(report.keystone_receipt_verdict.as_deref(), None);
    }

    #[test]
    fn run_mode_refuses_when_nested_release_capsule_lineage_drifts_from_latest_immutable_chain() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_handoff_bundle_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);

        let mut run: Value = load_json(&fixture.capstone_certificate_latest_run_json_path).unwrap();
        run["package_dir"] = json!("/tampered/package");
        persist_json(&fixture.capstone_certificate_latest_run_json_path, &run).unwrap();
        ...
        assert!(report
            .reason
            .contains("stored latest-capstone-certificate run package_dir"));
    }

    #[test]
    fn verify_mode_fails_when_persisted_latest_capstone_certificate_artifacts_are_tampered_or_missing_nested_lineage_truth(
    ) {
        {
            let fixture = fake_capstone_certificate_latest_fixture(
                "capstone_certificate_latest_verify_tampered_copy",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            run_latest_keystone_receipt_report(&fixture.run_config()).unwrap();

            let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
            let mut report: Value = load_json(&paths.keystone_receipt_report_path).unwrap();
            ...
            let verify = verify_latest_keystone_receipt_report(&fixture.verify_config()).unwrap();
            assert_eq!(
                verify.verdict,
                TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestVerifyInvalid
            );
        ...
        {
            let fixture = fake_capstone_certificate_latest_fixture(
                "capstone_certificate_latest_verify_missing_nested_truth",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
            ...
            let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
            fs::remove_file(nested_capstone_certificate_latest_report_path(
                &paths.nested_capstone_certificate_latest_session_dir,
            ))
            .unwrap();
            ...
            assert!(verify.verification_mismatches.iter().any(|entry| {
                entry.contains(
                    "tiny_live_activation_package_capstone_certificate_latest.report.json",
                )
            }));
        }
    }
    ...
    fn verify_accepts_real_shaped_native_keystone_identity_layers_on_happy_path() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_real_shaped_finality_paths_green",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn run_and_verify_reject_stale_capstone_wrapper_schema_for_downstream_keystone_copy() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_rejects_stale_capstone_wrapper_schema",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        assert!(paths.keystone_receipt_report_path.ends_with(
            "tiny_live_activation_package_keystone_receipt_latest.keystone_receipt.report.json"
        ));
        assert!(paths.keystone_receipt_report_path.exists());
        assert!(
            !fixture
                .wrapper_session_dir
                .join(
                    "tiny_live_activation_package_keystone_receipt_latest.capstone_certificate.report.json"
                )
                .exists()
        );
        ...
        let stored_step = status
            .get("keystone_receipt_step")
            .cloned()
            .expect("keystone_receipt_step should be present");
        assert!(status.get("capstone_certificate_step").is_none());
        status["capstone_certificate_step"] = stored_step;
        if let Some(object) = status.as_object_mut() {
            object.remove("keystone_receipt_step");
        }
        persist_json(&paths.status_path, &status).unwrap();

        let error = verify_latest_keystone_receipt_report(&fixture.verify_config()).unwrap_err();
        assert!(error.to_string().contains("keystone_receipt_step"));
    }

    #[test]
    fn verify_names_keystone_receipt_when_nested_native_session_load_breaks() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_nested_pinnacle_session_load_break",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        fs::remove_file(nested_keystone_receipt_session_path(
            &paths.nested_keystone_receipt_session_dir,
        ))
        .unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("failed reading nested keystone-receipt session under")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_keystone_receipt_session_path_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_finality_session_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.keystone_receipt_report_path).unwrap();
        report["keystone_receipt_session_path"] = json!("/tampered/finality-receipt-session.json");
        persist_json(&paths.keystone_receipt_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt run keystone_receipt_session_path")
        }));
    }

    #[test]
    fn verify_fails_when_copied_native_keystone_receipt_status_path_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_finality_status_path_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.keystone_receipt_report_path).unwrap();
        report["keystone_receipt_status_path"] = json!("/tampered/finality-receipt-status.json");
        persist_json(&paths.keystone_receipt_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt run keystone_receipt_status_path")
        }));
    }
    ...
    fn verify_fails_when_copied_native_pinnacle_receipt_sha256_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_pinnacle_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy pinnacle_receipt_sha256")
        }));
    }

    #[test]
    fn verify_fails_when_copied_nested_latest_capstone_certificate_explicit_statement_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_launch_packet_explicit_statement_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        let mut report: Value = load_json(&paths.latest_capstone_certificate_report_path).unwrap();
        report["explicit_statement"] =
            json!("tampered nested latest release capsule explicit statement");
        persist_json(&paths.latest_capstone_certificate_report_path, &report).unwrap();
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored latest-capstone-certificate copy explicit_statement")
        }));
    }

    #[test]
    fn verify_rejects_tampered_stale_capstone_certificate_wrapper_mode_string() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_wrapper_mode_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        report["mode"] = json!("run_latest_capstone_certificate");
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| { entry.contains("latest-keystone-receipt stored report mode") }));
    }

    #[test]
    fn downstream_native_capstone_session_dir_uses_real_capstone_certificate_session_path() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_downstream_session_dir_shape",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);

        let downstream = expected_downstream_capstone_certificate_session_dir(&paths);
        let expected = paths.nested_capstone_certificate_latest_session_dir.join(
            "tiny_live_activation_package_capstone_certificate_latest.capstone_certificate_session",
        );
        ...
        assert!(downstream
            ...
            .unwrap()
            .to_string_lossy()
            .contains("capstone_certificate_session"));
        assert!(!downstream
            .file_name()
            .unwrap()
            .to_string_lossy()
    ...
    #[test]
    fn run_persists_copied_native_capstone_session_and_status_under_real_capstone_filenames() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_native_capstone_filenames",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(
            real_session.exists(),
            "missing real native capstone session path"
        );
        assert!(
            real_status.exists(),
            "missing real native capstone status path"
        );
        assert!(
            !stale_session.exists(),
            "stale native pinnacle session filename should not be used"
        );
        assert!(
            !stale_status.exists(),
            "stale native pinnacle status filename should not be used"
        );
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_decision_packet_result_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_decision_packet_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy decision_packet_result")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_attestation_seal_session_dir_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_attestation_seal_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy attestation_seal_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_registry_entry_session_dir_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_registry_entry_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy registry_entry_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_notarization_receipt_session_dir_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_notarization_receipt_session_dir_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy notarization_receipt_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_summary_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_chain_fingerprint_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy chain_fingerprint_summary")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_sha256_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_chain_fingerprint_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy chain_fingerprint_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_notarization_receipt_chain_fingerprint_algorithm_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_chain_fingerprint_algorithm_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy chain_fingerprint_algorithm")
        }));
    }
    ...
    fn verify_fails_when_copied_native_completion_certificate_closure_certificate_sha256_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_closure_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy closure_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_archive_receipt_sha256_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_archive_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy archive_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_finality_receipt_finality_receipt_sha256_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_finality_receipt_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy finality_receipt_sha256")
        }));
    }
    ...
    fn verify_fails_when_copied_native_consummation_record_sha256_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_consummation_record_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy consummation_record_sha256")
        }));
    }
    ...
    {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_completion_certificate_sha256_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy completion_certificate_sha256")
        }));
    }
    ...
    fn verify_fails_when_downstream_decision_packet_confirmation_anchor_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_decision_packet_anchor_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify.verification_mismatches.iter().any(|entry| {
            entry.contains("stored keystone-receipt copy decision_packet_session_dir")
        }));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_execute_frozen_result_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_current_authorization_result_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| { entry.contains("stored keystone-receipt copy execute_frozen_result") }));
    }

    #[test]
    fn verify_fails_when_copied_nested_keystone_receipt_verdict_drifts() {
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_release_capsule_verdict_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        assert!(verify
            .verification_mismatches
            .iter()
            .any(|entry| entry.contains("stored keystone-receipt copy verdict")));
    }
    ...
    fn verify_fails_when_copied_nested_provenance_certificate_current_live_cutover_controller_summary_drifts(
        ...
        let fixture = fake_capstone_certificate_latest_fixture(
            "capstone_certificate_latest_verify_current_live_cutover_summary_drift",
            "runnable_when_gate_truth_turns_green",
            "ready_for_manual_go_live_signoff",
        );
        let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn all_modes_preserve_stage3_and_pre_activation_refusal_semantics_and_do_not_imply_activation_authorization_by_themselves(
        ...
        {
            let fixture = fake_capstone_certificate_latest_fixture(
                "capstone_certificate_latest_stage3",
                "refused_now_by_stage3",
                "refused_now_by_stage3",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);

            let plan = plan_latest_keystone_receipt_report(&fixture.plan_config()).unwrap();
            assert_eq!(
                plan.verdict,
                TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestPlanReady
            );
            assert_eq!(plan.mode, "plan_latest_keystone_receipt");
            assert!(!plan.activation_authorized);

            let run = run_latest_keystone_receipt_report(&fixture.run_config()).unwrap();
            assert_eq!(
                run.verdict,
                TinyLivePackageKeystoneReceiptLatestVerdict::TinyLivePackageKeystoneReceiptLatestRefusedNowByStage3
            );
            assert_eq!(run.mode, "run_latest_keystone_receipt");
            ...
            assert_eq!(verify.mode, "verify_latest_keystone_receipt");
            assert!(!verify.activation_authorized);
        }

        {
            let fixture = fake_capstone_certificate_latest_fixture(
                "capstone_certificate_latest_pre_activation",
                "refused_now_by_pre_activation_gate",
                "refused_now_by_pre_activation_gate",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
        ...
        {
            let fixture = fake_capstone_certificate_latest_fixture(
                "capstone_certificate_latest_green",
                "runnable_when_gate_truth_turns_green",
                "ready_for_manual_go_live_signoff",
            );
            let _path_guard = PathGuard::install(&fixture.bin_dir);
    ...
    fn fake_capstone_certificate_latest_fixture(
        label: &str,
        capstone_certificate_latest_run_result: &str,
        ...
        let capstone_certificate_latest_plan_json_path =
            temp_dir.join("capstone_certificate_latest.plan.json");
        let capstone_certificate_latest_run_json_path =
            temp_dir.join("capstone_certificate_latest.run.json");
        let capstone_certificate_latest_verify_json_path =
            temp_dir.join("capstone_certificate_latest.verify.json");
        ...
        let fixture = FakeNotarizationReceiptLatestFixture {
            ...
            install_root,
            backend_command,
            capstone_certificate_latest_plan_json_path,
            capstone_certificate_latest_run_json_path,
            capstone_certificate_latest_verify_json_path,
        ...
        persist_json(
            &fixture.capstone_certificate_latest_plan_json_path,
            &default_capstone_certificate_latest_plan_report(&fixture),
        )
        .unwrap();
        persist_json(
            &fixture.capstone_certificate_latest_run_json_path,
            &default_capstone_certificate_latest_run_report(
                &fixture,
                capstone_certificate_latest_run_result,
            ),
        )
        .unwrap();
        persist_json(
            &fixture.capstone_certificate_latest_verify_json_path,
            &default_capstone_certificate_latest_verify_report(
                &fixture,
                capstone_certificate_latest_run_result,
            ),
        )
        ...
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        write_fake_capstone_certificate_latest_command(
            &fixture.bin_dir.join(CAPSTONE_CERTIFICATE_LATEST_BIN),
            &fixture.capstone_certificate_latest_plan_json_path,
            &fixture.capstone_certificate_latest_run_json_path,
            &fixture.capstone_certificate_latest_verify_json_path,
            &fixture.root,
        ...
        write_fake_release_capsule_command(
            &fixture.bin_dir.join(KEYSTONE_RECEIPT_BIN),
            &fixture.handoff_bundle_run_json_path,
            &fixture.handoff_bundle_verify_json_path,
            &fixture.handoff_bundle_session_json_path,
            &fixture.handoff_bundle_status_json_path,
    ...
    fn default_capstone_certificate_latest_plan_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
    ) -> Value {
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        json!({
            "generated_at": Utc::now(),
            "mode": "plan_latest_keystone_receipt",
            "verdict": CAPSTONE_CERTIFICATE_LATEST_PLAN_READY,
            "reason": "latest immutable chain resolves cleanly into accepted latest-capstone-certificate contract",
            ...
            "session_dir": paths.nested_capstone_certificate_latest_session_dir.display().to_string(),
            ...
            "activation_authorized": false,
            "explicit_statement": "latest capstone-certificate wrapper plan"
        })
    }

    fn canonical_capstone_certificate_latest_result(result: &str) -> &str {
        match result {
            "runnable_when_gate_truth_turns_green" => {
                "ready_for_manual_execution_when_gate_turns_green"
            }
    ...
    fn default_capstone_certificate_latest_run_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let result = canonical_capstone_certificate_latest_result(result);
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        let (verdict, gate_verdict, gate_reason) = match result {
            "ready_for_manual_execution_when_gate_turns_green" => (
                "tiny_live_package_capstone_certificate_latest_ready_for_manual_execution_when_gate_turns_green",
                Value::Null,
                Value::Null,
            ),
            "refused_now_by_stage3" => (
                "tiny_live_package_capstone_certificate_latest_refused_now_by_stage3",
                json!("blocked"),
                json!("stage3 blocked"),
            ),
            "refused_now_by_pre_activation_gate" => (
                "tiny_live_package_capstone_certificate_latest_refused_now_by_pre_activation_gate",
                json!("blocked"),
        ...
        json!({
            "generated_at": Utc::now(),
            "mode": "run_latest_keystone_receipt",
            "verdict": verdict,
            "reason": format!("latest capstone-certificate {result}"),
            "latest_top_step_name": "clerestory_certificate",
            "latest_top_session_dir": fixture.latest_top_session_dir.display().to_string(),
            "historical_execute_frozen_session_dir": fixture.historical_execute_frozen_session_dir.display().to_string(),
            "turn_green_session_dir": fixture.turn_green_session_dir.display().to_string(),
            ...
            "clerestory_certificate_algorithm": "sha256",
            "activation_authorized": false,
            "explicit_statement": "latest capstone-certificate wrapper run"
        })
    }

    fn default_capstone_certificate_latest_verify_report(
        fixture: &FakeNotarizationReceiptLatestFixture,
        result: &str,
    ) -> Value {
        let mut report = default_capstone_certificate_latest_run_report(fixture, result);
        report["mode"] = json!("verify_latest_keystone_receipt");
        report["verdict"] = json!(CAPSTONE_CERTIFICATE_LATEST_VERIFY_OK);
    ...
    fn default_provenance_certificate_session(
        ...
        let paths = keystone_receipt_latest_paths(&fixture.wrapper_session_dir);
        let capstone_certificate_session_dir =
            expected_downstream_capstone_certificate_session_dir(&paths);
        ...
        json!({
            "session_version": "1",
            "planned_at": Utc::now(),
            "capstone_certificate_session_dir": capstone_certificate_session_dir.display().to_string(),
            ...
            "release_capsule_session_dir": capstone_certificate_session_dir.display().to_string(),
            ...
            "wrapper_timeout_ms": snapshot.wrapper_timeout_ms,
            "service_status_max_staleness_ms": snapshot.service_status_max_staleness_ms,
            "session_dir": keystone_receipt_latest_paths(&fixture.wrapper_session_dir).nested_keystone_receipt_session_dir.display().to_string(),
            "verify_capstone_certificate_command_summary": keystone_receipt_verify_capstone_certificate_command_summary(&capstone_certificate_session_dir),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
            ...
            "keystone_receipt_summary": "Keystone receipt identity: fixture immutable imperial seal over verified capstone-certificate truth.",
            "keystone_receipt_sha256": "fixture-keystone-receipt-sha256",
            "keystone_receipt_algorithm": "sha256",
            "explicit_statement": "the verified pinnacle-receipt session is the primary input here; this immutable capstone certificate freezes one final sovereign identity over the fully culminated chain without enabling production execution"
        })
    }
    ...
    fn default_provenance_certificate_status(
        ...
        json!({
            "status_version": "1",
            "updated_at": Utc::now(),
            "session_dir": paths.nested_keystone_receipt_session_dir.display().to_string(),
            "capstone_certificate_session_dir": expected_downstream_capstone_certificate_session_dir(&paths).display().to_string(),
            "result": result,
            "reason": reason,
            ...
            "current_pre_activation_gate_verdict": gate_verdict,
            "current_pre_activation_gate_reason": gate_reason,
            "keystone_receipt_step": Value::Null,
            ...
            "capstone_certificate_sha256": "fixture-capstone-certificate-sha256",
            "capstone_certificate_algorithm": "sha256",
            "keystone_receipt_summary": "Keystone receipt identity: fixture status immutable imperial seal over verified capstone-certificate truth.",
            "keystone_receipt_sha256": "fixture-keystone-receipt-sha256",
            "keystone_receipt_algorithm": "sha256",
            "explicit_statement": "this capstone certificate is archival and read-only; it never executes or enables the frozen controller"
        })
    }
    ...
    fn default_provenance_certificate_run_report(
        ...
        let keystone_receipt_verdict = match result {
            "ready_for_manual_execution_when_gate_turns_green" => {
                "tiny_live_package_keystone_receipt_ready_for_manual_execution_when_gate_turns_green"
            }
            "refused_now_by_stage3" => "tiny_live_package_keystone_receipt_refused_now_by_stage3",
            "refused_now_by_pre_activation_gate" => {
                "tiny_live_package_keystone_receipt_refused_now_by_pre_activation_gate"
            }
            _ => "tiny_live_package_keystone_receipt_refused_now_by_invalid_or_drifted_contract",
        };
        json!({
            "generated_at": Utc::now(),
            "mode": "run_live_package_keystone_receipt",
            "verdict": keystone_receipt_verdict,
            ...
            "release_capsule_session_dir": expected_downstream_capstone_certificate_session_dir(&paths).display().to_string(),
            ...
            "service_status_max_staleness_ms": 4500,
            "session_dir": paths.nested_keystone_receipt_session_dir.display().to_string(),
            "keystone_receipt_session_path": nested_keystone_receipt_session_path(&paths.nested_keystone_receipt_session_dir).display().to_string(),
            "keystone_receipt_status_path": nested_keystone_receipt_status_path(&paths.nested_keystone_receipt_session_dir).display().to_string(),
            "archived_capstone_certificate_report_path": paths.nested_keystone_receipt_session_dir.join("tiny_live_activation_package_capstone_certificate.capstone_certificate.report.json").display().to_string(),
            "result": result,
            ...
            "keystone_receipt_step": Value::Null,
            "verify_capstone_certificate_command_summary": keystone_receipt_verify_capstone_certificate_command_summary(&expected_downstream_capstone_certificate_session_dir(&paths)),
            "reviewed_frozen_live_cutover_controller_command_summary": fixture.frozen_controller_command,
            ...
            "keystone_receipt_summary": "Keystone receipt identity: fixture run immutable imperial seal over verified capstone-certificate truth.",
            "keystone_receipt_sha256": "fixture-keystone-receipt-sha256",
            "keystone_receipt_algorithm": "sha256",
    ...
    fn write_fake_capstone_certificate_latest_command(
        ...
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected latest-capstone-certificate session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --plan-latest-capstone-certificate \"*) mode='plan';;\n  *\" --run-latest-capstone-certificate \"*) mode='run';;\n  *\" --verify-latest-capstone-certificate \"*) mode='verify';;\n  *) echo 'unexpected latest-capstone-certificate mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  plan|run)\n    case \" $* \" in\n      *\" --root {} \"*) : ;;\n      *) echo 'unexpected root' >&2; exit 1;;\n    esac\n    ;;\nesac\ncase \"$mode\" in\n  plan) cat '{}';;\n  run) mkdir -p '{}'; cp '{}' '{}/tiny_live_activation_package_capstone_certificate_latest.report.json'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
            session_dir.display(),
            root.display(),
    ...
    fn write_fake_release_capsule_command(
        ...
        let nested_session_path = nested_keystone_receipt_session_path(session_dir);
        let nested_status_path = nested_keystone_receipt_status_path(session_dir);
        let script = format!(
            "#!/bin/sh\nset -eu\ncase \" $* \" in\n  *\" --capstone-certificate-session-dir {} \"*) : ;;\n  *) echo 'unexpected capstone-certificate-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --confirm-decision-packet-session-dir {} \"*) : ;;\n  *) echo 'unexpected confirm-decision-packet-session-dir' >&2; exit 1;;\nesac\ncase \" $* \" in\n  *\" --session-dir {} \"*) : ;;\n  *) echo 'unexpected capstone-certificate session-dir' >&2; exit 1;;\nesac\nmode=''\ncase \" $* \" in\n  *\" --run-live-package-keystone-receipt \"*) mode='run';;\n  *\" --verify-live-package-keystone-receipt \"*) mode='verify';;\n  *) echo 'unexpected keystone-receipt mode' >&2; exit 1;;\nesac\ncase \"$mode\" in\n  run) mkdir -p '{}'; cp '{}' '{}'; cp '{}' '{}'; cat '{}';;\n  verify) cat '{}';;\n  *) exit 1;;\nesac\n",
