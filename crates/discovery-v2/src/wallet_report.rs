...
pub fn build_discovery_v2_wallet_report(
    ...
    Ok(DiscoveryV2WalletReport {
        ...
        shadow_signals_24h: status.shadow_signals_24h,
...
fn report_row(
    ...
    DiscoveryV2WalletReportRow {
        ...
        shadow_pnl_sol_24h: metric.shadow_pnl_sol_24h,
        shadow_roi_24h: metric.shadow_roi_24h,
        shadow_worst_trade_roi_24h: metric.shadow_worst_trade_roi_24h,
        shadow_fast_loss_roi_24h: metric.shadow_fast_loss_roi_24h,
        shadow_stale_copy_loss_roi_24h: metric.shadow_stale_copy_loss_roi_24h,
