...
Date: 2026-03-23
Status: Canonical, Batch 1-3 implemented; bounded gap-fill compare-runs completed; live server is currently in bootstrap-degraded bridge mode
...
- код restore stack уже раскатан на live server в коммите `9661844`
...
3. Отдельно довести `live-safe recent raw snapshot` до реального серверного
   ...
   - snapshot path должен быть writer-safe под live writes
