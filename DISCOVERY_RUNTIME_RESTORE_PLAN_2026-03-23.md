...
- a read-only artifact validator has been accepted locally:
  `discovery_raw_gap_fill_program_history_artifact_validate`
- validator usage for the current exact window is:
