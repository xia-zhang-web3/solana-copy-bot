...
5. Cross-plan update (2026-02-19):
   ...
   14. go/no-go evidence helper added: `tools/execution_go_nogo_report.sh` composes calibration and runtime snapshot into a single `GO/NO_GO/HOLD` summary with gate reasons + ingestion context and optional artifact export; smoke suite validates paper-mode `HOLD` and adapter-mode `NO_GO` branches.
