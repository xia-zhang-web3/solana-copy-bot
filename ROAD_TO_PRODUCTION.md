...
5. `P1` investigate SQLite/WAL reliability as a separate track.
   ...
   12. remaining work is still broader than startup / heartbeat / history retention / observed-swap retention / stale-close cleanup / alert delivery / discovery cursor persistence / writer-owned discovery scoring materialization:
   ...
   13. not closed by either `e24eca2` or `8caa9b7`.
