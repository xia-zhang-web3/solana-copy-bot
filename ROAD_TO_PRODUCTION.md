...
25. execution telemetry now emits per-route counters per batch (`submit_attempted/retry/failed` + `pretrade_retry/rejected/failed` + `confirm_confirmed/retry/failed`) to support route-profile calibration.
