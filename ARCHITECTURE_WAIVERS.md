...
## Retired Guard Bootstrap Baseline

The initial architecture-guard rollout compared a pre-policy tree to the
refactor branch and recorded current include-shard debt as the baseline.

This waiver is now closed. Any increase in include-shard count is a normal guard
failure, including long-lived branches rebased from pre-policy history.
